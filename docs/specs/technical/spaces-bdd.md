...
**Location:** `packages/core/src/domain/spaces/aggregates/space.aggregate.ts`
...
**Space Member Roles:**
- **admin**: Full control (settings, members, content)
- **moderator**: Can moderate content, manage posts
...
Feature: Space Creation
  ...
  Scenario: Successful space creation
    ...
    Then the API should:
      ...
      3. Create space document with campusId: 'ub-buffalo'
...
**Location:** `packages/core/src/domain/spaces/events/space-created.event.ts`
...
**Location:** `packages/core/src/domain/spaces/events/member-joined.event.ts`
...
**Location:** `packages/core/src/domain/spaces/events/member-removed.event.ts`
...
**Location:** `packages/core/src/domain/spaces/events/member-role-updated.event.ts`
...
**Location:** `packages/core/src/domain/spaces/events/post-created.event.ts`
...
**Location:** `packages/core/src/application/space-discovery.service.ts`
...
Invariant: No two spaces can have the same name on a campus
  Given a space "UB Computer Science" exists on "ub-buffalo"
...
**Location:** `apps/web/src/app/api/spaces/route.ts`
...
**Location:** `apps/web/src/app/api/spaces/[spaceId]/seed-rss/route.ts`
...
- **Domain Model:** `packages/core/src/domain/spaces/`
- **Application Services:** `packages/core/src/application/space-discovery.service.ts`
- **API Routes:** `apps/web/src/app/api/spaces/`
