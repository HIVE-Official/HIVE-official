...
✓ Access Control & Integrations
  ...
  - Space integration
  - Usage analytics
  - Calendar/email connector packs
  - LMS/data export hooks
  - Connector SDK for campus IT
```
...
○ Advanced Features
  ...
  - Template kit expansion
  - AI-assisted draft builder (planned)

○ Connectors
  - Partner-built integrations via SDK
  - Governance process for submissions
