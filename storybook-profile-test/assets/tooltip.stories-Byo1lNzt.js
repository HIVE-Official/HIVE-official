import{j as e}from"./jsx-runtime-B9GTzLod.js";import{T as a,C as p,I as b,D as h,L as x}from"./tooltip-Cmc7EsjU.js";import{H as i,a as s,b as r,c as n}from"./hive-card-DIMxrd4t.js";import{B as o}from"./badge-BLajwy0n.js";import{B as t}from"./button-enhanced-DKTgaNxR.js";/* empty css                    */import"./index-BMjrbHXN.js";import"./index-BwobEAja.js";import"./utils-CytzSlOG.js";import"./framer-motion-proxy-Bip1EXUU.js";const P={title:"01-Atoms/Tooltip - COMPLETE DEFINITION",component:a,parameters:{docs:{description:{component:`
...
`}}},tags:["autodocs"],argTypes:{placement:{control:"select",options:["top","bottom","left","right"],description:"Tooltip placement relative to trigger element"},trigger:{control:"select",options:["hover","click","focus"],description:"How tooltip is triggered"},variant:{control:"select",options:["default","dark","light"],description:"Visual style variant"},size:{control:"select",options:["sm","md","lg"],description:"Tooltip size"},delay:{control:{type:"range",min:0,max:1e3,step:50},description:"Delay before showing tooltip (ms)"},arrow:{control:"boolean",description:"Show pointing arrow"},disabled:{control:"boolean",description:"Disable tooltip"}}},l={args:{content:"This course requires MTH 241 and CSE 250 as prerequisites",placement:"top",trigger:"hover",variant:"default",size:"md",delay:200,arrow:!0,disabled:!1},render:m=>e.jsx("div",{className:"flex justify-center items-center h-32 p-6 bg-[var(--hive-background-primary)]",children:e.jsx(a,{...m,children:e.jsx(t,{variant:"outline",children:"CSE 331 Prerequisites"})})})},c={render:()=>e.jsxs("div",{className:"space-y-8 p-6 bg-[var(--hive-background-primary)]",children:[e.jsxs(i,{children:[e.jsxs(s,{children:[e.jsxs(r,{className:"flex items-center gap-3",children:[e.jsx(o,{variant:"success",children:"✅ PLACEMENT"}),"Tooltip Placement - Smart Positioning"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"4 placement options with intelligent positioning relative to trigger elements"})]}),e.jsx(n,{children:e.jsxs("div",{className:"flex justify-center items-center min-h-[200px] bg-[var(--hive-background-secondary)] rounded-lg relative",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"w-4 h-4 bg-[var(--hive-brand-secondary)] rounded-full mx-auto mb-4"}),e.jsx("p",{className:"text-sm text-[var(--hive-text-tertiary)]",children:"Trigger Element"})]}),e.jsx("div",{className:"absolute top-8 left-1/2 -translate-x-1/2",children:e.jsx(a,{content:"Top placement tooltip for academic course information",placement:"top",variant:"default",children:e.jsx(t,{size:"sm",variant:"outline",children:"Top"})})}),e.jsx("div",{className:"absolute bottom-8 left-1/2 -translate-x-1/2",children:e.jsx(a,{content:"Bottom placement tooltip for supplementary details",placement:"bottom",variant:"default",children:e.jsx(t,{size:"sm",variant:"outline",children:"Bottom"})})}),e.jsx("div",{className:"absolute left-8 top-1/2 -translate-y-1/2",children:e.jsx(a,{content:"Left placement tooltip for contextual help",placement:"left",variant:"default",children:e.jsx(t,{size:"sm",variant:"outline",children:"Left"})})}),e.jsx("div",{className:"absolute right-8 top-1/2 -translate-y-1/2",children:e.jsx(a,{content:"Right placement tooltip for additional information",placement:"right",variant:"default",children:e.jsx(t,{size:"sm",variant:"outline",children:"Right"})})})]})})]}),e.jsxs(i,{children:[e.jsxs(s,{children:[e.jsxs(r,{className:"flex items-center gap-3",children:[e.jsx(o,{variant:"info",children:"🎨 VARIANTS"}),"Tooltip Variants - Perfect Semantic Token Usage"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"3 visual variants using 100% semantic tokens for consistent theming"})]}),e.jsx(n,{children:e.jsxs("div",{className:"grid md:grid-cols-3 gap-6",children:[e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Default Variant:"}),e.jsx(a,{content:"Default tooltip style with secondary background and primary text. Perfect for general campus information and help text.",variant:"default",placement:"top",children:e.jsx(t,{variant:"default",children:"Course Info"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"General purpose tooltip"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Dark Variant:"}),e.jsx(a,{content:"Dark tooltip style with primary background for high contrast. Ideal for important notifications and system messages.",variant:"dark",placement:"top",children:e.jsx(t,{variant:"secondary",children:"System Status"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"High contrast tooltip"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Light Variant:"}),e.jsx(a,{content:"Light tooltip style with tertiary background for subtle information. Great for supplementary details and non-critical help.",variant:"light",placement:"top",children:e.jsx(t,{variant:"outline",children:"Additional Info"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Subtle information tooltip"})]})]})})]}),e.jsxs(i,{children:[e.jsxs(s,{children:[e.jsxs(r,{className:"flex items-center gap-3",children:[e.jsx(o,{variant:"primary",children:"⚡ TRIGGERS"}),"Trigger Types - Interaction Methods"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"3 trigger types for different campus interaction contexts and accessibility needs"})]}),e.jsx(n,{children:e.jsxs("div",{className:"grid md:grid-cols-3 gap-6",children:[e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Hover Trigger:"}),e.jsx(a,{content:"Hover to see course prerequisites and enrollment requirements. This tooltip appears on mouse hover and focus for accessibility.",trigger:"hover",delay:100,children:e.jsx(t,{variant:"default",children:"Hover Me"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Default hover interaction"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Click Trigger:"}),e.jsx(p,{content:"Click to toggle detailed course information. Click outside or on the button again to close. Perfect for mobile devices.",placement:"top",children:e.jsx(t,{variant:"secondary",children:"Click Me"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Mobile-friendly click interaction"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Focus Trigger:"}),e.jsx(a,{content:"Focus trigger shows tooltip when element receives keyboard focus. Essential for accessibility and keyboard navigation.",trigger:"focus",children:e.jsx(t,{variant:"outline",children:"Focus Me"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Keyboard navigation accessible"})]})]})})]}),e.jsxs(i,{children:[e.jsxs(s,{children:[e.jsxs(r,{className:"flex items-center gap-3",children:[e.jsx(o,{variant:"secondary",children:"📏 SIZES"}),"Tooltip Sizes - Content Capacity"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"3 sizes optimized for different content lengths and campus information types"})]}),e.jsx(n,{children:e.jsxs("div",{className:"grid md:grid-cols-3 gap-6",children:[e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Small Size:"}),e.jsx(a,{content:"Short help text",size:"sm",placement:"top",children:e.jsx(t,{size:"sm",variant:"outline",children:"Small Tooltip"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Brief information"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Medium Size:"}),e.jsx(a,{content:"Medium length tooltip with additional course details and enrollment information for students.",size:"md",placement:"top",children:e.jsx(t,{variant:"default",children:"Medium Tooltip"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Standard information"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Large Size:"}),e.jsx(a,{content:"Large tooltip capacity for comprehensive course descriptions, detailed prerequisites, semester availability, professor information, and complete enrollment requirements that students need to understand before registration.",size:"lg",placement:"top",children:e.jsx(t,{size:"lg",variant:"secondary",children:"Large Tooltip"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Detailed information"})]})]})})]}),e.jsxs(i,{children:[e.jsxs(s,{children:[e.jsxs(r,{className:"flex items-center gap-3",children:[e.jsx(o,{variant:"warning",children:"🛠️ FEATURES"}),"Advanced Features - Arrows, Delays, States"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Advanced tooltip features for enhanced campus UX and accessibility"})]}),e.jsx(n,{children:e.jsxs("div",{className:"space-y-8",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Arrow Options:"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx(a,{content:"Tooltip with arrow pointing to the trigger element for clear visual connection.",arrow:!0,placement:"top",children:e.jsx(t,{variant:"default",children:"With Arrow"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Clear visual connection"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx(a,{content:"Tooltip without arrow for cleaner, minimal appearance.",arrow:!1,placement:"top",children:e.jsx(t,{variant:"outline",children:"Without Arrow"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"Minimal appearance"})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Delay Timing:"}),e.jsxs("div",{className:"grid md:grid-cols-3 gap-6",children:[e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx(a,{content:"Immediate tooltip (0ms delay) for instant feedback.",delay:0,placement:"top",children:e.jsx(t,{variant:"default",children:"Instant"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"0ms delay"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx(a,{content:"Standard delay (200ms) for normal interactions.",delay:200,placement:"top",children:e.jsx(t,{variant:"secondary",children:"Standard"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"200ms delay"})]}),e.jsxs("div",{className:"text-center space-y-4",children:[e.jsx(a,{content:"Slow delay (500ms) to prevent accidental triggers.",delay:500,placement:"top",children:e.jsx(t,{variant:"outline",children:"Slow"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)]",children:"500ms delay"})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Disabled State:"}),e.jsxs("div",{className:"text-center",children:[e.jsx(a,{content:"This tooltip is disabled and will not appear.",disabled:!0,placement:"top",children:e.jsx(t,{variant:"outline",disabled:!0,children:"Disabled Tooltip"})}),e.jsx("p",{className:"text-xs text-[var(--hive-text-tertiary)] mt-2",children:"Tooltip disabled for inactive elements"})]})]})]})})]}),e.jsxs(i,{children:[e.jsxs(s,{children:[e.jsxs(r,{className:"flex items-center gap-3",children:[e.jsx(o,{variant:"info",children:"🎯 PRESETS"}),"Tooltip Presets - Common Campus Patterns"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Pre-built tooltip components for common campus help and information scenarios"})]}),e.jsx(n,{children:e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Info Tooltip:"}),e.jsx("div",{className:"text-center",children:e.jsx(b,{content:"General information tooltip using default styling for campus help text and feature explanations.",placement:"top",children:e.jsx(t,{variant:"default",children:"Campus Info"})})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Dark Tooltip:"}),e.jsx("div",{className:"text-center",children:e.jsx(h,{content:"High-contrast dark tooltip for important system notifications and critical campus alerts.",placement:"top",children:e.jsx(t,{variant:"secondary",children:"System Alert"})})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Light Tooltip:"}),e.jsx("div",{className:"text-center",children:e.jsx(x,{content:"Subtle light tooltip for supplementary campus information and non-critical help text.",placement:"top",children:e.jsx(t,{variant:"outline",children:"Extra Details"})})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Click Tooltip:"}),e.jsx("div",{className:"text-center",children:e.jsx(p,{content:"Click-triggered tooltip optimized for mobile campus interfaces and touch interactions.",placement:"top",children:e.jsx(t,{variant:"primary",children:"Mobile Friendly"})})})]})]})})]}),e.jsxs(i,{children:[e.jsxs(s,{children:[e.jsxs(r,{className:"flex items-center gap-3",children:[e.jsx(o,{variant:"primary",children:"🦌 UNIVERSITY AT BUFFALO"}),"Real Campus Tooltip Examples"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Tooltip usage in actual University at Buffalo academic and administrative contexts"})]}),e.jsxs(n,{className:"space-y-8",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Course Registration Interface:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-4",children:e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h5",{className:"font-medium text-[var(--hive-text-primary)]",children:"Course Selection:"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm",children:"CSE 331"}),e.jsx(a,{content:"Algorithm Analysis and Design - Covers asymptotic notation, recurrence relations, divide-and-conquer, greedy algorithms, dynamic programming, and graph algorithms. Prerequisites: CSE 250 (Data Structures) and MTH 241 (Calculus III).",size:"lg",placement:"right",children:e.jsx(t,{size:"sm",variant:"ghost",children:"ℹ️"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm",children:"Section A1"}),e.jsx(a,{content:"MWF 10:00-10:50am in Davis Hall 101. Instructor: Dr. Sarah Johnson. Available spots: 12/35. This section has historically high ratings for clear instruction.",placement:"right",children:e.jsx(t,{size:"sm",variant:"ghost",children:"📍"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm text-[var(--hive-status-warning)]",children:"Waitlist"}),e.jsx(a,{content:"Join the waitlist to be automatically enrolled if a spot opens. You'll be notified via email and UB mobile app. Waitlist position updates daily.",placement:"right",variant:"default",children:e.jsx(t,{size:"sm",variant:"ghost",children:"⏰"})})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h5",{className:"font-medium text-[var(--hive-text-primary)]",children:"Registration Tools:"}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{content:"Check if you meet all prerequisite requirements for this course. System will verify completion of CSE 250 and MTH 241 with minimum grades.",placement:"left",size:"md",children:e.jsx(t,{variant:"outline",size:"sm",children:"Check Prerequisites"})}),e.jsx(a,{content:"View your current course schedule for time conflicts. Shows all enrolled courses, work schedule, and campus commitments to help avoid scheduling conflicts.",placement:"left",size:"md",children:e.jsx(t,{variant:"outline",size:"sm",children:"View Schedule"})}),e.jsx(p,{content:"Get recommendations for courses that fit your schedule, major requirements, and academic interests. Based on your academic history and degree progress.",placement:"left",size:"lg",children:e.jsx(t,{variant:"secondary",size:"sm",children:"Course Recommendations"})})]})]})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Academic Dashboard:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-4",children:e.jsxs("div",{className:"grid md:grid-cols-3 gap-6",children:[e.jsxs("div",{className:"text-center space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2",children:[e.jsx("span",{className:"text-lg font-semibold text-[var(--hive-text-primary)]",children:"3.75"}),e.jsx(a,{content:"Current semester GPA calculation based on enrolled courses. Includes all courses in progress with current grades. Final GPA will be calculated after final exams.",placement:"top",size:"md",children:e.jsx(t,{size:"sm",variant:"ghost",children:"📊"})})]}),e.jsx("p",{className:"text-sm text-[var(--hive-text-secondary)]",children:"Current GPA"})]}),e.jsxs("div",{className:"text-center space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2",children:[e.jsx("span",{className:"text-lg font-semibold text-[var(--hive-text-primary)]",children:"102/120"}),e.jsx(a,{content:"Credit hours completed toward graduation. You need 120 total credits including 40 upper-level credits (300/400 level). Currently 18 credits remaining.",placement:"top",size:"md",children:e.jsx(t,{size:"sm",variant:"ghost",children:"🎓"})})]}),e.jsx("p",{className:"text-sm text-[var(--hive-text-secondary)]",children:"Credits Completed"})]}),e.jsxs("div",{className:"text-center space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2",children:[e.jsx("span",{className:"text-lg font-semibold text-[var(--hive-status-success)]",children:"Spring 2025"}),e.jsx(a,{content:"Expected graduation date based on current course enrollment and degree progress. Complete remaining 18 credits to graduate on schedule.",placement:"top",size:"md",children:e.jsx(t,{size:"sm",variant:"ghost",children:"📅"})})]}),e.jsx("p",{className:"text-sm text-[var(--hive-text-secondary)]",children:"Expected Graduation"})]})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Campus Services Navigation:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-4",children:e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx("h5",{className:"font-medium text-[var(--hive-text-primary)]",children:"Academic Resources:"}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm",children:"Lockwood Library"}),e.jsx(a,{content:"Main library with study spaces, computer labs, and research assistance. Open 24/7 during finals week. Current capacity: 847/1200 students.",placement:"right",size:"md",children:e.jsx(t,{size:"sm",variant:"ghost",children:"📚"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm",children:"Math Tutoring"}),e.jsx(a,{content:"Free tutoring for all math courses in Mathematics Learning Center (Math Building, Room 140). Walk-in hours: Mon-Fri 9am-5pm. No appointment needed.",placement:"right",size:"md",children:e.jsx(t,{size:"sm",variant:"ghost",children:"🧮"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm",children:"Writing Center"}),e.jsx(a,{content:"One-on-one writing consultations for any assignment or project. Located in Baldy Hall. Schedule appointments online through UB Connects.",placement:"right",size:"md",children:e.jsx(t,{size:"sm",variant:"ghost",children:"✍️"})})]})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("h5",{className:"font-medium text-[var(--hive-text-primary)]",children:"Campus Life:"}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm",children:"Student Union"}),e.jsx(h,{content:"Hub for dining, events, and student organizations. Food court open until 10pm. Student organization offices on 3rd floor. Event space bookings through UB Events.",placement:"right",size:"md",children:e.jsx(t,{size:"sm",variant:"ghost",children:"🏢"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm",children:"Recreation Center"}),e.jsx(x,{content:"Fitness facilities, group classes, and intramural sports. Current hours: 6am-11pm weekdays, 8am-10pm weekends. Towel service available.",placement:"right",size:"md",children:e.jsx(t,{size:"sm",variant:"ghost",children:"💪"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-sm",children:"Health Services"}),e.jsx(a,{content:"Michael Hall Health Center provides medical care, mental health counseling, and wellness programs. Emergency care available 24/7. Appointments recommended.",placement:"right",size:"md",variant:"default",children:e.jsx(t,{size:"sm",variant:"ghost",children:"🏥"})})]})]})]})]})})]})]})]})]})},d={args:{content:"University at Buffalo campus tooltip with helpful information",placement:"top",trigger:"hover",variant:"default",size:"md",delay:200,arrow:!0,disabled:!1},render:m=>e.jsx("div",{className:"flex justify-center items-center h-48 p-6 bg-[var(--hive-background-primary)]",children:e.jsxs(i,{children:[e.jsxs(s,{children:[e.jsx(r,{children:"Tooltip Playground"}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Use the controls to test different tooltip configurations"})]}),e.jsx(n,{className:"flex justify-center",children:e.jsx(a,{...m,children:e.jsx(t,{variant:"default",children:"UB Campus Tooltip"})})})]})})};var v,u,g;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
...
}`,...(g=(u=l.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};var f,y,N;c.parameters={...c.parameters,docs:{...(f=c.parameters)==null?void 0:f.docs,source:{originalSource:`{
        ...
        <CardContent>
          <div className="flex justify-center items-center min-h-[200px] bg-[var(--hive-background-secondary)] rounded-lg relative">
            ...
            <div className="absolute top-8 left-1/2 -translate-x-1/2">
              <Tooltip content="Top placement tooltip for academic course information" placement="top" variant="default">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
              <Tooltip content="Bottom placement tooltip for supplementary details" placement="bottom" variant="default">
            ...
            <div className="absolute left-8 top-1/2 -translate-y-1/2">
              <Tooltip content="Left placement tooltip for contextual help" placement="left" variant="default">
            ...
            <div className="absolute right-8 top-1/2 -translate-y-1/2">
              <Tooltip content="Right placement tooltip for additional information" placement="right" variant="default">
        ...
        <CardContent>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center space-y-4">
              ...
              <Tooltip content="Default tooltip style with secondary background and primary text. Perfect for general campus information and help text." variant="default" placement="top">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Tooltip content="Join the waitlist to be automatically enrolled if a spot opens. You'll be notified via email and UB mobile app. Waitlist position updates daily." placement="right" variant="default">
                        <Button size="sm" variant="ghost">⏰</Button>
                      </Tooltip>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Tooltip content="Michael Hall Health Center provides medical care, mental health counseling, and wellness programs. Emergency care available 24/7. Appointments recommended." placement="right" size="md" variant="default">
                        <Button size="sm" variant="ghost">🏥</Button>
                      </Tooltip>
                    </div>
                  </div>
...
}`,...(N=(y=c.parameters)==null?void 0:y.docs)==null?void 0:N.source}}};var j,T,C;d.parameters={...d.parameters,docs:{...(j=d.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
...
}`,...(C=(T=d.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};const M=["Default","CompleteShowcase","Playground"];export{c as CompleteShowcase,l as Default,d as Playground,M as __namedExportsOrder,P as default};
