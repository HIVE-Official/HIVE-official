import{j as e}from"./jsx-runtime-B9GTzLod.js";import{r as re}from"./index-BMjrbHXN.js";import{c as m}from"./utils-CytzSlOG.js";import{H as c,a as p,c as d,b as v}from"./hive-card-DIMxrd4t.js";import{B as u}from"./badge-BLajwy0n.js";import{T as r}from"./text-BOe2XosQ.js";import{B as g}from"./button-enhanced-DKTgaNxR.js";import{T as J}from"./trophy-Cdnp2oJR.js";import{S as ie}from"./settings-Cw08DGvz.js";import{B as G}from"./bar-chart-3-h9BTbren.js";import{T as K}from"./trending-up-DHCBXhUA.js";import{A as te}from"./award-DbQCrh6E.js";import{C as se}from"./chevron-right-CIwutkFF.js";import{T as f}from"./target-oZw-M8_W.js";import{E as oe}from"./eye-DHVClHkA.js";import{D as ne}from"./download-B_gmnu9b.js";import{Z as ce}from"./zap-BzDMfB1h.js";import{U as _}from"./users-B5XgMSov.js";import{A as de}from"./activity-BpE6NZRo.js";import{M as H}from"./minus-DgcdAxY4.js";import{A as le}from"./arrow-down-DRk5yD8I.js";import{A as me}from"./arrow-up-3WJGBaNT.js";import{H as ge}from"./heart-BuGzDzw2.js";import{a}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";/* empty css                    */import"./index-BwobEAja.js";import"./framer-motion-proxy-Bip1EXUU.js";import"./createLucideIcon-DtX30ipI.js";import"./v4-CtRu48qb.js";const pe=s=>{const o={engagement:{color:"text-blue-500",bgColor:"bg-blue-500/10",borderColor:"border-blue-500/20",icon:de,label:"Engagement"},academic:{color:"text-green-500",bgColor:"bg-green-500/10",borderColor:"border-green-500/20",icon:f,label:"Academic"},social:{color:"text-purple-500",bgColor:"bg-purple-500/10",borderColor:"border-purple-500/20",icon:_,label:"Social"},productivity:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",borderColor:"border-[var(--hive-gold)]/20",icon:ce,label:"Productivity"},growth:{color:"text-pink-500",bgColor:"bg-pink-500/10",borderColor:"border-pink-500/20",icon:K,label:"Growth"}};return o[s]||o.engagement},ve=s=>({up:me,down:le,stable:H})[s]||H,ue=s=>{const o={up:"text-green-500",down:"text-red-500",stable:"text-[var(--hive-text-muted)]"};return o[s]||o.stable},ye=s=>{const o={academic:{color:"text-blue-500",bgColor:"bg-blue-500/10",icon:f,label:"Academic"},social:{color:"text-purple-500",bgColor:"bg-purple-500/10",icon:_,label:"Social"},personal:{color:"text-green-500",bgColor:"bg-green-500/10",icon:ge,label:"Personal"},career:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",icon:J,label:"Career"}};return o[s]||o.personal},t=({user:s,keyMetrics:o=[],personalGoals:k=[],overallScore:$=0,weeklyGrowth:X=0,academicProgress:n=0,socialEngagement:E=0,platformLevel:Q=1,streak:V=0,isEditable:S=!0,onViewMetric:T,onViewAllStats:C,onSetGoal:y,onExportData:M,onViewInsights:I,className:ee})=>{const[D,L]=re.useState(!1),B=o.slice(0,4),A=k.filter(i=>i.isActive),ae=k.filter(i=>i.current>=i.target&&i.isActive);return e.jsxs(c,{className:m("relative overflow-hidden transition-all duration-300 hover:shadow-lg","bg-[var(--hive-background-primary)] border-[var(--hive-border-primary)]",D&&"scale-[1.02]",ee),onMouseEnter:()=>L(!0),onMouseLeave:()=>L(!1),children:[e.jsx(p,{className:"pb-2",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(r,{variant:"body-sm",color:"gold",weight:"medium",children:"Personal Analytics"}),V>0&&e.jsxs(u,{variant:"outline",className:"text-xs",children:[e.jsx(J,{className:"h-3 w-3 mr-1"}),"Level ",Q]})]}),S&&e.jsx(g,{variant:"ghost",size:"icon",onClick:C,className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(ie,{className:"h-3 w-3"})})]})}),e.jsxs(d,{className:"space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(G,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsx(r,{variant:"body-sm",weight:"medium",color:"primary",children:$})]}),e.jsx(r,{variant:"body-xs",color:"secondary",children:"Overall Score"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(K,{className:"h-3 w-3 text-green-500"}),e.jsxs(r,{variant:"body-sm",weight:"medium",color:"primary",children:["+",X,"%"]})]}),e.jsx(r,{variant:"body-xs",color:"secondary",children:"Weekly Growth"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(te,{className:"h-3 w-3 text-[var(--hive-gold)]"}),e.jsx(r,{variant:"body-sm",weight:"medium",color:"primary",children:V})]}),e.jsx(r,{variant:"body-xs",color:"secondary",children:"Day Streak"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(r,{variant:"body-sm",color:"primary",children:"Academic Progress"}),e.jsxs(r,{variant:"body-xs",color:"secondary",children:[n,"%"]})]}),e.jsx("div",{className:"w-full bg-[var(--hive-background-secondary)] rounded-full h-2",children:e.jsx("div",{className:"bg-blue-500 rounded-full h-2 transition-all duration-500",style:{width:`${n}%`}})})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(r,{variant:"body-sm",color:"primary",children:"Social Engagement"}),e.jsxs(r,{variant:"body-xs",color:"secondary",children:[E,"%"]})]}),e.jsx("div",{className:"w-full bg-[var(--hive-background-secondary)] rounded-full h-2",children:e.jsx("div",{className:"bg-purple-500 rounded-full h-2 transition-all duration-500",style:{width:`${E}%`}})})]})]}),B.length>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(r,{variant:"body-sm",color:"primary",weight:"medium",children:"Key Metrics:"}),o.length>4&&e.jsxs(r,{variant:"body-xs",color:"secondary",children:["+",o.length-4," more"]})]}),e.jsx("div",{className:"space-y-1",children:B.map(i=>{const l=pe(i.category),P=ve(i.trend),h=ue(i.trend);return e.jsxs("div",{className:m("flex items-center gap-2 p-2 rounded transition-colors cursor-pointer","hover:bg-[var(--hive-background-secondary)]",i.isHighlighted&&"bg-[var(--hive-gold)]/5 border border-[var(--hive-gold)]/20"),onClick:()=>T==null?void 0:T(i.id),children:[e.jsx(l.icon,{className:m("h-3 w-3",l.color)}),e.jsx(r,{variant:"body-xs",color:"primary",className:"flex-1 truncate",children:i.name}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsxs(r,{variant:"body-xs",color:"primary",weight:"medium",children:[i.value.toLocaleString(),i.unit]}),e.jsx(P,{className:m("h-2 w-2",h)}),e.jsxs(r,{variant:"body-xs",className:h,children:[i.trendPercentage,"%"]})]}),e.jsx(se,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"})]},i.id)})})]}),A.length>0&&e.jsxs("div",{className:"space-y-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(r,{variant:"body-sm",color:"primary",weight:"medium",children:"Active Goals:"}),e.jsxs(r,{variant:"body-xs",color:"secondary",children:[ae.length,"/",A.length," completed"]})]}),e.jsx("div",{className:"space-y-2",children:A.slice(0,2).map(i=>{const l=ye(i.category),P=Math.min(i.current/i.target*100,100),h=i.current>=i.target;return e.jsxs("div",{className:"space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(l.icon,{className:m("h-3 w-3",l.color)}),e.jsx(r,{variant:"body-xs",color:"primary",className:"truncate",children:i.name})]}),e.jsxs(r,{variant:"body-xs",color:"secondary",children:[i.current,"/",i.target," ",i.unit]})]}),e.jsx("div",{className:"w-full bg-[var(--hive-background-secondary)] rounded-full h-1.5",children:e.jsx("div",{className:m("rounded-full h-1.5 transition-all duration-500",h?"bg-green-500":l.color.replace("text-","bg-")),style:{width:`${P}%`}})})]},i.id)})})]}),s.academicYear&&e.jsxs("div",{className:"space-y-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[e.jsxs(r,{variant:"body-sm",color:"primary",weight:"medium",children:[s.academicYear.charAt(0).toUpperCase()+s.academicYear.slice(1)," Year Progress:"]}),e.jsxs("div",{className:"p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg",children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx(r,{variant:"body-sm",color:"primary",children:"Semester Completion"}),e.jsxs(r,{variant:"body-xs",color:"secondary",children:[n,"%"]})]}),e.jsx("div",{className:"w-full bg-[var(--hive-background-secondary)] rounded-full h-2",children:e.jsx("div",{className:"bg-blue-500 rounded-full h-2 transition-all duration-500",style:{width:`${n}%`}})}),e.jsx(r,{variant:"body-xs",color:"secondary",className:"mt-1",children:n>=75?"Excellent progress this semester! 🎓":n>=50?"Good progress - keep it up! 📚":n>=25?"Building momentum this term 💪":"Early semester - great potential ahead! ✨"})]})]}),e.jsxs("div",{className:"flex gap-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[S&&y&&e.jsxs(g,{variant:"outline",size:"sm",onClick:y,className:"flex-1",children:[e.jsx(f,{className:"h-3 w-3 mr-1"}),"Set Goal"]}),C&&e.jsxs(g,{variant:"default",size:"sm",onClick:C,className:"flex-1",children:[e.jsx(G,{className:"h-3 w-3 mr-1"}),"All Stats"]}),I&&e.jsx(g,{variant:"ghost",size:"icon",onClick:I,className:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(oe,{className:"h-3 w-3"})}),M&&e.jsx(g,{variant:"ghost",size:"icon",onClick:M,className:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(ne,{className:"h-3 w-3"})})]}),o.length===0&&k.length===0&&e.jsxs("div",{className:"text-center py-6",children:[e.jsx(G,{className:"h-8 w-8 mx-auto mb-3 text-[var(--hive-text-muted)]"}),e.jsx(r,{variant:"body-sm",color:"secondary",className:"mb-2",children:"No analytics data yet"}),e.jsx(r,{variant:"body-xs",color:"secondary",className:"mb-4",children:"Start engaging with the platform to see your personal analytics and insights"}),S&&y&&e.jsxs(g,{variant:"outline",size:"sm",onClick:y,children:[e.jsx(f,{className:"h-3 w-3 mr-1"}),"Set Your First Goal"]})]})]}),D&&e.jsx("div",{className:"absolute inset-0 -z-10 bg-gradient-to-r from-blue-500/5 to-[var(--hive-gold)]/5 rounded-lg blur-xl"})]})};t.__docgenInfo={description:"",methods:[],displayName:"ProfileStatsWidget",props:{user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: string;
  name: string;
  academicYear?: 'freshman' | 'sophomore' | 'junior' | 'senior' | 'graduate';
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}},{key:"academicYear",value:{name:"union",raw:"'freshman' | 'sophomore' | 'junior' | 'senior' | 'graduate'",elements:[{name:"literal",value:"'freshman'"},{name:"literal",value:"'sophomore'"},{name:"literal",value:"'junior'"},{name:"literal",value:"'senior'"},{name:"literal",value:"'graduate'"}],required:!1}}]}},description:""},keyMetrics:{required:!1,tsType:{name:"Array",elements:[{name:"StatMetric"}],raw:"StatMetric[]"},description:"",defaultValue:{value:"[]",computed:!1}},personalGoals:{required:!1,tsType:{name:"Array",elements:[{name:"PersonalGoal"}],raw:"PersonalGoal[]"},description:"",defaultValue:{value:"[]",computed:!1}},overallScore:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},weeklyGrowth:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},academicProgress:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},socialEngagement:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},platformLevel:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},streak:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},isEditable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onViewMetric:{required:!1,tsType:{name:"signature",type:"function",raw:"(metricId: string) => void",signature:{arguments:[{type:{name:"string"},name:"metricId"}],return:{name:"void"}}},description:""},onViewAllStats:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onSetGoal:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onExportData:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onViewInsights:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const Je={title:"04-Organisms/Profile System/Profile Stats Widget - COMPLETE DEFINITION",component:t,parameters:{docs:{description:{component:`
...
}`,...(U=(R=x.parameters)==null?void 0:R.docs)==null?void 0:U.source}}};var W,Z,O;b.parameters={...b.parameters,docs:{...(W=b.parameters)==null?void 0:W.docs,source:{originalSource:`{
...
}`,...(O=(Z=b.parameters)==null?void 0:Z.docs)==null?void 0:O.source}}};var q,F,z;w.parameters={...w.parameters,docs:{...(q=w.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    user: {
      id: 'user-playground',
      name: 'Alex Chen',
...
}`,...(z=(F=w.parameters)==null?void 0:F.docs)==null?void 0:z.source}}};const Ke=["Default","CompleteShowcase","Playground"];export{b as CompleteShowcase,x as Default,w as Playground,Ke as __namedExportsOrder,Je as default};
