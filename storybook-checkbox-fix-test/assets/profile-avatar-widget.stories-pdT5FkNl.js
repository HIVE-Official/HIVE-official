import{j as e}from"./jsx-runtime-B9GTzLod.js";import{r as L}from"./index-BMjrbHXN.js";import{c as y}from"./utils-CytzSlOG.js";import{H as s,a as t,c as n,b as v}from"./hive-card-DIMxrd4t.js";import{A as R}from"./avatar-Cb2P8PXW.js";import{B as g}from"./badge-BLajwy0n.js";import{T as i}from"./text-BOe2XosQ.js";import{B as c}from"./button-enhanced-DKTgaNxR.js";import{E as C}from"./eye-off-BD-Ijkxb.js";import{S as F}from"./settings-Cw08DGvz.js";import{C as z}from"./camera-CdUB1Ujt.js";import{A as D}from"./award-DbQCrh6E.js";import{G as _}from"./graduation-cap-CjRbfMsL.js";import{C as q}from"./calendar-RwBiWFlj.js";import{M as W}from"./map-pin-J5WJcL57.js";import{E as x}from"./eye-DHVClHkA.js";import{U as J}from"./users-B5XgMSov.js";import{S as Q}from"./star-q8LOEa9p.js";import{P as Y}from"./pen-line-CSFAAl9N.js";import{a}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";/* empty css                    */import"./index-BwobEAja.js";import"./framer-motion-proxy-Bip1EXUU.js";import"./user-DLkx1tbP.js";import"./createLucideIcon-DtX30ipI.js";import"./v4-CtRu48qb.js";const r=({user:o,isEditable:l=!0,onEditProfile:u,onUploadPhoto:B,onToggleVisibility:f,onViewProfile:b,className:G})=>{var N,T,P;const[j,w]=L.useState(!1);return e.jsxs(s,{className:y("relative overflow-hidden transition-all duration-300 hover:shadow-lg","bg-[var(--hive-background-primary)] border-[var(--hive-border-primary)]",j&&"scale-[1.02]",G),onMouseEnter:()=>w(!0),onMouseLeave:()=>w(!1),children:[e.jsx(t,{className:"pb-2",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Profile Identity"}),o.isGhostMode&&e.jsxs(g,{variant:"outline",className:"text-xs",children:[e.jsx(C,{className:"h-3 w-3 mr-1"}),"Ghost Mode"]})]}),l&&e.jsx(c,{variant:"ghost",size:"icon",onClick:u,className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(F,{className:"h-3 w-3"})})]})}),e.jsxs(n,{className:"space-y-4",children:[e.jsx("div",{className:"relative group",children:e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("div",{className:"relative",children:[e.jsx(R,{src:o.avatar,alt:o.name,fallback:o.name.split(" ").map(H=>H[0]).join(""),size:"lg",className:"ring-2 ring-[var(--hive-border-primary)] ring-offset-2 ring-offset-[var(--hive-background-primary)]"}),o.isOnline&&e.jsx("div",{className:"absolute -bottom-1 -right-1 w-4 h-4 bg-green-500 border-2 border-[var(--hive-background-primary)] rounded-full"}),l&&e.jsx("div",{className:y("absolute inset-0 bg-black/50 rounded-full flex items-center justify-center cursor-pointer transition-opacity","opacity-0 group-hover:opacity-100"),onClick:B,children:e.jsx(z,{className:"h-5 w-5 text-white"})})]}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(i,{variant:"heading-sm",color:"primary",className:"truncate",children:o.name}),o.achievements&&o.achievements>10&&e.jsx(D,{className:"h-4 w-4 text-[var(--hive-gold)]"})]}),e.jsxs(i,{variant:"body-sm",color:"secondary",className:"truncate",children:["@",o.handle]}),e.jsxs("div",{className:"flex items-center gap-1 mt-1",children:[e.jsx("div",{className:y("w-2 h-2 rounded-full",o.isOnline?"bg-green-500":"bg-[var(--hive-text-muted)]")}),e.jsx(i,{variant:"body-xs",color:"secondary",children:o.isOnline?"Online":o.lastSeen})]})]})]})}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center gap-6",children:[o.major&&e.jsxs("div",{className:"flex items-center gap-2 min-w-0 flex-1",children:[e.jsx(_,{className:"h-4 w-4 text-[var(--hive-text-secondary)] flex-shrink-0"}),e.jsx(i,{variant:"body-sm",color:"primary",className:"truncate",children:o.major})]}),o.year&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(q,{className:"h-4 w-4 text-[var(--hive-text-secondary)]"}),e.jsx(i,{variant:"body-sm",color:"secondary",children:o.year})]})]}),o.residence&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(W,{className:"h-4 w-4 text-[var(--hive-text-secondary)]"}),e.jsx(i,{variant:"body-sm",color:"secondary",children:o.residence})]})]}),o.bio&&e.jsx("div",{className:"space-y-2",children:e.jsx(i,{variant:"body-sm",color:"primary",className:"line-clamp-3 leading-relaxed",children:o.bio})}),e.jsxs("div",{className:"grid grid-cols-3 gap-4 pt-2 border-t border-[var(--hive-border-primary)]",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(x,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:((N=o.profileViews)==null?void 0:N.toLocaleString())||"0"})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Profile Views"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(J,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:((T=o.connections)==null?void 0:T.toLocaleString())||"0"})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Connections"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(Q,{className:"h-3 w-3 text-[var(--hive-gold)]"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:((P=o.achievements)==null?void 0:P.toLocaleString())||"0"})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Achievements"})]})]}),e.jsxs("div",{className:"flex gap-2 pt-2",children:[b&&e.jsxs(c,{variant:"outline",size:"sm",onClick:b,className:"flex-1",children:[e.jsx(x,{className:"h-3 w-3 mr-1"}),"View Profile"]}),l&&u&&e.jsxs(c,{variant:"default",size:"sm",onClick:u,className:"flex-1",children:[e.jsx(Y,{className:"h-3 w-3 mr-1"}),"Edit Profile"]}),l&&f&&e.jsx(c,{variant:"ghost",size:"icon",onClick:f,className:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:o.isGhostMode?e.jsx(C,{className:"h-4 w-4"}):e.jsx(x,{className:"h-4 w-4"})})]})]}),j&&e.jsx("div",{className:"absolute inset-0 -z-10 bg-gradient-to-r from-[var(--hive-gold)]/5 to-[var(--hive-brand-secondary)]/5 rounded-lg blur-xl"})]})};r.__docgenInfo={description:"",methods:[],displayName:"ProfileAvatarWidget",props:{user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: string;
  name: string;
  handle: string;
  avatar?: string;
...
}`,...(k=(S=m.parameters)==null?void 0:S.docs)==null?void 0:k.source}}};var V,A,U;p.parameters={...p.parameters,docs:{...(V=p.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(U=(A=p.parameters)==null?void 0:A.docs)==null?void 0:U.source}}};var M,I,O;h.parameters={...h.parameters,docs:{...(M=h.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    user: sampleUsers.activeStudent,
    isEditable: true,
...
}`,...(O=(I=h.parameters)==null?void 0:I.docs)==null?void 0:O.source}}};const Ne=["Default","CompleteShowcase","Playground"];export{p as CompleteShowcase,m as Default,h as Playground,Ne as __namedExportsOrder,we as default};
