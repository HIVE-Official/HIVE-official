import{j as e}from"./jsx-runtime-B9GTzLod.js";import{S as s}from"./search-bar-EfkmU8_1.js";import{H as i,c as o,a as c,b as n}from"./hive-card-DIMxrd4t.js";import{B as d}from"./badge-BLajwy0n.js";import{T as r}from"./text-BOe2XosQ.js";import{a}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";/* empty css                    */import"./index-BMjrbHXN.js";import"./utils-CytzSlOG.js";import"./input-enhanced-CvbYnkKp.js";import"./index-BwobEAja.js";import"./button-enhanced-DKTgaNxR.js";import"./spinner-Bv6BPm7Z.js";import"./x-DmZh90ps.js";import"./createLucideIcon-DtX30ipI.js";import"./search-kw2io5mN.js";import"./framer-motion-proxy-Bip1EXUU.js";import"./v4-CtRu48qb.js";const R={title:"02-Molecules/Search Bar - COMPLETE DEFINITION",component:s,parameters:{docs:{description:{component:`
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <SearchBar placeholder="Search CSE 331 study groups..." variant="default" onSearch={action('default-search')} onChange={action('default-change')} />
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-3">
                      <SearchBar placeholder="Find CSE 331 study partners..." size="md" variant="default" onSearch={action('study-partner-search')} onChange={action('study-partner-change')} />
                      <Text variant="body-xs" color="secondary">
            ...
            <div className="bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-3">
                    <SearchBar placeholder="GPA calculator, study scheduler..." size="md" variant="default" onSearch={action('academic-tools-search')} onChange={action('academic-tools-change')} />
                    <Text variant="body-xs" color="secondary">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-3">
                    <SearchBar placeholder="Event planner, group chat..." size="md" variant="default" onSearch={action('social-tools-search')} onChange={action('social-tools-change')} />
                    <Text variant="body-xs" color="secondary">
...
}`,...(S=(f=h.parameters)==null?void 0:f.docs)==null?void 0:S.source}}};const O=["Default","CompleteShowcase","Playground"];export{l as CompleteShowcase,t as Default,h as Playground,O as __namedExportsOrder,R as default};
