import{j as e}from"./jsx-runtime-B9GTzLod.js";import{r as X}from"./index-BMjrbHXN.js";import{c as l}from"./utils-CytzSlOG.js";import{H as b,a as x,c as f,b as E}from"./hive-card-DIMxrd4t.js";import{B as g}from"./badge-BLajwy0n.js";import{T as i}from"./text-BOe2XosQ.js";import{B as u}from"./button-enhanced-DKTgaNxR.js";import{M as V}from"./message-square-B08MMCUN.js";import{S as Z}from"./settings-Cw08DGvz.js";import{U as y}from"./users-B5XgMSov.js";import{C as T}from"./crown-Bf-Ij_V7.js";import{T as $}from"./trending-up-DHCBXhUA.js";import{C as ee}from"./calendar-RwBiWFlj.js";import{E as ae}from"./external-link-BBRviWFd.js";import{C as ie}from"./chevron-right-CIwutkFF.js";import{P as B}from"./plus-BTyRuzWD.js";import{S as se}from"./search-kw2io5mN.js";import{S as te}from"./star-q8LOEa9p.js";import{C as oe}from"./code-OMVEgBw0.js";import{A as re}from"./award-DbQCrh6E.js";import{H as ne}from"./heart-BuGzDzw2.js";import{C as ce}from"./coffee-BUhMW6YC.js";import{B as de}from"./book-open-BAcXQadr.js";import{a}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";/* empty css                    */import"./index-BwobEAja.js";import"./framer-motion-proxy-Bip1EXUU.js";import"./createLucideIcon-DtX30ipI.js";import"./v4-CtRu48qb.js";const v=n=>{const r={academic:{color:"text-blue-500",bgColor:"bg-blue-500/10",borderColor:"border-blue-500/20",icon:de,label:"Academic"},residential:{color:"text-green-500",bgColor:"bg-green-500/10",borderColor:"border-green-500/20",icon:ce,label:"Residential"},social:{color:"text-purple-500",bgColor:"bg-purple-500/10",borderColor:"border-purple-500/20",icon:ne,label:"Social"},professional:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",borderColor:"border-[var(--hive-gold)]/20",icon:re,label:"Professional"},hobby:{color:"text-pink-500",bgColor:"bg-pink-500/10",borderColor:"border-pink-500/20",icon:oe,label:"Hobby"}};return r[n]||r.social},h=n=>{const r={member:{color:"text-[var(--hive-text-secondary)]",bgColor:"bg-[var(--hive-background-secondary)]",icon:y,label:"Member"},moderator:{color:"text-blue-500",bgColor:"bg-blue-500/10",icon:te,label:"Moderator"},admin:{color:"text-purple-500",bgColor:"bg-purple-500/10",icon:T,label:"Admin"},founder:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",icon:T,label:"Founder"}};return r[n]||r.member},le=n=>{const r={high:{color:"text-green-500",bgColor:"bg-green-500/10",label:"Very Active"},medium:{color:"text-yellow-500",bgColor:"bg-yellow-500/10",label:"Active"},low:{color:"text-[var(--hive-text-muted)]",bgColor:"bg-[var(--hive-background-secondary)]",label:"Quiet"}};return r[n]||r.medium},o=({user:n,joinedSpaces:r=[],totalSpaces:G=0,spacesCreated:me=0,totalMembers:Y=0,weeklyEngagement:N=0,featuredSpace:t,isEditable:A=!0,onJoinSpace:C,onViewSpace:d,onCreateSpace:pe,onViewAllSpaces:M,onExploreSpaces:P,className:Q})=>{const[k,L]=X.useState(!1),D=r.sort((s,p)=>(p.unreadMessages||0)-(s.unreadMessages||0)).slice(0,3),_=r.filter(s=>["admin","moderator","founder"].includes(s.role)).length,U=r.reduce((s,p)=>s+(p.unreadMessages||0),0);return e.jsxs(b,{className:l("relative overflow-hidden transition-all duration-300 hover:shadow-lg","bg-[var(--hive-background-primary)] border-[var(--hive-border-primary)]",k&&"scale-[1.02]",Q),onMouseEnter:()=>L(!0),onMouseLeave:()=>L(!1),children:[e.jsx(x,{className:"pb-2",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"My Spaces"}),U>0&&e.jsxs(g,{variant:"outline",className:"text-xs",children:[e.jsx(V,{className:"h-3 w-3 mr-1"}),U," unread"]})]}),A&&e.jsx(u,{variant:"ghost",size:"icon",onClick:M,className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(Z,{className:"h-3 w-3"})})]})}),e.jsxs(f,{className:"space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(y,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:G})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Spaces Joined"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(T,{className:"h-3 w-3 text-[var(--hive-gold)]"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:_})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Leadership"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx($,{className:"h-3 w-3 text-green-500"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:Y})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Community Size"})]})]}),t&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(i,{variant:"body-sm",color:"primary",weight:"medium",children:"Most Active Space:"}),(()=>{const s=h(t.role).icon;return e.jsx(s,{className:l("h-3 w-3",h(t.role).color)})})()]}),e.jsx("div",{className:l("p-3 rounded-lg border transition-colors hover:bg-[var(--hive-background-secondary)] cursor-pointer",v(t.type).bgColor,v(t.type).borderColor),onClick:()=>d==null?void 0:d(t.id),children:e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex items-start gap-2 flex-1 min-w-0",children:[(()=>{const s=v(t.type).icon;return e.jsx(s,{className:l("h-4 w-4 mt-0.5 flex-shrink-0",v(t.type).color)})})(),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",className:"truncate",children:t.name}),e.jsx(g,{variant:"outline",className:l("text-xs",h(t.role).color),children:h(t.role).label})]}),e.jsx(i,{variant:"body-xs",color:"secondary",className:"line-clamp-2",children:t.description}),e.jsxs("div",{className:"flex items-center gap-3 mt-2",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(y,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsxs(i,{variant:"body-xs",color:"secondary",children:[t.memberCount.toLocaleString()," members"]})]}),t.unreadMessages&&t.unreadMessages>0&&e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(V,{className:"h-3 w-3 text-blue-500"}),e.jsxs(i,{variant:"body-xs",color:"secondary",children:[t.unreadMessages," new"]})]}),t.upcomingEvents&&t.upcomingEvents>0&&e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(ee,{className:"h-3 w-3 text-green-500"}),e.jsxs(i,{variant:"body-xs",color:"secondary",children:[t.upcomingEvents," events"]})]})]})]})]}),e.jsx(u,{variant:"ghost",size:"icon",onClick:s=>{s.stopPropagation(),d==null||d(t.id)},className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)] flex-shrink-0 ml-2",children:e.jsx(ae,{className:"h-3 w-3"})})]})})]}),D.length>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(i,{variant:"body-sm",color:"primary",weight:"medium",children:"Active Spaces:"}),r.length>3&&e.jsxs(i,{variant:"body-xs",color:"secondary",children:["+",r.length-3," more"]})]}),e.jsx("div",{className:"space-y-1",children:D.map(s=>{const p=v(s.type);h(s.role);const K=le(s.activityLevel);return e.jsxs("div",{className:"flex items-center gap-2 p-2 rounded hover:bg-[var(--hive-background-secondary)] transition-colors cursor-pointer",onClick:()=>d==null?void 0:d(s.id),children:[e.jsx(p.icon,{className:l("h-3 w-3",p.color)}),e.jsx(i,{variant:"body-xs",color:"primary",className:"flex-1 truncate",children:s.name}),s.unreadMessages&&s.unreadMessages>0&&e.jsx(g,{variant:"outline",className:"text-xs",children:s.unreadMessages}),e.jsx("div",{className:l("w-2 h-2 rounded-full",K.color.replace("text-","bg-"))}),e.jsx(ie,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"})]},s.id)})})]}),N>0&&e.jsxs("div",{className:"space-y-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[e.jsx(i,{variant:"body-sm",color:"primary",weight:"medium",children:"This Week:"}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(i,{variant:"body-sm",color:"secondary",children:"Community Engagement"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"w-16 h-2 bg-[var(--hive-background-secondary)] rounded-full",children:e.jsx("div",{className:"h-2 bg-green-500 rounded-full transition-all duration-500",style:{width:`${Math.min(N,100)}%`}})}),e.jsxs(i,{variant:"body-xs",color:"gold",weight:"medium",children:[N,"%"]})]})]})]}),e.jsxs("div",{className:"flex gap-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[A&&C&&e.jsxs(u,{variant:"outline",size:"sm",onClick:C,className:"flex-1",children:[e.jsx(B,{className:"h-3 w-3 mr-1"}),"Join Space"]}),M&&e.jsxs(u,{variant:"default",size:"sm",onClick:M,className:"flex-1",children:[e.jsx(y,{className:"h-3 w-3 mr-1"}),"My Spaces"]}),P&&e.jsx(u,{variant:"ghost",size:"icon",onClick:P,className:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(se,{className:"h-3 w-3"})})]}),r.length===0&&e.jsxs("div",{className:"text-center py-6",children:[e.jsx(y,{className:"h-8 w-8 mx-auto mb-3 text-[var(--hive-text-muted)]"}),e.jsx(i,{variant:"body-sm",color:"secondary",className:"mb-2",children:"No spaces joined yet"}),e.jsx(i,{variant:"body-xs",color:"secondary",className:"mb-4",children:"Discover communities and connect with fellow UB students"}),A&&C&&e.jsxs(u,{variant:"outline",size:"sm",onClick:C,children:[e.jsx(B,{className:"h-3 w-3 mr-1"}),"Explore Spaces"]})]})]}),k&&e.jsx("div",{className:"absolute inset-0 -z-10 bg-gradient-to-r from-purple-500/5 to-green-500/5 rounded-lg blur-xl"})]})};o.__docgenInfo={description:"",methods:[],displayName:"ProfileSpacesWidget",props:{user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: string;
  name: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}}]}},description:""},joinedSpaces:{required:!1,tsType:{name:"Array",elements:[{name:"JoinedSpace"}],raw:"JoinedSpace[]"},description:"",defaultValue:{value:"[]",computed:!1}},totalSpaces:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},spacesCreated:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},totalMembers:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},weeklyEngagement:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},featuredSpace:{required:!1,tsType:{name:"JoinedSpace"},description:""},isEditable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onJoinSpace:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onViewSpace:{required:!1,tsType:{name:"signature",type:"function",raw:"(spaceId: string) => void",signature:{arguments:[{type:{name:"string"},name:"spaceId"}],return:{name:"void"}}},description:""},onCreateSpace:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onViewAllSpaces:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onExploreSpaces:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const Oe={title:"03-Organisms/Profile Spaces Widget - COMPLETE DEFINITION",component:o,parameters:{docs:{description:{component:`
...
}`,...(J=(I=S.parameters)==null?void 0:I.docs)==null?void 0:J.source}}};var H,F,O;j.parameters={...j.parameters,docs:{...(H=j.parameters)==null?void 0:H.docs,source:{originalSource:`{
...
}`,...(O=(F=j.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};var W,z,q;w.parameters={...w.parameters,docs:{...(W=w.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    user: sampleUser,
...
}`,...(q=(z=w.parameters)==null?void 0:z.docs)==null?void 0:q.source}}};const We=["Default","CompleteShowcase","Playground"];export{j as CompleteShowcase,S as Default,w as Playground,We as __namedExportsOrder,Oe as default};
