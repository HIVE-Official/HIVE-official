            ...
            <div className="space-y-4">
              ...
              <div className="bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    <Checkbox label="Enable notifications" description="Receive updates about space activity" variant="default" onChange={action('default-compact')} />
                    <Checkbox label="Join study group" description="Participate in CSE 331 algorithm study sessions" variant="default" checked onChange={action('default-compact-checked')} />
                    <Checkbox label="Share calendar availability" description="Let group members see your free time" variant="default" onChange={action('default-compact-calendar')} />
                  </div>
...
}`,...(B=(P=x.parameters)==null?void 0:P.docs)==null?void 0:B.source}}};const se=["Default","CompleteShowcase","Playground"];export{y as CompleteShowcase,g as Default,x as Playground,se as __namedExportsOrder,ie as default};
