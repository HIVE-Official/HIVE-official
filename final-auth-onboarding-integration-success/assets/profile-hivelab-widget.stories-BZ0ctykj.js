import{j as e}from"./jsx-runtime-SKoiH9zj.js";import{r as ae}from"./index-DJO9vBfz.js";import{c as d}from"./utils-CytzSlOG.js";import{H as c,a as b,c as m,b as w}from"./hive-tokens-BKUtHA8Z.js";import{B as u}from"./badge-B09J4pcg.js";import{T as i}from"./text-Cao0VGB4.js";import{S as te}from"./settings-GFIh7SpU.js";import{c as ee}from"./createLucideIcon-WpwZgzX-.js";import{R as P}from"./rocket-D4zszhsM.js";import{U as L}from"./users-kvqvVsnf.js";import{S as re}from"./star-DcfUHeTk.js";import{T as le}from"./target-CMXB8H7t.js";import{P as se}from"./play-D7e6preK.js";import{C as ne}from"./chevron-right-BGhHLs4c.js";import{P as Z}from"./plus-Cg8nMOSF.js";import{E as de}from"./external-link-DkxaGAGS.js";import{T as ce}from"./trophy-B5Tnzdfb.js";import{C as me}from"./code-B2XVm3Gn.js";import{S as ue}from"./sparkles-CC54NCDA.js";import{F as pe}from"./flask-conical-C8RLNoba.js";import{W as ve}from"./wrench-7DMXSgPE.js";import{Z as ye}from"./zap-0mfePDxG.js";import{a as o}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";import"./index-BwobEAja.js";import"./framer-motion-proxy-Bzlf7Pk2.js";import"./v4-CtRu48qb.js";/**
 * @license lucide-react v0.411.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const D=ee("Beaker",[["path",{d:"M4.5 3h15",key:"c7n0jr"}],["path",{d:"M6 3v16a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V3",key:"m1uhx7"}],["path",{d:"M6 14h12",key:"4cwo0f"}]]);/**
 * @license lucide-react v0.411.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ge=ee("Lightbulb",[["path",{d:"M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5",key:"1gvzjb"}],["path",{d:"M9 18h6",key:"x1upvd"}],["path",{d:"M10 22h4",key:"ceow96"}]]),f=s=>{const t={academic:{color:"text-blue-500",bgColor:"bg-blue-500/10",borderColor:"border-blue-500/20",icon:ge,label:"Academic"},productivity:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",borderColor:"border-[var(--hive-gold)]/20",icon:ye,label:"Productivity"},social:{color:"text-purple-500",bgColor:"bg-purple-500/10",borderColor:"border-purple-500/20",icon:L,label:"Social"},utility:{color:"text-green-500",bgColor:"bg-green-500/10",borderColor:"border-green-500/20",icon:ve,label:"Utility"},experimental:{color:"text-pink-500",bgColor:"bg-pink-500/10",borderColor:"border-pink-500/20",icon:pe,label:"Experimental"}};return t[s]||t.utility},I=s=>{const t={concept:{color:"text-gray-500",bgColor:"bg-gray-500/10",label:"Concept",progress:10},prototype:{color:"text-yellow-500",bgColor:"bg-yellow-500/10",label:"Prototype",progress:35},testing:{color:"text-blue-500",bgColor:"bg-blue-500/10",label:"Testing",progress:70},published:{color:"text-green-500",bgColor:"bg-green-500/10",label:"Published",progress:100},archived:{color:"text-[var(--hive-text-muted)]",bgColor:"bg-[var(--hive-background-secondary)]",label:"Archived",progress:0}};return t[s]||t.concept},be=s=>{const t={novice:{color:"text-green-500",bgColor:"bg-green-500/10",icon:ue,label:"Novice Builder"},apprentice:{color:"text-blue-500",bgColor:"bg-blue-500/10",icon:me,label:"Apprentice Builder"},expert:{color:"text-purple-500",bgColor:"bg-purple-500/10",icon:P,label:"Expert Builder"},master:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",icon:ce,label:"Master Builder"}};return t[s]||t.novice},he=s=>{const t=new Date(s),x=new Date,p=Math.floor((x.getTime()-t.getTime())/(1e3*60*60));if(p<1){const T=Math.floor((x.getTime()-t.getTime())/6e4);return T<1?"Just now":`${T}m ago`}else return p<24?`${p}h ago`:`${Math.floor(p/24)}d ago`},l=({user:s,builderTools:t=[],activeProjects:x=[],totalBuilds:p=0,totalDeployments:T=0,totalCollaborations:oe=0,builderScore:v=0,weeklyBuildTime:A=0,featuredBuild:r,isEditable:j=!0,onCreateTool:B,onViewTool:y,onEditTool:M,onDeployTool:W,onViewAllBuilds:O,onViewBuildLab:V,className:ie})=>{const[z,U]=ae.useState(!1),F=t.sort((a,N)=>new Date(N.lastWorkedOn).getTime()-new Date(a.lastWorkedOn).getTime()).slice(0,3),E=be(s.builderLevel||"novice");return t.filter(a=>["prototype","testing"].includes(a.buildStatus)).length,t.filter(a=>a.buildStatus==="published").length,e.jsxs(c,{className:d("relative overflow-hidden transition-all duration-300 hover:shadow-lg","bg-[var(--hive-background-primary)] border-[var(--hive-border-primary)]",z&&"scale-[1.02]",ie),onMouseEnter:()=>U(!0),onMouseLeave:()=>U(!1),children:[e.jsx(b,{className:"pb-2",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"HiveLab Builder"}),e.jsxs(u,{variant:"secondary",className:d("text-xs",E.color),children:[e.jsx(E.icon,{className:"h-3 w-3 mr-1"}),E.label]})]}),j&&e.jsx(ButtonEnhanced,{variant:"ghost",size:"icon",onClick:V,className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(te,{className:"h-3 w-3"})})]})}),e.jsxs(m,{className:"space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(D,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:p})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Total Builds"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(P,{className:"h-3 w-3 text-green-500"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:T})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Deployments"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(L,{className:"h-3 w-3 text-purple-500"}),e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",children:oe})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Collaborations"})]})]}),v>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(i,{variant:"body-sm",color:"primary",weight:"medium",children:"Builder Score:"}),e.jsxs(i,{variant:"body-xs",color:"gold",weight:"medium",children:[v,"/100"]})]}),e.jsx("div",{className:"w-full bg-[var(--hive-background-secondary)] rounded-full h-2",children:e.jsx("div",{className:"bg-gradient-to-r from-purple-500 to-[var(--hive-gold)] rounded-full h-2 transition-all duration-500",style:{width:`${v}%`}})}),e.jsx(i,{variant:"body-xs",color:"secondary",children:v>=80?"Master level builder! 🚀":v>=60?"Expert builder - keep growing! ⚡":v>=40?"Apprentice builder - great progress! 💫":"Novice builder - exciting journey ahead! ✨"})]}),r&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(i,{variant:"body-sm",color:"primary",weight:"medium",children:"Featured Build:"}),e.jsx(re,{className:"h-3 w-3 text-[var(--hive-gold)]"})]}),e.jsx("div",{className:d("p-3 rounded-lg border transition-colors hover:bg-[var(--hive-background-secondary)] cursor-pointer",f(r.category).bgColor,f(r.category).borderColor),onClick:()=>y==null?void 0:y(r.id),children:e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex items-start gap-2 flex-1 min-w-0",children:[(()=>{const a=f(r.category).icon;return e.jsx(a,{className:d("h-4 w-4 mt-0.5 flex-shrink-0",f(r.category).color)})})(),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[e.jsx(i,{variant:"body-sm",weight:"medium",color:"primary",className:"truncate",children:r.name}),e.jsx(u,{variant:"secondary",className:d("text-xs",I(r.buildStatus).color),children:I(r.buildStatus).label})]}),e.jsx(i,{variant:"body-xs",color:"secondary",className:"line-clamp-2",children:r.description}),e.jsxs("div",{className:"flex items-center gap-3 mt-2",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(le,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsxs(i,{variant:"body-xs",color:"secondary",children:[r.progress,"% complete"]})]}),r.collaborators>1&&e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(L,{className:"h-3 w-3 text-purple-500"}),e.jsxs(i,{variant:"body-xs",color:"secondary",children:[r.collaborators," collaborators"]})]}),r.deployments>0&&e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(P,{className:"h-3 w-3 text-green-500"}),e.jsxs(i,{variant:"body-xs",color:"secondary",children:[r.deployments," deployments"]})]})]})]})]}),e.jsxs("div",{className:"flex items-center gap-1 ml-2",children:[j&&M&&e.jsx(ButtonEnhanced,{variant:"ghost",size:"icon",onClick:a=>{a.stopPropagation(),M(r.id)},className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(se,{className:"h-3 w-3"})}),W&&r.buildStatus==="testing"&&e.jsx(ButtonEnhanced,{variant:"ghost",size:"icon",onClick:a=>{a.stopPropagation(),W(r.id)},className:"h-6 w-6 text-green-500 hover:text-green-600",children:e.jsx(P,{className:"h-3 w-3"})})]})]})})]}),F.length>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(i,{variant:"body-sm",color:"primary",weight:"medium",children:"Recent Builds:"}),t.length>3&&e.jsxs(i,{variant:"body-xs",color:"secondary",children:["+",t.length-3," more"]})]}),e.jsx("div",{className:"space-y-1",children:F.map(a=>{const N=f(a.category),R=I(a.buildStatus);return e.jsxs("div",{className:"flex items-center gap-2 p-2 rounded hover:bg-[var(--hive-background-secondary)] transition-colors cursor-pointer",onClick:()=>y==null?void 0:y(a.id),children:[e.jsx(N.icon,{className:d("h-3 w-3",N.color)}),e.jsx(i,{variant:"body-xs",color:"primary",className:"flex-1 truncate",children:a.name}),e.jsx(u,{variant:"secondary",className:d("text-xs",R.color),children:R.label}),e.jsx(i,{variant:"body-xs",color:"secondary",children:he(a.lastWorkedOn)}),e.jsx(ne,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"})]},a.id)})})]}),x.length>0&&e.jsxs("div",{className:"space-y-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[e.jsx(i,{variant:"body-sm",color:"primary",weight:"medium",children:"Active Projects:"}),e.jsx("div",{className:"space-y-1",children:x.slice(0,2).map(a=>e.jsxs("div",{className:"flex items-center gap-2 p-2 rounded hover:bg-[var(--hive-background-secondary)] transition-colors",children:[e.jsxs("div",{className:"flex items-center gap-2 flex-1",children:[e.jsx("div",{className:d("w-2 h-2 rounded-full",a.isActive?"bg-green-500":"bg-[var(--hive-text-muted)]")}),e.jsx(i,{variant:"body-xs",color:"primary",className:"truncate",children:a.name})]}),e.jsxs(i,{variant:"body-xs",color:"secondary",children:[a.progress,"%"]}),a.teamSize>1&&e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(L,{className:"h-2 w-2 text-[var(--hive-text-secondary)]"}),e.jsx(i,{variant:"body-xs",color:"secondary",children:a.teamSize})]})]},a.id))})]}),A>0&&e.jsxs("div",{className:"space-y-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[e.jsx(i,{variant:"body-sm",color:"primary",weight:"medium",children:"This Week:"}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(i,{variant:"body-sm",color:"secondary",children:"Build Time"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"w-16 h-2 bg-[var(--hive-background-secondary)] rounded-full",children:e.jsx("div",{className:"h-2 bg-gradient-to-r from-purple-500 to-[var(--hive-gold)] rounded-full transition-all duration-500",style:{width:`${Math.min(A/20*100,100)}%`}})}),e.jsxs(i,{variant:"body-xs",color:"gold",weight:"medium",children:[A,"h"]})]})]})]}),e.jsxs("div",{className:"flex gap-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[j&&B&&e.jsxs(ButtonEnhanced,{variant:"secondary",size:"sm",onClick:B,className:"flex-1",children:[e.jsx(Z,{className:"h-3 w-3 mr-1"}),"New Build"]}),O&&e.jsxs(ButtonEnhanced,{variant:"primary",size:"sm",onClick:O,className:"flex-1",children:[e.jsx(D,{className:"h-3 w-3 mr-1"}),"All Builds"]}),V&&e.jsx(ButtonEnhanced,{variant:"ghost",size:"icon",onClick:V,className:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(de,{className:"h-3 w-3"})})]}),t.length===0&&e.jsxs("div",{className:"text-center py-6",children:[e.jsx(D,{className:"h-8 w-8 mx-auto mb-3 text-[var(--hive-text-muted)]"}),e.jsx(i,{variant:"body-sm",color:"secondary",className:"mb-2",children:"No builds yet"}),e.jsx(i,{variant:"body-xs",color:"secondary",className:"mb-4",children:"Start building your first tool in HiveLab for the UB community"}),j&&B&&e.jsxs(ButtonEnhanced,{variant:"secondary",size:"sm",onClick:B,children:[e.jsx(Z,{className:"h-3 w-3 mr-1"}),"Start Your First Build"]})]})]}),z&&e.jsx("div",{className:"absolute inset-0 -z-10 bg-gradient-to-r from-purple-500/5 to-[var(--hive-gold)]/5 rounded-lg blur-xl"})]})};l.__docgenInfo={description:"",methods:[],displayName:"ProfileHiveLabWidget",props:{user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: string;
  name: string;
...
}`,...(J=(G=k.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var Q,Y,$;C.parameters={...C.parameters,docs:{...(Q=C.parameters)==null?void 0:Q.docs,source:{originalSource:`{
...
}`,...($=(Y=C.parameters)==null?void 0:Y.docs)==null?void 0:$.source}}};var _,K,X;S.parameters={...S.parameters,docs:{...(_=S.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    user: {
      id: 'user-playground',
      name: 'Alex Chen',
...
}`,...(X=(K=S.parameters)==null?void 0:K.docs)==null?void 0:X.source}}};const Ge=["Default","CompleteShowcase","Playground"];export{C as CompleteShowcase,k as Default,S as Playground,Ge as __namedExportsOrder,qe as default};
