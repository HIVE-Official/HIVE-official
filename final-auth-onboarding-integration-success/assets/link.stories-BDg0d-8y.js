import{j as e}from"./jsx-runtime-SKoiH9zj.js";import{R as B}from"./index-DJO9vBfz.js";import{c as j}from"./utils-CytzSlOG.js";import{H as r,c as s,a as t,b as d}from"./hive-tokens-BKUtHA8Z.js";import{B as n}from"./badge-B09J4pcg.js";import{T as a}from"./text-Cao0VGB4.js";import{I as h}from"./icon-D_nDyTQj.js";import{M as H}from"./mail-CGUqHGcU.js";import{c as U}from"./createLucideIcon-WpwZgzX-.js";import{G as P}from"./globe-De5bsiXL.js";import"./index-BwobEAja.js";import"./framer-motion-proxy-Bzlf7Pk2.js";/**
 * @license lucide-react v0.411.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const V=U("Phone",[["path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z",key:"foiqr5"}]]),D={default:["text-[var(--hive-brand-primary)]","hover:text-[var(--hive-brand-secondary)]","active:text-[var(--hive-brand-primary)]","transition-colors duration-200 ease-out"].join(" "),ghost:["text-[var(--hive-text-primary)]","hover:text-[var(--hive-brand-primary)]","transition-colors duration-200 ease-out"].join(" "),underline:["text-[var(--hive-text-primary)]","underline decoration-[var(--hive-brand-primary)] underline-offset-2","hover:text-[var(--hive-brand-primary)] hover:decoration-[var(--hive-brand-secondary)]","transition-all duration-200 ease-out"].join(" "),button:["inline-flex items-center justify-center gap-2","px-4 py-2 rounded-lg","bg-[var(--hive-brand-primary)] text-[var(--hive-text-inverse)] font-medium","hover:bg-[var(--hive-brand-secondary)]","active:bg-[var(--hive-brand-primary)]","transition-all duration-200 ease-out"].join(" ")},O={sm:"text-sm",md:"text-base",lg:"text-lg"},G={primary:"text-[var(--hive-text-primary)] hover:text-[var(--hive-brand-primary)]",secondary:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",gold:"text-[var(--hive-brand-secondary)] hover:text-[var(--hive-brand-primary)]",muted:"text-[var(--hive-text-muted)] hover:text-[var(--hive-text-secondary)]"},i=B.forwardRef(({variant:c="default",size:E="md",color:x,external:p=!1,disabled:m=!1,className:u,children:g,href:y,...R},z)=>{const f=["font-medium","focus:outline-none focus:ring-2 focus:ring-[var(--hive-brand-primary)] focus:ring-offset-2 focus:ring-offset-[var(--hive-background-primary)]","rounded-sm",O[E],x?G[x]:D[c],m&&["pointer-events-none","opacity-50","cursor-not-allowed"].join(" ")].filter(Boolean).join(" "),I={...R,...p&&{target:"_blank",rel:"noopener noreferrer"}};return m||!y?e.jsx("span",{className:j(f,u),"aria-disabled":m,children:g}):e.jsxs("a",{ref:z,href:y,className:j(f,u),...I,children:[g,p&&e.jsxs("svg",{className:"ml-1 h-3 w-3",fill:"currentColor",viewBox:"0 0 20 20","aria-hidden":"true",children:[e.jsx("path",{fillRule:"evenodd",d:"M4.25 5.5a.75.75 0 00-.75.75v8.5c0 .414.336.75.75.75h8.5a.75.75 0 00.75-.75v-4a.75.75 0 011.5 0v4A2.25 2.25 0 0112.75 17h-8.5A2.25 2.25 0 012 14.75v-8.5A2.25 2.25 0 014.25 4h5a.75.75 0 010 1.5h-5z",clipRule:"evenodd"}),e.jsx("path",{fillRule:"evenodd",d:"M6.194 12.753a.75.75 0 001.06.053L16.5 4.44v2.81a.75.75 0 001.5 0v-4.5a.75.75 0 00-.75-.75h-4.5a.75.75 0 000 1.5h2.553l-9.056 8.194a.75.75 0 00-.053 1.06z",clipRule:"evenodd"})]})]})});i.displayName="Link";i.__docgenInfo={description:"",methods:[],displayName:"Link",props:{variant:{required:!1,tsType:{name:"union",raw:"'default' | 'ghost' | 'underline' | 'button'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'ghost'"},{name:"literal",value:"'underline'"},{name:"literal",value:"'button'"}]},description:"",defaultValue:{value:"'default'",computed:!1}},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},color:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary' | 'gold' | 'muted'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'gold'"},{name:"literal",value:"'muted'"}]},description:""},external:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const ee={title:"01-Atoms/Link - COMPLETE DEFINITION",component:i,parameters:{docs:{description:{component:`
...
}`,...(N=(k=l.parameters)==null?void 0:k.docs)==null?void 0:N.source}}};var L,C,T;o.parameters={...o.parameters,docs:{...(L=o.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(T=(C=o.parameters)==null?void 0:C.docs)==null?void 0:T.source}}};var S,w,A;v.parameters={...v.parameters,docs:{...(S=v.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    variant: 'default',
    size: 'md',
    color: 'primary',
...
}`,...(A=(w=v.parameters)==null?void 0:w.docs)==null?void 0:A.source}}};const ie=["Default","CompleteShowcase","Playground"];export{o as CompleteShowcase,l as Default,v as Playground,ie as __namedExportsOrder,ee as default};
