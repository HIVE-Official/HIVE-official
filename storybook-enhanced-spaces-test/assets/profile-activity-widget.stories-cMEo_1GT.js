import{j as e}from"./jsx-runtime-B9GTzLod.js";import{r as X}from"./index-BMjrbHXN.js";import{c as v}from"./utils-CytzSlOG.js";import{H as l,a as y,c as m,b as A}from"./hive-card-DIMxrd4t.js";import{B as w}from"./badge-BLajwy0n.js";import{T as t}from"./text-BOe2XosQ.js";import{B as p}from"./button-enhanced-DKTgaNxR.js";import{F as Q}from"./flame-CcK9O660.js";import{S as ee}from"./settings-Cw08DGvz.js";import{A as k}from"./activity-BpE6NZRo.js";import{T as te}from"./trending-up-DHCBXhUA.js";import{T as ie}from"./target-oZw-M8_W.js";import{C as ae}from"./clock-B-89-V79.js";import{H as j}from"./heart-BuGzDzw2.js";import{C as re}from"./chevron-right-CIwutkFF.js";import{P as S}from"./plus-BTyRuzWD.js";import{E as se}from"./external-link-BBRviWFd.js";import{C as oe}from"./calendar-RwBiWFlj.js";import{T as ne}from"./trophy-Cdnp2oJR.js";import{C as K}from"./code-OMVEgBw0.js";import{U as ce}from"./users-B5XgMSov.js";import{M as W}from"./message-square-B08MMCUN.js";import{A as de}from"./award-DbQCrh6E.js";import{C as le}from"./coffee-BUhMW6YC.js";import{B as me}from"./book-open-BAcXQadr.js";import{a as i}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";/* empty css                    */import"./index-BwobEAja.js";import"./framer-motion-proxy-Bip1EXUU.js";import"./createLucideIcon-DtX30ipI.js";import"./v4-CtRu48qb.js";const d=o=>{const r={post:{color:"text-blue-500",bgColor:"bg-blue-500/10",borderColor:"border-blue-500/20",icon:W,label:"Posted"},comment:{color:"text-green-500",bgColor:"bg-green-500/10",borderColor:"border-green-500/20",icon:W,label:"Commented"},join:{color:"text-purple-500",bgColor:"bg-purple-500/10",borderColor:"border-purple-500/20",icon:ce,label:"Joined"},create:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",borderColor:"border-[var(--hive-gold)]/20",icon:S,label:"Created"},like:{color:"text-red-500",bgColor:"bg-red-500/10",borderColor:"border-red-500/20",icon:j,label:"Liked"},collaborate:{color:"text-indigo-500",bgColor:"bg-indigo-500/10",borderColor:"border-indigo-500/20",icon:K,label:"Collaborated"},achievement:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",borderColor:"border-[var(--hive-gold)]/20",icon:ne,label:"Achieved"},event:{color:"text-green-500",bgColor:"bg-green-500/10",borderColor:"border-green-500/20",icon:oe,label:"Attended"}};return r[o]||r.post},ge=o=>({academic:me,residential:le,social:j,professional:de,hobby:K})[o]||j,ve=o=>{const r=new Date(o),u=new Date,n=Math.floor((u.getTime()-r.getTime())/(1e3*60*60));if(n<1){const g=Math.floor((u.getTime()-r.getTime())/6e4);return g<1?"Just now":`${g}m ago`}else return n<24?`${n}h ago`:`${Math.floor(n/24)}d ago`},s=({user:o,recentActivities:r=[],todayActivities:u=0,weeklyStreak:n=0,totalEngagement:g=0,activityScore:_=0,topActivityType:c="post",isEditable:T=!0,onViewActivity:C,onViewAllActivities:N,onCreatePost:h,onEngageMore:P,className:$})=>{const[V,B]=X.useState(!1),I=r.slice(0,4);r.filter(a=>a.isHighlighted).length;const M=r.length;return e.jsxs(l,{className:v("relative overflow-hidden transition-all duration-300 hover:shadow-lg","bg-[var(--hive-background-primary)] border-[var(--hive-border-primary)]",V&&"scale-[1.02]",$),onMouseEnter:()=>B(!0),onMouseLeave:()=>B(!1),children:[e.jsx(y,{className:"pb-2",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(t,{variant:"body-sm",color:"gold",weight:"medium",children:"Recent Activity"}),n>0&&e.jsxs(w,{variant:"outline",className:"text-xs",children:[e.jsx(Q,{className:"h-3 w-3 mr-1"}),n," day streak"]})]}),T&&e.jsx(p,{variant:"ghost",size:"icon",onClick:N,className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(ee,{className:"h-3 w-3"})})]})}),e.jsxs(m,{className:"space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(k,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsx(t,{variant:"body-sm",weight:"medium",color:"primary",children:u})]}),e.jsx(t,{variant:"body-xs",color:"secondary",children:"Today's Activity"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(te,{className:"h-3 w-3 text-green-500"}),e.jsx(t,{variant:"body-sm",weight:"medium",color:"primary",children:g})]}),e.jsx(t,{variant:"body-xs",color:"secondary",children:"Total Engagement"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(ie,{className:"h-3 w-3 text-[var(--hive-gold)]"}),e.jsx(t,{variant:"body-sm",weight:"medium",color:"primary",children:_})]}),e.jsx(t,{variant:"body-xs",color:"secondary",children:"Activity Score"})]})]}),n>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(t,{variant:"body-sm",color:"primary",weight:"medium",children:"Weekly Engagement:"}),e.jsxs(t,{variant:"body-xs",color:"gold",weight:"medium",children:[M," activities"]})]}),e.jsx("div",{className:"w-full bg-[var(--hive-background-secondary)] rounded-full h-2",children:e.jsx("div",{className:"bg-gradient-to-r from-blue-500 to-[var(--hive-gold)] rounded-full h-2 transition-all duration-500",style:{width:`${Math.min(M/20*100,100)}%`}})}),e.jsxs(t,{variant:"body-xs",color:"secondary",children:[n," day activity streak • Keep it going! 🔥"]})]}),I.length>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(t,{variant:"body-sm",color:"primary",weight:"medium",children:"Recent Activity:"}),r.length>4&&e.jsxs(t,{variant:"body-xs",color:"secondary",children:["+",r.length-4," more"]})]}),e.jsx("div",{className:"space-y-1",children:I.map(a=>{const H=d(a.type),U=a.contextSpace?ge(a.contextSpace.type):null;return e.jsxs("div",{className:v("flex items-center gap-2 p-2 rounded transition-colors cursor-pointer","hover:bg-[var(--hive-background-secondary)]",a.isHighlighted&&"bg-[var(--hive-gold)]/5 border border-[var(--hive-gold)]/20"),onClick:()=>C==null?void 0:C(a.id),children:[e.jsx(H.icon,{className:v("h-3 w-3 flex-shrink-0",H.color)}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx(t,{variant:"body-xs",color:"primary",className:"truncate",children:a.title}),e.jsxs("div",{className:"flex items-center gap-2 mt-0.5",children:[a.contextSpace&&U&&e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(U,{className:"h-2 w-2 text-[var(--hive-text-muted)]"}),e.jsx(t,{variant:"body-xs",color:"muted",className:"truncate",children:a.contextSpace.name})]}),e.jsx(ae,{className:"h-2 w-2 text-[var(--hive-text-muted)]"}),e.jsx(t,{variant:"body-xs",color:"muted",children:ve(a.timestamp)})]})]}),a.engagement&&e.jsx("div",{className:"flex items-center gap-1",children:a.engagement.likes>0&&e.jsxs("div",{className:"flex items-center gap-0.5",children:[e.jsx(j,{className:"h-2 w-2 text-red-500"}),e.jsx(t,{variant:"body-xs",color:"muted",children:a.engagement.likes})]})}),e.jsx(re,{className:"h-3 w-3 text-[var(--hive-text-secondary)] flex-shrink-0"})]},a.id)})})]}),c&&e.jsxs("div",{className:"space-y-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[e.jsx(t,{variant:"body-sm",color:"primary",weight:"medium",children:"Activity Insights:"}),e.jsxs("div",{className:v("p-3 rounded-lg border",d(c).bgColor,d(c).borderColor),children:[e.jsxs("div",{className:"flex items-center gap-2",children:[(()=>{const a=d(c).icon;return e.jsx(a,{className:v("h-4 w-4",d(c).color)})})(),e.jsxs(t,{variant:"body-sm",color:"primary",children:["Most active in: ",d(c).label.toLowerCase()]})]}),e.jsxs(t,{variant:"body-xs",color:"secondary",className:"mt-1",children:["You're building strong engagement through ",d(c).label.toLowerCase()," activities"]})]})]}),e.jsxs("div",{className:"flex gap-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[T&&h&&e.jsxs(p,{variant:"outline",size:"sm",onClick:h,className:"flex-1",children:[e.jsx(S,{className:"h-3 w-3 mr-1"}),"Create Post"]}),N&&e.jsxs(p,{variant:"default",size:"sm",onClick:N,className:"flex-1",children:[e.jsx(k,{className:"h-3 w-3 mr-1"}),"All Activity"]}),P&&e.jsx(p,{variant:"ghost",size:"icon",onClick:P,className:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(se,{className:"h-3 w-3"})})]}),r.length===0&&e.jsxs("div",{className:"text-center py-6",children:[e.jsx(k,{className:"h-8 w-8 mx-auto mb-3 text-[var(--hive-text-muted)]"}),e.jsx(t,{variant:"body-sm",color:"secondary",className:"mb-2",children:"No recent activity"}),e.jsx(t,{variant:"body-xs",color:"secondary",className:"mb-4",children:"Start engaging with the UB community to see your activity here"}),T&&h&&e.jsxs(p,{variant:"outline",size:"sm",onClick:h,children:[e.jsx(S,{className:"h-3 w-3 mr-1"}),"Create Your First Post"]})]})]}),V&&e.jsx("div",{className:"absolute inset-0 -z-10 bg-gradient-to-r from-blue-500/5 to-purple-500/5 rounded-lg blur-xl"})]})};s.__docgenInfo={description:"",methods:[],displayName:"ProfileActivityWidget",props:{user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: string;
  name: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}}]}},description:""},recentActivities:{required:!1,tsType:{name:"Array",elements:[{name:"ActivityItem"}],raw:"ActivityItem[]"},description:"",defaultValue:{value:"[]",computed:!1}},todayActivities:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},weeklyStreak:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},totalEngagement:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},activityScore:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},topActivityType:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'post'",computed:!1}},isEditable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onViewActivity:{required:!1,tsType:{name:"signature",type:"function",raw:"(activityId: string) => void",signature:{arguments:[{type:{name:"string"},name:"activityId"}],return:{name:"void"}}},description:""},onViewAllActivities:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onCreatePost:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onEngageMore:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const ze={title:"04-Organisms/Profile System/Profile Activity Widget - COMPLETE DEFINITION",component:s,parameters:{docs:{description:{component:`
...
}`,...(R=(J=x.parameters)==null?void 0:J.docs)==null?void 0:R.source}}};var D,O,q;b.parameters={...b.parameters,docs:{...(D=b.parameters)==null?void 0:D.docs,source:{originalSource:`{
...
}`,...(q=(O=b.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var z,Y,G;f.parameters={...f.parameters,docs:{...(z=f.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    user: {
      id: 'user-playground',
      name: 'Alex Chen'
...
}`,...(G=(Y=f.parameters)==null?void 0:Y.docs)==null?void 0:G.source}}};const Ye=["Default","CompleteShowcase","Playground"];export{b as CompleteShowcase,x as Default,f as Playground,Ye as __namedExportsOrder,ze as default};
