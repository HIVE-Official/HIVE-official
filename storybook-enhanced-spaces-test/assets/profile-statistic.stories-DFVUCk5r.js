import{j as e}from"./jsx-runtime-B9GTzLod.js";import{P as a}from"./profile-statistic-Drp8ok4R.js";import{H as l,c as t,a as n,b as d}from"./hive-card-DIMxrd4t.js";import{B as m}from"./badge-BLajwy0n.js";import{T as i}from"./text-BOe2XosQ.js";/* empty css                    */import{U as s}from"./users-B5XgMSov.js";import{G as C}from"./graduation-cap-CjRbfMsL.js";import{C as c}from"./code-OMVEgBw0.js";import{C as h}from"./clock-B-89-V79.js";import{S as r}from"./star-q8LOEa9p.js";import{T as v}from"./trophy-Cdnp2oJR.js";import{Z as u}from"./zap-BzDMfB1h.js";import{T as o}from"./target-oZw-M8_W.js";import{C as f}from"./calendar-RwBiWFlj.js";import{U as S}from"./upload-Bikc-bYU.js";import{B as g}from"./book-open-BAcXQadr.js";import{C as H}from"./coffee-BUhMW6YC.js";import{W as V}from"./wifi-ZVXlguYO.js";import{B as j}from"./building-08mtcaFN.js";import{M as U}from"./map-pin-J5WJcL57.js";import{A as D}from"./award-DbQCrh6E.js";import{S as T}from"./share-2-DREqtcC9.js";import{D as G}from"./download-B_gmnu9b.js";import{H as N}from"./heart-BuGzDzw2.js";import"./index-BMjrbHXN.js";import"./index-BwobEAja.js";import"./utils-CytzSlOG.js";import"./minus-DgcdAxY4.js";import"./createLucideIcon-DtX30ipI.js";import"./trending-up-DHCBXhUA.js";import"./framer-motion-proxy-Bip1EXUU.js";const xe={title:"01-Atoms/Profile Statistic - COMPLETE DEFINITION",component:a,parameters:{docs:{description:{component:`
...
`}}},tags:["autodocs"],argTypes:{value:{control:"text",description:"Statistic value (number or string)"},label:{control:"text",description:"Statistic label"},variant:{control:"select",options:["default","ghost","highlight","compact"],description:"Visual variant"},size:{control:"select",options:["xs","sm","md","lg"],description:"Statistic size"},emphasis:{control:"select",options:["normal","gold","secondary"],description:"Value emphasis color"},showTrend:{control:"boolean",description:"Show trend indicator"},interactive:{control:"boolean",description:"Interactive hover effects"},loading:{control:"boolean",description:"Loading state"}}},p={args:{value:42,label:"Study Sessions",size:"md",variant:"default",emphasis:"normal",showTrend:!1,interactive:!1,loading:!1},render:y=>e.jsx("div",{className:"p-6 bg-[var(--hive-background-primary)]",children:e.jsx(l,{children:e.jsxs(t,{className:"space-y-4",children:[e.jsx(i,{variant:"body-md",color:"primary",children:"Student statistic display for University at Buffalo activity tracking:"}),e.jsx(a,{...y}),e.jsx(i,{variant:"body-sm",color:"secondary",children:"Campus engagement and achievement metric display"})]})})})},b={render:()=>e.jsxs("div",{className:"space-y-8 p-6 bg-[var(--hive-background-primary)]",children:[e.jsxs(l,{children:[e.jsxs(n,{children:[e.jsxs(d,{className:"flex items-center gap-3",children:[e.jsx(m,{variant:"success",children:"📊 STATISTIC TYPES"}),"Profile Statistic Display Variants"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Comprehensive statistic display system for University at Buffalo student metrics and achievement tracking"})]}),e.jsx(t,{children:e.jsx("div",{className:"space-y-8",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Visual Variants:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-4",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Default (Card Style):"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:156,label:"Connections",icon:s,iconColor:"gold",variant:"default"}),e.jsx(a,{value:"3.8",label:"GPA",icon:C,iconColor:"success",variant:"default"}),e.jsx(a,{value:23,label:"Tools Created",icon:c,iconColor:"secondary",variant:"default"}),e.jsx(a,{value:"12.5k",label:"Study Hours",icon:h,iconColor:"gold",variant:"default"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Highlight (Emphasized):"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:1250,label:"HIVE Points",icon:r,iconColor:"gold",variant:"highlight",emphasis:"gold"}),e.jsx(a,{value:8,label:"Leadership Roles",icon:v,iconColor:"success",variant:"highlight",emphasis:"secondary"}),e.jsx(a,{value:45,label:"Day Streak",icon:u,iconColor:"warning",variant:"highlight"}),e.jsx(a,{value:95,label:"Attendance %",icon:o,iconColor:"success",variant:"highlight"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Compact (Space Efficient):"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-6 gap-3",children:[e.jsx(a,{value:42,label:"Events",variant:"compact",size:"sm"}),e.jsx(a,{value:18,label:"Spaces",variant:"compact",size:"sm"}),e.jsx(a,{value:156,label:"Posts",variant:"compact",size:"sm"}),e.jsx(a,{value:89,label:"Tools",variant:"compact",size:"sm"}),e.jsx(a,{value:"4.2k",label:"Views",variant:"compact",size:"sm"}),e.jsx(a,{value:234,label:"Likes",variant:"compact",size:"sm"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Ghost (Minimal):"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:34,label:"Followers",variant:"ghost"}),e.jsx(a,{value:67,label:"Following",variant:"ghost"}),e.jsx(a,{value:12,label:"Groups",variant:"ghost"}),e.jsx(a,{value:5,label:"Projects",variant:"ghost"})]})]})]})]})})})]}),e.jsxs(l,{children:[e.jsxs(n,{children:[e.jsxs(d,{className:"flex items-center gap-3",children:[e.jsx(m,{variant:"info",children:"📈 TREND TRACKING"}),"Progress and Change Indicators"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Visual trend indicators for tracking progress, changes, and performance over time"})]}),e.jsx(t,{children:e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Trending Statistics:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Positive Trends (Up):"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:"3.8",label:"GPA",icon:C,iconColor:"success",showTrend:!0,change:12,changeLabel:"+0.2 this semester"}),e.jsx(a,{value:156,label:"Connections",icon:s,iconColor:"gold",showTrend:!0,change:24,changeLabel:"+24 this month"}),e.jsx(a,{value:89,label:"Study Hours",icon:h,iconColor:"secondary",showTrend:!0,change:15,changeLabel:"+15 this week"}),e.jsx(a,{value:23,label:"Tools Created",icon:c,iconColor:"gold",showTrend:!0,change:3,changeLabel:"+3 this month"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Negative Trends (Down):"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:67,label:"Missed Classes",icon:f,iconColor:"error",showTrend:!0,change:-8,changeLabel:"-8 this month"}),e.jsx(a,{value:234,label:"Procrastination",icon:h,iconColor:"warning",showTrend:!0,change:-45,changeLabel:"-45 min/day"}),e.jsx(a,{value:12,label:"Late Submissions",icon:S,iconColor:"error",showTrend:!0,change:-5,changeLabel:"-5 this semester"}),e.jsx(a,{value:3,label:"Missed Deadlines",icon:o,iconColor:"error",showTrend:!0,change:-2,changeLabel:"-2 this month"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Neutral Trends (Stable):"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:45,label:"Library Visits",icon:g,iconColor:"default",showTrend:!0,change:0,changeLabel:"Consistent"}),e.jsx(a,{value:89,label:"Attendance %",icon:o,iconColor:"success",showTrend:!0,change:0,changeLabel:"Steady"}),e.jsx(a,{value:12,label:"Study Groups",icon:s,iconColor:"secondary",showTrend:!0,change:0,changeLabel:"Maintained"}),e.jsx(a,{value:156,label:"Course Load",icon:g,iconColor:"default",showTrend:!0,change:0,changeLabel:"Stable"})]})]})]})]})})})]}),e.jsxs(l,{children:[e.jsxs(n,{children:[e.jsxs(d,{className:"flex items-center gap-3",children:[e.jsx(m,{variant:"secondary",children:"📏 SIZES"}),"Statistic Size Options"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"4 sizes for different interface contexts and layout requirements"})]}),e.jsx(t,{children:e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Size Comparison:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Extra Small (xs):"}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx(a,{value:42,label:"Events",size:"xs"}),e.jsx(a,{value:"3.8",label:"GPA",size:"xs",icon:r}),e.jsx(a,{value:156,label:"Connections",size:"xs",showTrend:!0,change:12})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Compact dashboard widgets and inline metrics"})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Small (sm):"}),e.jsxs("div",{className:"flex gap-4",children:[e.jsx(a,{value:42,label:"Events",size:"sm"}),e.jsx(a,{value:"3.8",label:"GPA",size:"sm",icon:r}),e.jsx(a,{value:156,label:"Connections",size:"sm",showTrend:!0,change:12})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Sidebar statistics and card components"})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Medium (md - default):"}),e.jsxs("div",{className:"flex gap-4",children:[e.jsx(a,{value:42,label:"Events",size:"md"}),e.jsx(a,{value:"3.8",label:"GPA",size:"md",icon:r}),e.jsx(a,{value:156,label:"Connections",size:"md",showTrend:!0,change:12})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Standard profile statistics and main dashboard"})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Large (lg):"}),e.jsxs("div",{className:"flex gap-4",children:[e.jsx(a,{value:42,label:"Events",size:"lg"}),e.jsx(a,{value:"3.8",label:"GPA",size:"lg",icon:r}),e.jsx(a,{value:156,label:"Connections",size:"lg",showTrend:!0,change:12})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Hero sections and prominent achievement displays"})]})]})]})})})]}),e.jsxs(l,{children:[e.jsxs(n,{children:[e.jsxs(d,{className:"flex items-center gap-3",children:[e.jsx(m,{variant:"primary",children:"⚡ INTERACTIVE FEATURES"}),"Statistic Interaction and Emphasis"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Interactive states, emphasis colors, loading states, and icon customization"})]}),e.jsx(t,{children:e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Interactive States:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Clickable Statistics:"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:156,label:"View Connections",icon:s,interactive:!0,onClick:()=>alert("Navigate to connections")}),e.jsx(a,{value:23,label:"View Tools",icon:c,interactive:!0,onClick:()=>alert("Navigate to tools")}),e.jsx(a,{value:89,label:"View Calendar",icon:f,interactive:!0,onClick:()=>alert("Navigate to calendar")}),e.jsx(a,{value:12,label:"View Achievements",icon:v,interactive:!0,onClick:()=>alert("Navigate to achievements")})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Loading States:"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:0,label:"Loading...",loading:!0,size:"xs"}),e.jsx(a,{value:0,label:"Loading...",loading:!0,size:"sm"}),e.jsx(a,{value:0,label:"Loading...",loading:!0,size:"md"}),e.jsx(a,{value:0,label:"Loading...",loading:!0,size:"lg"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Emphasis Colors:"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-3 gap-4",children:[e.jsx(a,{value:1250,label:"HIVE Points",icon:r,emphasis:"gold",variant:"highlight"}),e.jsx(a,{value:8,label:"Leadership Roles",icon:v,emphasis:"secondary",variant:"highlight"}),e.jsx(a,{value:156,label:"Standard Metric",icon:o,emphasis:"normal"})]})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Icon Customization:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Icon Color Variants:"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-6 gap-4",children:[e.jsx(a,{value:42,label:"Default",icon:o,iconColor:"default",size:"sm"}),e.jsx(a,{value:42,label:"Gold",icon:r,iconColor:"gold",size:"sm"}),e.jsx(a,{value:42,label:"Secondary",icon:c,iconColor:"secondary",size:"sm"}),e.jsx(a,{value:42,label:"Success",icon:v,iconColor:"success",size:"sm"}),e.jsx(a,{value:42,label:"Warning",icon:u,iconColor:"warning",size:"sm"}),e.jsx(a,{value:42,label:"Error",icon:o,iconColor:"error",size:"sm"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Custom Icons:"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(a,{value:89,label:"Coffee Breaks",icon:H,iconColor:"warning"}),e.jsx(a,{value:156,label:"WiFi Sessions",icon:V,iconColor:"secondary"}),e.jsx(a,{value:23,label:"Building Visits",icon:j,iconColor:"default"}),e.jsx(a,{value:67,label:"Campus Events",icon:U,iconColor:"gold"})]})]})]})]})]})})]}),e.jsxs(l,{children:[e.jsxs(n,{children:[e.jsxs(d,{className:"flex items-center gap-3",children:[e.jsx(m,{variant:"primary",children:"🦌 UNIVERSITY AT BUFFALO"}),"Real Campus Student Analytics Scenarios"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Profile statistics in actual University at Buffalo student academic and social engagement contexts"})]}),e.jsxs(t,{className:"space-y-8",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Academic Performance Dashboard:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx(i,{as:"h3",variant:"heading-sm",color:"primary",children:"Sarah Chen - Computer Science Senior"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Academic Metrics:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(a,{value:"3.87",label:"Cumulative GPA",icon:C,iconColor:"success",variant:"highlight",emphasis:"gold",showTrend:!0,change:5,changeLabel:"+0.12 this semester"}),e.jsx(a,{value:118,label:"Credit Hours",icon:g,iconColor:"secondary",showTrend:!0,change:15,changeLabel:"+15 this semester"}),e.jsx(a,{value:"92%",label:"Attendance Rate",icon:o,iconColor:"success",showTrend:!0,change:3,changeLabel:"+3% this month"}),e.jsx(a,{value:28,label:"Assignments Completed",icon:D,iconColor:"gold",showTrend:!0,change:4,changeLabel:"+4 this week"})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Fall 2024 semester progress tracking for School of Engineering and Applied Sciences"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Study Engagement:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(a,{value:156,label:"Study Hours",icon:h,iconColor:"secondary",showTrend:!0,change:24,changeLabel:"+24 this month"}),e.jsx(a,{value:67,label:"Library Sessions",icon:g,iconColor:"gold",showTrend:!0,change:8,changeLabel:"+8 this month"}),e.jsx(a,{value:23,label:"Study Groups",icon:s,iconColor:"secondary",showTrend:!0,change:3,changeLabel:"+3 this semester"}),e.jsx(a,{value:45,label:"Day Streak",icon:u,iconColor:"warning",variant:"highlight",emphasis:"gold"})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Lockwood Library and campus study space utilization tracking"})]})]})]})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Campus Social Engagement Analytics:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:e.jsxs("div",{className:"grid md:grid-cols-3 gap-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"HIVE Platform Activity:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-4",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{value:234,label:"Connections",icon:s,iconColor:"gold",showTrend:!0,change:18,changeLabel:"+18 this month",interactive:!0}),e.jsx(a,{value:67,label:"Spaces Joined",icon:j,iconColor:"secondary",showTrend:!0,change:3,changeLabel:"+3 this semester",interactive:!0}),e.jsx(a,{value:156,label:"Posts Shared",icon:T,iconColor:"default",showTrend:!0,change:12,changeLabel:"+12 this week",interactive:!0})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"HIVE social utility platform engagement metrics"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Campus Events & Organizations:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-4",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{value:23,label:"Events Attended",icon:f,iconColor:"gold",showTrend:!0,change:5,changeLabel:"+5 this month"}),e.jsx(a,{value:8,label:"Organizations",icon:j,iconColor:"secondary",showTrend:!0,change:1,changeLabel:"+1 this semester"}),e.jsx(a,{value:4,label:"Leadership Roles",icon:v,iconColor:"success",variant:"highlight",emphasis:"secondary"})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"UB student organization participation and campus event engagement"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Tool Building & Creation:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-4",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{value:15,label:"Tools Created",icon:c,iconColor:"gold",variant:"highlight",emphasis:"gold",showTrend:!0,change:3,changeLabel:"+3 this month"}),e.jsx(a,{value:"2.4k",label:"Tool Downloads",icon:G,iconColor:"success",showTrend:!0,change:456,changeLabel:"+456 this week"}),e.jsx(a,{value:89,label:"Community Likes",icon:N,iconColor:"error",showTrend:!0,change:23,changeLabel:"+23 this week"})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Platform contribution and community impact tracking"})]})]})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Course Space Analytics:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx(i,{as:"h3",variant:"heading-sm",color:"primary",children:"CSE 331 - Algorithm Analysis Course Engagement"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-4",children:[e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Course Performance:"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(a,{value:"94%",label:"Assignment Score",icon:o,iconColor:"success",showTrend:!0,change:8,changeLabel:"+8% this assignment",size:"sm"}),e.jsx(a,{value:12,label:"Submissions",icon:S,iconColor:"gold",showTrend:!0,change:1,changeLabel:"On time",size:"sm"}),e.jsx(a,{value:"87%",label:"Participation",icon:s,iconColor:"secondary",showTrend:!0,change:5,changeLabel:"+5% this week",size:"sm"}),e.jsx(a,{value:8,label:"Questions Asked",icon:g,iconColor:"gold",showTrend:!0,change:3,changeLabel:"+3 this week",size:"sm"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Collaboration Metrics:"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(a,{value:23,label:"Study Partners",icon:s,iconColor:"secondary",showTrend:!0,change:4,changeLabel:"+4 this semester",size:"sm"}),e.jsx(a,{value:67,label:"Peer Helps",icon:N,iconColor:"success",showTrend:!0,change:12,changeLabel:"+12 this month",size:"sm"}),e.jsx(a,{value:34,label:"Resources Shared",icon:T,iconColor:"gold",showTrend:!0,change:6,changeLabel:"+6 this week",size:"sm"}),e.jsx(a,{value:15,label:"Group Projects",icon:c,iconColor:"secondary",showTrend:!0,change:1,changeLabel:"Current project",size:"sm"})]})]})]}),e.jsx(i,{variant:"body-sm",color:"secondary",children:"Real-time analytics for CSE 331 student engagement, performance tracking, and collaborative learning metrics"})]})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Mobile Campus Analytics Dashboard:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsx(i,{variant:"body-md",color:"primary",children:"Mobile-optimized statistic display for quick campus activity overview:"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Quick Overview (Compact):"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-3",children:[e.jsxs("div",{className:"grid grid-cols-3 gap-2",children:[e.jsx(a,{value:12,label:"Today's Events",variant:"compact",size:"xs"}),e.jsx(a,{value:"3.8",label:"GPA",variant:"compact",size:"xs",emphasis:"gold"}),e.jsx(a,{value:45,label:"Streak",variant:"compact",size:"xs"}),e.jsx(a,{value:156,label:"Connections",variant:"compact",size:"xs"}),e.jsx(a,{value:23,label:"Tools",variant:"compact",size:"xs"}),e.jsx(a,{value:67,label:"Points",variant:"compact",size:"xs"})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Quick overview panel for mobile dashboard home screen"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(i,{variant:"body-sm",color:"gold",weight:"medium",children:"Featured Metrics (Highlighted):"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] space-y-3",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{value:1250,label:"HIVE Points",icon:r,iconColor:"gold",variant:"highlight",emphasis:"gold",size:"sm",interactive:!0}),e.jsx(a,{value:45,label:"Study Streak",icon:u,iconColor:"warning",variant:"highlight",size:"sm",showTrend:!0,change:1,changeLabel:"Keep it up!",interactive:!0})]}),e.jsx(i,{variant:"body-xs",color:"secondary",children:"Prominent achievement display for mobile motivation and engagement"})]})]})]})]})]})]})]})]})},x={args:{value:156,label:"Study Sessions",size:"md",variant:"default",emphasis:"normal",showTrend:!1,interactive:!1,loading:!1},render:y=>e.jsx("div",{className:"p-6 bg-[var(--hive-background-primary)]",children:e.jsxs(l,{children:[e.jsxs(n,{children:[e.jsx(d,{children:"Profile Statistic Playground"}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Use the controls to test different statistic configurations"})]}),e.jsx(t,{className:"p-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx(a,{...y}),e.jsx(i,{variant:"body-sm",color:"secondary",children:"Interactive statistic testing for University at Buffalo campus analytics and achievement tracking"})]})})]})})};var w,P,k;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    value: 42,
...
}`,...(k=(P=p.parameters)==null?void 0:P.docs)==null?void 0:k.source}}};var z,L,E;b.parameters={...b.parameters,docs:{...(z=b.parameters)==null?void 0:z.docs,source:{originalSource:`{
...
}`,...(E=(L=b.parameters)==null?void 0:L.docs)==null?void 0:E.source}}};var A,I,B;x.parameters={...x.parameters,docs:{...(A=x.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    value: 156,
    label: 'Study Sessions',
    size: 'md',
...
}`,...(B=(I=x.parameters)==null?void 0:I.docs)==null?void 0:B.source}}};const ye=["Default","CompleteShowcase","Playground"];export{b as CompleteShowcase,p as Default,x as Playground,ye as __namedExportsOrder,xe as default};
