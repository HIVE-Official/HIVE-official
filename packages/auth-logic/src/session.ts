...
export class SessionManager {
  ...
  private renewalTimeout?: NodeJS.Timeout;
...
export const useSessionManager = () => {
  return {
    validateSession: (session: Session) => sessionManager.validateSession(session),
    resetInactivityTimer: () => sessionManager.resetInactivityTimer(),
    initializeSession: (session: Session) => sessionManager.initializeSession(session),
