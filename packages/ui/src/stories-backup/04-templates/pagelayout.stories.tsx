...
import { HiveLayout as PageLayout } from '../../layout/hive-layout';

/**
 * # PageLayout - Social Media + Utility Platform
 * 
 * The PageLayout template provides the structural foundation for social-utility pages, organizing multiple organisms to create comprehensive campus life experiences.
 * 
...
const MockPageLayout: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">PageLayout</h3>
...
const meta: Meta<typeof MockPageLayout> = {
  ...
  parameters: {
    docs: {
      description: {
        component: `
# PageLayout - Campus Social + Utility
...
The PageLayout ensures every interaction serves both social connection and academic success.
        `
      }
    },
    layout: 'padded'
