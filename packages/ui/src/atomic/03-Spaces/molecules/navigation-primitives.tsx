...
const activeClassMap: Record<NavigationLayout, string> = {
  sidebar:
    "bg-[color-mix(in_srgb,var(--hive-brand-primary,#FACC15) 18%,transparent)] text-[var(--hive-text-primary,#F9FAFB)] border border-[color-mix(in_srgb,var(--hive-brand-primary,#FACC15) 32%,var(--hive-border-subtle,#2E2F39))] shadow-[0_16px_42px_rgba(7,8,15,0.32)]",
  inline:
    "bg-[color-mix(in_srgb,var(--hive-brand-primary,#FACC15) 18%,transparent)] text-[var(--hive-text-primary,#F9FAFB)] border border-[color-mix(in_srgb,var(--hive-brand-primary,#FACC15) 30%,var(--hive-border-subtle,#2E2F39))]",
  rail:
    "bg-[color-mix(in_srgb,var(--hive-brand-primary,#FACC15) 18%,transparent)] text-[var(--hive-text-primary,#F9FAFB)] border border-[color-mix(in_srgb,var(--hive-brand-primary,#FACC15) 30%,var(--hive-border-subtle,#2E2F39))] shadow-[0_12px_30px_rgba(7,8,15,0.28)]",
  bottom:
    "bg-[color-mix(in_srgb,var(--hive-brand-primary,#FACC15) 16%,transparent)] text-[var(--hive-text-primary,#F9FAFB)] shadow-[0_-8px_28px_rgba(7,8,15,0.3)]",
};
  ...
  function NavigationItem(
    ...
    const sharedChildren = (
      <>
        ...
        {badgeValue ? (
          <span className="ml-auto inline-flex min-w-[24px] items-center justify-center rounded-full bg-[color-mix(in_srgb,var(--hive-brand-primary,#FACC15) 20%,transparent)] px-2 py-0.5 text-xs font-semibold text-[var(--hive-text-primary,#F9FAFB)]">
            {badgeValue}
          </span>
        ) : null}
      </>
      ...
      <div className="space-y-6">
        {sections.map((section) => (
          <div key={section.id} className="space-y-2">
            {section.label ? (
              <div className="px-2 text-xs uppercase tracking-[0.22em] text-[color-mix(in_srgb,var(--hive-text-secondary,#C0C2CC) 68%,transparent)]">
                {section.label}
              </div>
            ) : null}
...
export function NavigationRail({
  ...
  return (
    ...
    >
      {label ? (
        <span className="text-[10px] font-semibold uppercase tracking-[0.32em] text-[color-mix(in_srgb,var(--hive-text-secondary,#C0C2CC) 68%,transparent)]">
          {label}
        </span>
      ) : null}
