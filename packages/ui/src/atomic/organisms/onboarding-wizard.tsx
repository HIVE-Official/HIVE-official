...
export interface OnboardingWizardProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof onboardingwizardVariants> {
  currentStep?: any;
  onNext?: any;
  onBack?: any;
  onSkip?: any;
...
export const OnboardingWizard = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(onboardingwizardVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
