...
const profileconnectionslistVariants = cva(
...
export interface ProfileConnectionsListProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof profileconnectionslistVariants> {
  connections?: any;
  onSearch?: any;
  onFilter?: any;
  isLoading?: boolean;
...
export const ProfileConnectionsList = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(profileconnectionslistVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(profileconnectionslistVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
