...
const onboardingconnectionsuggestionsVariants = cva(
...
export interface OnboardingConnectionSuggestionsProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof onboardingconnectionsuggestionsVariants> {
  suggestions?: any;
  onConnect?: any;
  onSkip?: any;
  isLoading?: boolean;
...
export const OnboardingConnectionSuggestions = React.forwardRef<
  HTMLDivElement,
  OnboardingConnectionSuggestionsProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(onboardingconnectionsuggestionsVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(onboardingconnectionsuggestionsVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
