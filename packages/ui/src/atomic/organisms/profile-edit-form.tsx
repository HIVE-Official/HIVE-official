...
const profileeditformVariants = cva(
...
export interface ProfileEditFormProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof profileeditformVariants> {
  user?: any;
  onSave?: any;
  onCancel?: any;
  isLoading?: boolean;
...
export const ProfileEditForm = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(profileeditformVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(profileeditformVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
