...
const toolruntimeexecutorVariants = cva(
...
export interface ToolRuntimeExecutorProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof toolruntimeexecutorVariants> {
  tool?: any;
  onRun?: any;
  isLoading?: boolean;
  error?: string;
...
export const ToolRuntimeExecutor = React.forwardRef<
  HTMLDivElement,
  ToolRuntimeExecutorProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(toolruntimeexecutorVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(toolruntimeexecutorVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
