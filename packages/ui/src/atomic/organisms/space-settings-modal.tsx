...
const spacesettingsmodalVariants = cva(
...
export interface SpaceSettingsModalProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof spacesettingsmodalVariants> {
  activeTab?: any;
  space?: any;
  onSave?: any;
  isLoading?: boolean;
...
export const SpaceSettingsModal = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spacesettingsmodalVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spacesettingsmodalVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
