...
const toolbuildercanvasVariants = cva(
...
export interface ToolBuilderCanvasProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof toolbuildercanvasVariants> {
  elements?: any;
  selectedElement?: any;
  onElementAdd?: any;
  onElementSelect?: any;
...
export const ToolBuilderCanvas = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(toolbuildercanvasVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(toolbuildercanvasVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
