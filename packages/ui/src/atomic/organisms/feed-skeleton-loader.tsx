...
const feedskeletonloaderVariants = cva(
...
export interface FeedSkeletonLoaderProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof feedskeletonloaderVariants> {
  count?: any;
  isLoading?: boolean;
  error?: string;
}

export const FeedSkeletonLoader = React.forwardRef<
  HTMLDivElement,
  FeedSkeletonLoaderProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(feedskeletonloaderVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(feedskeletonloaderVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
