...
const spacesidebarVariants = cva(
...
export interface SpaceSidebarProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof spacesidebarVariants> {
  about?: any;
  members?: any;
  events?: any;
  resources?: any;
...
export const SpaceSidebar = React.forwardRef<
  HTMLDivElement,
  SpaceSidebarProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spacesidebarVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spacesidebarVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
