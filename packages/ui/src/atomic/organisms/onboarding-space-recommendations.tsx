...
const onboardingspacerecommendationsVariants = cva(
...
export interface OnboardingSpaceRecommendationsProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof onboardingspacerecommendationsVariants> {
  recommendations?: any;
  onJoin?: any;
  onSkip?: any;
  isLoading?: boolean;
...
export const OnboardingSpaceRecommendations = React.forwardRef<
  HTMLDivElement,
  OnboardingSpaceRecommendationsProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(onboardingspacerecommendationsVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(onboardingspacerecommendationsVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
