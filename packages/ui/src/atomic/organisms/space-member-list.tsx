...
const spacememberlistVariants = cva(
...
export interface SpaceMemberListProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof spacememberlistVariants> {
  members?: any;
  onFilter?: any;
  onSearch?: any;
  isLeader?: any;
...
export const SpaceMemberList = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spacememberlistVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spacememberlistVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
