...
const feedemptystateVariants = cva(
...
export interface FeedEmptyStateProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof feedemptystateVariants> {
  message?: any;
  actionText?: any;
  onAction?: any;
  isLoading?: boolean;
...
export const FeedEmptyState = React.forwardRef<
  HTMLDivElement,
  FeedEmptyStateProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(feedemptystateVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(feedemptystateVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
