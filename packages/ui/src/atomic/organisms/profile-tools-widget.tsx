...
const profiletoolswidgetVariants = cva(
...
export interface ProfileToolsWidgetProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof profiletoolswidgetVariants> {
  tools?: any;
  canCreate?: any;
  isLoading?: boolean;
  error?: string;
...
export const ProfileToolsWidget = React.forwardRef<
  HTMLDivElement,
  ProfileToolsWidgetProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(profiletoolswidgetVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(profiletoolswidgetVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
