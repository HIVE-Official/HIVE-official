 ...
 */
const ProfilePhotoLightbox = React.forwardRef<HTMLDivElement, ProfilePhotoLightboxProps>(
  ({
    className,
    photos,
    initialIndex = 0,
    ...
    return (
      ...
      >
        ...
        {/* Photo counter */}
        <div className="absolute top-4 left-4 z-50 bg-black/50 backdrop-blur-sm px-4 py-2 rounded-full">
