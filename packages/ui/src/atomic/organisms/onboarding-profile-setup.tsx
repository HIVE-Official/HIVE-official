...
const onboardingprofilesetupVariants = cva(
...
export interface OnboardingProfileSetupProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof onboardingprofilesetupVariants> {
  onSave?: any;
  isLoading?: boolean;
  error?: string;
}

export const OnboardingProfileSetup = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(onboardingprofilesetupVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(onboardingprofilesetupVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
