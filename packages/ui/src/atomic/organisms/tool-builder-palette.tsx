...
const toolbuilderpaletteVariants = cva(
...
export interface ToolBuilderPaletteProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof toolbuilderpaletteVariants> {
  elementTypes?: any;
  onDragStart?: any;
  isLoading?: boolean;
  error?: string;
...
export const ToolBuilderPalette = React.forwardRef<
  HTMLDivElement,
  ToolBuilderPaletteProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(toolbuilderpaletteVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(toolbuilderpaletteVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
