...
const ritualparticipationuiVariants = cva(
...
export interface RitualParticipationUiProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof ritualparticipationuiVariants> {
  ritual?: any;
  progress?: any;
  streak?: any;
  points?: any;
...
export const RitualParticipationUi = React.forwardRef<
  HTMLDivElement,
  RitualParticipationUiProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(ritualparticipationuiVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(ritualparticipationuiVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
