...
const profilestatsdashboardVariants = cva(
...
export interface ProfileStatsDashboardProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof profilestatsdashboardVariants> {
  stats?: any;
  timePeriod?: any;
  isLoading?: boolean;
  error?: string;
...
export const ProfileStatsDashboard = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(profilestatsdashboardVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(profilestatsdashboardVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
