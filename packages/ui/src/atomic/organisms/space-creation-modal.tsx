...
const spacecreationmodalVariants = cva(
...
export interface SpaceCreationModalProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof spacecreationmodalVariants> {
  currentStep?: any;
  onNext?: any;
  onBack?: any;
  onSubmit?: any;
...
export const SpaceCreationModal = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spacecreationmodalVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spacecreationmodalVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
