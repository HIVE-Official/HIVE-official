...
const toolbrowsegridVariants = cva(
...
export interface ToolBrowseGridProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof toolbrowsegridVariants> {
  tools?: any;
  onInstall?: any;
  onRun?: any;
  isLoading?: boolean;
...
export const ToolBrowseGrid = React.forwardRef<
  HTMLDivElement,
  ToolBrowseGridProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(toolbrowsegridVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(toolbrowsegridVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
