...
export interface FeedFiltersProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof feedfiltersVariants> {
  activeFilter?: any;
  spaces?: any;
  contentTypes?: any;
  onFilterChange?: any;
...
export const FeedFilters = React.forwardRef<
  HTMLDivElement,
  FeedFiltersProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(feedfiltersVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(feedfiltersVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
