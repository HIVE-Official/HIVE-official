...
const spaceaboutsectionVariants = cva(
...
export interface SpaceAboutSectionProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof spaceaboutsectionVariants> {
  description?: any;
  created?: any;
  creator?: any;
  category?: any;
...
export const SpaceAboutSection = React.forwardRef<
  HTMLDivElement,
  SpaceAboutSectionProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spaceaboutsectionVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spaceaboutsectionVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
