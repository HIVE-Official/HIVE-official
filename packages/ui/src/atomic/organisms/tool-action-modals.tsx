        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={question}
              onChange={(e: React.ChangeEvent) => setQuestion((e.target as HTMLInputElement).value)}
            />
          </div>
          ...
          <div className="space-y-3 border-t border-white/8 pt-3">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                type="datetime-local"
                value={endDate}
                onChange={(e: React.ChangeEvent) => setEndDate((e.target as HTMLInputElement).value)}
              />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                type="datetime-local"
                value={startTime}
                onChange={(e: React.ChangeEvent) => setStartTime((e.target as HTMLInputElement).value)}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                type="datetime-local"
                value={endTime}
                onChange={(e: React.ChangeEvent) => setEndTime((e.target as HTMLInputElement).value)}
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={location}
              onChange={(e: React.ChangeEvent) => setLocation((e.target as HTMLInputElement).value)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              value={description}
              onChange={(e: React.ChangeEvent) => setDescription((e.target as HTMLInputElement).value)}
              rows={3}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={rsvpLimit}
              onChange={(e: React.ChangeEvent) => setRsvpLimit((e.target as HTMLInputElement).value)}
            />
          </div>
        </div>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              type="datetime-local"
              value={dueDate}
              onChange={(e: React.ChangeEvent) => setDueDate((e.target as HTMLInputElement).value)}
            />
          </div>
          ...
          {type === "link" ? (
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="https://..."
                value={url}
                onChange={(e: React.ChangeEvent) => setUrl((e.target as HTMLInputElement).value)}
              />
            </div>
          ) : (
            <div className="space-y-2">
