...
const spaceresourcespanelVariants = cva(
...
export interface SpaceResourcesPanelProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof spaceresourcespanelVariants> {
  resources?: any;
  links?: any;
  isLoading?: boolean;
  error?: string;
...
export const SpaceResourcesPanel = React.forwardRef<
  HTMLDivElement,
  SpaceResourcesPanelProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spaceresourcespanelVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spaceresourcespanelVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
