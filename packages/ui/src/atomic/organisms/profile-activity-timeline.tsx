...
const profileactivitytimelineVariants = cva(
...
export interface ProfileActivityTimelineProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof profileactivitytimelineVariants> {
  activities?: any;
  onLoadMore?: any;
  isLoading?: boolean;
  error?: string;
...
export const ProfileActivityTimeline = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(profileactivitytimelineVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(profileactivitytimelineVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
