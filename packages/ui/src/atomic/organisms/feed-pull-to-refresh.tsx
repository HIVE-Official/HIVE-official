...
const FeedPullToRefresh = React.forwardRef<HTMLDivElement, FeedPullToRefreshProps>(
  (
    {
      className,
      children,
    ...
    return (
      ...
      >
        ...
        {enabled && (isPulling || isRefreshing) && (
          <div
            className="absolute top-0 left-0 right-0 flex items-center justify-center transition-all duration-300 ease-liquid"
            style={{
