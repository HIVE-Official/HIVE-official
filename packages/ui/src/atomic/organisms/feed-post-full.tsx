...
const feedpostfullVariants = cva(
...
export interface FeedPostFullProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof feedpostfullVariants> {
  post?: any;
  comments?: any;
  onComment?: any;
  onShare?: any;
...
export const FeedPostFull = React.forwardRef<
  HTMLDivElement,
  FeedPostFullProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(feedpostfullVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(feedpostfullVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
