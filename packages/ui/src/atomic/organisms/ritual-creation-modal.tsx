...
const ritualcreationmodalVariants = cva(
...
export interface RitualCreationModalProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof ritualcreationmodalVariants> {
  onSubmit?: any;
  isLoading?: boolean;
  error?: string;
}

export const RitualCreationModal = React.forwardRef<
  HTMLDivElement,
  RitualCreationModalProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(ritualcreationmodalVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(ritualcreationmodalVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
