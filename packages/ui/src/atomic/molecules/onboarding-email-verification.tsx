...
const onboardingemailverificationVariants = cva(
...
export interface OnboardingEmailVerificationProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof onboardingemailverificationVariants> {
  email?: any;
  onVerify?: any;
  onResend?: any;
  isLoading?: boolean;
...
export const OnboardingEmailVerification = React.forwardRef<
  HTMLDivElement,
  OnboardingEmailVerificationProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(onboardingemailverificationVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(onboardingemailverificationVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
