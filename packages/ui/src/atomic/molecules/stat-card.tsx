...
export const StatCardPresets = {
  ...
  Metric: (props: Omit<StatCardProps, 'variant'>) => (
    <StatCard variant="compact" {...props} />
  ),
  
  // Analytics dashboard
  Analytics: (props: Omit<StatCardProps, 'variant'>) => (
    <StatCard variant="detailed" {...props} />
  )
};
