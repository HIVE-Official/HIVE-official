...
const ritualrewarddisplayVariants = cva(
...
export interface RitualRewardDisplayProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof ritualrewarddisplayVariants> {
  icon?: any;
  description?: any;
  points?: any;
  isEarned?: any;
...
export const RitualRewardDisplay = React.forwardRef<
  HTMLDivElement,
  RitualRewardDisplayProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(ritualrewarddisplayVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(ritualrewarddisplayVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
