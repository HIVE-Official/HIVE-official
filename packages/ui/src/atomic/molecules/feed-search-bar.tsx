...
const feedsearchbarVariants = cva(
...
export interface FeedSearchBarProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof feedsearchbarVariants> {
  placeholder?: any;
  onSearch?: any;
  filters?: any;
  suggestions?: any;
...
export const FeedSearchBar = React.forwardRef<
  HTMLDivElement,
  FeedSearchBarProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(feedsearchbarVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(feedsearchbarVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
