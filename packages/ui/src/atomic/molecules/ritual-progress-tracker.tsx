...
const ritualprogresstrackerVariants = cva(
...
export interface RitualProgressTrackerProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof ritualprogresstrackerVariants> {
  dailyGoals?: any;
  weeklyProgress?: any;
  completion?: any;
  isLoading?: boolean;
...
export const RitualProgressTracker = React.forwardRef<
  HTMLDivElement,
  RitualProgressTrackerProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(ritualprogresstrackerVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(ritualprogresstrackerVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
