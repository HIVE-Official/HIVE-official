...
const ritualcheckinbuttonVariants = cva(
...
export interface RitualCheckInButtonProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof ritualcheckinbuttonVariants> {
  isCheckedIn?: any;
  onCheckIn?: any;
  isLoading?: boolean;
  error?: string;
...
export const RitualCheckInButton = React.forwardRef<
  HTMLDivElement,
  RitualCheckInButtonProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(ritualcheckinbuttonVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(ritualcheckinbuttonVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
