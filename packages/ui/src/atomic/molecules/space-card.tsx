...
export const SpaceCard = React.forwardRef<
  HTMLDivElement,
  SpaceCardProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spacecardVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spacecardVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
