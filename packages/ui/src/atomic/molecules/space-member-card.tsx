...
const spacemembercardVariants = cva(
...
export interface SpaceMemberCardProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof spacemembercardVariants> {
  name?: any;
  avatar?: any;
  role?: any;
  joinDate?: any;
...
export const SpaceMemberCard = React.forwardRef<
  HTMLDivElement,
  SpaceMemberCardProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spacemembercardVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spacemembercardVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
