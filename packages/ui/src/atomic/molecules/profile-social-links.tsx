...
const profilesociallinksVariants = cva(
...
export interface ProfileSocialLinksProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof profilesociallinksVariants> {
  links?: any;
  isEditable?: any;
  isLoading?: boolean;
  error?: string;
...
export const ProfileSocialLinks = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(profilesociallinksVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(profilesociallinksVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
