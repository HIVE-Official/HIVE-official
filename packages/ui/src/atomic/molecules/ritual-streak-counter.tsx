...
const ritualstreakcounterVariants = cva(
...
export interface RitualStreakCounterProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof ritualstreakcounterVariants> {
  currentStreak?: any;
  longestStreak?: any;
  checkIns?: any;
  isLoading?: boolean;
...
export const RitualStreakCounter = React.forwardRef<
  HTMLDivElement,
  RitualStreakCounterProps
>(
  (
    {
      className,
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(ritualstreakcounterVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(ritualstreakcounterVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
