...
const profilebioeditorVariants = cva(
...
export interface ProfileBioEditorProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof profilebioeditorVariants> {
  bio?: any;
  maxLength?: any;
  onSave?: any;
  isLoading?: boolean;
...
export const ProfileBioEditor = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(profilebioeditorVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(profilebioeditorVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
