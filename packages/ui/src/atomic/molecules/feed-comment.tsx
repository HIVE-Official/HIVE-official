...
export interface FeedCommentProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof feedcommentVariants> {
  authorName?: any;
  authorAvatar?: any;
  content?: any;
  timestamp?: any;
...
export const FeedComment = React.forwardRef<
  HTMLDivElement,
  FeedCommentProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(feedcommentVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(feedcommentVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
