...
/**
 * Checkbox component from HIVE design system
 *
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Checkbox component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      ...
      <Checkbox className="hover:opacity-80">Hover State</Checkbox>
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <Checkbox className="w-full">Full Width</Checkbox>
    </div>
  ),
  parameters: {
    viewport: {
