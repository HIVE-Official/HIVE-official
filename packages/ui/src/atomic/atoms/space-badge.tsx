...
export interface SpaceBadgeProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof spacebadgeVariants> {
  type?: any;
  label?: any;
  isLoading?: boolean;
  error?: string;
...
export const SpaceBadge = React.forwardRef<
  HTMLDivElement,
  SpaceBadgeProps
>(
  (
    ...
    if (isLoading) {
      return (
        <div
          ref={ref}
          className={cn(spacebadgeVariants({ variant }), className)}
          {...props}
        >
    ...
    if (error) {
      return (
        <div
          ref={ref}
          className={cn(spacebadgeVariants({ variant }), 'border-[var(--hive-error)]', className)}
          {...props}
        >
