...
/**
 * Command component from HIVE design system
 *
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Command component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <Command variant="default">Default</Command>
      <Command variant="secondary">Secondary</Command>
      <Command variant="outline">Outline</Command>
      <Command variant="ghost">Ghost</Command>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <Command size="sm">Small</Command>
      <Command size="default">Default</Command>
      <Command size="lg">Large</Command>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      ...
      <Command className="hover:opacity-80">Hover State</Command>
      <Command disabled>Disabled</Command>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <Command className="w-full">Full Width</Command>
    </div>
  ),
  parameters: {
    viewport: {
