...
export const HiveLogo = React.forwardRef<HTMLDivElement, HiveLogoProps>(
  ({ className, size, color = "auto", ...props }, ref) => {
    // Determine which logo to use based on color preference
    const getLogoPath = () => {
      if (color === "black") return "/assets/hive-logo-black.svg";
      if (color === "gold") return "/assets/hive-logo-gold.svg";
      if (color === "white") return "/assets/hive-logo-white.svg";
