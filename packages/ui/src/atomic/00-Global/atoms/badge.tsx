...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border border-[var(--hive-border-default)] px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--hive-interactive-focus)] focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--hive-background-primary)] text-[var(--hive-text-primary)] hover:bg-[var(--hive-background-secondary)]",
        secondary:
          "bg-[var(--hive-background-secondary)] text-[var(--hive-text-primary)] hover:bg-[var(--hive-background-tertiary)]",
        destructive:
          "bg-[var(--hive-status-error)] text-[var(--hive-status-error-text)] hover:bg-[var(--hive-status-error)]/80",
        success:
          "bg-[var(--hive-status-success)] text-[var(--hive-status-success-text)] hover:bg-[var(--hive-status-success)]/80",
        warning:
