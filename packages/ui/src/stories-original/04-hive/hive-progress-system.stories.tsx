    ...
    return (
      <div className="space-y-6 w-full max-w-lg">
        <div className="text-center space-y-4">
          <h3 className="text-lg font-semibold text-[var(--hive-text-primary)]">File Upload Progress</h3>
...
export const MultiStepProcess: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-6 w-full max-w-lg">
        <div className="text-center space-y-4">
          <h3 className="text-lg font-semibold text-[var(--hive-text-primary)]">Account Setup</h3>
          ...
          <div className="p-6 bg-[var(--hive-text-primary)]/5 rounded-lg border border-white/10">
            <h4 className="font-medium text-[var(--hive-text-primary)] mb-2">Step {currentStep + 1}: {steps[currentStep]}</h4>
  ...
  render: () => {
    ...
    return (
      <div className="space-y-8 w-full max-w-2xl">
        <div className="text-center space-y-4">
          <h3 className="text-lg font-semibold text-[var(--hive-text-primary)]">Loading State Examples</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Page Loading */}
          <div className="space-y-4 p-4 bg-[var(--hive-text-primary)]/5 rounded-lg border border-white/10">
            <h4 className="font-medium text-[var(--hive-text-primary)]">Page Loading</h4>
            {loadingStates.page ? (
          ...
          {/* Content Loading */}
          <div className="space-y-4 p-4 bg-[var(--hive-text-primary)]/5 rounded-lg border border-white/10">
            <h4 className="font-medium text-[var(--hive-text-primary)]">Content Loading</h4>
          ...
          {/* Action Loading */}
          <div className="space-y-4 p-4 bg-[var(--hive-text-primary)]/5 rounded-lg border border-white/10">
            <h4 className="font-medium text-[var(--hive-text-primary)]">Action Progress</h4>
