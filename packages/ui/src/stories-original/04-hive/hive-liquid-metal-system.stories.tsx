...
const MagneticInteractionsDemo = () => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    <HiveCard variant="gold-featured" size="xl" animateEntrance={true}>
      <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-6">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <Star className="w-8 h-8 text-[var(--hive-brand-secondary)] mx-auto mb-2" />
            <p className="text-[var(--hive-text-primary)]">Interactive Card</p>
          </HiveCard>
          ...
          <HiveCard 
            ...
            className="p-4 text-center"
          >
            <Zap className="w-8 h-8 text-[var(--hive-brand-secondary)] mx-auto mb-2" />
            <p className="text-[var(--hive-text-primary)]">Builder Card</p>
          </HiveCard>
        </div>
      </div>
    </HiveCard>
    ...
    <HiveCard variant="elevated" size="xl" animateEntrance={true} cascadeIndex={1}>
      ...
      <div className="space-y-6">
        <HiveLiquidRipple intensity="medium" className="p-8 border border-[var(--hive-brand-secondary)]/30 rounded-2xl">
          <div className="text-center">
            <p className="text-[var(--hive-text-secondary)] mb-4">Click anywhere for ripple effect</p>
            <div className="w-16 h-16 bg-[var(--hive-brand-secondary)]/20 rounded-full mx-auto flex items-center justify-center">
              <Waves className="w-8 h-8 text-[var(--hive-brand-secondary)]" />
            </div>
          </div>
        </HiveLiquidRipple>
        ...
        <div className="grid grid-cols-3 gap-3">
          {['Subtle', 'Medium', 'Strong'].map((intensity, index) => (
            <HiveLiquidRipple 
              ...
              className="p-4 bg-[var(--hive-background-secondary)] border border-[var(--hive-border-default)] rounded-xl text-center"
            >
              <p className="text-[var(--hive-text-secondary)] text-sm">{intensity}</p>
            </HiveLiquidRipple>
          ))}
        </div>
      </div>
          ...
          {[0, 1, 2].map((index) => (
            ...
            >
              <HiveCard 
                ...
                cascadeIndex={index}
              >
                <div className="w-12 h-12 bg-[var(--hive-brand-secondary)]/20 rounded-full mx-auto mb-4 flex items-center justify-center">
                  <span className="text-[var(--hive-brand-secondary)] font-bold">{index + 1}</span>
                </div>
                <p className="text-[var(--hive-text-secondary)]">Sequence Element</p>
              </HiveCard>
            </motion.div>
          ))}
        </div>
      ...
      <HiveCard variant="tool" size="xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-[var(--hive-text-primary)] mb-4">Drag Tools to Assembly Zone</h4>
            <div className="flex flex-wrap gap-4">
              {['timer', 'counter', 'poll', 'form'].map((tool) => (
                ...
                >
                  ...
                  >
                    <div className="w-8 h-8 bg-[var(--hive-brand-secondary)]/20 rounded-lg mx-auto mb-2 flex items-center justify-center">
                      <Plus className="w-4 h-4 text-[var(--hive-brand-secondary)]" />
                    </div>
                    <p className="text-[var(--hive-text-secondary)] text-sm capitalize">{tool}</p>
                  </HiveCard>
                </HiveMagneticSnap>
              ))}
            </div>
          ...
          {/* Assembly Zone */}
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-[var(--hive-text-primary)] mb-4">Assembly Zone</h4>
            <HiveMagneticTarget
            ...
            >
              <div className="text-center">
                <div className="w-16 h-16 bg-[var(--hive-brand-secondary)]/20 rounded-full mx-auto mb-4 flex items-center justify-center">
                  <Target className="w-8 h-8 text-[var(--hive-brand-secondary)]" />
                </div>
    ...
    <div className="bg-[var(--hive-background-primary)] min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="text-center mb-12"
        >
          <h2 className="text-4xl font-bold text-[var(--hive-text-primary)] mb-4">
        ...
        <div className="grid grid-cols-4 md:grid-cols-8 gap-4">
          {Array.from({ length: 32 }, (_, i) => (
            ...
            >
              <span className="text-[var(--hive-brand-secondary)] font-bold">{i + 1}</span>
            </HiveCard>
          ))}
        </div>
