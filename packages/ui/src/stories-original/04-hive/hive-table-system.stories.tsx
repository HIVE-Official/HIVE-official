...
const spaceColumns = [
  {
    ...
    cell: ({ row }: any) => (
      <div className="flex items-center space-x-3">
        ...
        <div>
          <div className="font-medium text-[var(--hive-text-primary)] flex items-center space-x-2">
            {row.original.name}
  ...
  },
  {
    ...
    cell: ({ row }: any) => (
      <div className="flex items-center space-x-3">
        ...
        <span className="text-sm text-gray-400 min-w-8">{row.original.activity}%</span>
      </div>
    ),
  },
  {
    ...
    cell: ({ row }: any) => (
      <div className="flex items-center space-x-1">
        ...
        <span className="text-[var(--hive-text-primary)] font-medium">{row.original.engagement}</span>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }: any) => (
      <div className="flex items-center space-x-2">
        ...
        <span className="text-[var(--hive-text-primary)]">{row.original.tools}</span>
      </div>
    ),
  },
  {
...
const studentColumns = [
  {
    ...
    cell: ({ row }: any) => (
      <div className="flex items-center space-x-3">
        ...
        <div>
          <div className="font-medium text-[var(--hive-text-primary)]">{row.original.name}</div>
  ...
  },
  {
    ...
    cell: ({ row }: any) => (
      <div>
        <div className="text-[var(--hive-text-primary)] font-medium">{row.original.major}</div>
  ...
  },
  {
    ...
    sortable: true,
    cell: ({ row }: any) => (
      <span className="text-[var(--hive-text-primary)]">{row.original.credits}</span>
    ),
  },
  {
    id: 'engagement',
    ...
    cell: ({ row }: any) => (
      <div className="space-y-1">
        ...
        <div className="text-[var(--hive-text-primary)] font-medium">{row.original.posts} posts</div>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }: any) => (
      <div className="flex items-center space-x-2">
        ...
        <span className="text-[var(--hive-text-primary)] font-medium">{row.original.uses.toLocaleString()}</span>
      </div>
    ),
  },
  {
    ...
    cell: ({ row }: any) => (
      <div className="flex items-center space-x-1">
        <Star className="text-yellow-400" size={14} />
        <span className="text-[var(--hive-text-primary)] font-medium">{row.original.rating}</span>
      </div>
    ),
  },
  {
    ...
    cell: ({ row }: any) => (
      <div className="flex items-center space-x-2">
        ...
        <span className="text-[var(--hive-text-primary)]">{row.original.downloads.toLocaleString()}</span>
      </div>
    ),
  },
  {
...
export const BasicTable: Story = {
  render: (args) => (
    <div className="w-full max-w-6xl p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-[var(--hive-text-primary)] mb-2">Campus Spaces</h3>
  ...
  render: (args) => (
    <div className="w-full max-w-7xl p-8 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-2">Premium Space Management</h3>
        ...
        expandedRowRender={(row) => (
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h4 className="font-medium text-[var(--hive-text-primary)] mb-3">Space Details</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Description:</span>
                    <span className="text-[var(--hive-text-primary)] max-w-48 text-right">{row.description}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Category:</span>
                    <span className="text-[var(--hive-text-primary)]">{row.category}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Created:</span>
                    <span className="text-[var(--hive-text-primary)]">{row.created}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Privacy:</span>
                    <span className="text-[var(--hive-text-primary)]">{row.privacy}</span>
                  </div>
                </div>
              </div>
              
              <div>
                <h4 className="font-medium text-[var(--hive-text-primary)] mb-3">Performance Metrics</h4>
                <div className="space-y-3">
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span className="text-gray-400">Engagement Score</span>
                      <span className="text-[var(--hive-text-primary)]">{row.engagement}/5.0</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="text-center p-2 bg-[var(--hive-text-primary)]/5 rounded-lg">
                      <div className="text-lg font-semibold text-[var(--hive-text-primary)]">{row.posts}</div>
                      <div className="text-gray-400">Posts</div>
                    </div>
                    <div className="text-center p-2 bg-[var(--hive-text-primary)]/5 rounded-lg">
                      <div className="text-lg font-semibold text-[var(--hive-text-primary)]">{row.tools}</div>
              ...
              <div>
                <h4 className="font-medium text-[var(--hive-text-primary)] mb-3">Quick Actions</h4>
...
export const StudentAnalytics: Story = {
  render: () => (
    <div className="w-full max-w-7xl p-8 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-2">Student Performance Analytics</h3>
        ...
        expandedRowRender={(row) => (
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-[var(--hive-text-primary)] mb-3">Academic Details</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Mentor:</span>
                    <span className="text-[var(--hive-text-primary)]">{row.mentor}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Last Active:</span>
                    <span className="text-[var(--hive-text-primary)]">{row.lastActive}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Total Credits:</span>
                    <span className="text-[var(--hive-text-primary)]">{row.credits}</span>
                  </div>
                </div>
              </div>
              
              <div>
                <h4 className="font-medium text-[var(--hive-text-primary)] mb-3">Achievements</h4>
                <div className="space-y-2">
                  {row.achievements.map((achievement: string, index: number) => (
                    <div key={index} className="flex items-center space-x-2">
                      <Trophy className="text-yellow-400" size={14} />
                      <span className="text-[var(--hive-text-primary)] text-sm">{achievement}</span>
                    </div>
                  ))}
                </div>
              </div>
...
export const ToolAnalytics: Story = {
  render: () => (
    <div className="w-full max-w-6xl p-8 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-2">HIVE Tool Analytics</h3>
      ...
      <HiveTable
        ...
        expandedRowRender={(row) => (
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-[var(--hive-text-primary)] mb-3">Tool Details</h4>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-[var(--hive-text-primary)]">{row.lastUpdated}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Used in Spaces:</span>
                    <span className="text-[var(--hive-text-primary)]">{row.spaces}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="text-center p-3 bg-[var(--hive-text-primary)]/5 rounded-lg">
                    <div className="text-xl font-semibold text-[var(--hive-text-primary)]">{row.uses.toLocaleString()}</div>
                    <div className="text-gray-400 text-xs">Total Uses</div>
                  </div>
                  <div className="text-center p-3 bg-[var(--hive-text-primary)]/5 rounded-lg">
                    <div className="text-xl font-semibold text-[var(--hive-text-primary)]">{row.downloads.toLocaleString()}</div>
                  ...
                  <div className="text-center p-3 bg-[var(--hive-text-primary)]/5 rounded-lg">
                    <div className="text-xl font-semibold text-[var(--hive-text-primary)]">{row.spaces}</div>
  ...
  render: () => (
    <div className="space-y-8">
      <div className="w-full max-w-4xl p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Compact Density</h4>
        <HiveTable
          variant="minimal"
          density="compact"
      ...
      <div className="w-full max-w-4xl p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Default Density</h4>
        <HiveTable
          variant="default"
          density="default"
          data={mockSpaceData.slice(0, 3)}
      ...
      <div className="w-full max-w-4xl p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Spacious Density</h4>
        <HiveTable
          variant="premium"
          density="spacious"
          data={mockSpaceData.slice(0, 3)}
  ...
  render: () => (
    <div className="space-y-8">
      <div className="w-full max-w-5xl p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Loading State</h4>
        <HiveTable
          variant="default"
          density="default"
          data={[]}
      ...
      <div className="w-full max-w-5xl p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Empty State</h4>
        <HiveTable
          variant="default"
          density="default"
          data={[]}
          ...
          empty={
            <div className="text-center py-12">
              ...
              <div className="text-xl font-medium text-[var(--hive-text-primary)] mb-2">No spaces found</div>
...
export const InteractiveFeatures: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-7xl p-8 bg-[var(--hive-background-primary)] rounded-2xl">
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-2">Interactive Table Features</h3>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-[var(--hive-text-primary)]/5 rounded-xl">
          <div>
            <div className="text-sm text-gray-400">Current Sort</div>
            <div className="text-[var(--hive-text-primary)] font-medium">{sortBy || 'None'}</div>
          </div>
          <div>
            <div className="text-sm text-gray-400">Search Query</div>
            <div className="text-[var(--hive-text-primary)] font-medium">{searchQuery || 'None'}</div>
          </div>
          <div>
            <div className="text-sm text-gray-400">Selected Rows</div>
            <div className="text-[var(--hive-text-primary)] font-medium">{selectedRows.length}</div>
          </div>
        </div>
      </div>
    );
