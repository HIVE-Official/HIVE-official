          ...
          <HiveCard>
            <div className="p-4">
              ...
              <div className="space-y-2">
                <a 
                  href="#main-content" 
                  className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-blue-600 text-[var(--hive-text-primary)] px-4 py-2 rounded z-50"
                >
                  Skip to main content
                </a>
                <a 
                  href="#navigation" 
                  className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-32 bg-blue-600 text-[var(--hive-text-primary)] px-4 py-2 rounded z-50"
                >
                  Skip to navigation
                </a>
                <a 
                  href="#footer" 
                  className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-64 bg-blue-600 text-[var(--hive-text-primary)] px-4 py-2 rounded z-50"
                >
                  Skip to footer
                </a>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <button
                    ...
                    className="bg-blue-600 text-[var(--hive-text-primary)] px-4 py-2 rounded hover:bg-blue-700 focus:ring-2 focus:ring-blue-500"
...
export const HighContrastMode: Story = {
  render: () => {
    ...
    return (
      <div className={highContrast ? 'bg-[var(--hive-background-primary)] text-[var(--hive-text-primary)]' : 'bg-gray-50'}>
        <HiveSpaceLayout>
          <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <HiveButton 
                  ...
                  className={highContrast ? 'border-white text-[var(--hive-text-primary)] hover:bg-[var(--hive-text-primary)] hover:text-[var(--hive-background-primary)]' : ''}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <HiveCard className={highContrast ? 'bg-gray-900 border-[var(--hive-border-default)]' : ''}>
                <div className="p-4">
              ...
              <HiveCard className={highContrast ? 'bg-gray-900 border-[var(--hive-border-default)]' : ''}>
                <div className="p-4">
                  ...
                  <div className="space-y-3">
                    <HiveButton 
                      variant="primary"
                      className={highContrast ? 'bg-[var(--hive-text-primary)] text-[var(--hive-background-primary)] hover:bg-gray-200' : ''}
                    >
                      Primary Button
                    </HiveButton>
                    <HiveButton 
                    ...
                    <HiveInput
                      ...
                      className={highContrast ? 'bg-gray-800 border-gray-600 text-[var(--hive-text-primary)] placeholder-gray-400' : ''}
                    />
                  </div>
                </div>
              </HiveCard>
