        ...
        <div className="p-6 space-y-6">
          ...
          {attemptedAction && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="fixed inset-0 bg-[var(--hive-background-primary)] bg-opacity-50 flex items-center justify-center z-50"
            >
              <motion.div
                initial={{ scale: 0.9 }}
                animate={{ scale: 1 }}
                className="bg-[var(--hive-text-primary)] p-6 rounded-lg max-w-md mx-4"
              >
