          ...
          <ResizablePanelGroup direction="vertical">
              ...
              <div className="p-4 h-full relative">
                <div className="absolute top-2 left-4 right-4 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="px-2 py-1 text-xs bg-hive-accent text-[var(--hive-background-primary)] rounded">
                      Save
                    </button>
                  </div>
                </div>
            ...
            <ResizablePanel defaultSize={25} minSize={15}>
              <div className="p-4 h-full bg-hive-background-card border-t border-hive-border">
                ...
                <div className="h-full bg-[var(--hive-text-primary)] rounded border text-[var(--hive-background-primary)] text-xs p-2">
            ...
            <div className="space-y-1">
              {['Pinned 📌', 'Posts 📝', 'Events 📅', 'Tools 🔧', 'Chat 💬', 'Members 👥'].map((surface, i) => (
                <div key={i} className={`p-2 rounded text-xs cursor-pointer transition-colors ${
                  i === 1 ? 'bg-hive-accent text-[var(--hive-background-primary)]' : 'hover:bg-hive-background-muted'
                }`}>
                  {surface}
                </div>
              ))}
        ...
        <ResizablePanel defaultSize={65}>
          <div className="p-4 h-full">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="px-3 py-1 text-xs bg-hive-accent text-[var(--hive-background-primary)] rounded">
                New Post
              </button>
            </div>
            <div className="space-y-3">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          <button
            ...
            className={`px-3 py-1 text-sm rounded ${!isMobile ? 'bg-hive-accent text-[var(--hive-background-primary)]' : 'bg-hive-background-card border border-hive-border'}`}
          >
            Desktop
          </button>
          <button
