        ...
        <div className="grid grid-cols-4 gap-4">
          {mobileBottomTabs.map((tab) => (
            <div key={tab.id} className="text-center space-y-2">
              ...
              {tab.badge && (
                <div className="text-xs bg-red-500 text-[var(--hive-text-primary)] rounded-full w-5 h-5 flex items-center justify-center mx-auto">
                  {tab.badge}
                </div>
              )}
            </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="bg-gray-50 p-6 rounded-xl">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center justify-between p-3 bg-[var(--hive-text-primary)] rounded-lg">
