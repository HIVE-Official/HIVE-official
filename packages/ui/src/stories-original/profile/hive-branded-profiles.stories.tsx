...
const createBrandedBuilder = (): User => ({
  id: 'branded-builder',
  fullName: 'Maya Patel',
  handle: 'maya_builds',
...
const createBrandedStudent = (): User => ({
  id: 'branded-student',
...
const createDenseConnections = (): Connection[] => [
  {
    id: 'dorm-cs',
    type: 'dorm_classmate',
...
const createDenseHiveLab = (): HiveLabSection => ({
  isLocked: false,
  availableTools: [
    'Course Planner',
    'Grade Tracker', 
...
export const HIVEBrandedBuilder: Story = {
...
export const HIVEBrandedStudent: Story = {
...
export const HIVECompactMobile: Story = {
...
export const HIVETabletDense: Story = {
...
export const HIVEDesktopPacked: Story = {
...
export const HIVEMinimalNew: Story = {
