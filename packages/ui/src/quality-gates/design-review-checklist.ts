...
export const designQualityGates: DesignQualityGate[] = [
  {
    ...
    checks: [
      ...
      },
      {
        ...
        examples: {
          ...
          bad: "bg-gradient-to-r from-blue-500/10 to-gold-500/10, decorative gradients"
        }
      }
    ]
  },
...
export function checkAIPatterns(componentCode: string): string[] {
...
export function checkMobileOptimization(componentCode: string): string[] {
  const violations: string[] = [];
