...
import { HiveCard } from '../../atomic/atoms/hive-card';

/**
 * HiveCard component from HIVE design system
 *
...
const meta = {
  title: '11-Shared/Hive Card',
  component: HiveCard,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'HiveCard component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
} satisfies Meta<typeof HiveCard>;
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <HiveCard variant="default">Default</HiveCard>
      <HiveCard variant="secondary">Secondary</HiveCard>
      <HiveCard variant="outline">Outline</HiveCard>
      <HiveCard variant="ghost">Ghost</HiveCard>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <HiveCard size="sm">Small</HiveCard>
      <HiveCard size="default">Default</HiveCard>
      <HiveCard size="lg">Large</HiveCard>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      <HiveCard>Default</HiveCard>
      <HiveCard className="hover:opacity-80">Hover State</HiveCard>
      <HiveCard disabled>Disabled</HiveCard>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <HiveCard className="w-full">Full Width</HiveCard>
    </div>
  ),
  parameters: {
    viewport: {
