...
import { CheckIcon } from '../../atomic/atoms/check-icon';

/**
 * CheckIcon component from HIVE design system
 *
...
const meta = {
  title: '11-Shared/Check Icon',
  component: CheckIcon,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'CheckIcon component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <CheckIcon variant="default">Default</CheckIcon>
      <CheckIcon variant="secondary">Secondary</CheckIcon>
      <CheckIcon variant="outline">Outline</CheckIcon>
      <CheckIcon variant="ghost">Ghost</CheckIcon>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <CheckIcon size="sm">Small</CheckIcon>
      <CheckIcon size="default">Default</CheckIcon>
      <CheckIcon size="lg">Large</CheckIcon>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      ...
      <CheckIcon className="hover:opacity-80">Hover State</CheckIcon>
      <CheckIcon disabled>Disabled</CheckIcon>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <CheckIcon className="w-full">Full Width</CheckIcon>
    </div>
  ),
  parameters: {
    viewport: {
