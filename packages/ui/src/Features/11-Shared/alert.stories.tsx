...
import { AlertIcons } from '../../atomic/atoms/alert';

/**
 * AlertIcons component from HIVE design system
 *
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'AlertIcons component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
} satisfies Meta<typeof AlertIcons>;
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <AlertIcons variant="default">Default</AlertIcons>
      <AlertIcons variant="secondary">Secondary</AlertIcons>
      <AlertIcons variant="outline">Outline</AlertIcons>
      <AlertIcons variant="ghost">Ghost</AlertIcons>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <AlertIcons size="sm">Small</AlertIcons>
      <AlertIcons size="default">Default</AlertIcons>
      <AlertIcons size="lg">Large</AlertIcons>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      <AlertIcons>Default</AlertIcons>
      <AlertIcons className="hover:opacity-80">Hover State</AlertIcons>
      <AlertIcons disabled>Disabled</AlertIcons>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <AlertIcons className="w-full">Full Width</AlertIcons>
    </div>
  ),
  parameters: {
    viewport: {
