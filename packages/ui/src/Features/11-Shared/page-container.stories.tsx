...
import { PageContainer } from '../../atomic/molecules/page-container';

/**
 * PageContainer component from HIVE design system
 *
...
const meta = {
  title: '11-Shared/Page Container',
  component: PageContainer,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'PageContainer component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
export const Default: Story = {
  args: {
    children: 'Default PageContainer',
  },
};
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <PageContainer variant="default">Default</PageContainer>
      <PageContainer variant="secondary">Secondary</PageContainer>
      <PageContainer variant="outline">Outline</PageContainer>
      <PageContainer variant="ghost">Ghost</PageContainer>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <PageContainer size="sm">Small</PageContainer>
      <PageContainer size="default">Default</PageContainer>
      <PageContainer size="lg">Large</PageContainer>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      <PageContainer>Default</PageContainer>
      <PageContainer className="hover:opacity-80">Hover State</PageContainer>
      <PageContainer disabled>Disabled</PageContainer>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <PageContainer className="w-full">Full Width</PageContainer>
    </div>
  ),
  parameters: {
    viewport: {
