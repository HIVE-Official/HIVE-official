...
/**
 * ProfileBentoGrid component from HIVE design system
 *
...
const meta = {
  title: '02-Profile/Profile Bento Grid',
  component: ProfileBentoGrid,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'ProfileBentoGrid component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
export const Default: Story = {
  args: {
    children: 'Default ProfileBentoGrid',
  },
};
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <ProfileBentoGrid variant="default">Default</ProfileBentoGrid>
      <ProfileBentoGrid variant="secondary">Secondary</ProfileBentoGrid>
      <ProfileBentoGrid variant="outline">Outline</ProfileBentoGrid>
      <ProfileBentoGrid variant="ghost">Ghost</ProfileBentoGrid>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <ProfileBentoGrid size="sm">Small</ProfileBentoGrid>
      <ProfileBentoGrid size="default">Default</ProfileBentoGrid>
      <ProfileBentoGrid size="lg">Large</ProfileBentoGrid>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      <ProfileBentoGrid>Default</ProfileBentoGrid>
      <ProfileBentoGrid className="hover:opacity-80">Hover State</ProfileBentoGrid>
      <ProfileBentoGrid disabled>Disabled</ProfileBentoGrid>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <ProfileBentoGrid className="w-full">Full Width</ProfileBentoGrid>
    </div>
  ),
  parameters: {
    viewport: {
