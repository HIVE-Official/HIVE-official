...
/**
 * NavigationShell component from HIVE design system
 *
...
const meta = {
  title: '08-Navigation/Navigation Shell',
  component: NavigationShell,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'NavigationShell component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
export const Default: Story = {
  args: {
    children: 'Default NavigationShell',
  },
};
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <NavigationShell variant="default">Default</NavigationShell>
      <NavigationShell variant="secondary">Secondary</NavigationShell>
      <NavigationShell variant="outline">Outline</NavigationShell>
      <NavigationShell variant="ghost">Ghost</NavigationShell>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <NavigationShell size="sm">Small</NavigationShell>
      <NavigationShell size="default">Default</NavigationShell>
      <NavigationShell size="lg">Large</NavigationShell>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      <NavigationShell>Default</NavigationShell>
      <NavigationShell className="hover:opacity-80">Hover State</NavigationShell>
      <NavigationShell disabled>Disabled</NavigationShell>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <NavigationShell className="w-full">Full Width</NavigationShell>
    </div>
  ),
  parameters: {
    viewport: {
