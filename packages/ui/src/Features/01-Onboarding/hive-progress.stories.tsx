...
import { HiveProgress } from '../../atomic/atoms/hive-progress';

/**
 * HiveProgress component from HIVE design system
 *
...
const meta = {
  title: '01-Onboarding/Hive Progress',
  component: HiveProgress,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'HiveProgress component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
} satisfies Meta<typeof HiveProgress>;
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <HiveProgress variant="default">Default</HiveProgress>
      <HiveProgress variant="secondary">Secondary</HiveProgress>
      <HiveProgress variant="outline">Outline</HiveProgress>
      <HiveProgress variant="ghost">Ghost</HiveProgress>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <HiveProgress size="sm">Small</HiveProgress>
      <HiveProgress size="default">Default</HiveProgress>
      <HiveProgress size="lg">Large</HiveProgress>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      <HiveProgress>Default</HiveProgress>
      <HiveProgress className="hover:opacity-80">Hover State</HiveProgress>
      <HiveProgress disabled>Disabled</HiveProgress>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <HiveProgress className="w-full">Full Width</HiveProgress>
    </div>
  ),
  parameters: {
    viewport: {
