...
import { HiveInput } from '../../atomic/atoms/hive-input';

/**
 * HiveInput component from HIVE design system
 *
...
const meta = {
  title: '10-Forms/Hive Input',
  component: HiveInput,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'HiveInput component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
} satisfies Meta<typeof HiveInput>;
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <HiveInput variant="default">Default</HiveInput>
      <HiveInput variant="secondary">Secondary</HiveInput>
      <HiveInput variant="outline">Outline</HiveInput>
      <HiveInput variant="ghost">Ghost</HiveInput>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <HiveInput size="sm">Small</HiveInput>
      <HiveInput size="default">Default</HiveInput>
      <HiveInput size="lg">Large</HiveInput>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      <HiveInput>Default</HiveInput>
      <HiveInput className="hover:opacity-80">Hover State</HiveInput>
      <HiveInput disabled>Disabled</HiveInput>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <HiveInput className="w-full">Full Width</HiveInput>
    </div>
  ),
  parameters: {
    viewport: {
