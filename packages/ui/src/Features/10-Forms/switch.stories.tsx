...
/**
 * Switch component from HIVE design system
 *
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Switch component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      ...
      <Switch size="default">Default</Switch>
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      ...
      <Switch className="hover:opacity-80">Hover State</Switch>
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <Switch className="w-full">Full Width</Switch>
    </div>
  ),
  parameters: {
    viewport: {
