...
/**
 * InputEnhanced component from HIVE design system
 *
...
const meta = {
  title: '10-Forms/Input Enhanced',
  component: InputEnhanced,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'InputEnhanced component from HIVE design system. Built with HIVE design system standards: CVA variants, mobile-first sizing (44px minimum touch targets), HIVE CSS variables, React.forwardRef pattern.',
      },
    },
  },
...
} satisfies Meta<typeof InputEnhanced>;
...
export const Default: Story = {
  args: {
    children: 'Default InputEnhanced',
  },
};
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap items-center">
      <InputEnhanced variant="default">Default</InputEnhanced>
      <InputEnhanced variant="secondary">Secondary</InputEnhanced>
      <InputEnhanced variant="outline">Outline</InputEnhanced>
      <InputEnhanced variant="ghost">Ghost</InputEnhanced>
    </div>
  ),
  parameters: {
    docs: {
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      <InputEnhanced size="sm">Small</InputEnhanced>
      <InputEnhanced size="default">Default</InputEnhanced>
      <InputEnhanced size="lg">Large</InputEnhanced>
    </div>
  ),
  parameters: {
    docs: {
...
export const States: Story = {
  render: () => (
    <div className="flex gap-4 flex-wrap">
      <InputEnhanced>Default</InputEnhanced>
      <InputEnhanced className="hover:opacity-80">Hover State</InputEnhanced>
      <InputEnhanced disabled>Disabled</InputEnhanced>
    </div>
  ),
  parameters: {
    docs: {
...
export const Responsive: Story = {
  render: () => (
    <div className="w-full max-w-sm">
      <InputEnhanced className="w-full">Full Width</InputEnhanced>
    </div>
  ),
  parameters: {
    viewport: {
