    ...
    <div className="flex h-screen bg-gray-900">
      ...
      <div className="flex-1 p-8 overflow-auto">
        <div className="max-w-4xl">
          <h1 className="text-2xl font-bold text-white mb-4">Main Content Area</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-white/5 rounded-lg border border-white/10">
              <h3 className="text-lg font-semibold text-white mb-2">Content Section 1</h3>
              <p className="text-gray-400">Sample content to demonstrate the layout behavior.</p>
            </div>
            <div className="p-6 bg-white/5 rounded-lg border border-white/10">
              <h3 className="text-lg font-semibold text-white mb-2">Content Section 2</h3>
  ...
  render: () => {
    ...
    return (
      <div className="h-screen bg-gray-900">
        {/* Controls */}
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-50 bg-black/80 backdrop-blur-sm rounded-lg p-4 border border-white/10">
              ...
              {(['default', 'premium', 'minimal'] as const).map((v) => (
                <button
                  ...
                  className={`px-2 py-1 rounded text-xs ${
                    variant === v ? 'bg-yellow-500/20 text-yellow-400' : 'text-gray-400 hover:text-white'
                  }`}
                >
                  {v}
                </button>
            ...
            <div className="flex space-x-2">
              ...
              {(['left', 'right'] as const).map((p) => (
                <button
                  ...
                  className={`px-2 py-1 rounded text-xs ${
                    position === p ? 'bg-yellow-500/20 text-yellow-400' : 'text-gray-400 hover:text-white'
                  }`}
                >
                  {p}
                </button>
        ...
        <div className="flex h-full">
          ...
          <div className="flex-1 p-8 overflow-auto">
            <div className="max-w-4xl">
              <h1 className="text-2xl font-bold text-white mb-4">Interactive Sidebar Demo</h1>
              <p className="text-gray-400 mb-6">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Object.entries(features).map(([key, value]) => (
                    <label key={key} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                ...
                <div className="p-6 bg-white/5 rounded-lg border border-white/10">
                  <h3 className="text-lg font-semibold text-white mb-4">Navigation Features</h3>
