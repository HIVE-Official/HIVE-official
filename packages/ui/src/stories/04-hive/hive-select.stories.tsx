...
export const AllVariants: Story = {
  render: () => (
    <div className="space-y-6 w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div>
        <h4 className="text-white mb-2">Default Variant</h4>
        <HiveSelect
      ...
      <div>
        <h4 className="text-white mb-2">Premium Variant</h4>
        <HiveSelect
      ...
      <div>
        <h4 className="text-white mb-2">Minimal Variant</h4>
        <HiveSelect
...
export const SelectSizes: Story = {
  render: () => (
    <div className="space-y-4 w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div>
        <h4 className="text-white mb-2">Small Size</h4>
        <HiveSelect
      ...
      <div>
        <h4 className="text-white mb-2">Default Size</h4>
        <HiveSelect
      ...
      <div>
        <h4 className="text-white mb-2">Large Size</h4>
        <HiveSelect
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-white mb-4">Searchable Major Selection</h4>
        <HiveSelect
...
export const MultipleSelection: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-white mb-4">Your Active Spaces</h4>
        <HiveSelect
        ...
        <div className="mt-4">
          <h5 className="text-sm text-white/70 mb-2">Selected Spaces:</h5>
          <HiveSelectTags
            options={campusSpaces}
            value={value}
...
export const GroupedOptions: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-white mb-4">Academic Major Selection</h4>
        <HiveSelect
        ...
        {value && (
          <div className="mt-4 p-3 bg-black/20 rounded-xl">
            <div className="text-sm text-white/70">Selected Major:</div>
...
export const CreatableSelect: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-white mb-4">Tool Elements</h4>
        <HiveSelect
        ...
        {value.length > 0 && (
          <div className="mt-4">
            <h5 className="text-sm text-white/70 mb-2">Selected Elements:</h5>
            <HiveSelectTags
              options={options}
              value={value}
              onRemove={(removedValue) => 
...
export const LoadingAndStates: Story = {
  render: () => (
    <div className="space-y-6 w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div>
        <h4 className="text-white mb-2">Loading State</h4>
        <HiveSelect
      ...
      <div>
        <h4 className="text-white mb-2">Error State</h4>
        <HiveSelect
      ...
      <div>
        <h4 className="text-white mb-2">Disabled State</h4>
        <HiveSelect
    ...
    return (
      <div className="space-y-8 p-8 bg-[var(--hive-background-primary)] rounded-2xl">
        <div className="text-center mb-6">
          <h3 className="text-2xl font-semibold text-white mb-2">Student Profile Builder</h3>
        ...
        <div className="pt-4 border-t border-[var(--hive-border-subtle)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <div className="text-sm text-white/60 mb-1">Campus Spaces ({campusValue.length})</div>
              <HiveSelectTags
                options={campusSpaces}
                value={campusValue}
            ...
            <div>
              <div className="text-sm text-white/60 mb-1">Tool Elements ({elementValue.length})</div>
              <HiveSelectTags
                options={toolElements}
                value={elementValue}
...
export const CustomRendering: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <h4 className="text-white mb-4">Custom Rendering</h4>
        <HiveSelect
          placeholder="Select your major..."
          options={academicMajors}
          value={value}
