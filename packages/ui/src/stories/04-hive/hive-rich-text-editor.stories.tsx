...
export const Default: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-4xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-4">Tool Documentation</h3>
        <HiveRichTextEditor
          value={value}
          onChange={setValue}
...
export const CampusIntegration: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-4xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-4">Campus Project Builder</h3>
        <HiveRichTextEditor
          variant="elevated"
          value={value}
          onChange={setValue}
...
export const CollaborativeEditor: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-4xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-4">Collaborative Document</h3>
        <HiveRichTextEditor
          variant="premium"
          value={value}
          onChange={setValue}
...
export const SplitMode: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-6xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-4">Split View Editor</h3>
        <HiveRichTextEditor
          mode="split"
          size="lg"
          value={value}
    ...
    return (
      <div className="w-full max-w-4xl p-6 bg-[#0A0A0B] rounded-lg">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-medium text-white">Campus Tool Builder</h3>
...
export const SizeVariations: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-6xl p-6 bg-[#0A0A0B] rounded-lg space-y-8">
...
export const VariantShowcase: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-4xl p-6 bg-[#0A0A0B] rounded-lg space-y-8">
        <h3 className="text-lg font-medium text-white mb-4">Variant Showcase</h3>
...
export const StatesAndEdgeCases: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-4xl p-6 bg-[#0A0A0B] rounded-lg space-y-8">
        <h3 className="text-lg font-medium text-white mb-4">States & Edge Cases</h3>
    ...
    return (
      <div className="w-full max-w-6xl p-6 bg-[#0A0A0B] rounded-lg">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-white mb-2">HIVE Rich Text Editor</h2>
