...
export const HiveButtons: Story = {
  render: () => (
    <div className="p-8 bg-[#0A0A0B] min-h-screen">
      <h1 className="text-4xl font-bold text-[#E5E5E7] mb-8">HIVE Button System</h1>
      
      {/* Primary Variants */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-6">Primary Variants</h2>
      ...
      {/* Chip Variants */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-6">Chip Variants</h2>
        <div className="flex flex-wrap gap-4 mb-6">
      ...
      {/* Special Effects */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibent text-[#E5E5E7] mb-6">Special Effects</h2>
        <div className="flex flex-wrap gap-4 mb-6">
      ...
      {/* With Icons */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-6">With Icons</h2>
        <div className="flex flex-wrap gap-4 mb-6">
      ...
      {/* Loading States */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-6">Loading States</h2>
        <div className="flex flex-wrap gap-4 mb-6">
      ...
      {/* Icon Only */}
      <section>
        <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-6">Icon Only</h2>
...
export const HiveCards: Story = {
  render: () => (
    <div className="p-8 bg-[#0A0A0B] min-h-screen">
      <h1 className="text-4xl font-bold text-[#E5E5E7] mb-8">HIVE Card System</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <HiveCard className="p-6">
          <h3 className="text-[#E5E5E7] font-semibold mb-2">Default Card</h3>
        ...
        <HiveCard variant="elevated" className="p-6">
          <h3 className="text-[#E5E5E7] font-semibold mb-2">Elevated Card</h3>
          <p className="text-[#C1C1C4] text-sm">
        ...
        <HiveCard variant="glass" className="p-6">
          <h3 className="text-[#E5E5E7] font-semibold mb-2">Glass Card</h3>
          <p className="text-[#C1C1C4] text-sm">
        ...
        <HiveCard variant="gold" className="p-6">
          <h3 className="text-[#FFD700] font-semibold mb-2">Gold Accent Card</h3>
          <p className="text-[#C1C1C4] text-sm">
        ...
        <HiveCard variant="interactive" className="p-6 cursor-pointer">
          <h3 className="text-[#E5E5E7] font-semibold mb-2">Interactive Card</h3>
          <p className="text-[#C1C1C4] text-sm">
        ...
        <HiveCard variant="minimal" className="p-6">
          <h3 className="text-[#E5E5E7] font-semibold mb-2">Minimal Card</h3>
          <p className="text-[#C1C1C4] text-sm">
...
export const HiveInputs: Story = {
  render: () => (
    <div className="p-8 bg-[#0A0A0B] min-h-screen">
      <h1 className="text-4xl font-bold text-[#E5E5E7] mb-8">HIVE Input System</h1>
...
export const HiveBadges: Story = {
  render: () => (
    <div className="p-8 bg-[#0A0A0B] min-h-screen">
      <h1 className="text-4xl font-bold text-[#E5E5E7] mb-8">HIVE Badge System</h1>
      
      <div className="space-y-8">
        <section>
          <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-4">Variants</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-4">Sizes</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-4">With Icons</h2>
          <div className="flex flex-wrap gap-3">
...
export const PremiumComponents: Story = {
  render: () => (
    <div className="p-8 bg-[#0A0A0B] min-h-screen">
      <h1 className="text-4xl font-bold text-[#E5E5E7] mb-8">HIVE Premium Components</h1>
      
      <div className="space-y-12">
        <section>
          <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-6">Premium Buttons</h2>
          <div className="flex flex-wrap gap-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-[#E5E5E7] mb-6">Premium Cards</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
            <HiveCard className="p-6">
              <h3 className="text-[#FFD700] font-semibold mb-2">Premium Card</h3>
              <p className="text-[#C1C1C4] text-sm">
            ...
            <HiveCard variant="luxury" className="p-6">
              <h3 className="text-[#FFD700] font-semibold mb-2">Luxury Card</h3>
              <p className="text-[#C1C1C4] text-sm">
