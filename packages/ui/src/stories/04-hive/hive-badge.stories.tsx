...
export const Achievements: Story = {
  render: () => (
    <div className="space-y-6 p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      ...
      <div className="space-y-3">
        <h4 className="text-lg font-semibold text-white">Elite Status</h4>
        <div className="flex flex-wrap gap-3">
...
export const CampusLife: Story = {
  render: () => (
    <div className="space-y-6 p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="space-y-3">
        <h4 className="text-lg font-semibold text-white">Current Activity</h4>
        <div className="flex flex-wrap gap-3">
      ...
      <div className="space-y-3">
        <h4 className="text-lg font-semibold text-white">Urgent States</h4>
        <div className="flex flex-wrap gap-3">
  ...
  render: () => (
    <div className="space-y-6 p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="text-center mb-6">
        <h3 className="text-2xl font-semibold text-white mb-2">Pre-built Badge Components</h3>
        <p className="text-[var(--hive-text-secondary)]">Ready-to-use badges for common campus scenarios</p>
      </div>
      
      <div className="space-y-4">
        <div className="space-y-2">
          <h4 className="text-lg font-medium text-white">Academic Year</h4>
          <div className="flex flex-wrap gap-3">
            <FreshmanBadge />
            <DeansListBadge />
            <CampusLegendBadge />
        ...
        <div className="space-y-2">
          <h4 className="text-lg font-medium text-white">Study Modes</h4>
          <div className="flex flex-wrap gap-3">
            <GrindModeBadge />
            <AllNighterBadge />
            <FinalsWeekBadge />
        ...
        <div className="space-y-2">
          <h4 className="text-lg font-medium text-white">Recognition</h4>
          <div className="flex flex-wrap gap-3">
...
export const SizesAndShapes: Story = {
  render: () => (
    <div className="space-y-6 p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="space-y-4">
        <h4 className="text-lg font-semibold text-white">Badge Sizes</h4>
      ...
      <div className="space-y-4">
        <h4 className="text-lg font-semibold text-white">Badge Shapes</h4>
        <div className="flex items-center gap-4">
