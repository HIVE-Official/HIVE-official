...
export const StatusVariations: Story = {
  render: () => {
    ...
    return (
      <div className="max-w-6xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-6">Course Status Variations</h3>
...
export const DifficultyLevels: Story = {
  render: () => {
    ...
    return (
      <div className="max-w-6xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-6">Difficulty Levels</h3>
...
export const CourseTypes: Story = {
  render: () => {
    ...
    return (
      <div className="max-w-6xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-6">Course Types</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    return (
      <div className="max-w-6xl p-6 bg-[#0A0A0B] rounded-lg">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-white mb-2">Course Enrollment Dashboard</h2>
...
export const CompactDisplay: Story = {
  render: () => {
    return (
      <div className="max-w-4xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-6">Compact Course Display</h3>
...
export const DetailedView: Story = {
  render: () => {
    return (
      <div className="max-w-2xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-6">Detailed Course View</h3>
        <HiveCourseCard
...
export const InteractiveFeatures: Story = {
  render: () => {
    ...
    return (
      <div className="max-w-4xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-6">Interactive Features</h3>
...
export const StatesAndEdgeCases: Story = {
  render: () => {
    ...
    return (
      <div className="max-w-6xl p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-6">States & Edge Cases</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
