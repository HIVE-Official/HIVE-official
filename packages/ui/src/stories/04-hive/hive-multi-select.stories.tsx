...
export const CampusSpaces: Story = {
  render: () => {
    ...
    return (
      <div className="w-96 p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-4">Your Active Spaces</h3>
        <HiveMultiSelect
          variant="elevated"
...
export const AcademicMajors: Story = {
  render: () => {
    ...
    return (
      <div className="w-96 p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-4">Academic Interests</h3>
        <HiveMultiSelect
          variant="premium"
          size="lg"
...
export const ProjectTags: Story = {
  render: () => {
    ...
    return (
      <div className="w-96 p-6 bg-[#0A0A0B] rounded-lg">
        <h3 className="text-lg font-medium text-white mb-4">Project Categories</h3>
        <HiveMultiSelect
          variant="default"
          options={options}
          value={value}
...
export const ComprehensiveExample: Story = {
  render: () => {
    ...
    return (
      <div className="max-w-4xl p-6 bg-[#0A0A0B] rounded-lg space-y-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-white mb-2">Student Builder Profile</h2>
        ...
        <div className="bg-black/20 rounded-lg p-4 border border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <div className="text-white">{spaceValue.join(', ') || 'None selected'}</div>
            </div>
            <div>
              <div className="text-gray-400 mb-1">Skills ({skillValue.length})</div>
              <div className="text-white">{skillValue.join(', ') || 'None selected'}</div>
            </div>
            <div>
              <div className="text-gray-400 mb-1">Majors ({majorValue.length})</div>
              <div className="text-white">{majorValue.join(', ') || 'None selected'}</div>
            </div>
          </div>
        </div>
      </div>
...
export const SizeVariations: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-2xl p-6 bg-[#0A0A0B] rounded-lg space-y-6">
