    ...
    <ModalTrigger {...args}>
      <div className="space-y-4">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <h3 className="text-xl font-semibold text-white">Welcome to HIVE</h3>
    ...
    <ModalTrigger {...args} buttonText="View Premium Features" buttonVariant="premium">
      <div className="space-y-6">
        <div className="text-center space-y-3">
          ...
          <h3 className="text-2xl font-bold text-white">HIVE Premium</h3>
        ...
        <div className="border-t border-white/10 pt-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="text-2xl font-bold text-white">$29<span className="text-base text-gray-400 font-normal">/month</span></div>
    ...
    <ModalTrigger {...args} buttonText="Delete Space" buttonVariant="destructive">
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h3 className="text-xl font-semibold text-white">Delete Space</h3>
        ...
        <div className="space-y-3">
          <p className="text-gray-300">
            Are you absolutely sure you want to delete the <strong className="text-white">"CS Study Group"</strong> space? 
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="block text-sm font-medium text-white">Student Emails</label>
                <textarea
                  className="w-full bg-black/40 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-white/50 resize-none"
                  rows={4}
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <select className="w-full bg-black/40 border border-white/20 rounded-xl px-4 py-3 text-white">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-white">Personal Message (Optional)</label>
              <textarea
                className="w-full bg-black/40 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-white/50 resize-none"
                rows={3}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    ...
                    <textarea 
                      className="w-full bg-black/40 border border-white/20 rounded-lg px-3 py-2 text-white resize-none" 
                      rows={3}
                  ...
                  <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    ...
                    <select className="w-full bg-black/40 border border-white/20 rounded-lg px-3 py-2 text-white">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-medium">Private Space</span>
                  ...
                  <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-medium">University Only</span>
                      <input type="checkbox" className="rounded" defaultChecked />
                    </div>
                  ...
                  <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    <label className="block text-sm font-medium text-white mb-2">Member Limit</label>
                    <input 
                      type="number" 
                      className="w-full bg-black/40 border border-white/20 rounded-lg px-3 py-2 text-white" 
                      defaultValue="50"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-medium">Study Sessions</span>
                      <input type="checkbox" className="rounded" defaultChecked />
                    </div>
                  ...
                  <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-medium">Custom Tools</span>
                      <input type="checkbox" className="rounded" />
                    </div>
                  ...
                  <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    <label className="block text-sm font-medium text-white mb-2">Storage Limit</label>
                    <select className="w-full bg-black/40 border border-white/20 rounded-lg px-3 py-2 text-white">
                      <option>1 GB</option>
                      <option>5 GB</option>
                      <option>10 GB</option>
