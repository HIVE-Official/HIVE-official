...
const SpaceSwitcher = ({ 
  ...
  return (
    <div className="relative">
      ...
      {showDropdown && (
        <div className="absolute top-full left-0 mt-2 w-80 bg-white border rounded-lg shadow-lg z-10">
          <div className="p-2">
          ...
          <div className="border-t p-2">
            <button className="w-full flex items-center gap-2 px-3 py-2 text-left text-hive-gold hover:bg-gray-50 rounded-lg">
              <span>+</span>
        ...
        className={`
          ...
          ${surface.disabled 
            ...
            : activeSurface === surface.id 
              ? 'bg-white text-hive-gold shadow-sm' 
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`
                    ...
                    ${viewMode === 'tabs' ? 'bg-hive-gold text-black' : 'text-gray-600 hover:text-gray-900'}
                  `}
                >
                  Tab View
                </button>
                <button
                  ...
                  className={`
                    px-3 py-2 rounded-md text-sm font-medium transition-colors
                    ${viewMode === 'sidebar' ? 'bg-hive-gold text-black' : 'text-gray-600 hover:text-gray-900'}
                  `}
                >
                  Sidebar View
                </button>
                    ...
                    <div key={index} className="p-3 border rounded-lg">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-2 py-1 bg-hive-gold text-black rounded text-xs"
                        >
                          Copy
                        </button>
                      </div>
