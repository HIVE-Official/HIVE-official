        ...
        <div className="bg-white border-b">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 h-24 relative">
            ...
            <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
              <HiveButton variant="outline" size="sm" className="text-white border-white">
                ← Back
              </HiveButton>
              <HiveButton variant="outline" size="sm" className="text-white border-white">
                ⚙️
      ...
      <div className="min-h-screen bg-gray-50 p-4">
        ...
        {swipeAction && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 50 }}
            className="fixed bottom-20 left-4 right-4 bg-black bg-opacity-80 text-white p-3 rounded-lg text-center"
          >
            Swiped {swipeAction}
          </motion.div>
        )}
