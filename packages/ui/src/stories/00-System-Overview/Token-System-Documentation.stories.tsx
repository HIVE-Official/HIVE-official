...
export const TokenSystemOverview: Story = {
  ...
  render: () => {
    ...
    const tokenCategories = {
      ...
      "Text Tokens": [
        { name: "--hive-text-primary", value: "#E5E5E7", description: "Primary text color" },
        { name: "--hive-text-secondary", value: "#C1C1C4", description: "Secondary text color" },
        { name: "--hive-text-muted", value: "#9B9B9F", description: "Muted text color" },
      ...
      "Border Tokens - RECENTLY FIXED": [
        ...
        { name: "--hive-border-strong", value: "var(--hive-border-secondary)", description: "🆕 FIXED - Strong borders" },
      ],
      "Interactive Tokens": [
      ...
      "Status Tokens": [
        { name: "--hive-status-success", value: "#10B981", description: "Success states" },
        { name: "--hive-status-warning", value: "#F59E0B", description: "Warning states" },
        { name: "--hive-status-error", value: "#EF4444", description: "Error states" },
        { name: "--hive-status-info", value: "#3B82F6", description: "Info states" },
      ],
    };
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {(token.value.startsWith('#') || token.value.startsWith('rgba')) && (
                        <div 
                          className="w-6 h-6 rounded-full border-2 border-[var(--hive-border-default)]"
...
export const TokenValidationTool: Story = {
