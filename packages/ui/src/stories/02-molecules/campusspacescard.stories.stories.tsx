...
import { CampusSpacesCard.stories } from '../../atomic/molecules/campus-spaces-card.stories';

/**
 * # CampusSpacesCard.stories - Social Media + Utility Platform
 * 
 * The CampusSpacesCard.stories molecule combines multiple social and utility atoms to create focused campus interactions. It bridges social media engagement with academic productivity in meaningful ways.
 * 
...
const MockCampusSpacesCard.stories: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">CampusSpacesCard.stories</h3>
...
const meta: Meta<typeof MockCampusSpacesCard.stories> = {
  title: '02-Molecules/CampusSpacesCard.stories',
  component: MockCampusSpacesCard.stories,
  parameters: {
    docs: {
      description: {
        component: `
# CampusSpacesCard.stories - Campus Social + Utility
...
The CampusSpacesCard.stories ensures every interaction serves both social connection and academic success.
        `
      }
    },
    layout: 'padded'
