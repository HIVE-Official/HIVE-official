...
import { EmailInput } from '../../atomic/molecules/email-input';

/**
 * # EmailInput - Social Media + Utility Platform
 * 
 * The EmailInput molecule combines multiple social and utility atoms to create focused campus interactions. It bridges social media engagement with academic productivity in meaningful ways.
 * 
...
const MockEmailInput: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">EmailInput</h3>
...
const meta: Meta<typeof MockEmailInput> = {
  title: '02-Molecules/EmailInput',
  component: MockEmailInput,
  parameters: {
    docs: {
      description: {
        component: `
# EmailInput - Campus Social + Utility
...
The EmailInput ensures every interaction serves both social connection and academic success.
        `
      }
    },
    layout: 'padded'
