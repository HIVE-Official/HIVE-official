...
import { NavigationVariants } from '../../atomic/molecules/navigation-variants';

/**
 * # NavigationVariants - Social Media + Utility Platform
 * 
 * The NavigationVariants molecule combines multiple social and utility atoms to create focused campus interactions. It bridges social media engagement with academic productivity in meaningful ways.
 * 
...
const MockNavigationVariants: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">NavigationVariants</h3>
...
const meta: Meta<typeof MockNavigationVariants> = {
  title: '02-Molecules/NavigationVariants',
  component: MockNavigationVariants,
  parameters: {
    docs: {
      description: {
        component: `
# NavigationVariants - Campus Social + Utility
...
The NavigationVariants ensures every interaction serves both social connection and academic success.
        `
      }
    },
    layout: 'padded'
