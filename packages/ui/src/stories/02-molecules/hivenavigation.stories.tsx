...
import { HiveNavigation } from '../../atomic/molecules/hive-navigation';

/**
 * # HiveNavigation - Social Media + Utility Platform
 * 
 * The HiveNavigation molecule combines multiple social and utility atoms to create focused campus interactions. It bridges social media engagement with academic productivity in meaningful ways.
 * 
...
const MockHiveNavigation: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">HiveNavigation</h3>
...
const meta: Meta<typeof MockHiveNavigation> = {
  title: '02-Molecules/HiveNavigation',
  component: MockHiveNavigation,
  parameters: {
    docs: {
      description: {
        component: `
# HiveNavigation - Campus Social + Utility
...
The HiveNavigation ensures every interaction serves both social connection and academic success.
        `
      }
    },
    layout: 'padded'
