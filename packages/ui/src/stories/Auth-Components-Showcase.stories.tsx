        ...
        <div className="space-y-2">
          ...
          {email && (
            <div className={`text-xs transition-colors ${
              ...
              {isValidEmail ? '✓ Valid UB email address' : '○ Must use @buffalo.edu email'}
            </div>
          )}
...
export const EmailInputLoading: Story = {
  name: '⏳ Email Input (Loading State)',
  render: () => (
    <EmailInputComponent 
      loading={true}
      onEmailChange={(email) => console.log('Email:', email)} 
...
export const PasswordInputNoStrength: Story = {
  name: '🔒 Password Input (No Strength)',
  render: () => (
