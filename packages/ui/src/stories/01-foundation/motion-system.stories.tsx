        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <motion.div
              ...
              animate={{
                borderColor: draggedElement ? '#FFD700' : 'var(--hive-border)',
                backgroundColor: draggedElement ? 'rgba(255, 215, 0, 0.1)' : 'rgba(var(--hive-background-muted), 0.3)'
              }}
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <motion.button
              className="relative w-full h-20 bg-hive-accent text-white rounded-lg overflow-hidden font-semibold"
