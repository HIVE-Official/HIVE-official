...
import type { ProfileDashboardData } from '../../components/dashboard/hive-dashboard';

const meta: Meta<typeof HiveDashboard> = {
...
export default meta;
type Story = StoryObj<typeof HiveDashboard>;

// Mock data for stories
const mockDashboardData: ProfileDashboardData = {
  user: {
    id: 'user_123',
    name: 'Sarah Chen',
    handle: 'sarahc',
...
// Highly active user
export const SuperActiveUser: Story = {
  args: {
    data: {
      ...mockDashboardData,
      summary: {
