...
const MockHiveSpaceCard: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">HiveSpaceCard</h3>
...
const meta: Meta<typeof MockHiveSpaceCard> = {
  title: '03-Organisms/HiveSpaceCard',
  component: MockHiveSpaceCard,
  parameters: {
    docs: {
      description: {
        component: `
