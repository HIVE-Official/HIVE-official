...
import { ProfileCard } from '../../atomic/organisms/profile-card';
...
const MockProfileCard: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">ProfileCard</h3>
...
const meta: Meta<typeof MockProfileCard> = {
