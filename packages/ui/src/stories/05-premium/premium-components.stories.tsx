  ...
  render: () => (
    <div className="grid grid-cols-2 gap-6 p-8">
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-white">Premium Buttons</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-white">States & Variants</h3>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-8 max-w-6xl">
      <HivePremiumCard className="p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-white">Premium Space</h3>
        </div>
  ...
  render: () => (
    <div className="p-8 space-y-8 max-w-4xl">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-white mb-4">Premium Components</h2>
