...
const meta: Meta<typeof Badge> = {
  title: "Foundation/Premium Primitives",
  component: Badge,
  parameters: {
    layout: "padded",
    backgrounds: {
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <Text className="text-white/60">
            Apple/Vercel-grade design with sophisticated glassmorphism
          </Text>
        </div>
  ...
  render: () => (
    <div className="space-y-12 max-w-2xl">
      <div className="space-y-2">
        ...
        <Text className="text-white/60">
          Premium interaction design with fluid animations
        </Text>
      </div>
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <Text size="sm" className="text-white/60">
            Sophisticated selection with gold indicators
          </Text>
        </div>
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <Text size="sm" className="text-white/60">
            iOS-quality switches with 300ms fluid transitions
          </Text>
        </div>
        <div className="space-y-6">
...
export const AdvancedControlsShowcase: Story = {
  render: () => (
    <div className="space-y-12 max-w-2xl">
      <div className="space-y-2">
        <Heading level={2} className="text-white">
        ...
        <Text className="text-white/60">
          Professional-grade inputs with sophisticated design
        </Text>
      </div>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  glassmorphism, backdrop blur, and elegant motion.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
