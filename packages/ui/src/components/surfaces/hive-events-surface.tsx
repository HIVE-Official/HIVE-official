...
export const HiveEventsSurface = React.forwardRef<HTMLDivElement, HiveEventsSurfaceProps>(
  ({ 
    ...
    const handleRSVP = useCallback((eventId: string, status: keyof typeof rsvpStatuses) => {
      ...
      >
        ...
        {showFilters && (
          <div className="flex items-center gap-2 mb-6 overflow-x-auto pb-2">
            {[
              { key: 'all', label: 'All Events', icon: Star, color: 'text-white' },
          ...
          {upcomingEvents.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-4">
                <h4 className="text-md font-medium text-white">Upcoming Events</h4>
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-start gap-3 flex-1 min-w-0">
                            <div className={cn(
                              ...
                              event.isFeatured ? "bg-green-500/20" : "bg-white/5"
                            )}>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <motion.button
                            className="ml-auto p-1.5 text-gray-400 hover:text-white rounded-lg hover:bg-white/5 transition-all duration-200"
              ...
              <div className="space-y-2">
                {pastEvents.slice(0, 3).map((event, index) => {
                  ...
                  return (
                    <motion.div
                      key={event.id}
                      className="flex items-center gap-3 p-3 bg-black/5 backdrop-blur-sm border border-white/5 rounded-lg opacity-60"
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h6 className="text-sm font-medium text-white truncate">{event.title}</h6>
                        <div className="text-xs text-gray-400">
