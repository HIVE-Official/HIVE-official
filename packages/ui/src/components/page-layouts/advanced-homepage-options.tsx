...
export const LinearInspiredHomepage = () => {
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['Geist_Sans']">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-[#FFD700] rounded-[6px] flex items-center justify-center shadow-sm shadow-[#FFD700]/20">
              <span className="font-black text-black text-sm">H</span>
            </div>
          ...
          <div className="flex items-center gap-2">
            <Button 
              variant="ghost" 
              size="sm"
              className="text-white/60 hover:text-white/80 hover:bg-white/[0.04] text-[13px] font-medium h-8 px-3"
            >
              Sign In
            </Button>
            <Button 
              size="sm"
              className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 text-[13px] font-medium h-8 px-4 shadow-sm shadow-[#FFD700]/20"
            >
              Get Started
            </Button>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-6 mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#FFD700]/[0.08] border border-[#FFD700]/20 rounded-full mb-6">
              ...
              <span className="text-[13px] font-medium text-white/90">Built for the next generation</span>
            </div>
            ...
            <p className="text-[18px] text-white/60 max-w-2xl mx-auto leading-[1.6] font-normal">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <Button 
              size="lg" 
              className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 font-medium px-6 py-3 text-[15px] h-auto shadow-lg shadow-[#FFD700]/20 rounded-lg"
            >
      ...
      <section className="px-6 py-16 border-y border-white/[0.08] bg-white/[0.01]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[14px] text-white/40 font-medium tracking-wide uppercase mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="space-y-2">
              ...
              <div className="text-[14px] text-white/50 font-medium">Active Students</div>
            </div>
            <div className="space-y-2">
              <div className="text-[32px] font-semibold text-[#FFD700] tracking-[-0.02em]">89</div>
              <div className="text-[14px] text-white/50 font-medium">Campus Tools</div>
            </div>
            <div className="space-y-2">
              <div className="text-[32px] font-semibold text-[#FFD700] tracking-[-0.02em]">156</div>
              <div className="text-[14px] text-white/50 font-medium">Active Spaces</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-24">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[16px] text-white/60 max-w-2xl mx-auto leading-[1.6]">
      ...
      <section className="px-6 py-20 border-t border-white/[0.08]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-[16px] text-white/60 mb-8 leading-[1.6]">
            Join thousands of students building the future of campus life.
          </p>
          <Button 
            size="lg" 
            className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 font-medium px-8 py-4 text-[15px] h-auto shadow-lg shadow-[#FFD700]/20 rounded-lg"
          >
...
export const VercelInspiredHomepage = () => {
  return (
    <div className="min-h-screen bg-black text-white font-['Geist_Sans']">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6">
              <button className="text-xs text-white/70 hover:text-white transition-colors">Platform</button>
              <button className="text-xs text-white/70 hover:text-white transition-colors">Spaces</button>
              <button className="text-xs text-white/70 hover:text-white transition-colors">Tools</button>
              <button className="text-xs text-white/70 hover:text-white transition-colors">Docs</button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 text-xs h-7 px-3">
              Deploy
            </Button>
          </div>
        </div>
      ...
      <section className="px-6 pt-16 pb-20">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-white/5 border border-white/10 rounded-full mb-8">
            ...
            <span className="text-xs text-white/80">Platform v2.0 — Now available</span>
          </div>
            ...
            <Card className="bg-[#111111] border border-white/10 rounded-lg overflow-hidden">
              ...
              <div className="p-4 font-mono text-sm space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80">hive create study-group-poll</span>
                </div>
                <div className="text-white/60">Creating new tool...</div>
...
export const FigmaInspiredHomepage = () => {
  return (
    <div className="min-h-screen bg-[#0F0F0F] text-white font-['Geist_Sans']">
      ...
      <nav className="border-b border-white/8 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 font-medium shadow-sm shadow-[#FFD700]/20">
              Get Started
            </Button>
          </div>
        </div>
      ...
      <section className="px-6 py-20 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg" 
              className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 font-semibold px-8 py-4 text-base h-auto shadow-xl shadow-[#FFD700]/20 rounded-xl"
            >
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="space-y-3">
              ...
              <div className="text-sm text-white/60">Creative students</div>
            </div>
            <div className="space-y-3">
              <div className="text-4xl font-bold text-[#FFD700]">89</div>
              <div className="text-sm text-white/60">Campus projects</div>
            </div>
            <div className="space-y-3">
              <div className="text-4xl font-bold text-[#FFD700]">156</div>
              <div className="text-sm text-white/60">Tools deployed</div>
            </div>
          </div>
          
          <Button 
            size="lg" 
            className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 font-semibold px-10 py-4 text-lg h-auto shadow-xl shadow-[#FFD700]/20 rounded-xl"
          >
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['Geist_Sans']">
      ...
      <nav className="border-b border-white/[0.06] px-6 py-4 backdrop-blur-2xl bg-black/50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" className="text-white/60 hover:text-white/90 text-[13px]">
              Sign In
            </Button>
            <Button size="sm" className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 text-[13px] font-medium">
              Get Early Access
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#FFD700]/[0.08] border border-[#FFD700]/20 rounded-full mb-8">
              ...
              <span className="text-[12px] font-medium text-white/90 tracking-wide">NEXT-GEN CAMPUS PLATFORM</span>
            </div>
            ...
            <p className="text-[17px] text-white/60 max-w-2xl mx-auto leading-[1.6] mb-8">
            ...
            <Button 
              size="lg" 
              className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 font-semibold px-8 py-4 text-[15px] h-auto shadow-xl shadow-[#FFD700]/25 rounded-[10px]"
            >
              <Rocket className="w-4 h-4 mr-2" />
              Join Waitlist
            </Button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4 h-[600px]">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/50">Study Groups</div>
                  </div>
                  <div>
            ...
            <Card className="md:col-span-3 lg:col-span-4 bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/[0.08] rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-white/70">Study group started</span>
                  <span className="text-xs text-white/40">2m</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[#FFD700] rounded-full"></div>
                  <span className="text-sm text-white/70">New tool deployed</span>
                  <span className="text-xs text-white/40">5m</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[#FFD700] rounded-full"></div>
                  <span className="text-sm text-white/70">Event scheduled</span>
                  <span className="text-xs text-white/40">8m</span>
                </div>
              </div>
            </Card>
            ...
            <Card className="md:col-span-6 lg:col-span-4 bg-gradient-to-br from-[#FFD700]/[0.08] to-[#FFD700]/[0.02] border border-[#FFD700]/20 rounded-2xl p-6 text-center">
              ...
              <Button className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 font-medium w-full">
                Get Started Now
              </Button>
            </Card>
          </div>
