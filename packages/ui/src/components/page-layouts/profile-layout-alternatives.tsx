...
export const BentoGridProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['Geist_Sans'] p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/60 text-lg">Computer Science • Class of 2026</p>
            </div>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-white/60">Spaces Run</div>
                  </div>
                  <div className="text-center">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 bg-white/5 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">30 days of consistent learning</div>
                  </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-white/5 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">Connected 100+ students</div>
                  </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-white/5 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">Built 5 campus tools</div>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-white/5 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="px-2 py-1 bg-white/20 text-white/70 text-xs rounded">Member</div>
                  </div>
                  <div className="space-y-2 text-sm text-white/70">
                    <div className="flex items-center gap-2">
                      <Users className="w-3 h-3" />
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 bg-white/5 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">Data Structures & Algorithms</div>
                    <div className="text-xs text-white/50">10:00 AM - 11:30 AM</div>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-3 bg-white/5 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">Algorithm Review Session</div>
                    <div className="text-xs text-white/50">2:00 PM - 4:00 PM</div>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-3 bg-white/5 rounded-lg">
                  <div className="w-2 h-12 bg-accent rounded-full"></div>
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">Casual coding session</div>
                    <div className="text-xs text-white/50">7:00 PM - 9:00 PM</div>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            <div className="relative">
              <div className="w-24 h-24 rounded-full bg-[#FFD700] flex items-center justify-center">
                <span className="text-3xl font-black text-black">JS</span>
              </div>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-white/60">Campus Level</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/60">Junior • 3.8 GPA</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/60">Class of 2026</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/60">Dorm 3A • Room 214</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/60">AI, Web Dev, Coffee</div>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-[#111111] border-white/10 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/80">jacob.smith@stanford.edu</span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/80">@jacobsmith</span>
                </div>
                <div className="flex items-center gap-3">
                  <Twitter className="w-5 h-5 text-[#FFD700]" />
                  <span className="text-white/80">@jacob_codes</span>
                </div>
              </div>
            </Card>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">Study Session Timer for CS Study Hub</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">Started following weekly coding challenges</div>
                    <div className="text-xs text-white/50">1 day ago</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#FFD700]/20 flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">"Best algorithms for sorting large datasets"</div>
            ...
            <Card className="bg-[#111111] border-white/10 p-6">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/5 rounded-lg">
                  ...
                  <p className="text-sm text-white/70 mb-3">Pomodoro timer with group sync for study sessions</p>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-white/50">247 uses this week</span>
                    <Button variant="ghost" size="sm">
                ...
                <div className="p-4 bg-white/5 rounded-lg">
                  ...
                  <p className="text-sm text-white/70 mb-3">Interactive visualizations for sorting algorithms</p>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-white/50">1,247 uses this month</span>
                    <Button variant="ghost" size="sm">
                      <ExternalLink className="w-3 h-3" />
                    </Button>
                  </div>
                ...
                <div className="p-4 bg-white/5 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="px-2 py-1 bg-white/20 text-white/70 text-xs rounded">Beta</div>
                  </div>
                  <p className="text-sm text-white/70 mb-3">Find the best study spots on campus</p>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-white/50">89 uses this week</span>
                    <Button variant="ghost" size="sm">
                      <ExternalLink className="w-3 h-3" />
                    </Button>
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/70">Data Structures & Algorithms</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin className="w-5 h-5 text-[#FFD700]" />
                  <div>
                    ...
                    <div className="text-sm text-white/70">2nd floor, quiet zone</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/70">Sarah, Mike, Anna, Chris</div>
                  </div>
                </div>
                <div className="text-center pt-4 border-t border-white/10">
                  <div className="text-sm text-white/60">Session started</div>
                  <div className="text-2xl font-bold text-[#FFD700]">2h 34m</div>
                  <div className="text-sm text-white/60">ago</div>
                </div>
              </div>
            </Card>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">247 members • Admin</div>
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">47 residents • Member</div>
                  </div>
                  <ChevronRight className="w-4 h-4 text-white/40" />
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">156 members • Co-founder</div>
                  </div>
                  <ChevronRight className="w-4 h-4 text-white/40" />
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">89 members • Member</div>
                  </div>
                  <ChevronRight className="w-4 h-4 text-white/40" />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">30 days consistent</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#FFD700]/20 flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">100+ connections</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#FFD700]/20 flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-white/60">5 tools built</div>
                  </div>
                </div>
              </div>
            </Card>
        ...
        <div className="relative mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end gap-6 -mt-20 px-6">
            ...
            <div className="flex-1">
              <div className="mb-4">
                <h1 className="text-4xl font-bold tracking-[-0.02em] mb-2">Jacob Smith</h1>
                <p className="text-xl text-white/70 mb-4">Computer Science • Stanford University • Class of 2026</p>
            ...
            <Card className="bg-[#111111] border-white/10 p-6 flex-1">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-white/70">30 days of consistent learning</div>
                </div>
              </div>
            ...
            <Card className="bg-[#111111] border-white/10 p-6 flex-1">
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-sm text-white/60">247 students using it</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <Button variant="ghost" size="sm">
          ...
          <div className="flex gap-4">
            ...
            <Card className="bg-[#111111] border-white/10 p-6 flex-1">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-white/60">3 days ago</span>
              </div>
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-white/70">156 members • Weekly challenges</div>
                </div>
              </div>
              <p className="text-white/80 mb-4">
            ...
            <Card className="bg-[#111111] border-white/10 p-6 flex-1">
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-sm text-white/60">Campus Newsletter</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <Button variant="ghost" size="sm">
