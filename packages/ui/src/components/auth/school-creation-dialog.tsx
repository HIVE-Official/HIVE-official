        ...
        <div className="flex flex-col gap-2">
          ...
          >
            <input
              ...
              type="text"
              required
              className="w-full rounded-md border border-border bg-surface-02 px-3 py-2 text-foreground placeholder:text-muted focus:border-gold focus:outline-none focus:ring-1 focus:ring-gold"
