...
const hiveButtonVariants = cva(
  ...
  "inline-flex items-center justify-center whitespace-nowrap font-medium transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--hive-brand-primary)]/30 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--hive-background-primary)] disabled:pointer-events-none disabled:opacity-50 select-none backdrop-blur-sm",
  {
    variants: {
      ...
      size: {
        xs: "h-7 px-3 text-xs rounded-[var(--hive-radius-xl)]",
        sm: "h-9 px-4 text-sm rounded-[var(--hive-radius-xl)]", 
        default: "h-11 px-6 py-2 text-sm rounded-[var(--hive-radius-2xl)]",
        lg: "h-13 px-8 text-base rounded-[var(--hive-radius-2xl)]",
        xl: "h-16 px-10 text-lg rounded-[var(--hive-radius-2xl)]",
        icon: "h-11 w-11 rounded-[var(--hive-radius-2xl)]",
        "icon-sm": "h-9 w-9 rounded-[var(--hive-radius-xl)]",
        "icon-lg": "h-13 w-13 rounded-[var(--hive-radius-2xl)]",
        // Chip-specific sizes with pill shape
        "chip-xs": "h-7 px-4 text-xs rounded-[var(--hive-radius-full)]",
        "chip-sm": "h-8 px-5 text-sm rounded-[var(--hive-radius-full)]",
        "chip": "h-9 px-6 text-sm rounded-[var(--hive-radius-full)]",
        "chip-lg": "h-11 px-8 text-base rounded-[var(--hive-radius-full)]",
      },
    },
    defaultVariants: {
      variant: "primary",
