...
const MotionSystem = () => <div>Motion System</div>;
        ...
        <div
          ...
          style={{
            transitionTimingFunction:
              easingMap[easing as keyof typeof easingMap] || easing,
          }}
        >
      ...
      <Card className="border-yellow-400/20 bg-yellow-400/5">
        <CardHeader>
          ...
          <CardDescription className="text-xs">
            Dark-first, gold accents, premium easing
          </CardDescription>
        </CardHeader>
  ...
  render: () => (
    <div className="space-y-8 p-6 bg-background">
      <div className="space-y-2">
        <Heading size="h1" className="text-foreground">
          HIVE Motion System
        </Heading>
        <Text variant="muted">
          Custom motion language for dark-first UI with gold accents. Built on
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <Text size="sm">
              Space joins, achievements, special HIVE moments
            </Text>
          </HiveMotionDemo>
        </div>
      </div>
    ...
    return (
      <div className="space-y-6 p-6 bg-background">
        <div className="space-y-2">
          ...
          <Text variant="muted">
            Premium motion curves designed specifically for HIVE&apos;s
              ...
              <CardContent>
                <div className="space-y-3">
                  <Text
                    size="xs"
                    variant="muted"
                    className="font-mono bg-muted/30 p-2 rounded"
                  >
                    {curve.value}
                  </Text>
  ...
  render: () => (
    <div className="space-y-6 p-6 bg-background">
      <div className="space-y-2">
        ...
        <Text variant="muted">
          How HIVE&apos;s motion system enhances dark surfaces with subtle
          embossing and gold accents
        </Text>
      </div>
