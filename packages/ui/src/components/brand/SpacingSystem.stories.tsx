    ...
    <CardHeader className="pb-3">
      <div className="flex items-center justify-between">
        <div>
          ...
          <CardDescription className="text-xs">{size} • {description}</CardDescription>
        </div>
        {isPerformant && (
    ...
    <CardHeader className="pb-3">
      <div className="flex items-center justify-between">
        <div>
          ...
          <CardDescription className="text-xs">{columns} columns • {breakpoint}</CardDescription>
        </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="p-4 border border-border rounded-lg text-center space-y-2">
                ...
                <Text size="xs" variant="muted">≥ 768px</Text>
              ...
              <div className="p-4 border border-border rounded-lg text-center space-y-2">
                ...
                <Text size="xs" variant="muted">≥ 1024px</Text>
              ...
              <div className="p-4 border border-border rounded-lg text-center space-y-2">
                ...
                <Text size="xs" variant="muted">≥ 1280px</Text>
