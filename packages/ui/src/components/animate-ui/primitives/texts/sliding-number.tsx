'use client';
/*
  Attribution: SlidingNumber primitive sourced via shadcn add from
  @animate-ui/primitives-texts-sliding-number.
  Original project: animate-ui/primitives.
  Integrated into @hive/ui per docs/ux/THIRD_PARTY_UI_POLICY.md.
*/
