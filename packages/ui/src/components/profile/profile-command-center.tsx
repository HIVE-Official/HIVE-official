          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-white">My Spaces</h3>
                <Badge variant="secondary" className="text-xs">
                  {activeSpaces.length}
                </Badge>
              </div>
              <Button variant="ghost" size="sm" onClick={onJoinSpace}>
...
export function ProfileCommandCenterCompact({ 
  ...
  return (
    <Card className={cn("border border-gray-700 bg-gray-900", className)}>
