              ...
              >
                <Button
                  ...
                  className={cn(
                    ...
                    data.privacy.ghostMode ? "bg-gray-600 text-white" : "secondary",
              ...
              >
                ...
                >
                  ...
                  {notifications > 0 && (
                    ...
                    >
                      <Badge className="absolute -top-1 -right-1 bg-blue-500 text-white text-xs px-1 py-0 min-w-[18px] h-5 flex items-center justify-center">
                        {notifications}
                      </Badge>
                    </motion.div>
                  )}
        ...
        >
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button size="sm" variant="secondary" className={cn("w-full", butterClasses.button)}>
                Privacy Settings
              </Button>
            </motion.div>
          </motion.div>
