...
const CommandDialog = ({ children, ...props }: DialogProps) => {
  return (
    <Dialog {...props}>
      <DialogContent className={cn("command-dialog-content")} aria-label="Command palette"
      >
        <Command className="command-root-inner">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
...
>(({ className, ...props }, ref) => (
  <div className="command-input-wrapper" cmdk-input-wrapper="">
    <MagnifyingGlassIcon className="command-input-icon" aria-hidden />
