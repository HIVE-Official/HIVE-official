...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/80 backdrop-blur-sm transition-all duration-200 ease-hive-smooth",
  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-bg-card border border-white/8 rounded-2xl shadow-2xl",

        // Animation
        "transition-all duration-200 ease-hive-smooth",
