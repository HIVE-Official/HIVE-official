...
import { NavigationItem, NavigationSection, NAVIGATION_SECTIONS } from './types';
 ...
 */
export const createNavigationItems = (): ReadonlyArray<NavigationItem> => [
  {
    id: 'profile',
 ...
 */
export const getNavigationItemsWithActiveState = (
  currentPath: string
 ...
 */
const isPathActive = (currentPath: string, itemHref: string): boolean => {
  // Exact match
