...
import type { PersonalToolsData } from '../../components/dashboard/personal-tools';
...
export const ProductivityFocus: Story = {
  args: {
    data: {
      tools: [
        {
...
export const InteractiveDemo: Story = {
  args: {
    data: mockPersonalToolsData,
    isLoading: false,
    onToolAction: (toolId: string, action: string, data?: any) => {
