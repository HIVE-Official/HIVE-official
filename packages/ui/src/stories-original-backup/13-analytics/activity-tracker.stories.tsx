...
import type { ActivityTrackerData } from '../../components/dashboard/activity-tracker';
import { Clock, Users, Zap, Target, TrendingUp, BarChart3 } from 'lucide-react';

const meta: Meta<typeof ActivityTracker> = {
...
export const GoalsFocused: Story = {
  args: {
    data: {
...
export const AcademicInsights: Story = {
  args: {
    data: {
      ...mockActivityTrackerData,
      insights: [
...
export const InteractiveDemo: Story = {
  args: {
    data: mockActivityTrackerData,
    isLoading: false,
    onTimeRangeChange: (range: 'today' | 'week' | 'month') => {
    ...
    onGoalUpdate: (goalId: string, newTarget: number) => {
