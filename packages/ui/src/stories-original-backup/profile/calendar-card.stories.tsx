...
import { CalendarCardData, CalendarCardState, Event, CalendarConnection, CalendarConflict } from '../../components/profile/types';
...
export const SyncErrorMobile: Story = {
  args: {
    state: 'sync-failed',
    data: {
      ...mockData,
...
export const MorningView: Story = {
...
export const EveningView: Story = {
...
// Busy Day Scenario
export const BusyDaySchedule: Story = {
...
// Exam Week Scenario
export const ExamWeekSchedule: Story = {
...
export const SocialWeekend: Story = {
  name: '🎉 Social Weekend',
  args: {
    state: 'default',
    data: {
...
export const ConflictChaos: Story = {
...
export const AchievementDay: Story = {
...
export const InternationalStudentSchedule: Story = {
...
export const AccessibilitySchedule: Story = {
...
export const SyncNightmare: Story = {
...
export const MassiveCalendar: Story = {
  ...
  args: {
    ...
    data: {
      ...
      upcomingEvents: Array.from({ length: 50 }, (_, i) => ({
        ...
        time: `${i + 1}:00 PM`,
        type: ['academic', 'social', 'study', 'work', 'personal'][i % 5] as any,
