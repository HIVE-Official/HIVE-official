...
import { User, Space, Event, Connection } from '../../components/profile/types';
...
export const PreMedOverachiever: Story = {
...
export const TechStartupFounder: Story = {
...
export const CommunityCollegeTransfer: Story = {
...
export const GreekLifePresident: Story = {
...
export const PhDResearcher: Story = {
...
export const StudentComparison: Story = {
  ...
  render: () => (
    <div className="grid grid-cols-2 gap-8 p-8">
      <div className="space-y-4">
        <h2 className="text-xl font-bold text-[var(--hive-text-primary)]">Pre-Med Overachiever</h2>
        <ProfileSystem {...PreMedOverachiever.args} />
      </div>
      <div className="space-y-4">
        <h2 className="text-xl font-bold text-[var(--hive-text-primary)]">Community College Transfer</h2>
        <ProfileSystem {...CommunityCollegeTransfer.args} />
      </div>
    </div>
  )
};