      ...
      <div className="mt-12 space-y-6">
        ...
        <div className="bg-[var(--hive-background-secondary)] p-6 rounded-lg border border-[var(--hive-border-primary)]">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <div className="w-3 h-3 bg-[var(--hive-brand-secondary)] rounded-full"></div>
        ...
        <div className="bg-[var(--hive-background-secondary)] p-6 rounded-lg border border-[var(--hive-border-primary)]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="w-12 h-12 bg-[var(--hive-brand-secondary)]/20 rounded-lg flex items-center justify-center mb-2 mx-auto">
                <Wrench className="w-6 h-6 text-[var(--hive-brand-secondary)]" />
              </div>
              <span className="text-[var(--hive-text-secondary)] text-sm">Design</span>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[var(--hive-status-info)]/20 rounded-lg flex items-center justify-center mb-2 mx-auto">
                <FileText className="w-6 h-6 text-[var(--hive-status-info)]" />
              </div>
              <span className="text-[var(--hive-text-secondary)] text-sm">Development</span>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[var(--hive-status-success)]/20 rounded-lg flex items-center justify-center mb-2 mx-auto">
                <Users className="w-6 h-6 text-[var(--hive-status-success)]" />
              </div>
              <span className="text-[var(--hive-text-secondary)] text-sm">Product</span>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[var(--hive-status-warning)]/20 rounded-lg flex items-center justify-center mb-2 mx-auto">
                <Star className="w-6 h-6 text-[var(--hive-status-warning)]" />
              </div>
      ...
      <div className="mt-12 bg-[var(--hive-background-secondary)] p-6 rounded-lg border border-[var(--hive-border-primary)]">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 bg-[var(--hive-status-error)]/20 rounded flex items-center justify-center mt-0.5">
              <Pin className="w-3 h-3 text-[var(--hive-status-error)]" />
            </div>
            <div>
          ...
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 bg-[var(--hive-status-info)]/20 rounded flex items-center justify-center mt-0.5">
              <FileText className="w-3 h-3 text-[var(--hive-status-info)]" />
            </div>
            <div>
          ...
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 bg-[var(--hive-brand-secondary)]/20 rounded flex items-center justify-center mt-0.5">
              <Star className="w-3 h-3 text-[var(--hive-brand-secondary)]" />
            </div>
            <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-[var(--hive-background-secondary)] p-6 rounded-lg border border-[var(--hive-border-primary)]">
          <div className="flex items-center gap-3 mb-4">
            <MessageCircle className="w-6 h-6 text-[var(--hive-status-info)]" />
        ...
        <div className="bg-[var(--hive-background-secondary)] p-6 rounded-lg border border-[var(--hive-border-primary)]">
          <div className="flex items-center gap-3 mb-4">
            <Calendar className="w-6 h-6 text-[var(--hive-status-warning)]" />
        ...
        <div className="bg-[var(--hive-background-secondary)] p-6 rounded-lg border border-[var(--hive-border-primary)]">
          <div className="flex items-center gap-3 mb-4">
            <Pin className="w-6 h-6 text-[var(--hive-status-error)]" />
