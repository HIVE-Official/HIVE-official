                ...
                <HiveCard className="h-full">
                  <div className="p-4">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg flex items-center justify-center text-[var(--hive-text-primary)] font-bold">
                        {index + 1}
                      </div>
                    ...
                    <div style={{ height: itemCount * itemHeight, position: 'relative' }}>
                      ...
                      >
                        {visiblePosts.map((post, index) => (
                          <div
                            key={post.id}
                            className="border-b p-3 bg-[var(--hive-text-primary)]"
                            style={{ height: itemHeight }}
                          >
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full flex items-center justify-center text-[var(--hive-text-primary)] text-sm font-bold">
