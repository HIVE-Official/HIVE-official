  ...
  >
    <div className="flex items-start gap-4">
      <div className={`
        ...
        ${isCompleted ? 'bg-green-500 text-[var(--hive-text-primary)]' : 
          isActive ? 'bg-[var(--hive-brand-secondary)] text-[var(--hive-background-primary)]' : 'bg-gray-300 text-gray-600'}
      `}>
        {isCompleted ? '✓' : step}
      </div>
      <div className="flex-1">
        <h3 className={`text-lg font-bold ${isActive ? 'text-[var(--hive-brand-secondary)]' : 'text-gray-700'}`}>
          {title}
        </h3>
...
const JourneyTracker = ({ 
  ...
  <div className="bg-[var(--hive-text-primary)] rounded-lg shadow-sm border p-4 mb-6">
      ...
      {steps.map((step, index) => (
        <div key={index} className="flex items-center">
          <div className={`
            ...
            ${index < currentStep ? 'bg-green-500 text-[var(--hive-text-primary)]' : 
              index === currentStep ? 'bg-[var(--hive-brand-secondary)] text-[var(--hive-background-primary)]' : 'bg-gray-200 text-gray-600'}
          `}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <AnimatePresence mode="wait">
                ...
                {currentStep === 1 && (
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <div className="bg-[var(--hive-text-primary)] rounded-lg shadow-sm border p-4">
                ...
                {currentStep === 4 && (
                  <motion.div
                    ...
                    className="bg-[var(--hive-text-primary)] rounded-lg shadow-sm border p-6 text-center"
                  >
                    <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4">
                      <span className="text-[var(--hive-text-primary)] text-2xl">✓</span>
                    </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-[var(--hive-text-primary)] rounded-lg shadow-sm border p-4 sticky top-6">
          ...
          <AnimatePresence mode="wait">
            {currentStep === 0 && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -20 }}
                className="bg-[var(--hive-text-primary)] rounded-lg shadow-sm border p-8 text-center"
              >
                <div className="w-20 h-20 bg-[var(--hive-brand-secondary)] rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-[var(--hive-background-primary)] text-3xl font-bold">🎉</span>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {spaceIntro.guidelines.map((guideline, index) => (
                        <div key={index} className="flex items-start gap-3">
                          <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-xs text-[var(--hive-text-primary)]">
                            ✓
                          </div>
                    ...
                    <div className="space-y-4">
                      <div className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-[var(--hive-text-primary)] text-sm font-bold">
                            AC
                          </div>
                          <div>
                      ...
                      <div className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-[var(--hive-text-primary)] text-sm font-bold">
                            SM
                          </div>
                          <div>
                ...
                {currentStep === 2 && (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center text-[var(--hive-text-primary)] text-sm font-bold">
                            JD
                          </div>
                          <div>
                ...
                {currentStep === 4 && (
                  ...
                  >
                    ...
                    <div className="text-center mb-6">
                      <div className="w-16 h-16 bg-[var(--hive-brand-secondary)] rounded-full flex items-center justify-center mx-auto mb-4">
                        <span className="text-[var(--hive-background-primary)] text-2xl">⭐</span>
                      </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-2xl font-bold text-[var(--hive-brand-secondary)]">{userActions.postsCreated}</div>
                        <div className="text-xs text-gray-600">Posts Created</div>
                      </div>
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-2xl font-bold text-[var(--hive-brand-secondary)]">{userActions.commentsPosted}</div>
                        <div className="text-xs text-gray-600">Comments</div>
                      </div>
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-2xl font-bold text-[var(--hive-brand-secondary)]">{userActions.eventsJoined}</div>
                        <div className="text-xs text-gray-600">Events Joined</div>
                      </div>
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-2xl font-bold text-[var(--hive-brand-secondary)]">{userActions.reactionsGiven}</div>
                        <div className="text-xs text-gray-600">Reactions</div>
                      </div>
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-2xl font-bold text-[var(--hive-brand-secondary)]">{userActions.toolsUsed}</div>
                        <div className="text-xs text-gray-600">Tools Used</div>
                      </div>
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-2xl font-bold text-[var(--hive-brand-secondary)]">5</div>
              ...
              <div className="bg-[var(--hive-text-primary)] rounded-lg shadow-sm border p-4 sticky top-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold text-[var(--hive-brand-secondary)]">{userActions.postsCreated}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>Comments Posted</span>
                    <span className="font-semibold text-[var(--hive-brand-secondary)]">{userActions.commentsPosted}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>Events Joined</span>
                    <span className="font-semibold text-[var(--hive-brand-secondary)]">{userActions.eventsJoined}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>Reactions Given</span>
                    <span className="font-semibold text-[var(--hive-brand-secondary)]">{userActions.reactionsGiven}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>Tools Used</span>
                    <span className="font-semibold text-[var(--hive-brand-secondary)]">{userActions.toolsUsed}</span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="bg-gradient-to-r from-hive-gold/20 to-yellow-100 rounded-lg p-6 mb-6">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 bg-[var(--hive-brand-secondary)] rounded-full flex items-center justify-center">
                      <span className="text-[var(--hive-background-primary)] text-xl">⭐</span>
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-[var(--hive-brand-secondary)]">24</div>
                    ...
                    <div className="text-center">
                      <div className="text-2xl font-bold text-[var(--hive-brand-secondary)]">4.9</div>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-[var(--hive-text-primary)] text-xs">
                          ✓
                        </div>
                        <span className="text-sm">Application received</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-[var(--hive-text-primary)] text-xs">
                          2
                        </div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-[var(--hive-brand-secondary)] rounded-full mt-2"></div>
                        <span>
            ...
            {currentStep === 3 && (
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[var(--hive-brand-secondary)]/20 border border-hive-gold/30 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <HiveCard className="p-4 cursor-pointer hover:shadow-md transition-shadow">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div className="text-center">
                          <div className="font-bold text-[var(--hive-brand-secondary)]">156</div>
                          <div className="text-gray-600">Members</div>
                        </div>
                        <div className="text-center">
                          <div className="font-bold text-[var(--hive-brand-secondary)]">89%</div>
