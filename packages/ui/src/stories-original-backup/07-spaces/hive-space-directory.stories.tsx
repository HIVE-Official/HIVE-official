...
export const DefaultDirectory: Story = {
  args: {
    spaces: sampleSpaces,
    view: 'grid',
    showFilters: true
...
export const UniversityFiltered: Story = {
  args: {
...
export const FeaturedSpaces: Story = {
  args: {
...
export const LoadingDirectory: Story = {
  args: {
    loading: true,
    view: 'grid',
    showFilters: true,
  ...
  render: () => {
    ...
    return (
      <HiveSpaceDirectory
        ...
        onSpaceClick={(space) => console.log('Space clicked:', space.name)}
        onJoinSpace={(space) => console.log('Join space:', space.name)}
        onCreateSpace={() => console.log('Create new space')}
      />
    );
  }
};
...
export const CategoryBreakdown: Story = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="text-xl font-bold mb-4">Academic Departments</h3>
        <HiveSpaceDirectory
          spaces={sampleSpaces.filter(space => space.category === 'Academic Department')}
          view="grid"
          showFilters={false}
          compact={true}
        />
      ...
      <div>
        ...
        <HiveSpaceDirectory
          spaces={sampleSpaces.filter(space => space.category === 'Student Organization')}
          view="list"
          showFilters={false}
          compact={true}
        />
      ...
      <div>
        <h3 className="text-xl font-bold mb-4">Research Groups</h3>
        <HiveSpaceDirectory
          spaces={sampleSpaces.filter(space => space.category === 'Research Group')}
          view="grid"
          showFilters={false}
          compact={true}
        />
...
export const InteractiveDemo: Story = {
  args: {
    ...
    showFilters: true,
    interactive: true,
    onSpaceClick: (space: any) => {
      console.log('Navigate to space:', space.name);
    },
    onJoinSpace: (space: any) => {
