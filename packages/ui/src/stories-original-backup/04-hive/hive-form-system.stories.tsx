    ...
    return (
      <div className="w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <div className="text-center mb-6">
          <h3 className="text-xl font-semibold text-[var(--hive-text-primary)] mb-2">Create Account</h3>
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-lg p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <div className="text-center mb-6">
          <h3 className="text-xl font-semibold text-[var(--hive-text-primary)] mb-2">Advanced Validation</h3>
    ...
    return (
      <div className="w-full max-w-2xl p-8 bg-[var(--hive-background-primary)] rounded-2xl">
        <div className="text-center mb-8">
          <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-2">Campus Profile Setup</h3>
        ...
        >
          <div className="space-y-8">
            ...
            <div>
              <h4 className="text-lg font-medium text-[var(--hive-text-primary)] mb-4 flex items-center">
...
export const AsyncValidationDemo: Story = {
  render: () => {
    ...
    return (
      <div className="w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
        <div className="text-center mb-6">
          <h3 className="text-xl font-semibold text-[var(--hive-text-primary)] mb-2">Async Validation</h3>
    ...
    return (
      <div className="space-y-8 p-8 bg-[var(--hive-background-primary)] rounded-2xl max-w-2xl">
        <div className="text-center">
          <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-2">Form Variants</h3>
        ...
        <HiveForm onSubmit={handleSubmit} initialValues={{}}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-medium text-[var(--hive-text-primary)]">Default</h4>
            ...
            {/* Premium Variant */}
            <div className="space-y-4">
              <h4 className="text-lg font-medium text-[var(--hive-text-primary)]">Premium</h4>
            ...
            {/* Minimal Variant */}
            <div className="space-y-4">
              <h4 className="text-lg font-medium text-[var(--hive-text-primary)]">Minimal</h4>
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-3xl p-8 bg-[var(--hive-background-primary)] rounded-2xl">
        <div className="text-center mb-8">
          <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-2">HIVE Tool Builder</h3>
