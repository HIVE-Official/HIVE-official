  ...
  render: () => (
    <div className="grid grid-cols-2 gap-6 p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Floating Labels</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Static Labels</h3>
...
export const SpecializedInputs: Story = {
  render: () => (
    <div className="space-y-6 w-full max-w-md p-6 bg-[var(--hive-background-primary)] rounded-2xl">
      <div>
        <h3 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Tool Creation</h3>
        <HiveToolNameInput
      ...
      <div>
        <h3 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Space Creation</h3>
        <HiveSpaceNameInput
      ...
      <div>
        <h3 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Search</h3>
        <HiveSearchInput
          leftIcon={<Search size={16} />}
        />
      </div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-[var(--hive-text-primary)] mb-4">Security</h3>
        <HivePasswordInput
  ...
  render: () => (
    <div className="space-y-8 p-8 bg-[var(--hive-background-primary)] rounded-2xl">
      <div className="text-center mb-6">
        <h3 className="text-2xl font-semibold text-[var(--hive-text-primary)] mb-2">HIVE Tool Builder Form</h3>
