...
// === EXPLICIT ENHANCED COMPONENT EXPORTS (for compatibility) ===
export { Button as ButtonEnhanced } from "./src/atomic/atoms/button-enhanced";
export { Input as InputEnhanced } from "./src/atomic/atoms/input-enhanced";
export { Checkbox as CheckboxEnhanced } from "./src/atomic/atoms/checkbox-enhanced";
export { Radio as RadioEnhanced } from "./src/atomic/atoms/radio-enhanced";
export { Select as SelectEnhanced } from "./src/atomic/atoms/select-enhanced";
export { Switch as SwitchEnhanced } from "./src/atomic/atoms/switch-enhanced";
export { Textarea as TextareaEnhanced } from "./src/atomic/atoms/textarea-enhanced";
...
} from "./src/components/profile/complete-hive-profile-system";

export { 
  CompleteHIVESpacesSystem,
  type CompleteHIVESpacesSystemProps
} from "./src/components/spaces/complete-hive-spaces-system";

export { 
  CompleteHIVEToolsSystem,
  type CompleteHIVEToolsSystemProps
} from "./src/components/tools/complete-hive-tools-system";
...
export { FirebaseAuthProvider as UnifiedAuthProvider, useFirebaseAuth as useUnifiedAuth } from "./src/contexts/unified-auth-context";
...
export { TreeView, type TreeNode } from "./src/components/ui/tree-view";
...
export {
  Label
} from "./src/atomic/atoms/label";

export {
  Skeleton
} from "./src/atomic/atoms/skeleton";

export {
  Separator
} from "./src/atomic/atoms/separator";
...
export const DialogHeader = ({ children }: { children: React.ReactNode }) => 
  React.createElement('div', { className: 'modal-header' }, children);

export const DialogContent = ({ children }: { children: React.ReactNode }) => 
  React.createElement('div', { className: 'modal-content' }, children);

export const DialogFooter = ({ children }: { children: React.ReactNode }) => 
  React.createElement('div', { className: 'modal-footer' }, children);

export const DialogTitle = ({ children }: { children: React.ReactNode }) => 
  React.createElement('h2', { className: 'modal-title' }, children);

export const DialogDescription = ({ children }: { children: React.ReactNode }) => 
  React.createElement('p', { className: 'modal-description' }, children);

export const DialogTrigger = ({ children }: { children: React.ReactNode }) => 
  React.createElement('div', { className: 'modal-trigger' }, children);
