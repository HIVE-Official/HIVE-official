...
export { 
  getMobileSafeAreaStyles,
  getTouchTargetStyles,
  mobileNavItemVariants,
  useMobileNavigationAnalytics;
} from './components/MobileNavigation';

export { 
  useDrawerSwipeGesture;
} from './components/TabletDrawer';
...
export const DEFAULT_NAVIGATION_CONFIG = {
  ...
  initialPreference: 'auto' as const,
