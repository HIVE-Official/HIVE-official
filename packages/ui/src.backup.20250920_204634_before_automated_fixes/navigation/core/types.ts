 ...
 */
export interface NavigationItem {readonly id: string;
 ...
 */
export interface NavigationSubItem {readonly id: string;
 ...
 */
export interface NavigationBadge {readonly type: 'notification' | 'status' | 'feature';
 ...
 */
export interface NavigationUser {readonly id: string;
 ...
 */
export interface NavigationUserPreferences {readonly layout: NavigationPreference;
 ...
 */
export interface NavigationState {readonly mode: NavigationMode;
 ...
 */
export interface NavigationLayout {readonly mode: NavigationMode;
 ...
 */
export interface NavigationContainerProps {readonly user: NavigationUser;
 ...
 */
export interface NavigationComponentProps {readonly items: ReadonlyArray<NavigationItem>;
  readonly currentPath: string;
 ...
 */
export interface NavigationEvent {readonly type: 'navigate' | 'preference_change' | 'layout_change' | 'interaction';
  readonly section?: NavigationSection;
 ...
 */
export interface NavigationContext {readonly state: NavigationState;
 ...
 */
export const isNavigationSection = (value: string): value is NavigationSection => {
  return Object.values(NAVIGATION_SECTIONS).includes(value as NavigationSection);
};

export const isNavigationPreference = (value: string): value is NavigationPreference => {
 ...
 */
export interface NavigationConfig {readonly baseItems: ReadonlyArray<PartialNavigationItem>;
