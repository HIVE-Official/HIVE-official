...
interface TabletDrawerProps {items: ReadonlyArray<NavigationItem>;
  user: NavigationUser;
  isOpen: boolean;
...
interface DrawerItemProps {item: NavigationItem;
  onNavigate: (href: string) => void;
  onClose: () => void;}

interface DrawerHeaderProps {onClose: () => void;}
...
interface TabletDrawerTriggerProps {onOpen: () => void;
  className?: string;}
