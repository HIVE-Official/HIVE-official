...
interface DesktopSidebarProps {items: ReadonlyArray<NavigationItem>;
  user: NavigationUser;
  collapsed: boolean;
...
interface SidebarItemProps {item: NavigationItem;
  collapsed: boolean;
  onNavigate: (href: string) => void;}

interface SidebarHeaderProps {collapsed: boolean;
  onToggleCollapse: () => void;}
...
interface SidebarOverlayProps {isOpen: boolean;
  onClose: () => void;}
