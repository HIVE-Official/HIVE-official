...
interface NavigationLayoutProps {
  children: React.ReactNode;
  navigationState: any; // We'll fix this type later
}
...
export const NavigationContainer = memo<NavigationContainerProps>(
  ({
    ...
    return (
      <NavigationLayout navigationState={state}>
        <div
        ...
        >
          ...
          <AnimatePresence mode="wait">{renderNavigation()}</AnimatePresence>
...
export const withNavigation = <P extends object>(
  ...
  const WithNavigationComponent = memo<P & WithNavigationProps>((props) => {
    ...
    return (
      <NavigationLayout navigationState={navigationState.state}>
        <NavigationContainer
          user={user}
          onOpenCommandPalette={onOpenCommandPalette}
          onOpenNotifications={onOpenNotifications}
