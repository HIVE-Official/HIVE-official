...
export interface ConfigField {id: string;
  name: string;
...
export interface ToolConfigurationData {toolId: string;
  toolName: string;
  toolIcon: string;
  version: string;
...
export interface ToolConfigurationPanelProps {tool: ToolConfigurationData;
  isOpen: boolean;
  onClose: () => void;
...
export const ToolConfigurationPanel: React.FC<ToolConfigurationPanelProps> = ({
  ...
  const groupedFields = tool.fields.reduce((groups: Record<string, ConfigField[]>, field) => {
