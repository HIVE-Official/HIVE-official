...
export interface SpacePreview {id: string;
  name: string;
  description: string;
...
export interface SpaceCategoryBrowserProps {spaces: SpacePreview[];
...
export const SpaceCategoryBrowser: React.FC<SpaceCategoryBrowserProps> = ({
  ...
  const SpaceCard: React.FC<{ space: SpacePreview }> = ({ space }) => {
    ...
    return (
      ...
      >
        {/* Background Effects */}
        <div className={cn('absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300',
        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            <div className={cn('rounded-2xl flex items-center justify-center font-bold text-white relative overflow-hidden',
