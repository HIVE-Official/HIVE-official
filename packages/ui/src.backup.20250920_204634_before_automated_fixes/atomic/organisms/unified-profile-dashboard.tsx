...
interface CampusSpace {id: string;
  name: string;
...
interface CampusActivity {id: string;
...
interface CampusTool {id: string;
  name: string;
...
interface CalendarConflict {id: string;
...
interface UserStats {connections?: number;
  spaces?: number;
  tools?: number;
  achievements?: number;
  contributions?: number;}

interface LoadingStates {profile?: boolean;
  spaces?: boolean;
  activities?: boolean;
  tools?: boolean;
  calendar?: boolean;}
...
export interface UnifiedProfileDashboardProps {user: HiveUser;
  spaces?: CampusSpace[];
