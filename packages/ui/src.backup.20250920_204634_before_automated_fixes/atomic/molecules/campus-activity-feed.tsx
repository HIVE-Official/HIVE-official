...
export interface CampusActivity {id: string;
...
export interface CampusActivityFeedProps {activities: CampusActivity[];
  isLoading?: boolean;
            ...
            {displayedActivities.map((activity, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Hover Glow Effect */}
                  <motion.div;
                    className={cn('absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300',
