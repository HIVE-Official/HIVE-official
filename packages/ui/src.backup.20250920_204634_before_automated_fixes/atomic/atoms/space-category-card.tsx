...
export interface SpaceCategoryData {type: SpaceCategoryType;
  title: string;
  description: string;
...
export interface SpaceCategoryCardProps {category: SpaceCategoryData;
...
export const SpaceCategoryCard: React.FC<SpaceCategoryCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div;
        className={cn('absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500',
