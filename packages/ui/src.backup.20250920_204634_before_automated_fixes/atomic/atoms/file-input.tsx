...
export const ImageInput: React.FC<
  Omit<FileInputProps, "accept" | "preview">
> = (props) => <FileInput accept="image/*" preview {...props} />;

export const DocumentInput: React.FC<Omit<FileInputProps, "accept">> = (
  props
) => <FileInput accept=".pdf,.doc,.docx,.txt,.rtf" {...props} />;

export const DropzoneInput: React.FC<Omit<FileInputProps, "variant">> = (
  props
) => <FileInput variant="dropzone" {...props} />;

export const ButtonFileInput: React.FC<Omit<FileInputProps, "variant">> = (
  props
