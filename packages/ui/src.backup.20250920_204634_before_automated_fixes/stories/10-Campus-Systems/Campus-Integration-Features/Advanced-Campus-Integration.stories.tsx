...
interface CampusBuilding {id: string;
  name: string;
  shortName: string;
  address: string;
...
interface DiningLocation {id: string;
  name: string;
  building: string;
...
interface TransportService {id: string;
  name: string;
...
interface CampusEvent {id: string;
  title: string;
  description: string;
