...
interface TranslationKey {[key: string]: string | TranslationKey;}

interface Translations {[languageCode: string]: TranslationKey;}
...
interface LocalizationContextType {currentLanguage: Language;
