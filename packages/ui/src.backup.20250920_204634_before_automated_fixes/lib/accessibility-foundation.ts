...
export const focusStyles = cva("", {
  variants: {
    type: {
      // Standard focus ring;
      default:
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--hive-brand-primary)]/30 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--hive-background-primary)]",

      // High contrast focus;
      strong:
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--hive-brand-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--hive-background-primary)]",

      // Subtle focus for cards/containers;
      subtle:
        "focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--hive-border-primary)] focus-visible:ring-offset-1",

      // Skip links and screen reader focus;
      skipLink:
        "focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[var(--hive-background-primary)] focus:text-[var(--hive-text-primary)] focus:border focus:border-[var(--hive-brand-primary)] focus:rounded-md",
    },
  },
  defaultVariants: {
    type: "default",
...
export const screenReader = {
  ...
  focusable:
    "sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[var(--hive-background-primary)] focus:text-[var(--hive-text-primary)]",
...
export const highContrast = {
  ...
  background:
    "contrast-more:bg-[var(--hive-background-primary)] contrast-more:text-[var(--hive-text-primary)]",
} as const;
 ...
 */
export function getInteractiveA11yProps(
  type: keyof typeof ariaPatterns.interactive,
  label?: string
) {
  const baseProps = {
 ...
 */
export function getFormA11yProps(
  id: string,
  label: string,
  description?: string,
  error?: string,
 ...
 */
export function getModalA11yProps(titleId: string, descriptionId?: string) {
  const props = {
    role: "dialog",
    "aria-modal": "true",
 ...
 */
export function createSkipLink(target: string, label: string) {
  return {
    href: `#${target}`,
 ...
 */
export function getTestProps(testId?: string, componentName?: string) {
  return {
