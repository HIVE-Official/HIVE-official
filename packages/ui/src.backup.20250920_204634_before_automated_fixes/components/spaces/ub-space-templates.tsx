...
export interface UBSpaceTemplate {id: string;
  name: string;
...
interface UBSpaceTemplateCardProps {space: UBSpaceTemplate;
...
interface UBSpacesDirectoryProps {spaces?: UBSpaceTemplate[];
  onRequestActivation?: (spaceId: string) => void;
  onViewDetails?: (spaceId: string) => void;
...
interface SpaceActivationModalProps {spaceId: string;
  spaceName: string;
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: ActivationRequestData) => void;}

export interface ActivationRequestData {leadershipExperience: string;
