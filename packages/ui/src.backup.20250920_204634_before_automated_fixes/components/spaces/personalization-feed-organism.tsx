...
export interface UserSpace {id: string;
  name: string;
  description?: string;
  memberCount?: number;
  type?: string;
...
export interface RecommendedSpace {id: string;
  name: string;
  description?: string;
  memberCount?: number;
  type?: string;
...
export interface ActivityStats {spacesJoined: number;
  weeklyGrowth: number;
  activeNow: number;
  totalInteractions?: number;
  favoriteSpaces?: number;}

export interface PersonalizationFeedOrganismProps {/** User's active spaces */
  mySpaces?: UserSpace[];
