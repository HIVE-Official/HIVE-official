...
export type ValidationRule = {type: 'required' | 'min' | 'max' | 'pattern' | 'email' | 'custom';
  value?: any;
  message: string;
  validator?: (value: any) => boolean | Promise<boolean>};

export type FieldError = {type: string;
  message: string;};

export type FormFieldState = {value: any;
  errors: FieldError[];
  touched: boolean;
  validating: boolean;
  valid: boolean;};

export type FormState = {values: Record<string, any>;
...
// Form context;
interface FormContextType {state: FormState;
...
export interface HiveFormProps {children: React.ReactNode;
