...
interface PerformanceConfig {enableMetrics: boolean;
...
interface OptimizationStrategy {virtualizeRendering: boolean;
...
interface PerformanceLogoProps {variant?: 'primary' | 'gold' | 'inverted' | 'monochrome';
