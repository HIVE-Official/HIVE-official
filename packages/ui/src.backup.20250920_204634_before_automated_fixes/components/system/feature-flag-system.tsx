...
export interface FeatureFlag {id: string;
  name: string;
  description: string;
...
export interface FeatureFlagGroup {id: string;
  name: string;
  description: string;
  flags: string[];
  isCollapsed?: boolean;}

interface FeatureFlagSystemProps {flags: FeatureFlag[];
...
interface FeatureFlagContextType {flags: Record<string, boolean>;
