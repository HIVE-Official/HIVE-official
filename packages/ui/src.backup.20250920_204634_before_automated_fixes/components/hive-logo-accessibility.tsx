...
interface AccessibilitySettings {// WCAG compliance level;
...
interface AccessibilityLogoProps {// Core props;
...
export const HiveLogoAccessibilityTest: React.FC<{
  ...
  const [testResults, setTestResults] = useState({contrastRatio: 0,
