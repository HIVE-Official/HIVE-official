  ...
  ({ 
    ...
    return (
      <div className="space-y-2">
        ...
        >
          <motion.div;
            className={cn(progressFillVariants({variant: fillVariant)},
...
export interface StepProgressItem {id: string;
  label: string;
  description?: string;
...
export interface HiveProgressProps {variant?: 'bar' | 'circular' | 'step' | 'spinner' | 'skeleton';
  value?: number;
  max?: number;
  size?: 'xs' | 'sm' | 'md' | 'lg' | 'xl';
