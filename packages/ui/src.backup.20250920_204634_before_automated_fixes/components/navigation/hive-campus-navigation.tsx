...
interface BreadcrumbItem {id: string;
  label: string;
  href?: string;
  icon?: React.ComponentType<{ className?: string}>
}

interface ContextBreadcrumbsProps {items: BreadcrumbItem[];
  className?: string;}
...
interface SixSurfacesTabBarProps {surfaces: Surface[];
...
interface CampusLayoutShellProps {children: React.ReactNode;
