...
export function HiveNavigationInput({
  ...
  return (
    <motion.div;
      className={cn(hiveNavigationInputVariants({variant, size)},
...
export interface HiveCommandResultProps {title: string;
  subtitle?: string;
  icon?: React.ReactNode;
  shortcut?: string;
  isSelected?: boolean;
...
export interface HiveCommandSectionProps {title: string;
  count?: number;
  className?: string;}
