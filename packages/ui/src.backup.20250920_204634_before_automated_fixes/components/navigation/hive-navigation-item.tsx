  ...
  return (
    <div>
      <motion.button;
        ...
        className={cn(hiveNavigationItemVariants({variant: effectiveVariant, 
            size, 
...
export interface HiveNavigationSectionProps {label: string;
  collapsed?: boolean;
  className?: string;}
...
export interface HiveNavigationCreateButtonProps {collapsed?: boolean;
  onClick?: () => void;
  className?: string;}
