...
export interface TouchRipple {id: string;
  x: number;
  y: number;
  timestamp: number;}

export interface HapticFeedbackOptions {type: 'light' | 'medium' | 'heavy' | 'selection' | 'impact' | 'notification';
  enabled?: boolean;}
...
export interface UBMobileNavItem {id: string;
  label: string;
...
interface UBMobileBottomNavProps {items: UBMobileNavItem[];
...
interface UBMobileNavItemProps {item: UBMobileNavItem;
  onNavigate: (href: string) => void;}
...
interface UBMobileHeaderProps {title: string;
  subtitle?: string;
  leftAction?: {
    icon: React.ComponentType<any>;
    label: string;
...
interface UBMobileTouchButtonProps {icon: React.ComponentType<any>;
  label: string;
  onPress: () => void;
...
interface UBMobileSwipeCardProps {children: React.ReactNode;
  onSwipeLeft?: () => void;
  onSwipeRight?: () => void;
  onPress?: () => void;
  className?: string;}
...
interface UBMobilePullToRefreshProps {children: React.ReactNode;
