...
export interface PostAuthor {id: string;
  name: string;
  avatar?: string;
  role?: 'leader' | 'co_leader' | 'member';
  verified?: boolean;}

export interface PostReaction {emoji: string;
  count: number;
  userReacted?: boolean;
  users?: { id: string; name: string}[]
}

export interface PostAttachment {id: string;
...
export interface PostEvent {id: string;
  title: string;
  date: string;
  location?: string;
  rsvpCount?: number;
...
export interface PostPoll {id: string;
  question: string;
  options: Array<{
    id: string;
    text: string;
...
export interface PostAnnouncement {priority: 'low' | 'medium' | 'high' | 'urgent';
  isPinned?: boolean;
  expiresAt?: string;}
...
export interface PostBoardProps {posts: SpacePost[];
  currentUser?: {
    id: string;
    role?: 'leader' | 'co_leader' | 'member'};
