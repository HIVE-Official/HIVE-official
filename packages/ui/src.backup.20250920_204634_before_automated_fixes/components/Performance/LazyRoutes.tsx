...
interface CampusContext {networkQuality: 'excellent' | 'good' | 'fair' | 'poor';
...
interface NavigationAnalytics {visitedRoutes: string[];
  currentSession: {
    startTime: number;
...
interface LazyRoutesProps {routes: LazyRoute[];
