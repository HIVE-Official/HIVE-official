...
interface CampusPreloadContext {networkQuality: 'excellent' | 'good' | 'fair' | 'poor';
...
interface UserPreloadContext {userId: string;
...
interface PreloadResource {id: string;
  type: ResourceType;
  url?: string;
  data?: any;
...
interface PreloaderProps {resources: PreloadResource[];
...
interface PreloadStats {totalResources: number;
