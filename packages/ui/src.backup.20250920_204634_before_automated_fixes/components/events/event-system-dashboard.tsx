...
interface EventSystemDashboardProps {spaceId: string;
  userId: string;
...
interface EventSystemTool {id: string;
  name: string;
  description: string;
...
interface EventToolCardProps {tool: EventSystemTool;
  onLaunch: () => void;}
...
interface EventCardProps {event: EventDefinition;}
