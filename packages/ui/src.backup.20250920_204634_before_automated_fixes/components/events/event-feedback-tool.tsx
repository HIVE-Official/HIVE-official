...
interface EventFeedbackToolProps {event: EventDefinition;
  isBuilder?: boolean;
  onSendFeedbackRequest?: (recipients: string[]) => Promise<void>;
  onExportFeedback?: (format: 'csv' | 'pdf') => void;}

interface FeedbackQuestion {id: string;
...
interface FeedbackSurvey {id: string;
  eventId: string;
  title: string;
  description: string;
