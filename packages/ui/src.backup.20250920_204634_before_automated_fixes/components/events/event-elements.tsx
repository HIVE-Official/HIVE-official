...
export interface ElementProps {id?: string;
  label?: string;
  value?: any;
...
export interface RSVPOption {status: 'yes' | 'no' | 'maybe';
  guestCount?: number;
...
export function RSVPElement({ 
  ...
  onSubmit,
  className;
}: RSVPElementProps) {const [response, setResponse] = useState<RSVPOption>(
...
export interface ConditionalElementProps {condition: boolean;
