...
interface DirectMessageSystemProps {currentUserId: string;
...
interface MessageInputProps {onSendMessage: (content: string, replyTo?: string) => Promise<void>;
  replyTo?: Message;
  onCancelReply?: () => void;
  isLoading?: boolean;}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        {conversation.unreadCount > 0 && (
                          <Badge;
                            size="sm" 
                            className="bg-[var(--hive-primary)] text-white min-w-[20px] h-5 flex items-center justify-center"
                          >
    ...
    <div className="p-4 border-t border-[var(--hive-border-subtle)]">
      ...
      <div className="flex items-end gap-3">
        ...
        <Button;
          ...
          className="bg-[var(--hive-primary)] text-white hover:bg-[var(--hive-primary)]/90 px-4 py-3"
        >
          {isLoading ? (
