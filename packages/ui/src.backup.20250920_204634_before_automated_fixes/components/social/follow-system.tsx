...
export interface FollowableUser {id: string;
  name: string;
  handle: string;
  avatar?: string;
  bio?: string;
...
export interface FollowableSpace {id: string;
  name: string;
  description: string;
  avatar?: string;
  banner?: string;
...
interface FollowSystemProps {currentUserId: string;
...
interface FollowButtonProps {isFollowing: boolean;
  isLoading?: boolean;
...
interface UserCardProps {user: FollowableUser;
...
interface SpaceCardProps {space: FollowableSpace;
