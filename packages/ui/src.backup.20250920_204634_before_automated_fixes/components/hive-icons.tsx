...
// HIVE Icon System - HIVE brand logos + Lucide icons;
// Clean approach: HIVE logos for branding, Lucide for everything else;
...
// Utility component for consistent icon styling;
interface IconWrapperProps {size?: IconSize | number;
  className?: string;
