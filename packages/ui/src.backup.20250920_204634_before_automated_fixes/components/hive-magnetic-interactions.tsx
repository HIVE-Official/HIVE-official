...
interface MagneticHoverProps {children: ReactNode;
  className?: string;
...
interface MagneticSnapProps {children: ReactNode;
  className?: string;
  snapTarget?: string;
  snapId: string;
...
interface LiquidRippleProps {children: ReactNode;
  className?: string;
  rippleColor?: string;
...
interface LiquidTransformProps {children: ReactNode;
  className?: string;
...
interface MagneticTargetProps {children: ReactNode;
  className?: string;
  targetId: string;
