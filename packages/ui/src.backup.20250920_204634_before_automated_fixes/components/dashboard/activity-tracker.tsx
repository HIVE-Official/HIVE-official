...
// Activity data types;
export interface ActivityMetric {id: string;
  name: string;
  value: number;
  unit: string;
  change: number;
...
export interface ActivityInsight {id: string;
  title: string;
  description: string;
...
export interface ActivityGoal {id: string;
  title: string;
  description: string;
  target: number;
  current: number;
...
export interface ActivityTrackerData {metrics: ActivityMetric[];
...
interface ActivityTrackerProps {data?: ActivityTrackerData;
  isLoading?: boolean;
