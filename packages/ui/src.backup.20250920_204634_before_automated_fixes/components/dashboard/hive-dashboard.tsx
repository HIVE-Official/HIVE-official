...
export interface ProfileDashboardData {user: {
    id: string;
    name: string;
    handle: string;
    email: string;
...
interface HiveDashboardProps {data?: ProfileDashboardData;
  isLoading?: boolean;
  onRefresh?: () => void;
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          <p className="text-lg text-gray-600 mb-4">Unable to load dashboard</p>
          ...
          <Card className="h-full bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
            ...
            <CardContent className="space-y-4">
              ...
              {data.insights.mostActiveSpace && (
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">Most Active Space</span>
...
// Stat Card Component;
interface StatCardProps {label: string;
  value: string | number;
  total?: number;
