...
export interface HiveNotification {id: string;
...
interface NotificationCenterProps {notifications: HiveNotification[];
...
interface NotificationItemProps {notification: HiveNotification;
