...
export interface UnlockCriteria {type: 'count' | 'streak' | 'time' | 'rating' | 'collaboration' | 'milestone';
  target: number;
  timeframe?: 'day' | 'week' | 'month' | 'semester' | 'year';
  conditions?: Record<string, any>}

export interface AchievementReward {type: 'badge' | 'title' | 'feature' | 'cosmetic' | 'xp' | 'boost';
  value: string | number;
  duration?: number; // For temporary rewards (in days)}

export interface AchievementStats {totalEarned: number;
...
interface AchievementSystemProps {achievements: Achievement[];
