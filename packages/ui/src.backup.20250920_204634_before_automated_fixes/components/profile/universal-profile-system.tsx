...
export interface UniversalProfileUser {id: string;
  name: string;
  handle: string;
  email: string;
  avatar?: string;
...
interface ProfileSpace {id: string;
  name: string;
...
interface ProfileTool {id: string;
  name: string;
  description: string;
  category: string;
  icon: string;
...
interface ActivityItem {id: string;
...
interface UniversalProfileSystemProps {user: UniversalProfileUser;
  spaces: ProfileSpace[];
  tools: ProfileTool[];
