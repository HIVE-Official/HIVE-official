...
export interface AnalyticsMetric {id: string;
  label: string;
  value: number;
...
export interface AnalyticsTimeframe {id: string;
  label: string;
  value: string;}

export interface AnalyticsData {timeframe: string;
  metrics: AnalyticsMetric[];
  chartData: any[];
  lastUpdated: string;}

interface AnalyticsDashboardProps {data: AnalyticsData;
  isLoading?: boolean;
...
interface MetricCardProps {metric: AnalyticsMetric;
  isSelected?: boolean;
  onClick?: () => void;}
