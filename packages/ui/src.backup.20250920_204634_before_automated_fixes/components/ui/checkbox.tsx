    ...
    const checkboxElement = (
      <div className="relative flex items-center">
        <input;
          type="checkbox"
          id={checkboxId}
          className={cn(checkboxVariants({size, variant, radius)},
            className;
          )}
          ref={setRefs}
          checked={checked}
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 space-y-1">
              {label && (
                <label;
                  htmlFor={checkboxId}
                  className={cn(checkboxLabelVariants({color: labelProps?.color, 
...
interface IconProps {size?: VariantProps<typeof checkboxVariants>["size"]}
