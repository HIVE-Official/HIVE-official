...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ 
    ...
    const inputElement = (
      <input;
        id={inputId}
        className={cn(inputVariants({variant: computedVariant, size, radius)},
    ...
    return (
      <div className="relative">
        <input;
          ref={ref}
          id={inputId}
          className={cn(inputVariants({variant: props.error ? "error" : props.success ? "success" : props.variant,
              size: props.size,
              radius: props.radius;)},
