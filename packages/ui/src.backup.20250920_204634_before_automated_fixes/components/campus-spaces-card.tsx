...
export interface CampusSpace {id: string;
  name: string;
...
export interface CampusSpacesCardProps {spaces: CampusSpace[];
  isLoading?: boolean;
      ...
      <div className="relative z-10 space-y-3">
        <AnimatePresence>
          {displayedSpaces.map((space, index) => (
            ...
            >
              {/* Space Type Glow */}
              <div className={cn('absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300',
