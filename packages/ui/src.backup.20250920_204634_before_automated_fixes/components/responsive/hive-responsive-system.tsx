...
export interface ResponsiveBreakpoints {mobile: number;    // 320-768px - Phone-first experience;
  tablet: number;    // 768-1024px - Hybrid layouts;
  desktop: number;   // 1024px+ - Full feature experience;
  wide: number;      // 1440px+ - Wide screen optimizations;}

export const hiveBreakpoints: ResponsiveBreakpoints = {
...
export interface ResponsiveLayoutConfig {deviceType: DeviceType;
  layoutMode: LayoutMode;
  
  // Navigation configuration for each breakpoint;
  navigation: {
...
export const responsiveLayoutConfigs: Record<DeviceType, ResponsiveLayoutConfig> = {
  mobile: {
    deviceType: 'mobile',
...
interface ResponsiveContextType {deviceType: DeviceType;
  layoutMode: LayoutMode;
...
interface ResponsiveProviderProps {children: React.ReactNode;
 ...
 */
interface ResponsiveShowProps {on?: DeviceType[];
  above?: DeviceType;
  below?: DeviceType;
 ...
 */
interface ResponsiveGridProps {children: React.ReactNode;
  className?: string;
 ...
 */
interface MobileBottomTabsProps {tabs: Array<{
    id: string;
    label: string;
...
export function MobileBottomTabs({ tabs, onTabClick, className }: MobileBottomTabsProps) {
  ...
  return (
    <div className={cn(
      ...
      'bg-[var(--hive-background-primary)] border-t border-[var(--hive-border-subtle)]',
      'backdrop-blur-sm',
      className;
    )}>
      <div className="flex">
...
export function generateResponsiveClasses(
  baseClass: string,
  variants: Partial<Record<DeviceType, string>>
): string {
