...
type CampusLoadingContext = {networkQuality: 'excellent' | 'good' | 'fair' | 'poor';
...
interface LoadingResource {id: string;
  name: string;
...
interface UserJourneyContext {currentPage: 'profile' | 'spaces' | 'tools' | 'feed' | 'onboarding';
  previousPage?: string;
...
interface LoadingOrchestratorProps {// Core configuration;
...
interface LoadingState {phase: LoadingPhase;
