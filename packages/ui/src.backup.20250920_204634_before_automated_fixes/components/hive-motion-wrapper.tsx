...
interface RippleProps {children: React.ReactNode;
  className?: string;
  disabled?: boolean;}
...
interface MagneticHoverProps {children: React.ReactNode;
  className?: string;
...
interface CascadeProps {children: React.ReactNode;
  className?: string;
  staggerDelay?: number;
...
interface FloatProps {children: React.ReactNode;
  className?: string;
  intensity?: 'subtle' | 'medium' | 'strong';
  duration?: number;}
...
interface GlowPulseProps {children: React.ReactNode;
  className?: string;
  color?: string;
  intensity?: 'subtle' | 'medium' | 'strong'}
...
interface ToolPlantProps {children: React.ReactNode;
  className?: string;
  planted?: boolean;}
