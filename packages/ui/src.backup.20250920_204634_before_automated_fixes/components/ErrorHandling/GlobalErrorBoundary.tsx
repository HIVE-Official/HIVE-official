...
interface ErrorAnalytics {errorCount: number;
...
interface GlobalErrorBoundaryProps {children: ReactNode;
...
interface GlobalErrorBoundaryState {hasError: boolean;
  error: Error | null;
...
interface GlobalErrorFallbackProps {error: HiveError;
  errorId: string;
  retryCount: number;
            ...
            {retryCount >= maxRetryAttempts && (
              <div className="text-center space-y-3">
                ...
                <button;
                  ...
                  className="w-full py-3 px-4 bg-hive-blue text-white font-semibold rounded-xl hover:bg-hive-blue/90 transition-colors"
                >
                  Contact Support;
                </button>
              </div>
