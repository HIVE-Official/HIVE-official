...
export interface ExpandFocusProps {children: React.ReactNode;
      ...
      <AnimatePresence>
        {isExpanded && backdrop && (
          <motion.div;
            ...
            onClick={closeOnBackdropClick ? onCollapse : undefined}
          />
        )}
      </AnimatePresence>
        ...
        {isExpanded && (
          <motion.div;
            className={cn(
              ...
              'bg-hive-background-elevated rounded-2xl border border-hive-border-subtle',
              'shadow-2xl z-[1001] overflow-hidden',
              'flex flex-col',
              expandedClassName;
            )}
            initial={{ 
          ...
          >
            ...
            <button;
              onClick={onCollapse}
              className="absolute top-4 right-4 z-10 p-2 rounded-lg bg-hive-background-tertiary/80 hover:bg-hive-background-tertiary text-hive-text-secondary hover:text-hive-text-primary transition-colors"
            >
              <X size={20} />
            </button>
