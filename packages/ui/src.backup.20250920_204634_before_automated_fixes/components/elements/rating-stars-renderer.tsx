...
interface RatingStarsConfig {// Element-specific properties (flexible)
  label: string;
  maxRating?: number;
  allowHalf?: boolean;
  size?: 'sm' | 'md' | 'lg';
...
interface RatingStarsRendererProps {element: ElementInstance;
...
export const RatingStarsRenderer: React.FC<RatingStarsRendererProps> = ({
  ...
  const handleStarClick = (rating: number) => {
    ...
    if (onStateChange) {
      onStateChange({rating: newRating,
