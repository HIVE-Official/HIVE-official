...
interface ConditionGateProps {config: ConditionGateConfig;
  children: React.ReactNode;
  toolState: Record<string, any>;
  onAction?: (action: ConditionAction) => void;
  className?: string;}

interface ConditionAction {type: 'show' | 'hide' | 'setValue' | 'trigger';
  targetElementId: string;
  value?: unknown;}

interface ToolState {[elementId: string]: any;}
