...
interface SpaceToolsTabProps {spaceId: string;
  userId: string;
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">Tool Running</span>
            </div>
          </div>
        </div>
    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {(userRole === 'admin' || userRole === 'moderator') && (
          <HiveButton onClick={() => setCurrentView('marketplace')}>
...
interface InstalledToolCardProps {tool: InstalledTool;
  userRole: 'admin' | 'moderator' | 'member';
  onLaunch: () => void;
...
function InstalledToolCard({ tool, userRole, onLaunch, onToggle }: InstalledToolCardProps) {
  ...
  return (
    <HiveCard className="p-4 hover:shadow-md transition-shadow">
