...
export const ToolConfigurationStep: StoryObj<typeof ToolConfiguration> = {
  render: () => {
    const [config, setConfig] = React.useState({toolName: 'CS Algorithm Study Group',
...
export const LaundryTrackerConfiguration: StoryObj<typeof ToolConfiguration> = {
  render: () => {
    const [config, setConfig] = React.useState({toolName: 'Ellicott East Laundry Tracker',
...
export const CompleteToolBuildingFlow: Story = {
  render: () => {
    ...
    const [selectedTemplate, setSelectedTemplate] = React.useState(null);
    const [config, setConfig] = React.useState({toolName: '',
      description: '',
      targetSpace: '',
      isPublic: false,
      settings: { })}
