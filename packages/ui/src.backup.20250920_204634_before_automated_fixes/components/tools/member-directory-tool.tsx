...
interface DirectoryMember {id: string;
  name: string;
  username: string;
  avatar?: string;
...
interface MemberDirectoryToolProps {spaceId: string;
  spaceName: string;
  isLeader: boolean;
...
interface MemberCardProps {member: DirectoryMember;
  viewMode: ViewMode;
  isLeader: boolean;
...
interface MemberDetailModalProps {member: DirectoryMember;
  isLeader: boolean;
  currentUserRole: string;
  onClose: () => void;
  onAction: (action: string, data?: any) => void;}
