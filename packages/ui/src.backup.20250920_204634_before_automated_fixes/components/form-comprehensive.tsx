...
export interface UniversityEmailFieldProps {value?: string;
...
export interface StudentIDFieldProps {value?: string;
  onChange?: (value: string) => void;
  onBlur?: () => void;
  error?: string;
  required?: boolean;
...
export interface MajorSelectionFieldProps {major?: string;
  year?: string;
...
export interface DormSelectionFieldProps {dormBuilding?: string;
  roomNumber?: string;
...
export interface GreekAffiliationFieldProps {organization?: string;
  position?: string;
...
export interface CalendarConnectionFieldProps {googleCalendar?: boolean;
...
export interface PrivacyLevelFieldProps {value?: 'public' | 'friends' | 'ghost';
...
export interface BuilderVerificationFieldProps {portfolioUrl?: string;
  githubUrl?: string;
  experience?: string;
...
export interface SpaceActivationFieldProps {spaceName?: string;
  spaceType?: string;
  description?: string;
...
export interface ToolPublishingFieldProps {toolName?: string;
