...
export interface CampusLink {type: 'space' | 'student' | 'course' | 'tool';
  id: string;
  name: string;
  url?: string;}
...
const HiveRichTextEditor = React.forwardRef<HTMLDivElement, HiveRichTextEditorProps>(
  ({ 
    ...
    return (
      <div;
        ref={ref}
        className={cn(hiveRichTextEditorVariants({variant, size, mode)},
              ...
              <div className="flex items-center gap-1 mr-4">
                ...
                <div className="flex -space-x-2">
                  {collaborators.slice(0, 3).map((collaborator, index) => (
                    <div;
                      key={collaborator.id}
                      className="w-6 h-6 rounded-full bg-[var(--hive-overlay-gold-subtle)] border border-[var(--hive-border-gold)] flex items-center justify-center text-xs font-medium text-[var(--hive-brand-primary)]"
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input;
                      type="text"
                      className="w-full bg-[var(--hive-background-tertiary)] border border-[var(--hive-border-subtle)] rounded-lg px-3 py-2 text-[var(--hive-text-primary)] focus:outline-none focus:border-[var(--hive-border-gold)]"
          ...
          {showImageDialog && (
            ...
            >
              ...
              >
                ...
                <div className="space-y-4">
                  <div;
                    className="border-2 border-dashed border-[var(--hive-border-subtle)] rounded-lg p-8 text-center hover:border-[var(--hive-border-gold)] transition-colors"
