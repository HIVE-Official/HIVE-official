...
export interface OnboardingState {step: OnboardingStep;
...
export interface OnboardingContextType {state: OnboardingState;
  nextStep: () => void;
  prevStep: () => void;
...
interface OnboardingProviderProps {children: React.ReactNode;
...
interface HiveOnboardingWizardEnhancedProps {className?: string;
  onComplete?: (userData: OnboardingState['data']) => void;
  initialStep?: OnboardingStep;
  mockMode?: boolean;}
