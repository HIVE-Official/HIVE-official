...
interface SpaceFeedProps {spaceId: string;
  currentUser: FeedUser;
  className?: string;
  posts?: FeedPost[]}

interface FeedResponse {posts: FeedPost[];
  hasMore: boolean;
  lastPostId: string | null;}

interface InfiniteQueryData {pages: FeedResponse[];
  pageParams: (string | undefined)[]}

interface ReactResponse {success: boolean;
  reactions?: {
    heart: number;}
}
...
interface ModerateResponse {success: boolean;}
...
export const SpaceFeed: React.FC<SpaceFeedProps> = ({
  ...
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, refetch } =
    useInfiniteQuery({queryKey: ["space-feed", spaceId],
