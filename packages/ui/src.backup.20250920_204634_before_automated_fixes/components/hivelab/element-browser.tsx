...
export interface ElementDefinition {id: string;
  name: string;
  description: string;
...
export interface ElementProp {name: string;
...
export interface ElementExample {id: string;
  title: string;
  description: string;
  props: Record<string, any>;
  code?: string;}

interface ElementBrowserProps {onElementSelect?: (element: ElementDefinition) => void;
