...
declare const hiveButtonVariants: (props?: {
    variant?: "outline" | "link" | "primary" | "secondary" | "premium" | "outline-subtle" | "ghost" | "ghost-gold" | "chip" | "chip-platinum" | "chip-gold" | "chip-glass" | "glow" | "minimal" | "success" | "destructive" | "warning";
    size?: "default" | "chip" | "xs" | "sm" | "lg" | "xl" | "icon" | "icon-sm" | "icon-lg" | "chip-xs" | "chip-sm" | "chip-lg";
