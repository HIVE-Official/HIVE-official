...
export const InteractiveBreadcrumbs = {
    args: {
        ...
        onDropdownSelect: (parent, selected) => {
            console.log('Dropdown selected:', parent.label, '->', selected.label);
        }
    }
};
export const ResponsiveExample = {
    render: () => (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-semibold mb-3", children: "Desktop View" }), _jsx("div", { className: "w-full", children: _jsx(HiveBreadcrumbs, { variant: "space", items: deepNavigation, showIcons: true, responsive: false }) })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-semibold mb-3", children: "Mobile View (Responsive)" }), _jsx("div", { className: "w-80", children: _jsx(HiveBreadcrumbs, { variant: "space", items: deepNavigation, showIcons: true, responsive: true, mobileCollapse: true }) })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-semibold mb-3", children: "Tablet View" }), _jsx("div", { className: "w-96", children: _jsx(HiveBreadcrumbs, { variant: "space", items: deepNavigation, showIcons: true, responsive: true, maxItems: 3 }) })] })] }))
};
//# sourceMappingURL=hive-breadcrumbs.stories.js.map