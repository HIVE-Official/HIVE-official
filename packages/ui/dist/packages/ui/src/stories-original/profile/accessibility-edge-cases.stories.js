...
export const DataExtremes = {
    ...
    args: {
        ...
        spaces: Array.from({ length: 50 }, (_, i) => ({
            ...
            type: ['course', 'research', 'social', 'study', 'organization'][i % 5],
        ...
        events: Array.from({ length: 100 }, (_, i) => ({
            ...
            time: `${i + 1} hours`,
            type: ['academic', 'social', 'work', 'study', 'personal'][i % 5],
...
export const NetworkErrorStates = {
...
export const SlowNetworkSimulation = {
    name: '🐌 Slow Network Performance',
    render: () => {
        return (_jsxs("div", { className: "max-w-4xl mx-auto p-6 space-y-6", children: [_jsxs("div", { className: "bg-orange-500/20 border border-orange-500/30 p-4 rounded-lg", children: [_jsx("h2", { className: "text-xl font-bold text-orange-300 mb-2", children: "\uD83D\uDC0C Slow Network Detected" }), _jsx("p", { className: "text-orange-200 mb-4", children: "Connection speed: 2G (slow) | Data saver mode enabled | Images disabled" }), _jsx("div", { className: "text-sm text-orange-300", children: "\u26A1 Showing optimized low-bandwidth version | \uD83D\uDCF1 Reduced animations | \uD83D\uDDBC\uFE0F Text-only mode" })] }), _jsx(CalendarCard, { state: "loading", variant: "desktop", data: {
                        nextEvent: undefined,
                        upcomingEvents: [],
                        todaysEvents: [],
                        connections: [
                        ...
                        conflicts: []
                    } }), _jsxs("div", { className: "bg-hive-background-secondary p-4 rounded-lg", children: [_jsx("h3", { className: "font-medium text-[var(--hive-text-primary)] mb-2", children: "Slow Network Optimizations:" }), _jsxs("ul", { className: "space-y-1 text-sm text-gray-300", children: [_jsx("li", { children: "\u2705 Skeleton loading states instead of spinners" }), _jsx("li", { children: "\u2705 Progressive image loading disabled" }), _jsx("li", { children: "\u2705 Reduced animation complexity" }), _jsx("li", { children: "\u2705 Compressed data payloads" }), _jsx("li", { children: "\u2705 Critical content prioritized" }), _jsx("li", { children: "\u2705 Background sync disabled" })] })] })] }));
    }
};
...
export const KeyboardNavigationDemo = {
    ...
    render: () => {
        return (_jsxs("div", { className: "max-w-4xl mx-auto p-6 space-y-6", children: [_jsxs("div", { className: "bg-blue-500/20 border border-blue-500/30 p-4 rounded-lg", children: [_jsx("h2", { className: "text-xl font-bold text-blue-300 mb-2", children: "\u2328\uFE0F Keyboard Navigation Instructions" }), _jsxs("div", { className: "grid grid-cols-2 gap-4 text-sm text-blue-200", children: [_jsxs("div", { children: [_jsx("strong", { children: "Basic Navigation:" }), _jsxs("ul", { className: "mt-2 space-y-1", children: [_jsx("li", { children: "\u2022 Tab - Next focusable element" }), _jsx("li", { children: "\u2022 Shift+Tab - Previous element" }), _jsx("li", { children: "\u2022 Enter/Space - Activate button" }), _jsx("li", { children: "\u2022 Arrow keys - Navigate within components" })] })] }), _jsxs("div", { children: [_jsx("strong", { children: "Advanced Navigation:" }), _jsxs("ul", { className: "mt-2 space-y-1", children: [_jsx("li", { children: "\u2022 Alt+M - Skip to main content" }), _jsx("li", { children: "\u2022 Alt+N - Skip to navigation" }), _jsx("li", { children: "\u2022 Ctrl+Home - Go to top" }), _jsx("li", { children: "\u2022 Esc - Close modals/menus" })] })] })] })] }), _jsx(ProfileSystem, { user: {
                        id: 'keyboard-user',
...
//# sourceMappingURL=accessibility-edge-cases.stories.js.map