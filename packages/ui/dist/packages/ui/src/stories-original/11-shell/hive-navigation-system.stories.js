...
import { HiveNavigationShell, navigationPresets } from '../../components/navigation/hive-navigation-shell';
import { Home, Users, Zap, Calendar, BookOpen, Settings, User, Hash, TrendingUp, FileText, Shield } from 'lucide-react';
const meta = {
...
const SampleContent = () => (_jsxs("div", { className: "p-8 max-w-4xl mx-auto", children: [_jsxs("div", { className: "mb-8", children: [_jsx("h1", { className: "text-3xl font-bold mb-4", style: { color: 'var(--hive-text-primary)' }, children: "Welcome to HIVE" }), _jsx("p", { className: "text-lg mb-6", style: { color: 'var(--hive-text-secondary)' }, children: "Your campus platform for collaboration, learning, and building amazing tools." })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8", children: [
                ...
                { title: 'Events This Week', value: '5', icon: Calendar }
                    ...
                    ].map((activity, index) => (_jsxs("div", { className: "flex items-center gap-3 p-4 rounded-lg border", style: {
                            backgroundColor: 'var(--hive-background-secondary)',
                            borderColor: 'var(--hive-border-primary)'
                        }, children: [_jsx("div", { className: "w-2 h-2 rounded-full", style: { backgroundColor: 'var(--hive-brand-primary)' } }), _jsx("span", { style: { color: 'var(--hive-text-primary)' }, children: activity })] }, index))) })] })] }));
// ============================================================================
// STORIES
// ============================================================================
...
export const AdminDashboard = {
    args: {
        ...
        collapsible: true,
        keyboardShortcuts: true,
        children: (_jsxs("div", { className: "p-8", children: [_jsx("h1", { className: "text-3xl font-bold mb-6", style: { color: 'var(--hive-text-primary)' }, children: "Admin Dashboard" }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: [
...
export const InteractiveDemo = {
    args: {
        ...
        collapsible: true,
        keyboardShortcuts: true,
        children: (_jsxs("div", { className: "p-8", children: [_jsxs("div", { className: "mb-8", children: [_jsx("h1", { className: "text-3xl font-bold mb-4", style: { color: 'var(--hive-text-primary)' }, children: "Interactive Navigation Demo" }), _jsx("p", { className: "text-lg mb-6", style: { color: 'var(--hive-text-secondary)' }, children: "Try these keyboard shortcuts:" }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { className: "p-4 rounded-lg border", style: {
                                        backgroundColor: 'var(--hive-background-secondary)',
                                        borderColor: 'var(--hive-border-primary)'
                                    }, children: [_jsx("kbd", { className: "px-2 py-1 bg-gray-700 rounded text-sm", children: "Cmd/Ctrl + K" }), _jsx("span", { className: "ml-2", style: { color: 'var(--hive-text-primary)' }, children: "Open search" })] }), _jsxs("div", { className: "p-4 rounded-lg border", style: {
                                        backgroundColor: 'var(--hive-background-secondary)',
                                        borderColor: 'var(--hive-border-primary)'
                                    }, children: [_jsx("kbd", { className: "px-2 py-1 bg-gray-700 rounded text-sm", children: "Cmd/Ctrl + B" }), _jsx("span", { className: "ml-2", style: { color: 'var(--hive-text-primary)' }, children: "Toggle sidebar" })] }), _jsxs("div", { className: "p-4 rounded-lg border", style: {
                                        backgroundColor: 'var(--hive-background-secondary)',
                                        borderColor: 'var(--hive-border-primary)'
                                    }, children: [_jsx("kbd", { className: "px-2 py-1 bg-gray-700 rounded text-sm", children: "Escape" }), _jsx("span", { className: "ml-2", style: { color: 'var(--hive-text-primary)' }, children: "Close overlays" })] }), _jsxs("div", { className: "p-4 rounded-lg border", style: {
                                        backgroundColor: 'var(--hive-background-secondary)',
                                        borderColor: 'var(--hive-border-primary)'
                                    }, children: [_jsx("kbd", { className: "px-2 py-1 bg-gray-700 rounded text-sm", children: "\u2191\u2193" }), _jsx("span", { className: "ml-2", style: { color: 'var(--hive-text-primary)' }, children: "Navigate search" })] })] })] }), _jsx(SampleContent, {})] }))
    }
};
//# sourceMappingURL=hive-navigation-system.stories.js.map