...
export const createStaggerDelay = (index, baseDelay = 100) => {
...
export const createHiveAnimation = (keyframes, duration = 'liquid', easing = 'liquid', iterations = 1) => ({
...
export const respectsReducedMotion = (styles) => ({
    ...styles,
