...
// Utility functions
export const withLuxuryGlow = (color, intensity = 0.3) => `0 0 5 ${color.replace(')', `, ${intensity})`)}`;
export const createLuxuryGradient = (from, to, direction = 135) => `linear-gradient(${direction}deg, ${from} 0%, ${to} 100%)`;
export const luxuryBorder = (color = darkLuxury.steel, width = 1) => `${width}px solid ${color}`;
...
//# sourceMappingURL=dark-luxury.js.map