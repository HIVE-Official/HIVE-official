...
export class HiveMotionOrchestrator {
    ...
    async triggerSequence(sequenceType, elements) {
    ...
    triggerRipple(sourceId, connectedElements) {
        // Start center ripple
...
export const motionUtils = {
    ...
    isInMagneticZone(element, target, zone) {
    ...
    getStaggerDelay(index, type = 'stagger') {
        return index * cascadeTiming[type];
    },
    // Create liquid metal transition
    createLiquidTransition(duration = 'smooth') {
        return {
...
//# sourceMappingURL=hive-motion-system.js.map