...
export const SpacesDiscoveryStep = ({ onSpacesChange, onContinue, selectedSpaces = [], userInterests = [], userRole = '', className }) => {
    ...
    const SpaceCard = ({ space }) => {
        ...
        return (_jsx(Card, { variant: isSelected ? "accent" : "interactive", padding: "md", className: "cursor-pointer transition-all duration-200 hover:scale-[1.02]", onClick: () => handleSpaceToggle(space.id), children: _jsx(CardContent, { className: "p-4", children: _jsx("div", { className: "flex items-start justify-between mb-3", children: _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [_jsx("h3", { className: "font-semibold text-[var(--hive-text-inverse)]", children: space.name }), isSelected && _jsx(CheckCircle, { className: "w-4 h-4 text-accent" })] }), _jsx("p", { className: "text-sm text-muted leading-relaxed mb-2", children: space.description }), _jsxs("div", { className: "flex items-center gap-3 text-xs text-muted", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Users, { className: "w-3 h-3" }), _jsxs("span", { children: [space.memberCount, " members"] })] }), _jsx("span", { className: "text-accent", children: space.category })] })] }) }) }) }));
    };
    return (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, className: cn("w-full max-w-3xl mx-auto", className), children: [_jsxs("div", { className: "text-center mb-8", children: [_jsx("h1", { className: "text-3xl font-bold text-[var(--hive-text-inverse)] mb-3", children: "Discover spaces" }), _jsx("p", { className: "text-lg text-muted", children: "Join at least 2 spaces to start connecting with your campus community" }), _jsxs("div", { className: "mt-2 text-sm text-muted", children: [localSelectedSpaces.length, "/2+ selected"] })] }), _jsxs("div", { className: "space-y-8", children: [_jsxs("div", { className: "relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-muted w-4 h-4" }), _jsx(Input, { type: "text", placeholder: "Search spaces...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "pl-10", variant: "search" })] }), suggestedSpaces.length > 0 && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Star, { className: "w-5 h-5 text-accent" }), _jsx("h2", { className: "text-lg font-semibold text-[var(--hive-text-inverse)]", children: "Suggested for you" })] }), _jsx(Alert, { variant: "info", children: _jsxs("div", { children: [_jsx("p", { className: "font-medium", children: "Personalized recommendations" }), _jsx("p", { className: "text-sm", children: "Based on your interests and role, these spaces might be a great fit." })] }) }), _jsx("div", { className: "grid gap-4", children: suggestedSpaces.map((space, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: index * 0.1 }, children: _jsx(SpaceCard, { space: space }) }, space.id))) })] })), otherSpaces.length > 0 && (_jsxs("div", { className: "space-y-4", children: [_jsx("h2", { className: "text-lg font-semibold text-[var(--hive-text-inverse)]", children: "All spaces" }), _jsx("div", { className: "grid gap-3", children: otherSpaces.map((space, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: (suggestedSpaces.length + index) * 0.05 }, children: _jsx(SpaceCard, { space: space }) }, space.id))) })] })), filteredSpaces.length === 0 && searchQuery && (_jsxs("div", { className: "text-center py-8", children: [_jsxs("div", { className: "text-muted mb-4", children: ["No spaces found matching \"", searchQuery, "\""] }), _jsxs(Button, { variant: "secondary", size: "sm", children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Request new space"] })] })), _jsxs("div", { className: "flex flex-col items-center gap-4 pt-6", children: [_jsxs("div", { className: "text-center", children: [_jsx("div", { className: cn("text-sm font-medium mb-2", canContinue ? "text-accent" : "text-muted"), children: canContinue
