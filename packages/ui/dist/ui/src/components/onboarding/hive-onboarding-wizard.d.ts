...
export declare function HiveOnboardingWizard({ className, onComplete, initialStep, mockMode }: HiveOnboardingWizardProps): import("react/jsx-runtime").JSX.Element;
export {};
//# sourceMappingURL=hive-onboarding-wizard.d.ts.map