...
const AcademicsStep = () => {
    ...
    return (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -20 }, className: "space-y-6", children: [_jsxs("div", { className: "text-center space-y-2", children: [_jsx("h2", { className: "text-2xl font-bold text-slate-900 dark:text-white", children: "Academic Information" }), _jsx("p", { className: "text-slate-600 dark:text-slate-400", children: "Help us connect you with relevant academic communities" })] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "space-y-2", children: [_jsxs("label", { className: "text-sm font-medium text-slate-900 dark:text-white", children: ["Major/Program ", _jsx("span", { className: "text-red-500", children: "*" })] }), _jsxs("select", { value: selectedMajor, onChange: (e) => handleMajorChange(e.target.value), className: "w-full p-3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg focus:border-yellow-500 text-slate-900 dark:text-white", children: [_jsx("option", { value: "", children: "Select your major" }), UB_MAJORS.map(major => (_jsx("option", { value: major.id, children: major.name }, major.id)))] })] }), _jsxs("div", { className: "space-y-2", children: [_jsxs("label", { className: "text-sm font-medium text-slate-900 dark:text-white", children: ["Class Year ", _jsx("span", { className: "text-red-500", children: "*" })] }), _jsxs("select", { value: classYear, onChange: (e) => {
                                    setClassYear(e.target.value);
                                    updateData({ classYear: e.target.value });
                                }, className: "w-full p-3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg focus:border-yellow-500 text-slate-900 dark:text-white", children: [_jsx("option", { value: "", children: "Select your class year" }), _jsx("option", { value: "freshman", children: "Freshman" }), _jsx("option", { value: "sophomore", children: "Sophomore" }), _jsx("option", { value: "junior", children: "Junior" }), _jsx("option", { value: "senior", children: "Senior" }), _jsx("option", { value: "graduate", children: "Graduate Student" }), _jsx("option", { value: "phd", children: "PhD Student" })] })] })] }), _jsxs("div", { className: "flex justify-between", children: [_jsxs(Button, { variant: "outline", onClick: prevStep, children: [_jsx(ArrowLeft, { className: "mr-2 h-4 w-4" }), "Back"] }), _jsxs(Button, { onClick: nextStep, disabled: !canProceed, className: "bg-yellow-500 hover:bg-yellow-600 text-black", children: ["Continue", _jsx(ArrowRight, { className: "ml-2 h-4 w-4" })] })] })] }));
};
const InterestsStep = () => {
    const { state, updateData, nextStep, prevStep } = useOnboarding();
...
const CompleteStep = () => {
    ...
    return (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -20 }, className: "space-y-8 text-center", children: [_jsxs("div", { className: "space-y-6", children: [_jsx(motion.div, { animate: {
                            ...
                            duration: 2,
                            ease: "easeInOut"
                        }, children: _jsx(Trophy, { className: "h-16 w-16 text-yellow-500 mx-auto" }) }), _jsxs("div", { className: "space-y-4", children: [_jsxs("h1", { className: "text-3xl font-bold text-slate-900 dark:text-white", children: ["Welcome to HIVE, ", state.name.split(' ')[0], "! \uD83C\uDF89"] }), _jsx("p", { className: "text-lg text-slate-600 dark:text-slate-300 max-w-md mx-auto", children: "Your profile is set up and you're ready to start building connections and solving problems with your campus community." })] })] }), _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 text-left", children: [_jsxs("div", { className: "bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700", children: [_jsx(Users, { className: "h-6 w-6 text-yellow-500 mb-2" }), _jsx("h3", { className: "font-semibold text-slate-900 dark:text-white text-sm", children: "Explore Spaces" }), _jsx("p", { className: "text-xs text-slate-600 dark:text-slate-400", children: "Join communities around your interests and major" })] }), _jsxs("div", { className: "bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700", children: [_jsx(Code, { className: "h-6 w-6 text-yellow-500 mb-2" }), _jsx("h3", { className: "font-semibold text-slate-900 dark:text-white text-sm", children: "Build Tools" }), _jsx("p", { className: "text-xs text-slate-600 dark:text-slate-400", children: "Create solutions that help your campus community" })] }), _jsxs("div", { className: "bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700", children: [_jsx(Calendar, { className: "h-6 w-6 text-yellow-500 mb-2" }), _jsx("h3", { className: "font-semibold text-slate-900 dark:text-white text-sm", children: "Coordinate" }), _jsx("p", { className: "text-xs text-slate-600 dark:text-slate-400", children: "Organize events and collaborate with others" })] })] }), _jsxs(Button, { size: "lg", className: "bg-yellow-500 hover:bg-yellow-600 text-black", children: ["Enter HIVE", _jsx(Rocket, { className: "ml-2 h-4 w-4" })] })] })] }));
};
