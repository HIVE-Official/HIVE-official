...
export function EventSystemDashboard({ spaceId, userId, userRole, className }) {
    ...
    if (currentView === 'tool' && selectedTool) {
        return (_jsxs("div", { className: cn("space-y-4", className), children: [_jsx("div", { className: "flex items-center justify-between", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Button, { variant: "secondary", size: "sm", onClick: () => {
                                    setSelectedTool(null);
                                    setCurrentView('dashboard');
    ...
    // Main Dashboard View
    return (_jsxs("div", { className: cn("space-y-6", className), children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "Event Management System" }), _jsx("p", { className: "text-[var(--hive-text-muted)]", children: "Complete event coordination for your campus community" })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs(Badge, { variant: "secondary", children: [events.length, " total events"] }), _jsxs(Button, { onClick: () => setCurrentView('create'), children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Create Event"] })] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [_jsx(Card, { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center", children: _jsx(Calendar, { className: "w-5 h-5 text-blue-600" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-2xl font-bold text-gray-900", children: upcomingEvents.length }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)]", children: "Upcoming Events" })] })] }) }), _jsx(Card, { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center", children: _jsx(Users, { className: "w-5 h-5 text-green-600" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-2xl font-bold text-gray-900", children: "847" }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)]", children: "Total RSVPs" })] })] }) }), _jsx(Card, { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center", children: _jsx(Clock, { className: "w-5 h-5 text-amber-600" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-2xl font-bold text-gray-900", children: "94%" }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)]", children: "Attendance Rate" })] })] }) }), _jsx(Card, { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center", children: _jsx(BarChart3, { className: "w-5 h-5 text-purple-600" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-2xl font-bold text-gray-900", children: "4.8" }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)]", children: "Avg Rating" })] })] }) })] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("h2", { className: "text-xl font-semibold text-gray-900", children: "Event Tools" }), _jsx(Badge, { variant: "secondary", children: "5 tools" })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: eventTools.map(tool => (_jsx(EventToolCard, { tool: tool, onLaunch: () => handleLaunchTool(tool) }, tool.id))) })] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h2", { className: "text-xl font-semibold text-gray-900", children: "Upcoming Events" }), _jsx(Button, { variant: "secondary", size: "sm", children: "View All Events" })] }), loading ? (_jsx("div", { className: "space-y-3", children: [1, 2, 3].map(i => (_jsx("div", { className: "animate-pulse", children: _jsx("div", { className: "h-20 bg-gray-200 rounded-lg" }) }, i))) })) : upcomingEvents.length === 0 ? (_jsxs(Card, { className: "p-8 text-center", children: [_jsx(Calendar, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "No upcoming events" }), _jsx("p", { className: "text-[var(--hive-text-muted)] mb-4", children: "Create your first event to get started" }), _jsx(Button, { onClick: () => setCurrentView('create'), children: "Create Event" })] })) : (_jsx("div", { className: "space-y-3", children: upcomingEvents.map(event => (_jsx(EventCard, { event: event }, event.id))) }))] }), _jsxs("div", { className: "bg-amber-50 border border-amber-200 rounded-lg p-4", children: [_jsx("h4", { className: "font-medium text-amber-800 mb-2", children: "\uD83C\uDFAF vBETA Event System" }), _jsx("p", { className: "text-sm text-amber-700 mb-2", children: "This is HIVE's focused Event Management System - the single system we're launching for vBETA." }), _jsxs("div", { className: "text-xs text-amber-600 space-y-1", children: [_jsxs("p", { children: ["\u2022 ", _jsx("strong", { children: "5 Integrated Tools" }), ": Event Creator, RSVP Manager, Check-In System, Calendar, Feedback"] }), _jsxs("p", { children: ["\u2022 ", _jsx("strong", { children: "Complete Workflow" }), ": Plan \u2192 Promote \u2192 Execute \u2192 Analyze"] }), _jsxs("p", { children: ["\u2022 ", _jsx("strong", { children: "Campus Integration" }), ": Works across all Spaces with unified coordination"] }), _jsxs("p", { children: ["\u2022 ", _jsx("strong", { children: "Built with Elements" }), ": Shows students how tools are constructed from reusable components"] })] })] })] }));
}
function EventToolCard({ tool, onLaunch }) {
    ...
    return (_jsx(Card, { className: "p-4 hover:shadow-md transition-shadow cursor-pointer", onClick: onLaunch, children: _jsxs("div", { className: "space-y-3", children: [_jsx("div", { className: "flex items-start justify-between", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center", children: _jsx(tool.icon, { className: "w-5 h-5 text-amber-600" }) }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-gray-900", children: tool.name }), _jsx(Badge, { variant: "secondary", className: cn("text-xs", categoryColors[tool.category]), children: tool.category })] })] }) }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)]", children: tool.description }), _jsx("div", { className: "flex items-center gap-2 pt-2 border-t border-gray-100", children: _jsx(Button, { size: "sm", className: "flex-1", children: "Launch Tool" }) })] }) }));
}
function EventCard({ event }) {
    ...
    return (_jsx(Card, { className: "p-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [_jsx("h3", { className: "font-semibold text-gray-900", children: event.title }), _jsx(Badge, { variant: "secondary", className: "text-xs", children: event.category })] }), _jsxs("div", { className: "flex items-center gap-4 text-sm text-[var(--hive-text-muted)]", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Calendar, { className: "w-4 h-4" }), _jsx("span", { children: formatDate(event.startDate) })] }), event.location && (_jsx("div", { className: "flex items-center gap-1", children: _jsx("span", { children: event.location.venue || event.location.type }) }))] })] }), _jsx("div", { className: "flex items-center gap-2", children: _jsx(Badge, { variant: event.status === 'published' ? 'default' : 'outline', children: event.status }) })] }) }));
}
