...
const QRScanner = ({ isActive, onScan, onClose }) => {
    ...
    if (!isActive)
        return null;
    return (_jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4", children: _jsxs("div", { className: "bg-white rounded-lg p-6 max-w-md w-full", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h3", { className: "text-lg font-semibold", children: "Scan QR Code" }), _jsx(HiveButton, { size: "sm", variant: "outline", onClick: onClose, children: _jsx(EyeOff, { className: "w-4 h-4" }) })] }), error ? (_jsxs("div", { className: "text-center py-8", children: [_jsx(AlertCircle, { className: "w-12 h-12 text-red-400 mx-auto mb-4" }), _jsx("p", { className: "text-red-600 mb-4", children: error }), _jsx(HiveButton, { onClick: onClose, children: "Close" })] })) : hasCamera ? (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "relative", children: [_jsx("video", { ref: videoRef, autoPlay: true, playsInline: true, className: "w-full h-64 object-cover rounded-lg bg-gray-100" }), _jsxs("div", { className: "absolute inset-0 border-2 border-amber-400 rounded-lg pointer-events-none", children: [_jsx("div", { className: "absolute top-4 left-4 w-8 h-8 border-t-2 border-l-2 border-amber-400" }), _jsx("div", { className: "absolute top-4 right-4 w-8 h-8 border-t-2 border-r-2 border-amber-400" }), _jsx("div", { className: "absolute bottom-4 left-4 w-8 h-8 border-b-2 border-l-2 border-amber-400" }), _jsx("div", { className: "absolute bottom-4 right-4 w-8 h-8 border-b-2 border-r-2 border-amber-400" })] })] }), _jsx("p", { className: "text-sm text-gray-600 text-center", children: "Position the QR code within the yellow frame" }), _jsx(HiveButton, { className: "w-full", onClick: () => {
                                onScan('mock_qr_code_user_123');
                                onClose();
                            }, children: "Simulate Successful Scan" })] })) : (_jsxs("div", { className: "text-center py-8", children: [_jsx(Camera, { className: "w-12 h-12 text-gray-400 mx-auto mb-4 animate-pulse" }), _jsx("p", { className: "text-gray-600", children: "Starting camera..." })] }))] }) }));
};
