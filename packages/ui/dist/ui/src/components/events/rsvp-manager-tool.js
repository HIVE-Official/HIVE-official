...
export function RSVPManagerTool({ event, onUpdateEvent, onMessageAttendees, onExportRSVPs }) {
    ...
    if (loading) {
        return (_jsxs("div", { className: "p-8 text-center", children: [_jsx("div", { className: "w-8 h-8 bg-amber-500 rounded-lg animate-pulse mx-auto mb-4" }), _jsx("p", { className: "text-[var(--hive-text-muted)]", children: "Loading RSVPs..." })] }));
    }
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between mb-6", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900", children: "RSVP Manager" }), _jsx("p", { className: "text-[var(--hive-text-muted)]", children: "Manage event attendance and communicate with attendees" })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs(Button, { variant: "secondary", onClick: () => handleExport('csv'), children: [_jsx(Download, { className: "w-4 h-4 mr-2" }), "Export CSV"] }), _jsxs(Button, { variant: "secondary", onClick: handleBulkMessage, disabled: selectedRSVPs.length === 0, children: [_jsx(Mail, { className: "w-4 h-4 mr-2" }), "Message Selected (", selectedRSVPs.length, ")"] })] })] }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-6", children: [_jsxs(Card, { className: "p-4 text-center", children: [_jsx("div", { className: "text-2xl font-bold text-gray-900", children: stats.total }), _jsx("div", { className: "text-sm text-gray-500", children: "Total RSVPs" })] }), _jsxs(Card, { className: "p-4 text-center", children: [_jsx("div", { className: "text-2xl font-bold text-green-600", children: stats.yes }), _jsx("div", { className: "text-sm text-gray-500", children: "Going" })] }), _jsxs(Card, { className: "p-4 text-center", children: [_jsx("div", { className: "text-2xl font-bold text-yellow-600", children: stats.maybe }), _jsx("div", { className: "text-sm text-gray-500", children: "Maybe" })] }), _jsxs(Card, { className: "p-4 text-center", children: [_jsx("div", { className: "text-2xl font-bold text-red-600", children: stats.no }), _jsx("div", { className: "text-sm text-gray-500", children: "Not Going" })] }), _jsxs(Card, { className: "p-4 text-center", children: [_jsx("div", { className: "text-2xl font-bold text-blue-600", children: stats.checkedIn }), _jsx("div", { className: "text-sm text-gray-500", children: "Checked In" })] }), _jsxs(Card, { className: "p-4 text-center", children: [_jsx("div", { className: "text-2xl font-bold text-[var(--hive-text-muted)]", children: stats.noShow }), _jsx("div", { className: "text-sm text-gray-500", children: "No Shows" })] }), event.capacity && (_jsxs(Card, { className: "p-4 text-center", children: [_jsx("div", { className: "text-2xl font-bold text-purple-600", children: stats.waitlist }), _jsx("div", { className: "text-sm text-gray-500", children: "Waitlist" })] }))] }), event.capacity && stats.yes > event.capacity && (_jsx("div", { className: "mb-6 p-4 bg-orange-50 border border-orange-200 rounded-lg", children: _jsxs("div", { className: "flex items-start gap-2", children: [_jsx(AlertCircle, { className: "w-5 h-5 text-orange-500 mt-0.5" }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium text-orange-800", children: "Over Capacity" }), _jsxs("p", { className: "text-sm text-orange-700", children: ["You have ", stats.yes, " confirmed attendees for a capacity of ", event.capacity, ". Consider increasing capacity or managing the waitlist."] })] })] }) }))] }), _jsxs("div", { className: "flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between", children: [_jsxs("div", { className: "flex-1 relative max-w-md", children: [_jsx(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" }), _jsx("input", { type: "text", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: "Search attendees...", className: "w-full pl-10 pr-4 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500" })] }), _jsxs("div", { className: "flex gap-2", children: [_jsxs("select", { value: statusFilter, onChange: (e) => setStatusFilter(e.target.value), className: "px-3 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500", children: [_jsx("option", { value: "all", children: "All Status" }), _jsx("option", { value: "yes", children: "Going" }), _jsx("option", { value: "maybe", children: "Maybe" }), _jsx("option", { value: "no", children: "Not Going" })] }), _jsxs("select", { value: checkinFilter, onChange: (e) => setCheckinFilter(e.target.value), className: "px-3 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500", children: [_jsx("option", { value: "all", children: "All Attendees" }), _jsx("option", { value: "checked_in", children: "Checked In" }), _jsx("option", { value: "not_checked_in", children: "Not Checked In" })] })] })] }), _jsx(Card, { children: _jsx("div", { className: "divide-y divide-gray-100", children: filteredRSVPs.length === 0 ? (_jsxs("div", { className: "p-8 text-center", children: [_jsx(Users, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "No RSVPs Found" }), _jsx("p", { className: "text-gray-500", children: searchQuery ? 'No attendees match your search.' : 'No one has RSVP\'d to this event yet.' })] })) : (_jsxs(_Fragment, { children: [selectedRSVPs.length > 0 && (_jsx("div", { className: "p-4 bg-amber-50 border-b border-amber-200", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("p", { className: "text-sm font-medium text-amber-800", children: [selectedRSVPs.length, " attendee", selectedRSVPs.length > 1 ? 's' : '', " selected"] }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(Button, { size: "sm", variant: "secondary", onClick: handleBulkMessage, children: [_jsx(Mail, { className: "w-3 h-3 mr-1" }), "Message"] }), _jsx(Button, { size: "sm", variant: "secondary", onClick: () => setSelectedRSVPs([]), children: "Clear" })] })] }) })), filteredRSVPs.map((rsvp) => (_jsx(AttendeeRow, { rsvp: rsvp, onUpdateStatus: handleUpdateRSVPStatus, onToggleCheckin: handleToggleCheckin, onMessage: handleMessageAttendee }, rsvp.id)))] })) }) }), _jsxs("div", { className: "text-sm text-gray-500 text-center", children: ["Showing ", filteredRSVPs.length, " of ", stats.total, " RSVPs", event.capacity && (_jsxs("span", { children: [" \u2022 Capacity: ", stats.yes, "/", event.capacity] }))] })] }));
}
