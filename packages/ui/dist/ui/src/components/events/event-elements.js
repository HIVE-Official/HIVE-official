...
export function DatePickerElement({ id, label, value, onChange, minDate, maxDate, includeTime = true, required, disabled, className }) {
    ...
    return (_jsxs("div", { className: cn("space-y-2", className), children: [label && (_jsxs("label", { htmlFor: id, className: "block text-sm font-medium text-gray-900", children: [label, " ", required && _jsx("span", { className: "text-red-500", children: "*" })] })), _jsxs("div", { className: "relative", children: [_jsx("input", { id: id, type: includeTime ? "datetime-local" : "date", value: formatDateForInput(value), onChange: (e) => onChange?.(new Date(e.target.value)), min: minDate ? formatDateForInput(minDate) : undefined, max: maxDate ? formatDateForInput(maxDate) : undefined, required: required, disabled: disabled, className: "w-full p-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500" }), _jsx(Calendar, { className: "absolute right-3 top-2.5 w-4 h-4 text-gray-400 pointer-events-none" })] })] }));
}
export function LocationElement({ id, label = "Event Location", value = { type: 'on_campus' }, onChange, allowedTypes = ['on_campus', 'off_campus', 'virtual', 'hybrid'], required, disabled, className }) {
    ...
    return (_jsxs("div", { className: cn("space-y-4", className), children: [label && (_jsxs("label", { className: "block text-sm font-medium text-gray-900", children: [label, " ", required && _jsx("span", { className: "text-red-500", children: "*" })] })), _jsxs("select", { value: location.type, onChange: (e) => updateLocation({ type: e.target.value }), disabled: disabled, className: "w-full p-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500", children: [allowedTypes.includes('on_campus') && _jsx("option", { value: "on_campus", children: "On Campus" }), allowedTypes.includes('off_campus') && _jsx("option", { value: "off_campus", children: "Off Campus" }), allowedTypes.includes('virtual') && _jsx("option", { value: "virtual", children: "Virtual" }), allowedTypes.includes('hybrid') && _jsx("option", { value: "hybrid", children: "Hybrid" })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3", children: [_jsx(Input, { value: location.venue || '', onChange: (e) => updateLocation({ venue: e.target.value }), placeholder: "Venue name...", disabled: disabled }), _jsx(Input, { value: location.room || '', onChange: (e) => updateLocation({ room: e.target.value }), placeholder: location.type === 'virtual' ? 'Meeting link...' : 'Room/Address...', disabled: disabled })] })] }));
}
export function SelectElement({ id, label, value, onChange, options, placeholder = "Select an option...", required, disabled, className }) {
    return (_jsxs("div", { className: cn("space-y-2", className), children: [label && (_jsxs("label", { htmlFor: id, className: "block text-sm font-medium text-gray-900", children: [label, " ", required && _jsx("span", { className: "text-red-500", children: "*" })] })), _jsxs("select", { id: id, value: value || '', onChange: (e) => onChange?.(e.target.value), required: required, disabled: disabled, className: "w-full p-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500", children: [_jsx("option", { value: "", children: placeholder }), options.map((option) => (_jsx("option", { value: option.value, children: option.label }, option.value)))] }), value && options.find(o => o.value === value)?.description && (_jsx("p", { className: "text-xs text-gray-500", children: options.find(o => o.value === value)?.description }))] }));
}
export function NumberInputElement({ id, label, value, onChange, min, max, step = 1, placeholder, required, disabled, className }) {
    return (_jsxs("div", { className: cn("space-y-2", className), children: [label && (_jsxs("label", { htmlFor: id, className: "block text-sm font-medium text-gray-900", children: [label, " ", required && _jsx("span", { className: "text-red-500", children: "*" })] })), _jsx(Input, { id: id, type: "number", value: value || '', onChange: (e) => onChange?.(parseInt(e.target.value) || undefined), min: min, max: max, step: step, placeholder: placeholder, required: required, disabled: disabled })] }));
}
export function CheckboxElement({ id, label, value = false, onChange, description, disabled, className }) {
    return (_jsx("div", { className: cn("space-y-1", className), children: _jsxs("label", { htmlFor: id, className: "flex items-start gap-2 cursor-pointer", children: [_jsx("input", { id: id, type: "checkbox", checked: value, onChange: (e) => onChange?.(e.target.checked), disabled: disabled, className: "mt-0.5 rounded border-[var(--hive-border-default)] focus:ring-amber-500" }), _jsxs("div", { children: [label && _jsx("span", { className: "text-sm font-medium text-gray-900", children: label }), description && _jsx("p", { className: "text-xs text-gray-500", children: description })] })] }) }));
}
export function RadioElement({ id, label, value, onChange, options, disabled, className }) {
    return (_jsxs("div", { className: cn("space-y-3", className), children: [label && (_jsx("label", { className: "block text-sm font-medium text-gray-900", children: label })), _jsx("div", { className: "space-y-2", children: options.map((option) => (_jsxs("label", { className: "flex items-start gap-2 cursor-pointer", children: [_jsx("input", { type: "radio", name: id, value: option.value, checked: value === option.value, onChange: (e) => onChange?.(e.target.value), disabled: disabled, className: "mt-0.5 border-[var(--hive-border-default)] focus:ring-amber-500" }), _jsxs("div", { children: [_jsx("span", { className: "text-sm font-medium text-gray-900", children: option.label }), option.description && (_jsx("p", { className: "text-xs text-gray-500", children: option.description }))] })] }, option.value))) })] }));
}
export function EventCardElement({ event, showActions = true, onRSVP, onEdit, className }) {
    ...
    return (_jsxs(Card, { className: cn("p-4", className), children: [_jsxs("div", { className: "flex items-start justify-between mb-3", children: [_jsxs("div", { className: "flex-1", children: [_jsx("h3", { className: "font-semibold text-gray-900 mb-1", children: event.title }), _jsxs("div", { className: "flex items-center gap-2 text-sm text-[var(--hive-text-muted)]", children: [_jsx(Calendar, { className: "w-4 h-4" }), _jsx("span", { children: formatDate(event.startDate) })] })] }), event.status && (_jsx(Badge, { variant: event.status === 'published' ? 'secondary' : 'outline', children: event.status }))] }), event.location && (_jsxs("div", { className: "flex items-center gap-2 text-sm text-[var(--hive-text-muted)] mb-3", children: [_jsx(MapPin, { className: "w-4 h-4" }), _jsx("span", { children: event.location.venue || event.location.type })] })), (event.capacity || event.rsvpCount !== undefined) && (_jsxs("div", { className: "flex items-center gap-2 text-sm text-[var(--hive-text-muted)] mb-3", children: [_jsx(Users, { className: "w-4 h-4" }), _jsxs("span", { children: [event.rsvpCount || 0, event.capacity && ` / ${event.capacity}`, " attendees"] })] })), showActions && (_jsxs("div", { className: "flex gap-2 pt-3 border-t", children: [onRSVP && (_jsx(Button, { size: "sm", onClick: onRSVP, children: "RSVP" })), onEdit && (_jsx(Button, { variant: "secondary", size: "sm", onClick: onEdit, children: "Edit" }))] }))] }));
}
export function CounterElement({ label, current, total, icon: Icon = Users, color = 'default', className }) {
    const colorClasses = {
        default: 'text-[var(--hive-text-muted)]',
...
export function QRCodeElement({ label, data, size = 200, onScan, className }) {
    ...
    return (_jsxs("div", { className: cn("text-center space-y-3", className), children: [label && _jsx("p", { className: "font-medium text-gray-900", children: label }), _jsx("div", { className: "mx-auto bg-[var(--hive-background-secondary)] border-2 border-dashed border-[var(--hive-border-default)] rounded-lg flex items-center justify-center", style: { width: size, height: size }, children: _jsxs("div", { className: "text-center", children: [_jsx(QrCode, { className: "w-8 h-8 text-gray-400 mx-auto mb-2" }), _jsx("p", { className: "text-xs text-gray-500", children: "QR Code" }), _jsx("p", { className: "text-xs text-gray-400 mt-1 break-all px-2", children: data })] }) }), onScan && (_jsx(Button, { size: "sm", onClick: () => onScan(data), children: "Scan Code" }))] }));
}
...
export function FilterElement({ filters, onFiltersChange, className }) {
    return (_jsxs(Card, { className: cn("p-4 space-y-4", className), children: [_jsx("h3", { className: "font-semibold text-gray-900", children: "Filter Events" }), _jsx(SelectElement, { id: "category-filter", label: "Category", value: filters.categories?.[0] || '', onChange: (category) => onFiltersChange?.({
                    ...filters,
...
export function AttendeeListElement({ attendees, showCheckIn = false, onCheckIn, className }) {
    ...
    return (_jsxs(Card, { className: cn("p-4 space-y-4", className), children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "font-semibold text-gray-900", children: "Attendees" }), _jsxs("div", { className: "flex items-center gap-4 text-sm text-[var(--hive-text-muted)]", children: [_jsxs("span", { children: [confirmedAttendees.length, " confirmed"] }), showCheckIn && _jsxs("span", { children: [checkedInCount, " checked in"] })] })] }), _jsx("div", { className: "space-y-2 max-h-64 overflow-y-auto", children: attendees.map((attendee) => (_jsxs("div", { className: "flex items-center justify-between p-2 border border-gray-200 rounded-lg", children: [_jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "font-medium text-gray-900", children: attendee.name }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)]", children: attendee.email }), attendee.guestCount && attendee.guestCount > 0 && (_jsxs("p", { className: "text-xs text-gray-500", children: ["+", attendee.guestCount, " guests"] }))] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Badge, { variant: attendee.status === 'confirmed' ? 'secondary' : 'outline', children: attendee.status }), showCheckIn && attendee.status === 'confirmed' && (attendee.checkedIn ? (_jsx(Badge, { variant: "secondary", className: "bg-green-100 text-green-800", children: "\u2713 Checked In" })) : (_jsx(Button, { size: "sm", onClick: () => onCheckIn?.(attendee.id), children: "Check In" })))] })] }, attendee.id))) })] }));
}
...
export function NotificationElement({ notifications, onMarkRead, onMarkAllRead, className }) {
    ...
    return (_jsxs(Card, { className: cn("p-4", className), children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("h3", { className: "font-semibold text-gray-900", children: "Notifications" }), unreadCount > 0 && (_jsxs(Badge, { className: "bg-red-100 text-red-800", children: [unreadCount, " new"] }))] }), unreadCount > 0 && (_jsx(Button, { variant: "secondary", size: "sm", onClick: onMarkAllRead, children: "Mark All Read" }))] }), _jsx("div", { className: "space-y-3 max-h-80 overflow-y-auto", children: notifications.length === 0 ? (_jsx("p", { className: "text-sm text-gray-500 text-center py-4", children: "No notifications" })) : (notifications.map((notification) => {
                    const Icon = getNotificationIcon(notification.type);
                    return (_jsx("div", { className: cn("p-3 border rounded-lg cursor-pointer transition-colors", notification.read
                            ? "border-gray-200 bg-white"
                            : "border-amber-200 bg-amber-50"), onClick: () => onMarkRead?.(notification.id), children: _jsxs("div", { className: "flex gap-3", children: [_jsx(Icon, { className: "w-5 h-5 text-[var(--hive-text-muted)] mt-0.5 flex-shrink-0" }), _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-start justify-between", children: [_jsx("h4", { className: "font-medium text-gray-900", children: notification.title }), _jsx("span", { className: "text-xs text-gray-500", children: notification.timestamp.toLocaleDateString() })] }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)] mt-1", children: notification.message })] })] }) }, notification.id));
                })) })] }));
}
export function AnalyticsChartElement({ data, title = "Analytics", type = 'bar', className }) {
    const maxValue = Math.max(...data.map(d => d.value));
    return (_jsxs(Card, { className: cn("p-4", className), children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h3", { className: "font-semibold text-gray-900", children: title }), _jsx(TrendingUp, { className: "w-5 h-5 text-[var(--hive-text-muted)]" })] }), type === 'bar' && (_jsx("div", { className: "space-y-3", children: data.map((item, index) => (_jsxs("div", { className: "space-y-1", children: [_jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-gray-700", children: item.label }), _jsx("span", { className: "font-medium text-gray-900", children: item.value })] }), _jsx("div", { className: "w-full bg-gray-200 rounded-full h-2", children: _jsx("div", { className: "bg-amber-500 h-2 rounded-full transition-all duration-300", style: { width: `${(item.value / maxValue) * 100}%` } }) })] }, index))) })), type === 'line' && (_jsx("div", { className: "h-32 flex items-end justify-between border-b border-gray-200", children: data.map((item, index) => (_jsxs("div", { className: "flex flex-col items-center space-y-2", children: [_jsx("div", { className: "w-3 bg-amber-500 rounded-t", style: { height: `${(item.value / maxValue) * 100}%` } }), _jsx("span", { className: "text-xs text-[var(--hive-text-muted)] -rotate-45 transform origin-left", children: item.label })] }, index))) }))] }));
}
export function FeedbackFormElement({ eventId, questions = [
    ...
    return (_jsxs(Card, { className: cn("p-4 space-y-4", className), children: [_jsx("h3", { className: "font-semibold text-gray-900", children: "Event Feedback" }), questions.map((question) => (_jsxs("div", { className: "space-y-2", children: [_jsxs("label", { className: "block text-sm font-medium text-gray-900", children: [question.question, question.required && _jsx("span", { className: "text-red-500 ml-1", children: "*" })] }), question.type === 'rating' && (_jsx("div", { className: "flex gap-1", children: [1, 2, 3, 4, 5].map((rating) => (_jsx("button", { onClick: () => updateResponse(question.id, rating), className: cn("p-1 transition-colors", responses[question.id] >= rating
                                ? "text-yellow-400"
                                : "text-gray-300 hover:text-yellow-300"), children: _jsx(Star, { className: "w-6 h-6 fill-current" }) }, rating))) })), question.type === 'text' && (_jsx(Textarea, { value: responses[question.id] || '', onChange: (e) => updateResponse(question.id, e.target.value), placeholder: "Share your thoughts...", rows: 3 })), question.type === 'select' && question.options && (_jsxs("select", { value: responses[question.id] || '', onChange: (e) => updateResponse(question.id, e.target.value), className: "w-full p-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500", children: [_jsx("option", { value: "", children: "Select an option..." }), question.options.map((option) => (_jsx("option", { value: option, children: option }, option)))] }))] }, question.id))), _jsx(Button, { onClick: handleSubmit, className: "w-full", children: "Submit Feedback" })] }));
}
export function ShareElement({ eventId, eventTitle, shareUrl = window.location.href, onShare, className }) {
    ...
    return (_jsxs(Card, { className: cn("p-4", className), children: [_jsx("h3", { className: "font-semibold text-gray-900 mb-3", children: "Share Event" }), _jsx("div", { className: "grid grid-cols-2 gap-2", children: shareOptions.map((option) => (_jsx(Button, { variant: "secondary", size: "sm", onClick: option.action, className: "justify-center", children: option.label }, option.platform))) })] }));
}
export function RecurrenceElement({ recurrence, onRecurrenceChange, className }) {
    ...
    return (_jsxs(Card, { className: cn("p-4 space-y-4", className), children: [_jsx("h3", { className: "font-semibold text-gray-900", children: "Event Recurrence" }), _jsx(SelectElement, { id: "recurrence-type", label: "Repeat", value: recurrence.type, onChange: (type) => updateRecurrence({ type }), options: [
...
export function TagsElement({ tags, availableTags = ['academic', 'social', 'professional', 'wellness', 'cultural', 'service', 'sports'], onTagsChange, maxTags = 5, className }) {
    ...
    return (_jsxs("div", { className: cn("space-y-3", className), children: [_jsxs("label", { className: "block text-sm font-medium text-gray-900", children: ["Tags (", tags.length, "/", maxTags, ")"] }), _jsx("div", { className: "flex flex-wrap gap-2", children: tags.map((tag) => (_jsxs(Badge, { variant: "secondary", className: "cursor-pointer hover:bg-red-100 hover:text-red-800", onClick: () => removeTag(tag), children: [tag, " \u00D7"] }, tag))) }), _jsx(Input, { value: inputValue, onChange: (e) => setInputValue(e.target.value), onKeyDown: handleKeyDown, placeholder: "Add a tag...", disabled: tags.length >= maxTags }), availableTags.length > 0 && (_jsxs("div", { className: "space-y-2", children: [_jsx("p", { className: "text-sm text-[var(--hive-text-muted)]", children: "Suggested tags:" }), _jsx("div", { className: "flex flex-wrap gap-2", children: availableTags
                            .filter(tag => !tags.includes(tag))
                            .slice(0, 8)
                            .map((tag) => (_jsxs(Badge, { variant: "secondary", className: "cursor-pointer hover:bg-amber-50", onClick: () => addTag(tag), children: ["+ ", tag] }, tag))) })] }))] }));
}
export function StatusElement({ status, statusHistory = [], onStatusChange, className }) {
    const [reason, setReason] = useState('');
    const [showReasonInput, setShowReasonInput] = useState(false);
    const statusConfig = {
        draft: { color: 'bg-[var(--hive-background-secondary)] text-gray-800', label: 'Draft' },
    ...
    return (_jsxs(Card, { className: cn("p-4 space-y-4", className), children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "font-semibold text-gray-900", children: "Event Status" }), _jsx(Badge, { className: statusConfig[status].color, children: statusConfig[status].label })] }), _jsxs("div", { className: "space-y-2", children: [_jsx("label", { className: "block text-sm font-medium text-gray-900", children: "Change Status" }), _jsxs("select", { value: status, onChange: (e) => handleStatusChange(e.target.value), className: "w-full p-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500", children: [_jsx("option", { value: "draft", children: "Draft" }), _jsx("option", { value: "published", children: "Published" }), _jsx("option", { value: "cancelled", children: "Cancelled" }), _jsx("option", { value: "completed", children: "Completed" })] }), showReasonInput && (_jsxs("div", { className: "space-y-2", children: [_jsx(Textarea, { value: reason, onChange: (e) => setReason(e.target.value), placeholder: "Reason for cancellation...", rows: 2 }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { size: "sm", onClick: submitStatusChange, children: "Confirm" }), _jsx(Button, { variant: "secondary", size: "sm", onClick: () => setShowReasonInput(false), children: "Cancel" })] })] }))] }), statusHistory.length > 0 && (_jsxs("div", { className: "space-y-2", children: [_jsx("h4", { className: "text-sm font-medium text-gray-900", children: "Status History" }), _jsx("div", { className: "space-y-2 max-h-32 overflow-y-auto", children: statusHistory.map((entry, index) => (_jsxs("div", { className: "text-sm text-[var(--hive-text-muted)] p-2 bg-gray-50 rounded", children: [_jsxs("div", { className: "flex justify-between", children: [_jsx("span", { className: "font-medium", children: entry.status }), _jsx("span", { children: entry.timestamp.toLocaleDateString() })] }), _jsxs("p", { children: ["Changed by ", entry.changedBy] }), entry.reason && _jsxs("p", { className: "text-xs", children: ["Reason: ", entry.reason] })] }, index))) })] }))] }));
}
