...
export function EventCreatorToolV2({ spaceId, onEventCreated, onCancel, initialEvent }) {
    ...
    return (_jsxs("div", { className: "max-w-4xl mx-auto p-6", children: [_jsxs("div", { className: "mb-8", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-2", children: "Create Event" }), _jsxs("p", { className: "text-gray-600", children: ["Built with ", _jsxs("span", { className: "font-medium text-amber-600", children: [steps.reduce((acc, step) => {
                                        if (step.id === 'basic')
                                            return acc + 4;
                                        if (step.id === 'datetime')
                                            return acc + 4;
