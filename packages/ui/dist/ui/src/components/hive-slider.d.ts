...
declare const HiveVolumeSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "max" | "min" | "label" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
declare const HiveBrightnessSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "max" | "min" | "label" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
declare const HiveProgressSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "max" | "min" | "label" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
declare const HivePriceRangeSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "max" | "min" | "label" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
declare const HiveTemperatureSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "max" | "min" | "label" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
