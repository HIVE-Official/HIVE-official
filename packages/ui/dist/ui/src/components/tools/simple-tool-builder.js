...
export function ToolTemplateSelection({ templates, onSelectTemplate }) {
    ...
    return (_jsxs("div", { className: "space-y-8", children: [_jsxs("div", { className: "text-center", children: [_jsx(Text, { variant: "heading-lg", weight: "semibold", className: "mb-2", children: "Choose Your Tool Template" }), _jsx(Text, { variant: "body-md", color: "secondary", children: "Select from UB-optimized templates designed for campus life" })] }), Object.entries(categorizedTemplates).map(([category, categoryTemplates]) => (_jsxs("div", { children: [_jsxs(Text, { variant: "heading-md", weight: "semibold", className: "mb-4 capitalize", children: [category.replace('-', ' '), " Tools"] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: categoryTemplates.map((template) => (_jsx(ToolTemplateCard, { template: template, onSelect: () => onSelectTemplate(template) }, template.id))) })] }, category)))] }));
}
