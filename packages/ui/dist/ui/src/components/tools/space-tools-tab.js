...
function InstalledToolCard({ tool, userRole, onLaunch, onToggle }) {
    ...
    return (_jsx(Card, { className: "p-4 hover:shadow-md transition-shadow", children: _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [_jsx("h3", { className: "font-semibold text-gray-900 truncate", children: tool.name }), !tool.settings.enabled && (_jsx(Badge, { variant: "secondary", className: "text-xs", children: "Disabled" }))] }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)] line-clamp-2", children: tool.description })] }), canManage && (_jsx("button", { className: "p-1 text-gray-400 hover:text-[var(--hive-text-muted)]", children: _jsx(MoreVertical, { className: "w-4 h-4" }) }))] }), _jsxs("div", { className: "flex items-center gap-4 text-sm text-[var(--hive-text-muted)]", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Users, { className: "w-4 h-4" }), _jsxs("span", { children: [tool.usage.totalUsers, " users"] })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(TrendingUp, { className: "w-4 h-4" }), _jsxs("span", { children: [tool.usage.thisWeek, " this week"] })] })] }), tool.usage.lastUsed && (_jsxs("p", { className: "text-xs text-gray-500", children: ["Last used ", new Date(tool.usage.lastUsed).toLocaleDateString()] })), _jsxs("div", { className: "flex gap-2 pt-2 border-t border-gray-100", children: [_jsxs(Button, { size: "sm", onClick: onLaunch, disabled: !tool.settings.enabled, className: "flex-1", children: [_jsx(Play, { className: "w-4 h-4 mr-1" }), "Launch"] }), canManage && (_jsx(Button, { variant: "secondary", size: "sm", onClick: () => onToggle(!tool.settings.enabled), children: tool.settings.enabled ? 'Disable' : 'Enable' }))] })] }) }));
}
