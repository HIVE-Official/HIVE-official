...
export function MobileToolWrapper({ children, toolName, onBack, showMobileMenu = false, className }) {
    ...
    return (_jsxs("div", { className: cn("relative", mobileClasses.container, isFullscreen && "fixed inset-0 z-50 bg-white", className), children: [isMobile && (_jsxs("div", { className: mobileClasses.header, children: [_jsxs("div", { className: "flex items-center justify-between p-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [onBack && (_jsx(Button, { variant: "ghost", size: "sm", onClick: onBack, className: "p-2", children: _jsx(ChevronLeft, { className: "w-5 h-5" }) })), _jsx("h1", { className: "font-semibold text-gray-900 truncate", children: toolName })] }), _jsxs("div", { className: "flex items-center gap-2", children: [showMobileMenu && (_jsx(Button, { variant: "ghost", size: "sm", onClick: () => setShowMenu(!showMenu), className: "p-2", children: showMenu ? _jsx(X, { className: "w-5 h-5" }) : _jsx(Menu, { className: "w-5 h-5" }) })), _jsx(Button, { variant: "ghost", size: "sm", onClick: () => setIsFullscreen(!isFullscreen), className: "p-2", children: isFullscreen ? _jsx(Minimize2, { className: "w-5 h-5" }) : _jsx(Maximize2, { className: "w-5 h-5" }) })] })] }), showMenu && (_jsx("div", { className: "absolute top-full left-0 right-0 bg-white border-b border-gray-200 shadow-lg", children: _jsxs("div", { className: "p-4 space-y-2", children: [_jsx(Button, { variant: "ghost", className: "w-full justify-start", children: "Save Progress" }), _jsx(Button, { variant: "ghost", className: "w-full justify-start", children: "Share Tool" }), _jsx(Button, { variant: "ghost", className: "w-full justify-start", children: "Help & Tips" })] }) }))] })), _jsx("div", { className: cn(mobileClasses.content, "space-y-4"), children: _jsx(MobileOptimizedContent, { isMobile: isMobile, children: children }) }), isMobile && (_jsx("div", { className: "fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4", children: _jsxs("div", { className: "flex gap-3", children: [_jsx(Button, { className: "flex-1 h-12", children: "Save" }), _jsx(Button, { variant: "secondary", className: "flex-1 h-12", children: "Submit" })] }) }))] }));
}
