...
export function ToolMarketplace({ spaceId, userId, onInstallTool, onViewTool, className }) {
    ...
    return (_jsxs("div", { className: cn("space-y-6", className), children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "Tool Marketplace" }), _jsx("p", { className: "text-[var(--hive-text-muted)]", children: "Discover and install tools built by the HIVE community" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsxs(Badge, { variant: "secondary", children: [filteredTools.length, " tools available"] }), spaceId && (_jsx(Badge, { children: "Installing for Space" }))] })] }), _jsxs("div", { className: "flex flex-col lg:flex-row gap-4", children: [_jsxs("div", { className: "flex-1 relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" }), _jsx(Input, { value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: "Search tools, creators, or categories...", className: "pl-10" })] }), _jsxs("select", { value: selectedCategory, onChange: (e) => setSelectedCategory(e.target.value), className: "px-3 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500", children: [_jsx("option", { value: "all", children: "All Categories" }), _jsx("option", { value: "event", children: "Event Management" }), _jsx("option", { value: "academic", children: "Academic" }), _jsx("option", { value: "social", children: "Social" }), _jsx("option", { value: "productivity", children: "Productivity" }), _jsx("option", { value: "wellness", children: "Wellness" })] }), _jsxs("select", { value: sortBy, onChange: (e) => setSortBy(e.target.value), className: "px-3 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500", children: [_jsx("option", { value: "popular", children: "Most Popular" }), _jsx("option", { value: "rating", children: "Highest Rated" }), _jsx("option", { value: "recent", children: "Recently Updated" }), _jsx("option", { value: "name", children: "Name A-Z" })] })] }), searchQuery === '' && selectedCategory === 'all' && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(TrendingUp, { className: "w-5 h-5 text-amber-600" }), _jsx("h2", { className: "text-xl font-semibold text-gray-900", children: "Trending Tools" })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: filteredTools
                            .filter(tool => tool.stats.trending)
                            .slice(0, 4)
                            .map(tool => (_jsx(ToolCard, { tool: tool, compact: true, onInstall: () => handleInstallTool(tool.id), onView: () => onViewTool?.(tool.id), installing: installingTools.has(tool.id) }, `trending-${tool.id}`))) })] })), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h2", { className: "text-xl font-semibold text-gray-900", children: searchQuery || selectedCategory !== 'all' ? 'Search Results' : 'All Tools' }), _jsxs("div", { className: "text-sm text-gray-500", children: [filteredTools.length, " tools found"] })] }), filteredTools.length === 0 ? (_jsxs("div", { className: "text-center py-12", children: [_jsx("div", { className: "w-16 h-16 bg-[var(--hive-background-secondary)] rounded-full flex items-center justify-center mx-auto mb-4", children: _jsx(Search, { className: "w-8 h-8 text-gray-400" }) }), _jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "No tools found" }), _jsx("p", { className: "text-[var(--hive-text-muted)] mb-4", children: "Try adjusting your search terms or filters" }), _jsx(Button, { variant: "secondary", onClick: () => {
                                    setSearchQuery('');
...
function ToolCard({ tool, compact = false, onInstall, onView, installing }) {
    return (_jsx(Card, { className: cn("p-4 hover:shadow-md transition-shadow", compact && "p-3"), children: _jsxs("div", { className: "space-y-3", children: [_jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("h3", { className: cn("font-semibold text-gray-900 truncate", compact ? "text-sm" : "text-lg"), children: tool.name }), _jsxs("p", { className: cn("text-[var(--hive-text-muted)] truncate", compact ? "text-xs" : "text-sm"), children: ["by ", tool.creator.name, tool.creator.verified && _jsx("span", { className: "text-blue-500 ml-1", children: "\u2713" })] })] }), tool.stats.trending && !compact && (_jsxs(Badge, { variant: "secondary", className: "text-xs", children: [_jsx(TrendingUp, { className: "w-3 h-3 mr-1" }), "Trending"] }))] }), !compact && (_jsx("p", { className: "text-sm text-[var(--hive-text-muted)] line-clamp-2", children: tool.description })), _jsx("div", { className: "flex flex-wrap gap-1", children: tool.categories.slice(0, compact ? 2 : 3).map(category => (_jsx(Badge, { variant: "secondary", className: "text-xs", children: category }, category))) }), _jsxs("div", { className: "flex items-center gap-4 text-sm text-[var(--hive-text-muted)]", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Download, { className: "w-4 h-4" }), _jsx("span", { children: tool.stats.installations.toLocaleString() })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Star, { className: "w-4 h-4 fill-current text-yellow-400" }), _jsx("span", { children: tool.stats.rating.toFixed(1) })] }), !compact && (_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Users, { className: "w-4 h-4" }), _jsx("span", { children: tool.stats.reviews })] }))] }), _jsxs("div", { className: "flex gap-2 pt-2", children: [tool.isInstalled ? (_jsx(Badge, { className: "flex-1 justify-center", children: "\u2713 Installed" })) : (_jsx(Button, { size: "sm", onClick: onInstall, disabled: installing, className: "flex-1", children: installing ? 'Installing...' : 'Install' })), _jsx(Button, { variant: "secondary", size: "sm", onClick: onView, children: _jsx(Eye, { className: "w-4 h-4" }) })] })] }) }));
}
