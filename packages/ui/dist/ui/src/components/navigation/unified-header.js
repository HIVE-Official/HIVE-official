...
export function SchoolsPageHeader({ onComingSoonClick }) {
    return (_jsx(UnifiedHeader, { variant: "schools", rightAction: _jsx(Button, { variant: "secondary", size: "default", onClick: onComingSoonClick, children: "What's Coming" }) }));
}
