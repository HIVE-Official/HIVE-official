...
export function PersonalTools({ data, isLoading = false, onToolAction, onAddTool, className = "" }) {
    ...
    if (!data) {
        return (_jsx("div", { className: "flex items-center justify-center h-96", children: _jsxs("div", { className: "text-center", children: [_jsx("p", { className: "text-lg text-[var(--hive-text-muted)] mb-4", children: "Unable to load personal tools" }), _jsx(Button, { onClick: () => window.location.reload(), children: "Try Again" })] }) }));
    }
    const categories = [
...
function QuickStatCard({ label, value, icon, color }) {
    ...
    return (_jsxs("div", { className: "text-center", children: [_jsx("div", { className: `inline-flex items-center justify-center w-8 h-8 rounded-lg ${colorClasses[color]} mb-2`, children: icon }), _jsx("div", { className: "text-lg font-bold text-gray-900", children: value }), _jsx("div", { className: "text-xs text-[var(--hive-text-muted)]", children: label })] }));
}
// Loading Skeleton
