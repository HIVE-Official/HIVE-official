    ...
    return (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: {
        ...
        'p-6', className), children: [_jsxs("div", { className: "absolute inset-0 opacity-5", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-gold/10 via-transparent to-transparent" }), _jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-gradient-radial from-gold/20 to-transparent rounded-full blur-xl" }), _jsx("div", { className: "absolute bottom-0 left-0 w-24 h-24 bg-gradient-radial from-platinum/10 to-transparent rounded-full blur-lg" })] }), _jsxs("div", { className: "relative z-10 mb-6", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-8 h-8 rounded-xl bg-gradient-to-br from-gold/20 to-champagne/10 border border-gold/20 flex items-center justify-center", children: _jsx("span", { className: "text-gold text-lg", children: "\uD83C\uDFDB\uFE0F" }) }), _jsx("h3", { className: "text-platinum font-bold text-xl tracking-tight", children: "Your Campus Spaces" })] }), showQuickActions && onViewAll && (_jsx(motion.button, { whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, onClick: onViewAll, className: "text-gold hover:text-champagne transition-colors duration-200 text-sm font-medium", children: "View All" }))] }), _jsxs("p", { className: "text-mercury text-sm", children: [spaces.length, " space", spaces.length !== 1 ? 's' : '', " joined"] })] }), _jsxs("div", { className: "relative z-10 space-y-3", children: [_jsx(AnimatePresence, { children: displayedSpaces.map((space, index) => (_jsxs(motion.div, { initial: { opacity: 0, x: -20 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: 20 }, transition: {
                                ...
                                ease: [0.23, 1, 0.32, 1]
                                                            ...
                                                            }, className: "p-1.5 rounded-lg bg-charcoal/60 border border-steel/20 hover:border-gold/30 hover:bg-gold/10 transition-all duration-200 group/btn", title: "Quick Post", children: _jsx(MessageSquare, { className: "w-3 h-3 text-mercury group-hover/btn:text-gold" }) }), _jsx("button", { onClick: (e) => {
                                                                e.stopPropagation();
                                                                onPinSpace?.(space.id, !space.isPinned);
                                                            }, className: "p-1.5 rounded-lg bg-charcoal/60 border border-steel/20 hover:border-gold/30 hover:bg-gold/10 transition-all duration-200 group/btn", title: space.isPinned ? "Unpin Space" : "Pin Space", children: space.isPinned ? (_jsx(PinOff, { className: "w-3 h-3 text-gold group-hover/btn:text-champagne" })) : (_jsx(Pin, { className: "w-3 h-3 text-mercury group-hover/btn:text-gold" })) }), _jsx("button", { onClick: (e) => {
                                                                e.stopPropagation();
                                                                onMuteSpace?.(space.id, !space.isMuted);
                                                            }, className: "p-1.5 rounded-lg bg-charcoal/60 border border-steel/20 hover:border-gold/30 hover:bg-gold/10 transition-all duration-200 group/btn", title: space.isMuted ? "Unmute Space" : "Mute Space", children: space.isMuted ? (_jsx(BellOff, { className: "w-3 h-3 text-steel/60 group-hover/btn:text-mercury" })) : (_jsx(Bell, { className: "w-3 h-3 text-mercury group-hover/btn:text-gold" })) }), space.userRole === 'member' && (_jsx("button", { onClick: (e) => {
                                                                e.stopPropagation();
                                                        ...
                                                        }, placeholder: `Post to ${space.name}...`, className: "flex-1 px-3 py-1.5 bg-charcoal/40 border border-steel/20 rounded-lg text-platinum text-sm placeholder-mercury/60 focus:border-gold/30 focus:outline-none transition-colors", autoFocus: true }), _jsx("button", { onClick: () => handleQuickPost(space.id), disabled: !quickPostMessage.trim(), className: "p-1.5 rounded-lg bg-gold/20 border border-gold/30 text-gold hover:bg-gold/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200", children: _jsx(Send, { className: "w-3 h-3" }) }), _jsx("button", { onClick: () => {
                                                            setShowQuickPostFor(null);
                                                            setQuickPostMessage('');
