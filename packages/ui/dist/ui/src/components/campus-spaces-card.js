...
export const CampusSpacesCard = ({ spaces, isLoading = false, variant = 'default', showQuickActions = true, onSpaceClick, onJoinSpace, onViewAll, onMuteSpace, onPinSpace, onLeaveSpace, onQuickPost, className }) => {
    ...
    return (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: {
        ...
        'p-6', className), children: [_jsxs("div", { className: "absolute inset-0 opacity-5", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-gold/10 via-transparent to-transparent" }), _jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-gradient-radial from-gold/20 to-transparent rounded-full blur-xl" }), _jsx("div", { className: "absolute bottom-0 left-0 w-24 h-24 bg-gradient-radial from-platinum/10 to-transparent rounded-full blur-lg" })] }), _jsxs("div", { className: "relative z-10 mb-6", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-8 h-8 rounded-xl bg-gradient-to-br from-gold/20 to-champagne/10 border border-[var(--hive-brand-secondary)]/20 flex items-center justify-center", children: _jsx("span", { className: "text-[var(--hive-brand-secondary)] text-lg", children: "\uD83C\uDFDB\uFE0F" }) }), _jsx("h3", { className: "text-platinum font-bold text-xl tracking-tight", children: "Your Campus Spaces" })] }), showQuickActions && onViewAll && (_jsx(motion.button, { whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, onClick: onViewAll, className: "text-[var(--hive-brand-secondary)] hover:text-champagne transition-colors duration-200 text-sm font-medium", children: "View All" }))] }), _jsxs("p", { className: "text-mercury text-sm", children: [spaces.length, " space", spaces.length !== 1 ? 's' : '', " joined"] })] }), _jsxs("div", { className: "relative z-10 space-y-3", children: [_jsx(AnimatePresence, { children: displayedSpaces.map((space, index) => (_jsxs(motion.div, { initial: { opacity: 0, x: -20 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: 20 }, transition: {
                                delay: index * 0.1,
                                duration: 0.4,
                                ease: [0.23, 1, 0.32, 1]
                            }, onHoverStart: () => setHoveredSpace(space.id), onHoverEnd: () => setHoveredSpace(null), onClick: () => onSpaceClick?.(space.id), className: cn('relative group cursor-pointer rounded-xl p-4', 'bg-gradient-to-br from-charcoal/40 via-charcoal/30 to-graphite/40', 'border border-steel/10 backdrop-blur-sm', 'hover:border-steel/20 hover:from-charcoal/60 hover:to-graphite/60', 'transition-all duration-300 ease-hive-smooth', 'hover:shadow-lg'), children: [_jsx("div", { className: cn('absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300', `bg-gradient-to-br ${spaceTypeColors[space.type]}`) }), _jsxs("div", { className: "relative z-10", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: cn('w-12 h-12 rounded-xl flex items-center justify-center border', 'bg-gradient-to-br from-charcoal/60 to-graphite/60 border-steel/20', 'group-hover:border-[var(--hive-brand-secondary)]/30 transition-all duration-300', hoveredSpace === space.id && 'scale-105 shadow-lg'), children: _jsx("span", { className: "text-xl", children: space.icon || spaceTypeIcons[space.type] }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-start justify-between mb-1", children: [_jsx("h4", { className: "text-platinum font-semibold truncate text-base", children: space.name }), _jsxs("div", { className: "flex items-center gap-2 ml-2", children: [space.isPinned && (_jsx("div", { className: "w-2 h-2 rounded-full bg-[var(--hive-brand-secondary)] shadow-[0_0_4px_color-mix(in_srgb,var(--hive-brand-secondary)_50%,transparent)]" })), space.isMuted && (_jsx(BellOff, { className: "w-3 h-3 text-steel/60" })), space.unreadCount && space.unreadCount > 0 && !space.isMuted && (_jsx("div", { className: "px-2 py-0.5 bg-[var(--hive-brand-secondary)]/20 border border-[var(--hive-brand-secondary)]/30 rounded-full", children: _jsx("span", { className: "text-[var(--hive-brand-secondary)] text-xs font-medium", children: space.unreadCount > 99 ? '99+' : space.unreadCount }) }))] })] }), _jsxs("div", { className: "flex items-center gap-2 text-sm text-mercury", children: [_jsx("span", { className: "capitalize", children: space.type }), _jsx("span", { className: "text-steel/60", children: "\u2022" }), _jsxs("span", { children: [formatMemberCount(space.memberCount), " members"] }), space.lastActivity && (_jsxs(_Fragment, { children: [_jsx("span", { className: "text-steel/60", children: "\u2022" }), _jsx("span", { className: "text-xs", children: formatLastActivity(space.lastActivity) })] }))] })] }), showQuickActions && hoveredSpace === space.id && (_jsxs(motion.div, { initial: { opacity: 0, x: 10 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: 10 }, className: "flex items-center gap-1", children: [_jsx("button", { onClick: (e) => {
                                                                e.stopPropagation();
                                                                toggleQuickPost(space.id);
                                                            }, className: "p-1.5 rounded-lg bg-charcoal/60 border border-steel/20 hover:border-[var(--hive-brand-secondary)]/30 hover:bg-[var(--hive-brand-secondary)]/10 transition-all duration-200 group/btn", title: "Quick Post", children: _jsx(MessageSquare, { className: "w-3 h-3 text-mercury group-hover/btn:text-[var(--hive-brand-secondary)]" }) }), _jsx("button", { onClick: (e) => {
                                                                e.stopPropagation();
                                                                onPinSpace?.(space.id, !space.isPinned);
                                                            }, className: "p-1.5 rounded-lg bg-charcoal/60 border border-steel/20 hover:border-[var(--hive-brand-secondary)]/30 hover:bg-[var(--hive-brand-secondary)]/10 transition-all duration-200 group/btn", title: space.isPinned ? "Unpin Space" : "Pin Space", children: space.isPinned ? (_jsx(PinOff, { className: "w-3 h-3 text-[var(--hive-brand-secondary)] group-hover/btn:text-champagne" })) : (_jsx(Pin, { className: "w-3 h-3 text-mercury group-hover/btn:text-[var(--hive-brand-secondary)]" })) }), _jsx("button", { onClick: (e) => {
                                                                e.stopPropagation();
                                                                onMuteSpace?.(space.id, !space.isMuted);
                                                            }, className: "p-1.5 rounded-lg bg-charcoal/60 border border-steel/20 hover:border-[var(--hive-brand-secondary)]/30 hover:bg-[var(--hive-brand-secondary)]/10 transition-all duration-200 group/btn", title: space.isMuted ? "Unmute Space" : "Mute Space", children: space.isMuted ? (_jsx(BellOff, { className: "w-3 h-3 text-steel/60 group-hover/btn:text-mercury" })) : (_jsx(Bell, { className: "w-3 h-3 text-mercury group-hover/btn:text-[var(--hive-brand-secondary)]" })) }), space.userRole === 'member' && (_jsx("button", { onClick: (e) => {
                                                                e.stopPropagation();
                                                                onLeaveSpace?.(space.id);
                                                            }, className: "p-1.5 rounded-lg bg-charcoal/60 border border-steel/20 hover:border-red-400/30 hover:bg-red-400/10 transition-all duration-200 group/btn", title: "Leave Space", children: _jsx(UserMinus, { className: "w-3 h-3 text-mercury group-hover/btn:text-red-400" }) }))] }))] }), space.recentActivity && hoveredSpace === space.id && !showQuickPostFor && (_jsx(motion.div, { initial: { opacity: 0, height: 0 }, animate: { opacity: 1, height: 'auto' }, exit: { opacity: 0, height: 0 }, className: "mt-3 pt-2 border-t border-steel/10", children: _jsx("p", { className: "text-xs text-silver/80 truncate", children: space.recentActivity.preview }) })), showQuickPostFor === space.id && (_jsx(motion.div, { initial: { opacity: 0, height: 0 }, animate: { opacity: 1, height: 'auto' }, exit: { opacity: 0, height: 0 }, className: "mt-3 pt-2 border-t border-steel/10", children: _jsxs("div", { className: "flex gap-2", children: [_jsx("input", { type: "text", value: quickPostMessage, onChange: (e) => setQuickPostMessage(e.target.value), onKeyDown: (e) => {
                                                            if (e.key === 'Enter') {
