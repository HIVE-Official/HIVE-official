...
import { Wrench, Pause, Users, Activity, CheckCircle, XCircle, RefreshCw, MessageSquare, Calendar, FileText, Image as ImageIcon, Video, Music, Calculator, Map, Camera, Mic, Gamepad2, Bookmark, Link as LinkIcon, Database, Code, Palette, Globe } from 'lucide-react';
...
return (_jsxs("div", { ref: ref, className: cn(hiveToolsSurfaceVariants({ mode, className })), ...props, children: [_jsxs("div", { className: "flex items-center justify-between mb-6", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsx("h3", { className: "text-lg font-semibold text-[var(--hive-text-primary)]", children: "Tools" }), _jsxs("span", { className: "text-sm text-gray-400", children: [filteredTools.length, " active"] })] }), _jsx("div", { className: "flex items-center gap-2", children: canManageTools && (_jsxs(motion.button, { className: "flex items-center gap-2 px-4 py-2 bg-purple-500/20 text-purple-400 border border-purple-500/30 rounded-xl hover:bg-purple-500/30 transition-all duration-200 font-medium", onClick: onAddTool, whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, children: [_jsx(Plus, { className: "w-4 h-4" }), _jsx("span", { className: "hidden sm:inline", children: "Add Tool" })] })) })] }), _jsxs("div", { className: "flex items-center gap-2 mb-6 overflow-x-auto pb-2", children: [[
                ...
                ], ") ].map((filter) => ", , "const Icon = filter.icon; const isActive = selectedCategory === filter.key; return (", _jsxs(motion.button, { className: cn("flex items-center gap-2 px-3 py-1.5 rounded-xl border text-sm font-medium transition-all duration-200 whitespace-nowrap", isActive
