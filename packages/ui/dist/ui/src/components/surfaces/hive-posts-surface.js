...
export const HivePostsSurface = React.forwardRef(({ className, mode, space, posts: propPosts, isBuilder = false, canPost = true, canModerate = false, onCreatePost, onLikePost, onReplyToPost, onSharePost, onPinPost, onDeletePost, onViewPost, sortBy = 'recent', showFilters = true, maxPosts = 10, autoFetch = true, authToken, ...props }, ref) => {
