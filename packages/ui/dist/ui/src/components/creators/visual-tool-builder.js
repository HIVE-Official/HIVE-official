...
export const VisualToolBuilder = ({ tool, elements, onChange, onSave, onPreview, isLoading = false }) => {
    ...
    return (_jsxs("div", { className: "flex h-screen bg-[var(--hive-background-primary)]", children: [_jsx("div", { className: "w-80 border-r border-[var(--hive-border-default)] bg-[var(--hive-background-secondary)]", children: _jsx(ElementPicker, { elements: elements, onElementSelect: (element) => {
