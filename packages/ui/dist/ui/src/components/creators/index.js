...
export const getBuilderComponent = (mode) => {
    switch (mode) {
        case 'visual':
...
export const createEmptyTool = (userId, mode = 'visual') => ({
...
// === ELEMENT UTILITIES ===
export const createElementInstance = (element, position = { x: 0, y: 0 }) => ({
...
export const createDeploymentOptions = (deployTo = 'personal', targetId = 'current-user') => ({
    deployTo,
    targetId,
    permissions: {
...
export const SUPPORTED_BUILDER_MODES = ['visual', 'template', 'wizard'];
// === FEATURE FLAGS ===
