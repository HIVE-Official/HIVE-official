...
import { SelectEnhanced as Select } from '../atomic/atoms/select-radix-enhanced';
...
export const MajorSelectionFieldMolecule = ({ major = '', year = '', onMajorChange, onYearChange, majorError, yearError, required = false, disabled = false, className }) => {
    return (_jsxs("div", { className: cn('space-y-4', className), children: [_jsx(FormField, { label: "Academic Major", description: "Your primary field of study", error: majorError, required: required, children: _jsx(Select, { options: ACADEMIC_MAJORS, value: major, onChange: (e) => onMajorChange?.(e.target.value), placeholder: "Select your major", disabled: disabled, searchable: true }) }), _jsx(FormField, { label: "Academic Year", description: "Your current year in university", error: yearError, required: required, children: _jsx(Select, { options: ACADEMIC_YEARS, value: year, onChange: (e) => onYearChange?.(e.target.value), placeholder: "Select your year", disabled: disabled }) })] }));
};
