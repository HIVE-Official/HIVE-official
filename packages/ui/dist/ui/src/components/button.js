...
const Button = React.forwardRef(({ className, variant, size, fullWidth, asChild = false, loading, children, disabled, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (_jsx(Comp, { className: cn(buttonVariants({ variant, size, fullWidth }), className), ref: ref, disabled: disabled || loading, "aria-busy": loading, ...props, children: loading ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Loader2, { className: "h-4 w-4 animate-spin" }), _jsx("span", { className: "opacity-80", children: "Loading..." })] })) : (children) }));
});
