...
const appleButtonVariants = cva("inline-flex items-center justify-center whitespace-nowrap font-medium relative transition-all duration-200 ease-out focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 select-none", {
    variants: {
        variant: {
            primary: [
...
const campusButtonVariants = cva("inline-flex items-center justify-center whitespace-nowrap font-medium relative transition-all duration-180 ease-out focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 select-none group", {
    variants: {
        variant: {
            energy: [
...
const techButtonVariants = cva("inline-flex items-center justify-center whitespace-nowrap font-mono text-sm relative transition-all duration-100 ease-out focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 select-none", {
    variants: {
        variant: {
            terminal: [
...
const socialButtonVariants = cva("inline-flex items-center justify-center whitespace-nowrap font-medium relative transition-all duration-300 ease-out focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 select-none group", {
    variants: {
        variant: {
            connect: [
...
export const VercelButton = React.forwardRef(({ className, variant, size, asChild = false, loading, children, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (_jsxs(Comp, { className: cn(vercelButtonVariants({ variant, size }), className), ref: ref, disabled: loading, ...props, children: [loading ? _jsx(Loader2, { className: "h-4 w-4 animate-spin mr-2" }) : null, children] }));
});
VercelButton.displayName = "VercelButton";
export const AppleButton = React.forwardRef(({ className, variant, size, asChild = false, loading, children, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (_jsxs(Comp, { className: cn(appleButtonVariants({ variant, size }), className), ref: ref, disabled: loading, ...props, children: [loading ? _jsx(Loader2, { className: "h-4 w-4 animate-spin mr-2" }) : null, children] }));
});
AppleButton.displayName = "AppleButton";
export const CampusButton = React.forwardRef(({ className, variant, size, asChild = false, loading, children, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (_jsxs(Comp, { className: cn(campusButtonVariants({ variant, size }), className), ref: ref, disabled: loading, ...props, children: [loading ? _jsx(Loader2, { className: "h-4 w-4 animate-spin mr-2" }) : null, children] }));
});
CampusButton.displayName = "CampusButton";
export const TechButton = React.forwardRef(({ className, variant, size, asChild = false, loading, children, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (_jsxs(Comp, { className: cn(techButtonVariants({ variant, size }), className), ref: ref, disabled: loading, ...props, children: [loading ? _jsx(Loader2, { className: "h-4 w-4 animate-spin mr-2" }) : null, children] }));
});
TechButton.displayName = "TechButton";
export const SocialButton = React.forwardRef(({ className, variant, size, asChild = false, loading, children, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (_jsxs(Comp, { className: cn(socialButtonVariants({ variant, size }), className), ref: ref, disabled: loading, ...props, children: [loading ? _jsx(Loader2, { className: "h-4 w-4 animate-spin mr-2" }) : null, children] }));
});
