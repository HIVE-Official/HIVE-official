...
const EnhancedButton = React.forwardRef(({ className, variant, size, intensity, asChild = false, loading, children, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (_jsx(Comp, { className: cn(enhancedButtonVariants({ variant, size, intensity }), className), ref: ref, disabled: loading, ...props, children: loading ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Loader2, { className: "h-4 w-4 animate-spin" }), _jsx("span", { className: "opacity-80", children: "Loading..." })] })) : (children) }));
});
EnhancedButton.displayName = "EnhancedButton";
export { EnhancedButton, enhancedButtonVariants };
//# sourceMappingURL=enhanced-button.js.map