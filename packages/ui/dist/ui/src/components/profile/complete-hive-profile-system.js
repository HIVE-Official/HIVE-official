...
export const CompleteHIVEProfileSystem = ({ user, stats, editMode = false, onEditModeToggle, onWidgetConfigure, completeness, onUploadAvatar, onToggleGhostMode, loading = false, error = null }) => {
    ...
    // Error state
    if (error) {
        return (_jsx("div", { className: "min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4", children: _jsx("div", { className: "max-w-7xl mx-auto", children: _jsx("div", { className: "flex items-center justify-center py-16", children: _jsxs(Card, { className: "p-6 text-center max-w-md", children: [_jsx(AlertCircle, { className: "h-12 w-12 text-red-400 mx-auto mb-4" }), _jsx("h2", { className: "text-xl font-semibold text-[var(--hive-text-inverse)] mb-2", children: "Profile Error" }), _jsx("p", { className: "text-gray-400 mb-4", children: error }), _jsx(Button, { onClick: () => window.location.reload(), children: "Try Again" })] }) }) }) }));
    }
    // Handle missing user data
    if (!user) {
        return (_jsx("div", { className: "min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4", children: _jsx("div", { className: "max-w-7xl mx-auto", children: _jsx("div", { className: "flex items-center justify-center py-16", children: _jsxs(Card, { className: "p-6 text-center", children: [_jsx(User, { className: "h-12 w-12 text-gray-400 mx-auto mb-4" }), _jsx("h2", { className: "text-xl font-semibold text-[var(--hive-text-inverse)] mb-2", children: "Profile Not Found" }), _jsx("p", { className: "text-gray-400", children: "Unable to load profile data" })] }) }) }) }));
    }
    const mockSpaces = [
        {
            id: '1',
    ...
    return (_jsx("div", { className: "min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900", children: _jsxs("div", { className: "max-w-7xl mx-auto p-4 space-y-6", children: [_jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, children: _jsx(ProfileHeader, { user: user, showOnboarding: false, showPrivacyBanner: false, showGraduationBanner: false, completionStatus: completeness, onEditProfile: onEditModeToggle, onPrivacySettings: () => console.log('Privacy settings') }) }), _jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.1 }, children: _jsxs(Card, { className: "p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h3", { className: "text-lg font-semibold text-[var(--hive-text-inverse)]", children: "Quick Actions" }), _jsxs("div", { className: "flex items-center gap-2", children: [user?.privacy?.ghostMode && (_jsxs("div", { className: "flex items-center gap-1 text-xs text-gray-400 bg-gray-800 px-2 py-1 rounded", children: [_jsx(EyeOff, { className: "w-3 h-3" }), "Ghost Mode"] })), _jsxs(Button, { variant: "ghost", size: "sm", onClick: onEditModeToggle, className: "text-gray-400 hover:text-[var(--hive-text-inverse)]", children: [_jsx(Edit3, { className: "w-4 h-4 mr-1" }), editMode ? 'Done' : 'Edit'] })] })] }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [_jsxs("button", { onClick: () => onWidgetConfigure?.('avatar'), className: "flex items-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors", children: [_jsx(Upload, { className: "w-4 h-4 text-[#FFD700]" }), _jsx("span", { className: "text-sm text-[var(--hive-text-inverse)]", children: "Avatar" })] }), _jsxs("button", { onClick: onToggleGhostMode, className: "flex items-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors", children: [user?.privacy?.ghostMode ? (_jsx(Eye, { className: "w-4 h-4 text-green-400" })) : (_jsx(EyeOff, { className: "w-4 h-4 text-gray-400" })), _jsx("span", { className: "text-sm text-[var(--hive-text-inverse)]", children: "Privacy" })] }), _jsxs("button", { onClick: () => onWidgetConfigure?.('settings'), className: "flex items-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors", children: [_jsx(Settings, { className: "w-4 h-4 text-blue-400" }), _jsx("span", { className: "text-sm text-[var(--hive-text-inverse)]", children: "Settings" })] }), _jsxs("button", { onClick: () => onWidgetConfigure?.('stats'), className: "flex items-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors", children: [_jsx(Zap, { className: "w-4 h-4 text-purple-400" }), _jsx("span", { className: "text-sm text-[var(--hive-text-inverse)]", children: "Stats" })] })] })] }) }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [_jsxs("div", { className: "lg:col-span-2 space-y-6", children: [_jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.2 }, children: _jsx(ProfileStats, { stats: stats || user?.stats }) }), _jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.3 }, children: _jsx(MySpacesFeed, { spaces: mockSpaces, onSpaceClick: (spaceId) => console.log('Space clicked:', spaceId), onJoinSpace: () => console.log('Join space') }) }), _jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.4 }, children: _jsx(HiveLabSection, { hiveLab: {
                                            isLocked: false,
                                            availableTools: [],
                                            createdTools: [],
                                            comingSoon: []
