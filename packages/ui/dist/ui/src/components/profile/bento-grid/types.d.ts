...
export type WidgetType = 'social-avatar' | 'priority-coordination' | 'community-coordination' | 'social-calendar' | 'privacy-control' | 'personal-tools' | 'profile-stats' | 'campus-connections';
