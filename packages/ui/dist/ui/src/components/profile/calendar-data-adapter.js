 ...
 */
export const adaptEventsToCalendarCardData = (events, isLoading, error) => {
 ...
 */
export const adaptSmartCalendarProps = (events, isLoading, error, onEventClick, onAddEvent, variant = 'desktop') => {
    ...
    return {
        ...
        onSyncCalendar: (connectionId) => {
            // Handle calendar sync
            console.log('Sync calendar:', connectionId);
        }
    };
};
//# sourceMappingURL=calendar-data-adapter.js.map