...
function NotificationSettingsDialog({ isOpen, onOpenChange }) {
    ...
    return (_jsx(Dialog, { open: isOpen, onOpenChange: onOpenChange, children: _jsxs(DialogContent, { className: "sm:max-w-md", children: [_jsx(DialogHeader, { children: _jsx(DialogTitle, { children: "Notification Settings" }) }), _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "space-y-3", children: [_jsx("h4", { className: "font-medium text-[var(--hive-text-primary)]", children: "Delivery" }), _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Bell, { className: "w-4 h-4 text-[var(--hive-text-muted)]" }), _jsx("span", { className: "text-sm", children: "Push Notifications" })] }), _jsx(Switch, { checked: settings.push, onChange: (e) => { const checked = e.target.checked; handleSettingChange('push', checked); } })] }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(MessageSquare, { className: "w-4 h-4 text-[var(--hive-text-muted)]" }), _jsx("span", { className: "text-sm", children: "Email Digest" })] }), _jsx(Switch, { checked: settings.email, onChange: (e) => { const checked = e.target.checked; handleSettingChange('email', checked); } })] })] })] }), _jsxs("div", { className: "space-y-3", children: [_jsx("h4", { className: "font-medium text-[var(--hive-text-primary)]", children: "Content" }), _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Users, { className: "w-4 h-4 text-[var(--hive-text-muted)]" }), _jsx("span", { className: "text-sm", children: "Space Activity" })] }), _jsx(Switch, { checked: settings.spaces, onChange: (e) => { const checked = e.target.checked; handleSettingChange('spaces', checked); } })] }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Heart, { className: "w-4 h-4 text-[var(--hive-text-muted)]" }), _jsx("span", { className: "text-sm", children: "Social Interactions" })] }), _jsx(Switch, { checked: settings.social, onChange: (e) => { const checked = e.target.checked; handleSettingChange('social', checked); } })] }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(BookOpen, { className: "w-4 h-4 text-[var(--hive-text-muted)]" }), _jsx("span", { className: "text-sm", children: "Academic Updates" })] }), _jsx(Switch, { checked: settings.academic, onChange: (e) => { const checked = e.target.checked; handleSettingChange('academic', checked); } })] }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Settings, { className: "w-4 h-4 text-[var(--hive-text-muted)]" }), _jsx("span", { className: "text-sm", children: "System Announcements" })] }), _jsx(Switch, { checked: settings.system, onChange: (e) => { const checked = e.target.checked; handleSettingChange('system', checked); } })] })] })] }), _jsxs("div", { className: "space-y-3", children: [_jsx("h4", { className: "font-medium text-[var(--hive-text-primary)]", children: "Quiet Hours" }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(VolumeX, { className: "w-4 h-4 text-[var(--hive-text-muted)]" }), _jsxs("div", { children: [_jsx("span", { className: "text-sm", children: "10 PM - 8 AM" }), _jsx("p", { className: "text-xs text-[var(--hive-text-muted)]", children: "Pause non-urgent notifications" })] })] }), _jsx(Switch, { checked: settings.quiet_hours, onChange: (e) => { const checked = e.target.checked; handleSettingChange('quiet_hours', checked); } })] })] })] })] }) }));
}
