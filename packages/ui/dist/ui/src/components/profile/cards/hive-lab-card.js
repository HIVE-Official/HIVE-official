...
function QuickActions({ onCreateTool, hasTools }) {
    ...
    return (_jsxs("div", { className: "space-y-2", children: [_jsx("div", { className: "flex items-center justify-between", children: _jsx("span", { className: "text-xs font-medium text-[var(--hive-text-muted)]", children: "Quick Create" }) }), _jsx("div", { className: "grid grid-cols-3 gap-1", children: quickTemplates.map(({ type, label, icon: Icon }) => (_jsxs(Button, { size: "sm", variant: "outline", className: "h-8 px-2 text-xs", onClick: onCreateTool, children: [_jsx(Icon, { className: "w-3 h-3 mr-1" }), label] }, type))) }), hasTools && (_jsxs(Button, { size: "sm", variant: "ghost", className: "w-full h-6 text-xs", children: [_jsx(ExternalLink, { className: "w-3 h-3 mr-1" }), "View All Tools"] }))] }));
}
