...
import { Users, Plus, Search, Settings, Crown, Lock, Globe, BookOpen, Coffee, Code, Heart, Eye, MoreHorizontal, ExternalLink, UserPlus, Star, TrendingUp, Clock, MapPin, Shield, AlertCircle, CheckCircle } from 'lucide-react';
...
const roleConfig = {
    ...
    member: { icon: Users, color: 'text-[var(--hive-text-muted)]', label: 'Member' }
};
// Time formatting
...
function SpaceSearch({ onSearch, onCreateSpace }) {
    ...
    return (_jsxs("div", { className: "space-y-3", children: [_jsxs("div", { className: "relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[var(--hive-text-muted)]" }), _jsx(Input, { placeholder: "Search spaces...", value: query, onChange: (e) => handleSearch(e.target.value), className: "pl-10 h-9" })] }), _jsxs(Button, { variant: "secondary", size: "sm", className: "w-full", onClick: onCreateSpace, children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Create New Space"] })] }));
}
