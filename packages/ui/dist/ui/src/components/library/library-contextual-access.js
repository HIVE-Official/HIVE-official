    ...
    const mockElements = [
        {
            ...
            previewComponent: () => _jsx("div", { className: "text-sm text-[var(--hive-text-muted)]", children: "Poll preview" }),
        ...
        },
        {
            ...
            previewComponent: () => _jsx("div", { className: "text-sm text-[var(--hive-text-muted)]", children: "Timer preview" }),
        ...
        },
        {
            ...
            previewComponent: () => _jsx("div", { className: "text-sm text-[var(--hive-text-muted)]", children: "Attendance preview" }),
        ...
        },
        {
            ...
            previewComponent: () => _jsx("div", { className: "text-sm text-[var(--hive-text-muted)]", children: "Mood check preview" }),
...
const SuggestionCard = ({ suggestion, onInstall, onPreview }) => {
    ...
    return (_jsx(Card, { className: "p-4 hover:shadow-md transition-all group cursor-pointer", children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "w-10 h-10 bg-gradient-to-br from-amber-400 to-amber-600 rounded-lg flex items-center justify-center flex-shrink-0", children: _jsx(IconComponent, { className: "w-5 h-5 text-[var(--hive-text-inverse)]" }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-start justify-between mb-2", children: [_jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("h3", { className: "font-semibold text-gray-900 truncate group-hover:text-amber-600 transition-colors", children: element.name }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)] line-clamp-2 mb-2", children: element.description })] }), _jsxs("div", { className: "flex items-center gap-1 ml-2", children: [_jsx(Badge, { className: categoryConfig[category].className, children: categoryConfig[category].label }), element.isVerified && (_jsx(Badge, { className: "bg-green-100 text-green-800 border-green-200", children: "\u2713" }))] })] }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3 text-xs text-gray-500", children: [_jsxs("span", { className: "flex items-center gap-1", children: [_jsx(Star, { className: "w-3 h-3 text-yellow-400 fill-yellow-400" }), element.rating] }), _jsx("span", { children: element.downloads.toLocaleString() })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Button, { size: "sm", variant: "secondary", onClick: (e) => {
                                                e.stopPropagation();
                                                onPreview(element);
                                            }, children: "Preview" }), _jsxs(Button, { size: "sm", onClick: (e) => {
                                                e.stopPropagation();
                                                onInstall(element.id);
                                            }, children: [_jsx(Plus, { className: "w-3 h-3 mr-1" }), "Add"] })] })] }), _jsx("div", { className: "mt-2 p-2 bg-gray-50 rounded-md", children: _jsx("p", { className: "text-xs text-[var(--hive-text-muted)]", children: reason }) })] })] }) }));
};
const CategorySection = ({ category, suggestions, onInstall, onPreview }) => {
    const IconComponent = category.icon;
    return (_jsxs("div", { className: "space-y-3", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(IconComponent, { className: "w-5 h-5 text-amber-600" }), _jsx("h3", { className: "font-semibold text-gray-900", children: category.title }), _jsxs("span", { className: "text-sm text-gray-500", children: ["(", suggestions.length, ")"] })] }), _jsx("p", { className: "text-sm text-[var(--hive-text-muted)]", children: category.description }), _jsx("div", { className: "grid gap-3", children: suggestions.map((suggestion) => (_jsx(SuggestionCard, { suggestion: suggestion, onInstall: onInstall, onPreview: onPreview }, suggestion.element.id))) })] }));
};
export function LibraryContextualAccess({ space, onToolInstall, onClose, isOpen = false, triggerRef }) {
    ...
    if (!isOpen)
        return null;
    return (_jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4", children: _jsxs("div", { className: "bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col", children: [_jsxs("div", { className: "p-6 border-b border-gray-200", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-900 flex items-center gap-2", children: [_jsx(Wand2, { className: "w-6 h-6 text-amber-500" }), "Add Tools to ", space.name] }), _jsxs("p", { className: "text-[var(--hive-text-muted)]", children: ["Discover tools perfect for your ", space.category, " community"] })] }), _jsx(Button, { variant: "secondary", onClick: onClose, children: _jsx(X, { className: "w-4 h-4" }) })] }), _jsxs("div", { className: "mt-4 flex gap-4", children: [_jsxs("div", { className: "flex-1 relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" }), _jsx("input", { type: "text", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: "Search tools...", className: "w-full pl-10 pr-4 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500" })] }), _jsxs("select", { value: activeCategory, onChange: (e) => setActiveCategory(e.target.value), className: "px-3 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500", children: [_jsx("option", { value: "all", children: "All Categories" }), _jsx("option", { value: "space_specific", children: "Space Specific" }), _jsx("option", { value: "trending", children: "Trending" }), _jsx("option", { value: "popular", children: "Popular" })] })] })] }), _jsx("div", { className: "flex-1 overflow-y-auto p-6", children: loading ? (_jsxs("div", { className: "text-center py-8", children: [_jsx("div", { className: "w-8 h-8 bg-amber-500 rounded-lg animate-pulse mx-auto mb-4" }), _jsx("p", { className: "text-[var(--hive-text-muted)]", children: "Installing tool..." })] })) : filteredSuggestions.length === 0 ? (_jsxs("div", { className: "text-center py-12", children: [_jsx(Sparkles, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-2", children: "No Tools Found" }), _jsx("p", { className: "text-[var(--hive-text-muted)]", children: searchQuery ? 'Try different search terms' : 'No tools available for the selected category' })] })) : searchQuery || activeCategory !== 'all' ? (
                    /* Filtered Results */
                    ...
                    _jsx("div", { className: "space-y-8", children: categorizedSuggestions.map((category) => {
                        ...
                        }) })) }), _jsx("div", { className: "p-6 border-t border-gray-200 bg-gray-50", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "text-sm text-[var(--hive-text-muted)]", children: ["Can't find what you need? ", _jsx("button", { className: "text-amber-600 hover:text-amber-700 font-medium", children: "Browse all tools" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Button, { variant: "secondary", onClick: onClose, children: "Cancel" }), _jsxs(Button, { onClick: () => console.log('Browse HiveLAB'), children: [_jsx(Zap, { className: "w-4 h-4 mr-2" }), "Browse HiveLAB"] })] })] }) })] }) }));
}
