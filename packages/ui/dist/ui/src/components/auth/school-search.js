...
export const SchoolSearch = ({ onSchoolSelect, onRequestSchool, className, initialSearch = '' }) => {
    ...
    return (_jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, className: cn("w-full max-w-2xl mx-auto", className), children: _jsxs(Card, { variant: "elevated", padding: "lg", children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { className: "text-2xl text-center", children: "Select your school" }), _jsx(CardDescription, { className: "text-center", children: "Choose your university to join the HIVE campus community" })] }), _jsxs(CardContent, { className: "space-y-6", children: [_jsxs("div", { className: "relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-muted w-4 h-4" }), _jsx(Input, { type: "text", placeholder: "Search universities...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "pl-10", variant: "search" })] }), _jsx("div", { className: "space-y-3 max-h-64 overflow-y-auto", children: _jsx(AnimatePresence, { children: filteredSchools.length > 0 ? (filteredSchools.map((school, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -10 }, transition: { delay: index * 0.05 }, children: _jsx(Card, { variant: selectedSchool?.id === school.id ? "accent" : "interactive", padding: "sm", className: "cursor-pointer transition-all duration-200", onClick: () => handleSchoolClick(school), children: _jsx("div", { className: "flex items-center justify-between", children: _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [_jsx(GraduationCap, { className: "w-4 h-4 text-accent" }), _jsx("h3", { className: "font-medium text-white", children: school.name }), selectedSchool?.id === school.id && (_jsx(CheckCircle, { className: "w-4 h-4 text-accent" }))] }), _jsxs("div", { className: "flex items-center gap-4 text-sm text-muted", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(MapPin, { className: "w-3 h-3" }), _jsx("span", { children: school.location })] }), school.studentCount && (_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Users, { className: "w-3 h-3" }), _jsxs("span", { children: [school.studentCount, " students"] })] }))] }), _jsxs("div", { className: "text-xs text-muted mt-1 font-mono", children: ["@", school.domain] })] }) }) }) }, school.id)))) : (_jsxs(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, className: "text-center py-8", children: [_jsxs("div", { className: "text-muted mb-4", children: ["No schools found matching \"", searchQuery, "\""] }), _jsxs(Button, { variant: "outline", size: "sm", onClick: () => setShowRequestForm(true), children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Request your school"] })] })) }) }), _jsx(AnimatePresence, { children: showRequestForm && (_jsxs(motion.div, { initial: { opacity: 0, height: 0 }, animate: { opacity: 1, height: 'auto' }, exit: { opacity: 0, height: 0 }, className: "border border-border rounded-lg p-4 bg-surface/50", children: [_jsx("h4", { className: "font-medium text-white mb-3", children: "Request a new school" }), _jsxs("div", { className: "space-y-3", children: [_jsx(Input, { type: "text", placeholder: "Enter your university name", value: requestSchoolName, onChange: (e) => setRequestSchoolName(e.target.value) }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { variant: "primary", size: "sm", onClick: handleRequestSchool, disabled: !requestSchoolName.trim(), children: "Submit Request" }), _jsx(Button, { variant: "ghost", size: "sm", onClick: () => setShowRequestForm(false), children: "Cancel" })] })] })] })) }), _jsxs("div", { className: "flex justify-between items-center pt-4", children: [_jsxs("div", { className: "text-xs text-muted", children: [filteredSchools.length, " school", filteredSchools.length !== 1 ? 's' : '', " available"] }), _jsx(Button, { variant: "primary", onClick: handleContinue, disabled: !selectedSchool, className: "min-w-[120px]", children: "Continue" })] }), _jsxs("div", { className: "text-xs text-muted text-center border-t border-border pt-4", children: ["Don't see your school? ", _jsx("button", { className: "text-accent hover:text-accent/80 underline", onClick: () => setShowRequestForm(true), children: "Request to add it" })] })] })] }) }));
};
