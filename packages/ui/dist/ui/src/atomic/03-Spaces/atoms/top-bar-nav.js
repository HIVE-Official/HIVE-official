...
const topBarNavVariants = cva("relative inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 rounded-lg", {
    variants: {
        variant: {
            default: [
            ...
            active: [
                ...
                "after:bg-gradient-to-r after:from-primary/80 after:via-primary after:to-primary/80",
                "after:shadow-lg after:shadow-primary/25",
                "backdrop-blur-sm"
            ],
            ghost: [
...
const topBarNavIconVariants = cva("flex-shrink-0 transition-all duration-200", {
    variants: {
        size: {
            default: "h-4 w-4",
            sm: "h-3 w-3",
...
const topBarNavLabelVariants = cva("transition-all duration-200 font-medium", {
    variants: {
        visibility: {
            always: "block",
