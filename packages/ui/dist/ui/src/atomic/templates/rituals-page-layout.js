...
import { RitualFeedBannerCard } from '../organisms/ritual-feed-banner.js';
import { Tabs, TabsList, TabsTrigger, TabsContent } from '../atoms/tabs.js';
 ...
 */
export const RitualsPageLayout = React.forwardRef(({ rituals, featuredRitual, featuredRitualBanner, onRitualJoin, onRitualView, onBannerAction, defaultTab = 'active', isLoading = false, className, ...props }, ref) => {
    ...
    return (_jsx("div", { ref: ref, className: cn('min-h-screen bg-[var(--hive-background-primary)]', className), ...props, children: _jsxs("div", { className: "mx-auto max-w-7xl px-4 py-8", children: [_jsxs("div", { className: "mb-8", children: [_jsx("h1", { className: "mb-2 text-3xl font-bold text-[var(--hive-text-primary)]", children: "Campus Rituals" }), _jsx("p", { className: "text-[var(--hive-text-secondary)]", children: "Build better habits together. Join campus-wide behavioral campaigns." })] }), activeTab === 'active' && (_jsxs("div", { className: "mb-8 space-y-3", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Sparkles, { className: "h-5 w-5 text-[var(--hive-brand-primary)]" }), _jsx("span", { className: "text-sm font-semibold uppercase tracking-[0.16em] text-[var(--hive-text-tertiary)]", children: "Featured" })] }), featuredRitualBanner ? (_jsx(RitualFeedBannerCard, { banner: featuredRitualBanner, onAction: onBannerAction })) : featuredRitual ? (_jsx(RitualCard, { ritual: featuredRitual, variant: "featured", onJoin: () => onRitualJoin?.(featuredRitual.id), onViewDetails: () => onRitualView?.(featuredRitual.id), className: "max-w-md" })) : null] })), _jsxs(Tabs, { value: activeTab, onValueChange: (v) => setActiveTab(v), children: [_jsxs(TabsList, { className: "mb-6", children: [_jsxs(TabsTrigger, { value: "active", children: ["Active", rituals.filter((r) => r.status === 'active').length > 0 && (_jsx("span", { className: "ml-2 rounded-full bg-[var(--hive-background-tertiary)] px-2 py-0.5 text-xs", children: rituals.filter((r) => r.status === 'active').length }))] }), _jsxs(TabsTrigger, { value: "upcoming", children: ["Upcoming", rituals.filter((r) => r.status === 'upcoming').length > 0 && (_jsx("span", { className: "ml-2 rounded-full bg-[var(--hive-background-tertiary)] px-2 py-0.5 text-xs", children: rituals.filter((r) => r.status === 'upcoming').length }))] }), _jsxs(TabsTrigger, { value: "completed", children: ["Completed", rituals.filter((r) => r.status === 'completed').length > 0 && (_jsx("span", { className: "ml-2 rounded-full bg-[var(--hive-background-tertiary)} px-2 py-0.5 text-xs", children: rituals.filter((r) => r.status === 'completed').length }))] })] }), _jsx(TabsContent, { value: "active", children: isLoading ? (_jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [...Array(6)].map((_, i) => (_jsx("div", { className: "h-80 animate-pulse rounded-2xl bg-[var(--hive-background-secondary)]" }, i))) })) : filteredRituals.length > 0 ? (_jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", children: filteredRituals.map((ritual) => (_jsx(RitualCard, { ritual: ritual, onJoin: () => onRitualJoin?.(ritual.id), onViewDetails: () => onRitualView?.(ritual.id) }, ritual.id))) })) : (renderEmptyState('active')) }), _jsx(TabsContent, { value: "upcoming", children: isLoading ? (_jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [...Array(6)].map((_, i) => (_jsx("div", { className: "h-80 animate-pulse rounded-2xl bg-[var(--hive-background-secondary)]" }, i))) })) : filteredRituals.length > 0 ? (_jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", children: filteredRituals.map((ritual) => (_jsx(RitualCard, { ritual: ritual, onJoin: () => onRitualJoin?.(ritual.id), onViewDetails: () => onRitualView?.(ritual.id) }, ritual.id))) })) : (renderEmptyState('upcoming')) }), _jsx(TabsContent, { value: "completed", children: isLoading ? (_jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [...Array(6)].map((_, i) => (_jsx("div", { className: "h-80 animate-pulse rounded-2xl bg-[var(--hive-background-secondary)]" }, i))) })) : filteredRituals.length > 0 ? (_jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", children: filteredRituals.map((ritual) => (_jsx(RitualCard, { ritual: ritual, onViewDetails: () => onRitualView?.(ritual.id) }, ritual.id))) })) : (renderEmptyState('completed')) })] })] }) }));
});
