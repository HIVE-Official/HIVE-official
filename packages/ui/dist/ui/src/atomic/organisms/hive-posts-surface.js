...
import { MessageSquare, Plus, Calendar, MapPin, Users, Clock, ChevronDown, MessageCircle, Share2, Pin, MoreHorizontal, AlertCircle, CheckCircle2, Timer, Car, Coffee, BookOpen, Crown, Activity, TrendingUp } from 'lucide-react';
...
export const HivePostsSurface = React.memo(({ space, mode = 'view', maxPosts, showFilters = true, canPost = false, canModerate = false, leaderMode, showLiveActivity = false, liveActivityCount = 0, currentUserId, onCreatePost, onCoordinationResponse, onUpdateCoordinationStatus }) => {
