...
export declare function RitualCalendar({ ritualInstances, onJoinRitual, onSetReminder, onViewDetails, className, view: initialView, filterType, showPastEvents, compactMode }: RitualCalendarProps): import("react/jsx-runtime").JSX.Element;
