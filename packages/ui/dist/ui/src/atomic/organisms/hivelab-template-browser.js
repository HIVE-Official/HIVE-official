...
const TemplateCard = ({ template, onSelect, onFork, onDeploy, }) => {
    return (_jsx(Card, { className: cn("group relative overflow-hidden transition-all hover:shadow-lg cursor-pointer", "border border-white/8 hover:border-[#FFD700]/50"), onClick: () => onSelect?.(template), children: _jsxs("div", { className: "p-4 space-y-3", children: [_jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "text-2xl", children: template.icon }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("h4", { className: "text-sm font-semibold text-white truncate", children: template.name }), _jsxs("p", { className: "text-xs text-white/70", children: ["by ", template.creatorName] })] })] }), template.isTrending && (_jsxs(Badge, { variant: "freshman", className: "h-5 px-1.5 text-[9px]", children: [_jsx(TrendingUp, { className: "h-3 w-3 mr-0.5" }), "HOT"] })), template.isNew && (_jsxs(Badge, { variant: "freshman", className: "h-5 px-1.5 text-[9px]", children: [_jsx(Sparkles, { className: "h-3 w-3 mr-0.5" }), "NEW"] }))] }), _jsx("p", { className: "text-xs text-white/70 line-clamp-2", children: template.description }), _jsxs("div", { className: "flex items-center gap-3 text-xs text-white/70", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Users, { className: "h-3 w-3" }), _jsxs("span", { children: [template.deploysCount, " deploys"] })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Copy, { className: "h-3 w-3" }), _jsxs("span", { children: [template.forksCount, " forks"] })] })] }), template.responseRate && (_jsx("div", { className: "pt-2 border-t border-white/8", children: _jsxs("div", { className: "flex items-center justify-between text-xs", children: [_jsx("span", { className: "text-white/70", children: "Success Rate" }), _jsxs("span", { className: "font-semibold text-green-500", children: [template.responseRate, "% response"] })] }) })), _jsxs("div", { className: "flex flex-wrap gap-1", children: [template.tags.slice(0, 3).map((tag, idx) => (_jsx(Badge, { variant: "sophomore", className: "h-5 px-1.5 text-[9px]", children: tag }, idx))), _jsxs(Badge, { variant: "freshman", className: "h-5 px-1.5 text-[9px]", children: [template.elementCount, " elements"] })] }), _jsxs("div", { className: "flex gap-2 pt-2", children: [_jsx(Button, { size: "sm", className: "flex-1 h-7 text-xs", onClick: (e) => {
                                e.stopPropagation();
