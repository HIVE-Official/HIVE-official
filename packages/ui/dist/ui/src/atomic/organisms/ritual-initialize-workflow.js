...
const GoalsStep = ({ onComplete, initialData }) => {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "text-center mb-8", children: [_jsx("div", { className: "w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-green-500 to-blue-500 rounded-full flex items-center justify-center", children: _jsx(Target, { className: "h-10 w-10 text-white" }) }), _jsx("h3", { className: "text-2xl font-bold text-hive-text-primary mb-2", children: "What Are Your Campus Goals?" }), _jsx("p", { className: "text-hive-text-secondary", children: "Select your top priorities to help us recommend relevant spaces and tools" })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: campusGoals.map(goal => (_jsx("button", { onClick: () => toggleGoal(goal.id), className: `p-4 rounded-lg border text-left transition-all ${selectedGoals.includes(goal.id)
