...
import { Clock, Users, MapPin, Eye, Bell, Sparkles, Calendar as CalendarIcon, Trophy, Target, Gift } from 'lucide-react';
...
export function RitualCalendar({ ritualInstances, onJoinRitual, onSetReminder, onViewDetails, className, view: initialView = 'month', filterType = [], showPastEvents = false, compactMode: _compactMode = false }) {
...
return (_jsx("div", { className: cn("bg-[var(--hive-background-secondary)] rounded-xl border border-[var(--hive-border-subtle)]", className), children: _jsxs("div", { className: "p-6 border-b border-[var(--hive-border-subtle)]", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-[var(--hive-text-primary)]", children: "Ritual Calendar" }), _jsxs("p", { className: "text-[var(--hive-text-secondary)]", children: [view === 'month' && MONTHS[currentDate.getMonth()] + ' ' + currentDate.getFullYear(), view === 'week' && 'Week of ' + formatDate(currentDate, 'short'), view === 'day' && formatDate(currentDate, 'long'), view === 'list' && 'Upcoming Rituals'] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "flex bg-[var(--hive-background-tertiary)] rounded-lg p-1", children: [
                                ...
                                isSelected, cn(config) { }, : .bgColor, config, : .color, "border": , "border-current":  }), ": \"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)] hover:bg-[var(--hive-background-tertiary)]\" )} >", _jsx(Icon, { className: "h-3 w-3" }), config.label] }), "); })}"] })] }) })) /* Content */;
{ /* Content */ }
