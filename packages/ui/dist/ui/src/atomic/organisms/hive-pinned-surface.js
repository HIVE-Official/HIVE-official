...
export const HivePinnedSurface = ({ space, items = mockPinnedItems, maxItems, canPin = false, canModerate = false, leaderMode, viewMode = 'list', onAddPinned, onViewItem, onDownloadItem, onUnpinItem }) => {
