...
export const CompletionPsychologyEnhancer = ({ currentStep, totalSteps, className, onCompletionBoost, userType = 'student', }) => {
    ...
    const getProgressColor = () => {
        if (completionPercentage >= 70)
            return 'from-[var(--hive-brand-primary)] to-yellow-400';
