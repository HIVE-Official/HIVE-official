...
export const CardTitle = ({ className, children, ...props }) => (_jsx("h3", { className: cn('text-lg font-semibold leading-none tracking-tight', className), ...props, children: children }));
