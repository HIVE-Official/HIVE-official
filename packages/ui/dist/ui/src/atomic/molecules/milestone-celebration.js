...
export function MilestoneCelebration({ milestone, isVisible, onClose, onShare, className = '' }) {
    ...
    if (!isVisible)
        return null;
    return (_jsxs("div", { className: `fixed inset-0 z-50 flex items-center justify-center p-4 ${className}`, children: [_jsx("div", { className: "absolute inset-0 bg-black/70 backdrop-blur-sm transition-opacity duration-500", onClick: onClose }), _jsxs(Card, { className: `
