...
// === DURATION SYSTEM ===
export const durationSystem = {
    // Apple-like timing - clean and purposeful
    micro: {
        value: 'var(--hive-duration-instant)', // 100ms - matches design-tokens.css
        use: 'Button press feedback, toggle states',
        ms: '100ms'
    },
    fast: {
        value: 'var(--hive-duration-fast)', // 150ms - matches design-tokens.css
        use: 'Hover states, focus transitions',
        ms: '150ms'
    },
    standard: {
        value: 'var(--hive-duration-base)', // 200ms - matches design-tokens.css
        use: 'Card expansions, modal appearances',
        ms: '200ms'
    },
    deliberate: {
        value: 'var(--hive-duration-slow)', // 300ms - matches design-tokens.css
        use: 'Page transitions, important state changes',
        ms: '300ms'
    },
    cinematic: {
        value: 'var(--hive-duration-slower)', // 500ms - matches design-tokens.css
        use: 'Onboarding, major workflow completions',
        ms: '500ms'
    },
    // === MORPHING SYSTEM ===
    morphing: {
...
export const springPhysics = {
    // HIVE's distinctive liquid feel - spring-based motion
    gentle: {
        tension: 120,
        friction: 14,
...
export const liquidMotion = {
    // Distinctive HIVE motion language
    ripple: {
...
export const componentMotion = {
    button: {
        ...
        press: {
            transform: 'scale(0.98) scaleX(1.02)', // Organic squish
            borderRadius: 'calc(var(--hive-radius-base) * 0.8)',
            spring: springPhysics.snap,
            duration: durationSystem.micro.value
        },
        release: {
            transform: 'scale(1.05) scaleX(0.98)', // Spring back overshoot
    ...
    navigation: {
        ...
        mobileSwipe: {
            gesture: {
                ...
                duration: '0ms', // Real-time during gesture
                easing: 'linear'
            },
            snap: {
                duration: durationSystem.fast.value,
...
export const socialMotion = {
    // Distinctive social feedback with liquid physics
    like: {
        sequence: [
...
//# sourceMappingURL=motion-composition.js.map