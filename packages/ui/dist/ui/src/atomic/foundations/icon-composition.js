...
import { 
// Navigation & Core
Home, Menu, Search, Bell, Settings, User, ChevronRight, ChevronLeft, ChevronUp, ChevronDown, ArrowLeft, ArrowRight, ArrowUp, ArrowDown, Plus, X, Check, AlertCircle, Info, 
// Campus & Academic
BookOpen, GraduationCap, Calendar, Clock, MapPin, Building, Users, UserPlus, School, Library, Coffee, Wifi, Car, Bus, Bike, 
// Social & Communication
MessageCircle, MessageSquare, Send, Heart, Share2, Bookmark, Flag, UserCheck, UserX, AtSign, Hash, Smile, Zap, Star, Award, Trophy, Target, ThumbsUp, Mail, 
// Tools & Productivity
Wrench, Hammer, Code, Laptop, Smartphone, Tablet, Monitor, Keyboard, Mouse, Database, Server, Cloud, Download, Upload, FileText, Folder, Archive, 
// Campus Utilities
Lightbulb, Calculator, Compass, Camera, Mic, Volume2, VolumeX, Lock, Unlock, Eye, EyeOff, Trash2, Edit3, Copy, ExternalLink, MoreVertical, Crown, 
// Status & Feedback
CheckCircle, XCircle, AlertTriangle, HelpCircle, Loader2, RefreshCw, TrendingUp, TrendingDown, BarChart3, PieChart, Activity } from 'lucide-react';
// === ICON PHILOSOPHY ===
...
export const createIconClass = (size, color = 'default') => {
    return `${iconSizes[size].className} ${iconColorPatterns.semantic[color]}`;
};
export const createInteractiveIconClass = (size) => {
    return `${iconSizes[size].className} ${iconColorPatterns.interactive.idle}`;
};
export const createCampusIconClass = (size, context) => {
...
Lightbulb, Calculator, Compass, Camera, Mic, Volume2, VolumeX, Lock, Unlock, Eye, EyeOff, Trash2, Edit3, Copy, ExternalLink, MoreVertical, Crown, 
// Status & Feedback
CheckCircle, XCircle, AlertTriangle, HelpCircle, Loader2, RefreshCw, TrendingUp, TrendingDown, BarChart3, PieChart, Activity };
