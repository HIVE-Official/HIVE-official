...
import { PresenceIndicator, } from "../../02-Feed/atoms/presence-indicator";
...
export function ProfileIdentityWidget({ profile, isOwnProfile = false, presenceStatus = "offline", lastSeen, campusLabel, completionPercentage, onEditPhoto, privacyLevel, onPrivacyChange, className, }) {
