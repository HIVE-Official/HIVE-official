...
const BreadcrumbLink = React.forwardRef(({ asChild, className, ...props }, ref) => {
    ...
    return (_jsx(Comp, { ref: ref, className: cn("transition-colors duration-smooth ease-liquid hover:text-foreground", className), ...props }));
});
...
const BreadcrumbSeparator = ({ children, className, ...props }) => (_jsx("li", { role: "presentation", "aria-hidden": "true", className: cn("[&>svg]:w-3.5 [&>svg]:h-3.5", className), ...props, children: children ?? _jsx(ChevronRightIcon, {}) }));
