...
const SelectTrigger = React.forwardRef(({ className, variant, size, radius, children, ...props }, _ref) => (_jsxs(SelectPrimitive.Trigger, { ref: _ref, className: cn(selectTriggerVariants({ variant, size, radius }), className), ...props, children: [children, _jsx(SelectPrimitive.Icon, { asChild: true, children: _jsx(ChevronDownIcon, { className: "h-4 w-4 opacity-50" }) })] })));
SelectTrigger.displayName = SelectPrimitive.Trigger.displayName;
const SelectScrollUpButton = React.forwardRef(({ className, ...props }, _ref) => (_jsx(SelectPrimitive.ScrollUpButton, { ref: _ref, className: cn("flex cursor-default items-center justify-center py-1 text-[var(--hive-text-secondary)]", className), ...props, children: _jsx(ChevronUpIcon, { className: "h-4 w-4" }) })));
SelectScrollUpButton.displayName = SelectPrimitive.ScrollUpButton.displayName;
const SelectScrollDownButton = React.forwardRef(({ className, ...props }, _ref) => (_jsx(SelectPrimitive.ScrollDownButton, { ref: _ref, className: cn("flex cursor-default items-center justify-center py-1 text-[var(--hive-text-secondary)]", className), ...props, children: _jsx(ChevronDownIcon, { className: "h-4 w-4" }) })));
SelectScrollDownButton.displayName = SelectPrimitive.ScrollDownButton.displayName;
const SelectContent = React.forwardRef(({ className, children, position = "popper", ...props }, _ref) => (_jsx(SelectPrimitive.Portal, { children: _jsxs(SelectPrimitive.Content, { ref: _ref, className: cn(selectContentVariants({ position }), className), position: position, ...props, children: [_jsx(SelectScrollUpButton, {}), _jsx(SelectPrimitive.Viewport, { className: cn("p-1", position === "popper" &&
                    "h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)]"), children: children }), _jsx(SelectScrollDownButton, {})] }) })));
SelectContent.displayName = SelectPrimitive.Content.displayName;
const SelectLabel = React.forwardRef(({ className, ...props }, _ref) => (_jsx(SelectPrimitive.Label, { ref: _ref, className: cn("py-1.5 pl-8 pr-2 text-sm font-semibold text-[var(--hive-text-secondary)]", className), ...props })));
SelectLabel.displayName = SelectPrimitive.Label.displayName;
const SelectItem = React.forwardRef(({ className, children, ...props }, _ref) => (_jsxs(SelectPrimitive.Item, { ref: _ref, className: cn("relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm text-[var(--hive-text-primary)] outline-none focus:bg-[var(--hive-interactive-hover)] focus:text-[var(--hive-text-primary)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className), ...props, children: [_jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: _jsx(SelectPrimitive.ItemIndicator, { children: _jsx(CheckIcon, { className: "h-4 w-4" }) }) }), _jsx(SelectPrimitive.ItemText, { children: children })] })));
SelectItem.displayName = SelectPrimitive.Item.displayName;
const SelectSeparator = React.forwardRef(({ className, ...props }, _ref) => (_jsx(SelectPrimitive.Separator, { ref: _ref, className: cn("-mx-1 my-1 h-px bg-[var(--hive-border-subtle)]", className), ...props })));
SelectSeparator.displayName = SelectPrimitive.Separator.displayName;
const HiveSelect = React.forwardRef(({ className, variant = "default", size = "default", radius = "default", placeholder, error, success, helperText, label, required, value, onValueChange, children, disabled, ...props }, _ref) => {
...
// === ICONS ===
const ChevronDownIcon = React.forwardRef(({ className, ...props }, _ref) => (_jsx("svg", { ref: _ref, className: className, width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", ...props, children: _jsx("path", { d: "m6 9 6 6 6-6" }) })));
ChevronDownIcon.displayName = "ChevronDownIcon";
const ChevronUpIcon = React.forwardRef(({ className, ...props }, _ref) => (_jsx("svg", { ref: _ref, className: className, width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", ...props, children: _jsx("path", { d: "m18 15-6-6-6 6" }) })));
ChevronUpIcon.displayName = "ChevronUpIcon";
const CheckIcon = React.forwardRef(({ className, ...props }, _ref) => (_jsx("svg", { ref: _ref, className: className, width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", ...props, children: _jsx("path", { d: "M20 6 9 17l-5-5" }) })));
