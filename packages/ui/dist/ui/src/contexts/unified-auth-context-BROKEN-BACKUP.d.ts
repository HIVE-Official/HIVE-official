/**
 * HIVE Firebase Auth Context Provider
 * Pure Firebase Authentication - NO SESSION AUTH
 * Provides consistent auth state across all HIVE systems
 */
...
declare const UnifiedAuthContext: React.Context<UnifiedAuthContextType | null>;
...
//# sourceMappingURL=unified-auth-context-BROKEN-BACKUP.d.ts.map