...
export const HIVE_MOTION_CURVE = [0.33, 0.65, 0, 1];
...
export const isHiveMotion = (transition) => {
    const hivePattern = new RegExp(`(${HIVE_DURATIONS.micro}|${HIVE_DURATIONS.standard}|${HIVE_DURATIONS.complex}|${HIVE_DURATIONS.cinematic})ms.*${HIVE_MOTION_CURVE_CSS.replace(/[()]/g, '\\$&')}`);
...
//# sourceMappingURL=hive-motion.js.map