...
class HiveStoryGenerator {
    ...
    async generateComponentStory(component) {
...
export const Motion: Story = {
  render: () => (
    ...
    generateComponentDescription(component, context) {
    ...
    generateDetailedDescription(component, context) {
        return `
...
The ${component.componentName} ensures every interaction serves both social connection and academic success.`;
    ...
    generateSocialScenarios(scenarios) {
    ...
    async hasExistingStory(componentPath) {
