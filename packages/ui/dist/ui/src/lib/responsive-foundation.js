 ...
 */
export function combineResponsive(...classes) {
    return classes.filter(Boolean).join(' ');
}
/**
 * Get responsive container props for common patterns
 */
export function getContainerProps(type = 'app') {
    return {
...
export function getTouchProps() {
    return {
        className: combineResponsive(touchInteractions.tapTarget, a11yResponsive.focus),
    };
}
//# sourceMappingURL=responsive-foundation.js.map