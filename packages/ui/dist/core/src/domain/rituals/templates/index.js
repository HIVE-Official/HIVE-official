...
// ═════════════════════════════════════════════════════════════════
export const FOUNDING_CLASS_TEMPLATE = {
    metadata: {
        id: 'founding-class',
        name: 'Founding Class',
...
export const LAUNCH_COUNTDOWN_TEMPLATE = {
    metadata: {
        id: 'launch-countdown',
...
export const BETA_LOTTERY_TEMPLATE = {
    metadata: {
        id: 'beta-lottery',
        name: 'Beta Lottery',
...
export const UNLOCK_CHALLENGE_TEMPLATE = {
    metadata: {
        id: 'unlock-challenge',
...
export const SURVIVAL_TEMPLATE = {
    metadata: {
        id: 'survival-mode',
        name: 'Survival Mode',
...
// ═════════════════════════════════════════════════════════════════
export const CAMPUS_MADNESS_TEMPLATE = {
    metadata: {
        id: 'campus-madness',
        name: 'Campus Madness',
...
export const MAJOR_WARS_TEMPLATE = {
    metadata: {
        id: 'major-wars',
        name: 'Major Wars',
        archetype: RitualArchetype.Tournament,
...
export const DORM_WARS_TEMPLATE = {
    metadata: {
        id: 'dorm-wars',
        name: 'Dorm Wars',
        archetype: RitualArchetype.Tournament,
...
export const BANG_ANONYMOUS_TEMPLATE = {
    metadata: {
        id: 'bang-anonymous',
        name: 'Bang Anonymous',
...
export function getAvailableTemplates(currentUsers) {
...
export function getTemplatesByCategory(category) {
    return Object.values(RITUAL_TEMPLATES).filter((template) => template.metadata.category === category);
}
// Helper function to list templates by archetype
export function getTemplatesByArchetype(archetype) {
    return Object.values(RITUAL_TEMPLATES).filter((template) => template.metadata.archetype === archetype);
}
