...
export declare class AnalyticsSession {
     ...
     */
    setupBatching(batchSize: number, flushInterval: number, onFlush: (events: (CreationAnalyticsEvent | FeedAnalyticsEvent | OnboardingAnalyticsEvent)[]) => Promise<void>): void;
    /**
