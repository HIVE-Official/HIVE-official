 ...
 */
export function generateCohortSpaces(config) {
 ...
 */
export function createMajorAbbreviation(major) {
 ...
 */
export function getCohortSpaceId(major, graduationYear) {
 ...
 */
export function isCohortSpace(spaceId) {
 ...
 */
export function parseCohortSpaceId(spaceId) {
