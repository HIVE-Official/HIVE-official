...
import { getFeedRepository, getProfileRepository, getSpaceRepository, getRitualRepository } from '../infrastructure/repositories/factory';
    ...
    async getTrendingFeed(limit = 20) {
        return this.execute(async () => {
            ...
            if (trendingResult.isFailure) {
                return Result.fail(trendingResult.error);
            }
            const result = {
