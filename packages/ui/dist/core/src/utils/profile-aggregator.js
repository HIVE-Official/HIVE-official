...
export function withProfileData(Component) {
    return function ProfileDataComponent(props) {
        ...
        if (loading) {
            return _jsx("div", { children: "Loading profile data..." });
        }
        if (error) {
            return _jsxs("div", { children: ["Error loading profile: ", error] });
        }
        if (!profileData) {
            return _jsx("div", { children: "No profile data available" });
        }
        return _jsx(Component, { ...props, profileData: profileData });
    };
}
