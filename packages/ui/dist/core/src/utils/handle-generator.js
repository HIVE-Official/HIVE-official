...
export function generateBaseHandle(displayName) {
    return displayName
        .toLowerCase()
...
export function generateNameBasedHandles(displayName) {
...
export function generateHandleVariants(baseHandle) {
...
export async function findAvailableHandle(displayName, checkAvailability) {
...
export function generateHandleSuggestions(displayName, count = 4) {
    if (!displayName || displayName.trim().length === 0) {
        return [];
    }
