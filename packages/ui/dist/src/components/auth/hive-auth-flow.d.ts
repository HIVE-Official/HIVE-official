...
export declare function HiveAuthFlow({ className, onAuthSuccess, initialStep, mockMode }: HiveAuthFlowProps): import("react/jsx-runtime").JSX.Element;
export {};
//# sourceMappingURL=hive-auth-flow.d.ts.map