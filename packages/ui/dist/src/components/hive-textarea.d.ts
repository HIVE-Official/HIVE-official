...
declare const HiveCodeTextarea: React.ForwardRefExoticComponent<Omit<HiveTextareaProps, "label" | "className"> & React.RefAttributes<HTMLTextAreaElement>>;
