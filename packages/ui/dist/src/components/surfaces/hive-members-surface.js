...
import { Users, Search, MoreHorizontal, UserPlus, UserMinus, Crown, Shield, Star, MessageCircle, Eye, Calendar, Heart, Grid, List, UserX, Globe, Github, Twitter, Instagram, Linkedin } from 'lucide-react';
...
export const HiveMembersSurface = React.forwardRef(({ className, mode, space, members = [], currentUserId, isBuilder = false, canModerate = false, onViewProfile, onMessageMember, onInviteMember, onRemoveMember, onChangeRole, onBlockMember, viewMode = 'grid', showOfflineMembers = true, showMemberStats = true, maxMembers = 20, ...props }, ref) => {
