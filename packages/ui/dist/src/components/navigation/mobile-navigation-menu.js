...
import { Separator } from '../../atomic/atoms/separator.js';
...
const secondaryNavItems = [
    ...
    { id: 'events', label: 'Events', icon: Users, href: '/events' },
    { id: 'resources', label: 'Resources', icon: BookOpen, href: '/resources' },
];
const builderNavItems = [
    { id: 'build', label: 'Build', icon: Plus, href: '/build', isNew: true },
    { id: 'analytics', label: 'Analytics', icon: Activity, href: '/tools/analytics' },
];
const quickActions = [
