...
declare const HiveVolumeSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "label" | "min" | "max" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
declare const HiveBrightnessSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "label" | "min" | "max" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
declare const HiveProgressSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "label" | "min" | "max" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
declare const HivePriceRangeSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "label" | "min" | "max" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
declare const HiveTemperatureSlider: React.ForwardRefExoticComponent<Omit<HiveSliderProps, "label" | "min" | "max" | "showValue" | "valueFormatter"> & React.RefAttributes<HTMLSpanElement>>;
