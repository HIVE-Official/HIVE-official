...
import { Search, ArrowRight, User, Settings, Code, Zap, Users, Calendar, MessageSquare, Home, Compass, Plus, Heart } from 'lucide-react';
...
export const defaultSearchItems = [
    // Navigation
    {
        ...
        keywords: ['home', 'feed', 'timeline', 'dashboard'],
        shortcut: '⌘1'
    },
    {
        id: 'nav-spaces',
        title: 'Browse Spaces',
        description: 'Discover communities on campus',
        icon: _jsx(Compass, { size: 16 }),
        category: 'navigation',
        type: 'navigation',
        action: () => window.location.href = '/spaces',
        keywords: ['spaces', 'communities', 'discover', 'browse', 'explore'],
        shortcut: '⌘2'
    },
    {
        id: 'nav-tools',
        ...
        keywords: ['tools', 'gallery', 'marketplace', 'apps'],
        shortcut: '⌘3'
    },
    {
        id: 'nav-build',
        title: 'HiveLAB Builder',
        description: 'Create custom tools',
        icon: _jsx(Zap, { size: 16 }),
        category: 'navigation',
        type: 'navigation',
        action: () => window.location.href = '/build',
        keywords: ['build', 'create', 'tool', 'hivelab', 'maker'],
        shortcut: '⌘4'
    },
    {
        id: 'nav-profile',
        title: 'Your Profile',
        description: 'View your campus profile',
    ...
    // Quick Actions
    {
        ...
        type: 'action',
        action: () => window.location.href = '/build',
        keywords: ['create', 'new', 'tool', 'build', 'make']
    },
    {
        ...
        keywords: ['join', 'community', 'space', 'discover']
    },
    {
