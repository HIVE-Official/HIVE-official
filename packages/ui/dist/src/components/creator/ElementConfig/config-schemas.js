...
exports.ELEMENT_CONFIG_SCHEMAS = void 0;
exports.getElementConfigSchema = getElementConfigSchema;
exports.getAllElementConfigSchemas = getAllElementConfigSchemas;
// Configuration schemas for all element types
exports.ELEMENT_CONFIG_SCHEMAS = {
    textBlock: {
...
function getElementConfigSchema(elementType) {
    return exports.ELEMENT_CONFIG_SCHEMAS[elementType] || null;
}
function getAllElementConfigSchemas() {
    return Object.values(exports.ELEMENT_CONFIG_SCHEMAS);
}
