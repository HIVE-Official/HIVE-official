 ...
 * Space Category
 */
export type SpaceCategory = "student_org" | "academic" | "residential" | "athletics" | "arts" | "campus_services" | "social" | "community";
/**
 ...
 */
export type SpaceCardVariant = "default" | "discovery" | "joined" | "compact";
/**
 * Space Card Layout
 */
export type SpaceCardLayout = "vertical" | "horizontal";
/**
 * Space Action Types
 *
 ...
 */
export declare const createEmptyCampusContext: () => SpaceCampusContext;
/**
 * Helper: Create Default User Context
 */
export declare const createDefaultUserContext: () => SpaceUserContext;
/**
 * Helper: Create Default Stats
 */
export declare const createDefaultStats: () => SpaceStats;
/**
 * Type Guard: Check if action is post-related
 */
export declare const isPostAction: (action: SpaceAction) => boolean;
/**
 * Type Guard: Check if action is event-related
 */
export declare const isEventAction: (action: SpaceAction) => boolean;
/**
 * Type Guard: Check if action is member-related
 */
export declare const isMemberAction: (action: SpaceAction) => boolean;
/**
 * Type Guard: Check if action requires leader permissions
 */
export declare const isLeaderAction: (action: SpaceAction) => boolean;
/**
