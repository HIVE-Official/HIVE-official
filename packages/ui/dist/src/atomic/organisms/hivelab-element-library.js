...
const ElementCard = ({ element, onSelect, onToggleFavorite }) => {
    ...
    return (_jsxs("div", { draggable: true, onDragStart: handleDragStart, onClick: () => onSelect?.(element), className: cn("group relative flex items-center gap-3 p-2.5 rounded-lg", "border border-white/8 bg-[#0c0c0c]", "hover:bg-white/10 hover:border-[#FFD700]/50 transition-all cursor-grab active:cursor-grabbing", "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFD700]/20"), children: [_jsx("div", { className: "flex items-center justify-center w-8 h-8 rounded bg-white/10 shrink-0 text-lg group-hover:scale-110 transition-transform", children: element.icon }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("p", { className: "text-xs font-medium text-white truncate", children: element.name }), element.isNew && (_jsx(Badge, { variant: "default", className: "h-4 px-1 text-[9px] shrink-0", children: "NEW" })), element.complexity && element.complexity !== "simple" && (_jsx(Badge, { variant: "secondary", className: "h-4 px-1 text-[9px] shrink-0", children: element.complexity === "advanced" ? "Advanced" : "Med" }))] }), _jsx("p", { className: "text-[10px] text-white/70 truncate", children: element.description })] }), _jsx("button", { onClick: (e) => {
                    e.stopPropagation();
