...
const textareaVariants = cva("flex min-h-[108px] w-full border border-[var(--hive-border-default)] bg-[var(--hive-background-secondary)] px-5 py-3 text-sm text-[var(--hive-text-primary)] transition-[border,background,box-shadow] duration-200 ease-out placeholder:text-[var(--hive-text-muted)] focus-visible:outline-none focus-visible:border-[var(--hive-brand-primary)] focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--hive-brand-primary) 85%,transparent)] focus-visible:ring-offset-0 focus-visible:shadow-[0_0_28px_rgba(255,215,0,0.22)] disabled:cursor-not-allowed disabled:opacity-60", {
    variants: {
        variant: {
