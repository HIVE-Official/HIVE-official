...
export declare const liquidMetalUtils: {
    ...
    createEasedTransition(duration?: keyof typeof liquidTiming.duration, easing?: keyof typeof liquidEasing): {
        duration: 0.1 | 0.2 | 0.4 | 0.6 | 0.8 | 1.2 | 1.8 | 0.15;
        ease: readonly [0.23, 1, 0.32, 1] | readonly [0.25, 0.46, 0.45, 0.94] | readonly [0.16, 1, 0.3, 1] | readonly [0.34, 1.56, 0.64, 1] | readonly [0.19, 1, 0.22, 1] | readonly [0.25, 0.1, 0.25, 1];
    };
};
