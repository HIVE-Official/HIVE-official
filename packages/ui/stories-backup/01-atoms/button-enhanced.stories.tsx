...
- CSS custom properties for theming
  ...
  argTypes: {
    variant: {
      control: { type: 'select' },
      options: ['primary', 'secondary', 'premium', 'outline', 'outline-subtle', 'ghost', 'ghost-gold', 'chip', 'chip-platinum', 'chip-gold', 'chip-glass', 'link', 'glow', 'minimal', 'success', 'destructive', 'warning'],
...
export const AllVariants: Story = {
  render: () => (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4">
      ...
      <div className="text-center space-y-2">
        <h3 className="text-xs font-medium text-[var(--hive-text-secondary)]">Premium</h3>
        <Button variant="premium">Premium</Button>
      </div>
      <div className="text-center space-y-2">
        <h3 className="text-xs font-medium text-[var(--hive-text-secondary)]">Outline</h3>
      ...
      <div className="text-center space-y-2">
        <h3 className="text-xs font-medium text-[var(--hive-text-secondary)]">Ghost Gold</h3>
        <Button variant="ghost-gold">Ghost Gold</Button>
      </div>
      <div className="text-center space-y-2">
        <h3 className="text-xs font-medium text-[var(--hive-text-secondary)]">Chip</h3>
      ...
      <div className="text-center space-y-2">
        <h3 className="text-xs font-medium text-[var(--hive-text-secondary)]">Glow</h3>
