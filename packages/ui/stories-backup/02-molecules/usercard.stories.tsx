...
import { HiveCard as UserCard } from '../../components/hive-card';

/**
 * # UserCard - Social Media + Utility Platform
 * 
 * The UserCard molecule combines multiple social and utility atoms to create focused campus interactions. It bridges social media engagement with academic productivity in meaningful ways.
 * 
...
const MockUserCard: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">UserCard</h3>
...
const meta: Meta<typeof MockUserCard> = {
  title: '02-Molecules/UserCard',
  component: MockUserCard,
  parameters: {
    docs: {
      description: {
        component: `
# UserCard - Campus Social + Utility
...
The UserCard ensures every interaction serves both social connection and academic success.
        `
      }
    },
    layout: 'padded'
