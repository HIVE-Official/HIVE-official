...
import { HiveCommandPalette as SearchBar } from '../../components/hive-command-palette';

/**
 * # SearchBar - Social Media + Utility Platform
 * 
 * The SearchBar molecule combines multiple social and utility atoms to create focused campus interactions. It bridges social media engagement with academic productivity in meaningful ways.
 * 
...
const meta: Meta<typeof SearchBar> = {
  ...
  parameters: {
    docs: {
      description: {
        component: `
# SearchBar - Campus Social + Utility
...
The SearchBar ensures every interaction serves both social connection and academic success.
        `
      }
    },
    layout: 'padded'
    ...
    items: [
      {
        ...
        description: 'Join the computer science study group',
        category: 'spaces',
        icon: 'hash',
        action: () => {}
      },
      {
        id: '2', 
        title: 'Library Hours',
        description: 'Check current library operating hours',
        category: 'info',
        icon: 'clock',
        action: () => {}
      }
