...
import { FormComprehensive } from '../../atomic/molecules/form-comprehensive';

/**
 * # FormComprehensive - Social Media + Utility Platform
 * 
 * The FormComprehensive molecule combines multiple social and utility atoms to create focused campus interactions. It bridges social media engagement with academic productivity in meaningful ways.
 * 
...
const MockFormComprehensive: React.FC<any> = (props) => (
  <div className="p-4 bg-[var(--hive-background-secondary)] rounded-lg border border-[var(--hive-border-default)]">
    <h3 className="font-semibold text-[var(--hive-text-primary)]">FormComprehensive</h3>
...
const meta: Meta<typeof MockFormComprehensive> = {
  title: '02-Molecules/FormComprehensive',
  component: MockFormComprehensive,
  parameters: {
    docs: {
      description: {
        component: `
# FormComprehensive - Campus Social + Utility
...
The FormComprehensive ensures every interaction serves both social connection and academic success.
        `
      }
    },
    layout: 'padded'
