...
exports.UB_MAJORS = void 0;
exports.getMajorsBySchool = getMajorsBySchool;
 ...
 */
function getMajorsBySchool() {
    return exports.UB_MAJORS.reduce((acc, major) => {
        if (!acc[major.school]) {
            acc[major.school] = [];
        }
...
function getSchoolNames() {
    return [...new Set(exports.UB_MAJORS.map(major => major.school))].sort();
}
/**
...
function searchMajors(query) {
    ...
    return exports.UB_MAJORS.filter(major => major.name.toLowerCase().includes(lowercaseQuery));
}
