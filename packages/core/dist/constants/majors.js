...
exports.UB_MAJORS = exports.UB_GRADUATE_PROGRAMS = exports.UB_UNDERGRADUATE_MAJORS = void 0;
exports.getMajorsBySchool = getMajorsBySchool;
exports.getSchoolNames = getSchoolNames;
exports.searchMajors = searchMajors;
exports.UB_UNDERGRADUATE_MAJORS = [
    'Accounting',
    'Acting',
...
exports.UB_MAJORS = exports.UB_UNDERGRADUATE_MAJORS.map((name) => ({
    name,
...
function getSchoolNames() {
    return Array.from(new Set(exports.UB_MAJORS.map((major) => major.school))).sort();
}
/**
