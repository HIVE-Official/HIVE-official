...
exports.ElementRegistry = exports.HIVE_ELEMENTS = void 0;
/**
 * Built-in HIVE Elements Library
 */
exports.HIVE_ELEMENTS = [
    // ============================================
    // INPUT ELEMENTS
    // ============================================
    {
...
class ElementRegistry {
    ...
    registerBuiltInElements() {
        exports.HIVE_ELEMENTS.forEach(element => {
    ...
    searchElements(query) {
        ...
        return Array.from(this.elements.values()).filter(el => el.name.toLowerCase().includes(lowerQuery) ||
    ...
    canConnect(fromElement, fromPort, toElement, toPort) {
