...
const creation_analytics_event_1 = require("../events/creation-analytics.event");
const feed_analytics_event_1 = require("../events/feed-analytics.event");
const onboarding_analytics_event_1 = require("../events/onboarding-analytics.event");
class AnalyticsService {
    /**
     * Create a creation analytics event
     */
    static createAnalyticsEvent(eventType, context) {
        const event = creation_analytics_event_1.CreationAnalyticsEventEntity.create(eventType, context);
        return event.toJSON();
    }
    /**
    ...
    static createFeedEvent(eventType, context) {
        const event = feed_analytics_event_1.FeedAnalyticsEventEntity.create(eventType, context);
        return event.toJSON();
    }
    /**
    ...
    static createOnboardingEvent(stepName, context) {
        const event = onboarding_analytics_event_1.OnboardingAnalyticsEventEntity.create(stepName, context);
        return event.toJSON();
    }
    /**
