...
export declare class EventBatchingService {
    ...
    constructor(batchSize: number | undefined, flushInterval: number | undefined, onFlush: (events: (CreationAnalyticsEvent | FeedAnalyticsEvent | OnboardingAnalyticsEvent)[]) => Promise<void>);
    /**
     * Add event to batch
     */
