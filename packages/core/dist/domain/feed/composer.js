...
exports.ComposerFieldSchema = exports.ComposerStateSchema = exports.ComposerEngine = exports.ComposerTool = exports.ComposerMode = void 0;
...
(function (ComposerMode) {
    ComposerMode["INLINE"] = "inline";
    ComposerMode["MODAL"] = "modal";
    ComposerMode["EXPANDED_INLINE"] = "expanded_inline";
})(ComposerMode || (exports.ComposerMode = ComposerMode = {}));
/**
 * Available composer tools
 */
var ComposerTool;
(function (ComposerTool) {
    ComposerTool["PROMPT_POST"] = "prompt_post";
    ComposerTool["PULSE"] = "pulse";
    ComposerTool["EVENT_CARD"] = "event_card";
    ComposerTool["JOIN_FORM"] = "join_form";
    ComposerTool["POLL"] = "poll";
    ComposerTool["MEDIA_POST"] = "media_post";
})(ComposerTool || (exports.ComposerTool = ComposerTool = {}));
/**
...
class ComposerEngine {
     ...
     */
    static shouldSuggestExpand(content, currentMode) {
        return (currentMode === ComposerMode.INLINE &&
     ...
     */
    static transitionMode(currentState, targetMode, selectedTool) {
        const newState = {
            ...currentState,
            mode: targetMode,
        };
    ...
    static generatePostData(state) {
        ...
        switch (selectedTool) {
            case ComposerTool.POLL:
                return {
                    ...baseData,
                    pollOptions: typeof metadata.pollOptions === "string"
...
ComposerEngine.EXPAND_THRESHOLD = 140; // Characters before suggesting modal
ComposerEngine.INLINE_TOOLS = [ComposerTool.PROMPT_POST];
ComposerEngine.MODAL_TOOLS = [
    ComposerTool.PULSE,
    ComposerTool.EVENT_CARD,
    ComposerTool.JOIN_FORM,
    ComposerTool.POLL,
 ...
 */
exports.ComposerStateSchema = zod_1.z.object({
    mode: zod_1.z.nativeEnum(ComposerMode),
    selectedTool: zod_1.z.nativeEnum(ComposerTool).nullable(),
    isExpanded: zod_1.z.boolean(),
    content: zod_1.z.string(),
    metadata: zod_1.z.record(zod_1.z.unknown()),
    targetSpaceId: zod_1.z.string().optional(),
    isDragging: zod_1.z.boolean(),
    expandThreshold: zod_1.z.number(),
});
exports.ComposerFieldSchema = zod_1.z.object({
    id: zod_1.z.string(),
    type: zod_1.z.enum(["text", "textarea", "select", "date", "time", "file", "emoji"]),
