...
export declare const heroVariantSchema: z.ZodObject<{
    ...
    type: "bold" | "default" | "animated" | "minimal";
...
export declare function createAnimatedHeroVariant(rotatingWords: string[]): Partial<HeroContent>;
export declare function createMinimalHeroVariant(): Partial<HeroContent>;
