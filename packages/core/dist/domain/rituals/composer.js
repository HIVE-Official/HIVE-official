...
exports.RitualComposerSchema = void 0;
exports.createDefaultConfig = createDefaultConfig;
const zod_1 = require("zod");
const archetypes_1 = require("./archetypes");
exports.RitualComposerSchema = zod_1.z.object({
    campusId: zod_1.z.string().optional(),
    title: zod_1.z.string().min(3, "Title must be at least 3 characters"),
    subtitle: zod_1.z.string().max(140).optional(),
    ...
    slug: zod_1.z
        ...
        .optional(),
    archetype: zod_1.z.nativeEnum(archetypes_1.RitualArchetype),
...
function createDefaultConfig(archetype) {
    const now = new Date();
    const inThreeDays = new Date(now.getTime() + 3 * 24 * 60 * 60 * 1000).toISOString();
    switch (archetype) {
        case archetypes_1.RitualArchetype.FoundingClass:
            return {
                founding: {
                    limit: 100,
                    currentCount: 0,
        ...
        case archetypes_1.RitualArchetype.LaunchCountdown:
            return {
                countdown: {
        ...
        case archetypes_1.RitualArchetype.BetaLottery:
            return {
                lottery: {
                    feature: {
                        id: "beta_feature",
        ...
        case archetypes_1.RitualArchetype.UnlockChallenge:
            return {
                unlock: {
                    goal: {
                        metric: "posts",
        ...
        case archetypes_1.RitualArchetype.Survival: {
            const nowIso = now.toISOString();
            const durationHours = Math.max(1, Math.round((new Date(inThreeDays).getTime() - now.getTime()) / (1000 * 60 * 60)));
            return {
                survival: {
        ...
        case archetypes_1.RitualArchetype.Leak:
            return {
                leak: {
                    hiddenRitual: {
                        name: "Secret Ritual",
        ...
        case archetypes_1.RitualArchetype.Tournament:
            return {
                tournament: {
        ...
        case archetypes_1.RitualArchetype.FeatureDrop:
            return {
                featureDrop: {
                    feature: {
                        id: "feature_drop",
        ...
        case archetypes_1.RitualArchetype.RuleInversion:
            return {
                ruleInversion: {
                    inversions: [
                        {
