...
exports.DEFAULT_SPEC_PROFILE = exports.DEFAULT_SPEC_PRIVACY = exports.PROFILE_COMPLETION_STAGES = void 0;
exports.calculateConnectionStrength = calculateConnectionStrength;
exports.calculateProfileCompletion = calculateProfileCompletion;
exports.canViewWidget = canViewWidget;
exports.sanitizeProfileForViewer = sanitizeProfileForViewer;
exports.validateProfile = validateProfile;
exports.isSpecCompliantProfile = isSpecCompliantProfile;
 ...
 */
function calculateConnectionStrength(factors) {
...
exports.PROFILE_COMPLETION_STAGES = [
    {
        id: 'basic',
        name: 'Basic Setup',
...
function calculateProfileCompletion(profile) {
    ...
    const rewards = [];
    for (const stage of exports.PROFILE_COMPLETION_STAGES) {
    ...
    const nextStage = exports.PROFILE_COMPLETION_STAGES.find(s => !completedStages.includes(s.id)) || null;
    return {
 ...
 */
function canViewWidget(widget, viewerProfile, targetProfile) {
 ...
 */
function sanitizeProfileForViewer(profile, viewerProfile) {
    const sanitized = {
        identity: {
            ...profile.identity,
...
// TYPE GUARDS
// ============================================================================
function isSpecCompliantProfile(obj) {
    return (obj &&
        typeof obj === 'object' &&
        obj.identity &&
        obj.academic &&
...
function createEmptyProfile(userId, email) {
    return {
        ...
        privacy: exports.DEFAULT_SPEC_PRIVACY,
        social: {
            followerCount: 0,
            followingCount: 0,
