...
exports.SpaceDiscoveryEngine = exports.SpaceDiscoverySchema = exports.SpaceOwnerType = exports.SpaceStatus = exports.SpaceSection = void 0;
...
})(SpaceSection || (exports.SpaceSection = SpaceSection = {}));
/**
...
})(SpaceOwnerType || (exports.SpaceOwnerType = SpaceOwnerType = {}));
/**
 * Validation Schema
 */
exports.SpaceDiscoverySchema = zod_1.z.object({
    id: zod_1.z.string(),
    name: zod_1.z.string().min(1).max(100),
    description: zod_1.z.string().max(500).optional(),
    section: zod_1.z.nativeEnum(SpaceSection),
    status: zod_1.z.nativeEnum(SpaceStatus),
    ownerType: zod_1.z.nativeEnum(SpaceOwnerType),
    ownerId: zod_1.z.string().optional(),
    isVisible: zod_1.z.boolean(),
    isJoinable: zod_1.z.boolean(),
    requiresApproval: zod_1.z.boolean(),
    isAutoJoin: zod_1.z.boolean(),
    memberCount: zod_1.z.number().min(0),
    postCount: zod_1.z.number().min(0),
    lastActivity: zod_1.z.date().optional(),
    createdAt: zod_1.z.date(),
    openedAt: zod_1.z.date().optional(),
    crestUrl: zod_1.z.string().url().optional(),
    organizationType: zod_1.z.string().optional(),
    contactEmail: zod_1.z.string().email().optional(),
    discoveryScore: zod_1.z.number().min(0).max(100),
    trendingScore: zod_1.z.number().min(0).max(100),
    activityScore: zod_1.z.number().min(0).max(100),
    unlockConditions: zod_1.z
        .object({
        requiresMajor: zod_1.z.string().optional(),
        requiresDorm: zod_1.z.string().optional(),
        requiresYear: zod_1.z.string().optional(),
        requiresInvite: zod_1.z.boolean().optional(),
        builderCanOpen: zod_1.z.boolean().optional(),
    })
        .optional(),
});
/**
...
exports.SpaceDiscoveryEngine = SpaceDiscoveryEngine;
