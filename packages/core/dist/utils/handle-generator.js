...
exports.generateBaseHandle = generateBaseHandle;
exports.generateNameBasedHandles = generateNameBasedHandles;
exports.containsBadWords = containsBadWords;
exports.generateHandleVariants = generateHandleVariants;
exports.findAvailableHandle = findAvailableHandle;
exports.validateHandle = validateHandle;
exports.generateHandleSuggestions = generateHandleSuggestions;
...
function generateBaseHandle(displayName) {
    return displayName
        .toLowerCase()
...
function generateNameBasedHandles(displayName) {
...
function generateHandleVariants(baseHandle) {
...
async function findAvailableHandle(displayName, checkAvailability) {
...
function generateHandleSuggestions(displayName, count = 4) {
    if (!displayName || displayName.trim().length === 0) {
        return [];
    }
...
//# sourceMappingURL=handle-generator.js.map