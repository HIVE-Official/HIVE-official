...
// Utility functions
export const parseElementId = (elementId: ElementId): { name: string; version: number } => {
...
export const getLatestElementVersion = (elements: Element[], baseName: string): Element | null => {
...
export const validateElementConfig = (element: Element, config: any): boolean => {
  try {
