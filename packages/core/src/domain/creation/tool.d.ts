...
export declare const ToolMetadataSchema: z.ZodObject<
  {
    ...
    difficulty: z.ZodOptional<
      z.ZodEnum<["beginner", "intermediate", "advanced"]>
    >;
...
export declare const CreateToolSchema: z.ZodObject<
  {
    ...
    config: z.ZodOptional<
      z.ZodObject<
        {
          theme: z.ZodOptional<
            z.ZodDefault<z.ZodEnum<["light", "dark", "auto"]>>
          >;
      ...
      z.ZodObject<
        {
          ...
          difficulty: z.ZodOptional<
            z.ZodOptional<z.ZodEnum<["beginner", "intermediate", "advanced"]>>
          >;
...
export declare const ToolUsageEventSchema: z.ZodObject<
  {
    ...
    eventType: z.ZodEnum<
      ["view", "start", "complete", "abandon", "share", "fork"]
    >;
    timestamp: z.ZodDate;
...
export declare const createToolDefaults: (
  ownerId: string,
  data: CreateTool
...
export declare const getNextVersion: (
  currentVersion: string,
  changeType: "major" | "minor" | "patch"
) => string;
export declare const determineChangeType: (
