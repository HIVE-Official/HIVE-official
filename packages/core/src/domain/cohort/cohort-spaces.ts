 ...
 */
export function generateCohortSpaces(config: CohortSpaceConfig) {
 ...
 */
export function createMajorAbbreviation(major: string): string {
 ...
 */
export function getCohortSpaceId(major: string | null, graduationYear: number | null): string {
 ...
 */
export function isCohortSpace(spaceId: string): boolean {
 ...
 */
export function parseCohortSpaceId(spaceId: string): { major?: string; graduationYear?: number; cohortType?: string } | null {
