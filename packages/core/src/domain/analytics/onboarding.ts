...
// Step started event
export const OnboardingStepStartedEventSchema =
  BaseOnboardingEventSchema.extend({
...
export const OnboardingStepCompletedEventSchema =
  BaseOnboardingEventSchema.extend({
...
// Step skipped event
export const OnboardingStepSkippedEventSchema =
  BaseOnboardingEventSchema.extend({
...
export const OnboardingValidationErrorEventSchema =
  BaseOnboardingEventSchema.extend({
...
// TypeScript types
export type OnboardingStartedEvent = z.infer<
  typeof OnboardingStartedEventSchema
>;
export type OnboardingStepStartedEvent = z.infer<
  typeof OnboardingStepStartedEventSchema
>;
export type OnboardingStepCompletedEvent = z.infer<
  typeof OnboardingStepCompletedEventSchema
>;
export type OnboardingStepSkippedEvent = z.infer<
  typeof OnboardingStepSkippedEventSchema
>;
export type OnboardingValidationErrorEvent = z.infer<
  typeof OnboardingValidationErrorEventSchema
>;
export type OnboardingCompletedEvent = z.infer<
  typeof OnboardingCompletedEventSchema
>;
export type OnboardingAbandonedEvent = z.infer<
  typeof OnboardingAbandonedEventSchema
>;
...
export const createOnboardingEvent = {
  ...
  validationError: (
    ...
    stepName: OnboardingStepName,
    metadata?: Record<string, unknown>
  ): OnboardingValidationErrorEvent => ({
