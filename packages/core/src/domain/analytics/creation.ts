...
// Tool Usage Events (end-user interactions)
export const ToolInstanceOpenedEventSchema =
  CreationAnalyticsEventSchema.extend({
...
export const ToolInstanceSubmittedEventSchema =
  CreationAnalyticsEventSchema.extend({
...
export const ToolElementInteractedEventSchema =
  CreationAnalyticsEventSchema.extend({
...
export const shouldTrackEvent = (
  eventType: CreationEventType,
  userPreferences: { analyticsOptOut?: boolean } = {}
): boolean => {
  ...
  const criticalEvents: CreationEventType[] = [
    "tool_created",
    "tool_published",
    "tool_instance_submitted",
  ];
...
export const batchAnalyticsEvents = (
  events: CreationAnalyticsEvent[],
  maxBatchSize: number = 100
): CreationAnalyticsEvent[][] => {
  const batches: CreationAnalyticsEvent[][] = [];
...
export const shouldRetainEvent = (
