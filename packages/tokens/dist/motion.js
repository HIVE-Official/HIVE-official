...
export const createHiveTransition = (property = "all", duration = "fast", easing = "smooth") => {
    return `${property} ${motion.duration[duration]} ${motion.easing[easing]}`;
};
export const createHiveHover = (scale = "micro") => {
    return {
...
export const createGoldAccent = (duration = "fast") => {
    return {
