 ...
 */
export const validateAllContrasts = () => {
    const results = [];
...
export const hiveColorRules = {
     ...
     */
    semanticTokens: (colorValue, context) => {
        ...
        if (hardcodedColors[upperColor]) {
            return {
                ...
                severity: 'error',
                suggestion: `Use ${hardcodedColors[upperColor]} instead`,
                autoFixable: true
            };
        }
        return null;
    ...
    deprecatedColors: (colorValue, context) => {
        ...
        if (deprecated[upperColor]) {
            return {
                ...
                severity: 'error',
                suggestion: deprecated[upperColor],
                autoFixable: true
            };
        }
        return null;
