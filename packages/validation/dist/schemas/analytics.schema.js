...
export const UserAnalyticsSchema = z.object({
    ...
    date: z.string().regex(/^\d{4}-\d{2}-\d{2}$/), // YYYY-MM-DD format  dailyActiveMinutes: z.number().min(0).max(1440), // Max 24 hours sessionsCount: z.number().min(0)  postsCreated: z.number().min(0),
