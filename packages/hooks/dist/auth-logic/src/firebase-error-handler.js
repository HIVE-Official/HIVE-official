...
exports.FirebaseErrorHandler = exports.FUNCTIONS_ERROR_MESSAGES = exports.AUTH_ERROR_MESSAGES = void 0;
exports.useFirebaseErrorHandler = useFirebaseErrorHandler;
...
exports.FUNCTIONS_ERROR_MESSAGES = {
...
class FirebaseErrorHandler {
    ...
    static handleAuthError(error) {
        ...
        const message = exports.AUTH_ERROR_MESSAGES[error.code] ||
            error.message ||
    ...
    static handleFunctionsError(error) {
        ...
        const message = exports.FUNCTIONS_ERROR_MESSAGES[error.code] ||
            error.message ||
...
exports.default = FirebaseErrorHandler;
