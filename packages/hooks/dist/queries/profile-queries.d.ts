...
export declare function useUpdateProfile(): import("@tanstack/react-query").UseMutationResult<any, Error, Partial<ProfileData>, {
    previousProfile: unknown;
}>;
export declare function useUploadProfilePhoto(): import("@tanstack/react-query").UseMutationResult<any, Error, File, unknown>;
