  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        logger.error('Failed to fetch tool', { error, toolId });
        throw error;
      }
    },
    enabled: !!toolId,
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        logger.error('Failed to fetch tool templates', { error });
        throw error;
      }
    },
    ...options
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        logger.error('Failed to fetch tool analytics', { error, toolId });
        throw error;
      }
    },
    enabled: !!toolId,
