import{j as e}from"./jsx-runtime-B9GTzLod.js";import{r as Q}from"./index-BMjrbHXN.js";import{c as m}from"./utils-CytzSlOG.js";import{H as g,a as u,c as y,b as w}from"./hive-card-DIMxrd4t.js";import{B as b}from"./badge-BLajwy0n.js";import{T as a}from"./text-BOe2XosQ.js";import{B as p}from"./button-enhanced-DKTgaNxR.js";import{E as M}from"./eye-off-BD-Ijkxb.js";import{S as B}from"./settings-Cw08DGvz.js";import{S as E}from"./shield-DruECp-Z.js";import{C as ee}from"./check-ChQelZXp.js";import{A as _}from"./activity-BpE6NZRo.js";import{c as ie}from"./createLucideIcon-DtX30ipI.js";import{C as ae}from"./clock-B-89-V79.js";import{C as k}from"./chevron-right-CIwutkFF.js";import{T as te}from"./triangle-alert-Cs-Y0lD5.js";import{L as oe}from"./lock-CpC2nJsY.js";import{U as re}from"./users-B5XgMSov.js";import{G as se}from"./globe-nBk3QZSs.js";import{M as ne}from"./map-pin-J5WJcL57.js";import{M as ce}from"./message-square-B08MMCUN.js";import{E as de}from"./eye-DHVClHkA.js";import{a as i}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";/* empty css                    */import"./index-BwobEAja.js";import"./framer-motion-proxy-Bip1EXUU.js";import"./v4-CtRu48qb.js";/**
 * @license lucide-react v0.411.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=ie("Moon",[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z",key:"a7tn18"}]]),ve=n=>{const t={visibility:{color:"text-blue-500",bgColor:"bg-blue-500/10",borderColor:"border-blue-500/20",icon:de,label:"Visibility"},data:{color:"text-red-500",bgColor:"bg-red-500/10",borderColor:"border-red-500/20",icon:E,label:"Data Protection"},interaction:{color:"text-green-500",bgColor:"bg-green-500/10",borderColor:"border-green-500/20",icon:ce,label:"Interactions"},location:{color:"text-purple-500",bgColor:"bg-purple-500/10",borderColor:"border-purple-500/20",icon:ne,label:"Location"},activity:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",borderColor:"border-[var(--hive-gold)]/20",icon:_,label:"Activity Tracking"}};return t[n]||t.visibility},me=n=>{const t={public:{color:"text-green-500",bgColor:"bg-green-500/10",icon:se,label:"Public Profile"},friends:{color:"text-blue-500",bgColor:"bg-blue-500/10",icon:re,label:"Friends Only"},private:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",icon:oe,label:"Private"},ghost:{color:"text-purple-500",bgColor:"bg-purple-500/10",icon:M,label:"Ghost Mode"}};return t[n]||t.private},pe=n=>{const t=new Date(n),c=new Date,v=Math.floor((c.getTime()-t.getTime())/(1e3*60*60));if(v<1){const h=Math.floor((c.getTime()-t.getTime())/6e4);return h<1?"Just now":`${h}m ago`}else return v<24?`${v}h ago`:`${Math.floor(v/24)}d ago`},o=({user:n,ghostModeConfig:t,privacySettings:c=[],visibilityLevel:v="private",lastPrivacyUpdate:h,privacyScore:U=85,activeSessions:$=1,isEditable:d=!0,onToggleGhostMode:V,onUpdatePrivacySetting:G,onViewPrivacySettings:f,onConfigureGhostMode:S,onViewDataExport:L,className:K})=>{const[I,A]=Q.useState(!1),l=(t==null?void 0:t.isActive)||v==="ghost",j=me(v),X=c.filter(r=>r.isEnabled).length,Z=c.filter(r=>r.category==="data"&&r.isEnabled).length;return e.jsxs(g,{className:m("relative overflow-hidden transition-all duration-300 hover:shadow-lg","bg-[var(--hive-background-primary)] border-[var(--hive-border-primary)]",I&&"scale-[1.02]",l&&"border-purple-500/30 bg-purple-500/5",K),onMouseEnter:()=>A(!0),onMouseLeave:()=>A(!1),children:[e.jsx(u,{className:"pb-2",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Privacy & Ghost Mode"}),l&&e.jsxs(b,{variant:"outline",className:"text-xs text-purple-500",children:[e.jsx(M,{className:"h-3 w-3 mr-1"}),"Ghost Active"]})]}),d&&e.jsx(p,{variant:"ghost",size:"icon",onClick:f,className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(B,{className:"h-3 w-3"})})]})}),e.jsxs(y,{className:"space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(E,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsxs(a,{variant:"body-sm",weight:"medium",color:"primary",children:[U,"%"]})]}),e.jsx(a,{variant:"body-xs",color:"secondary",children:"Privacy Score"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(ee,{className:"h-3 w-3 text-green-500"}),e.jsx(a,{variant:"body-sm",weight:"medium",color:"primary",children:X})]}),e.jsx(a,{variant:"body-xs",color:"secondary",children:"Settings Active"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(_,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsx(a,{variant:"body-sm",weight:"medium",color:"primary",children:$})]}),e.jsx(a,{variant:"body-xs",color:"secondary",children:"Active Sessions"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(a,{variant:"body-sm",color:"primary",weight:"medium",children:"Current Status:"}),e.jsx("div",{className:m("p-3 rounded-lg border",j.bgColor,"border-[var(--hive-border-primary)]"),children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(j.icon,{className:m("h-4 w-4",j.color)}),e.jsx(a,{variant:"body-sm",weight:"medium",color:"primary",children:j.label})]}),h&&e.jsxs(a,{variant:"body-xs",color:"secondary",children:["Updated ",pe(h)]})]})})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(a,{variant:"body-sm",color:"primary",weight:"medium",children:"Ghost Mode:"}),d&&V&&e.jsx(p,{variant:l?"default":"outline",size:"sm",onClick:()=>V(!l),className:m(l&&"bg-purple-500 hover:bg-purple-600 text-white"),children:l?e.jsxs(e.Fragment,{children:[e.jsx(M,{className:"h-3 w-3 mr-1"}),"Disable"]}):e.jsxs(e.Fragment,{children:[e.jsx(le,{className:"h-3 w-3 mr-1"}),"Enable"]})})]}),l&&t&&e.jsxs("div",{className:"p-3 bg-purple-500/10 border border-purple-500/20 rounded-lg space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(a,{variant:"body-sm",color:"primary",children:"Ghost Mode Active"}),e.jsx(b,{variant:"outline",className:"text-xs text-purple-500",children:t.visibilityLevel})]}),e.jsxs(a,{variant:"body-xs",color:"secondary",children:["Your profile is ",t.visibilityLevel==="invisible"?"completely hidden":t.visibilityLevel==="minimal"?"minimally visible":"selectively visible","to other UB students"]}),t.duration==="scheduled"&&t.scheduledEnd&&e.jsxs("div",{className:"flex items-center gap-1 mt-2",children:[e.jsx(ae,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsxs(a,{variant:"body-xs",color:"secondary",children:["Ends: ",new Date(t.scheduledEnd).toLocaleDateString()]})]}),d&&S&&e.jsxs(p,{variant:"ghost",size:"sm",onClick:S,className:"mt-2 text-purple-500 hover:text-purple-600",children:["Configure Settings",e.jsx(k,{className:"h-3 w-3 ml-1"})]})]})]}),c.length>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(a,{variant:"body-sm",color:"primary",weight:"medium",children:"Privacy Controls:"}),c.length>3&&e.jsxs(a,{variant:"body-xs",color:"secondary",children:["+",c.length-3," more"]})]}),e.jsx("div",{className:"space-y-1",children:c.slice(0,3).map(r=>{const D=ve(r.category);return e.jsxs("div",{className:"flex items-center gap-2 p-2 rounded hover:bg-[var(--hive-background-secondary)] transition-colors cursor-pointer",onClick:()=>d&&(G==null?void 0:G(r.id,!r.isEnabled)),children:[e.jsx(D.icon,{className:m("h-3 w-3",D.color)}),e.jsx(a,{variant:"body-xs",color:"primary",className:"flex-1 truncate",children:r.name}),e.jsx("div",{className:m("w-2 h-2 rounded-full",r.isEnabled?"bg-green-500":"bg-[var(--hive-text-muted)]")}),d&&e.jsx(k,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"})]},r.id)})})]}),Z>0&&e.jsxs("div",{className:"space-y-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[e.jsx(a,{variant:"body-sm",color:"primary",weight:"medium",children:"Privacy Insights:"}),e.jsxs("div",{className:"p-3 bg-green-500/10 border border-green-500/20 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(E,{className:"h-4 w-4 text-green-500"}),e.jsxs(a,{variant:"body-sm",color:"primary",children:[Z," data protection settings active"]})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-1",children:"Your personal data is well-protected according to UB privacy standards"})]})]}),e.jsxs("div",{className:"flex gap-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[d&&f&&e.jsxs(p,{variant:"outline",size:"sm",onClick:f,className:"flex-1",children:[e.jsx(E,{className:"h-3 w-3 mr-1"}),"Privacy Settings"]}),d&&S&&e.jsxs(p,{variant:"default",size:"sm",onClick:S,className:"flex-1",children:[e.jsx(M,{className:"h-3 w-3 mr-1"}),"Ghost Config"]}),L&&e.jsx(p,{variant:"ghost",size:"icon",onClick:L,className:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(B,{className:"h-3 w-3"})})]}),U<50&&e.jsxs("div",{className:"p-3 bg-red-500/10 border border-red-500/20 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(te,{className:"h-4 w-4 text-red-500"}),e.jsx(a,{variant:"body-sm",color:"primary",weight:"medium",children:"Privacy Score Low"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-1",children:"Consider enabling more privacy settings to protect your UB campus activity"}),d&&f&&e.jsxs(p,{variant:"ghost",size:"sm",onClick:f,className:"mt-2 text-red-500 hover:text-red-600",children:["Review Settings",e.jsx(k,{className:"h-3 w-3 ml-1"})]})]})]}),I&&e.jsx("div",{className:m("absolute inset-0 -z-10 rounded-lg blur-xl",l?"bg-gradient-to-r from-purple-500/5 to-indigo-500/5":"bg-gradient-to-r from-blue-500/5 to-green-500/5")})]})};o.__docgenInfo={description:"",methods:[],displayName:"ProfileGhostModeWidget",props:{user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: string;
  name: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}}]}},description:""},ghostModeConfig:{required:!1,tsType:{name:"GhostModeConfig"},description:""},privacySettings:{required:!1,tsType:{name:"Array",elements:[{name:"PrivacySetting"}],raw:"PrivacySetting[]"},description:"",defaultValue:{value:"[]",computed:!1}},visibilityLevel:{required:!1,tsType:{name:"union",raw:"'public' | 'friends' | 'private' | 'ghost'",elements:[{name:"literal",value:"'public'"},{name:"literal",value:"'friends'"},{name:"literal",value:"'private'"},{name:"literal",value:"'ghost'"}]},description:"",defaultValue:{value:"'private'",computed:!1}},lastPrivacyUpdate:{required:!1,tsType:{name:"string"},description:""},privacyScore:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"85",computed:!1}},activeSessions:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},isEditable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onToggleGhostMode:{required:!1,tsType:{name:"signature",type:"function",raw:"(enabled: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"enabled"}],return:{name:"void"}}},description:""},onUpdatePrivacySetting:{required:!1,tsType:{name:"signature",type:"function",raw:"(settingId: string, enabled: boolean) => void",signature:{arguments:[{type:{name:"string"},name:"settingId"},{type:{name:"boolean"},name:"enabled"}],return:{name:"void"}}},description:""},onViewPrivacySettings:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onConfigureGhostMode:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onViewDataExport:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const Re={title:"04-Organisms/Profile System/Profile Ghost Mode Widget - COMPLETE DEFINITION",component:o,parameters:{docs:{description:{component:`
...
}`,...(W=(F=C.parameters)==null?void 0:F.docs)==null?void 0:W.source}}};var R,O,q;N.parameters={...N.parameters,docs:{...(R=N.parameters)==null?void 0:R.docs,source:{originalSource:`{
...
}`,...(q=(O=N.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var z,Y,J;P.parameters={...P.parameters,docs:{...(z=P.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    user: {
      id: 'user-playground',
      name: 'Alex Chen'
...
}`,...(J=(Y=P.parameters)==null?void 0:Y.docs)==null?void 0:J.source}}};const Oe=["Default","CompleteShowcase","Playground"];export{N as CompleteShowcase,C as Default,P as Playground,Oe as __namedExportsOrder,Re as default};
