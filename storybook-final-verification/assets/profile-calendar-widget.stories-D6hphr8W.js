import{j as e}from"./jsx-runtime-B9GTzLod.js";import{r as X}from"./index-BMjrbHXN.js";import{c as m}from"./utils-CytzSlOG.js";import{H as g,a as h,c as b,b as w}from"./hive-card-DIMxrd4t.js";import{B as E}from"./badge-BLajwy0n.js";import{T as t}from"./text-BOe2XosQ.js";import{B as v}from"./button-enhanced-DKTgaNxR.js";import{S as K}from"./settings-Cw08DGvz.js";import{C as z}from"./clock-B-89-V79.js";import{M as ee}from"./map-pin-J5WJcL57.js";import{U as F}from"./users-B5XgMSov.js";import{C as ae}from"./chevron-right-CIwutkFF.js";import{c as te}from"./createLucideIcon-DtX30ipI.js";import{P as ie}from"./plus-BTyRuzWD.js";import{C as se}from"./calendar-RwBiWFlj.js";import{E as ne}from"./external-link-BBRviWFd.js";import{Z as W}from"./zap-BzDMfB1h.js";import{B as Y}from"./book-open-BAcXQadr.js";import{C as _}from"./circle-alert-D27CINV1.js";import{C as re}from"./coffee-BUhMW6YC.js";import{a}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";/* empty css                    */import"./index-BwobEAja.js";import"./framer-motion-proxy-Bip1EXUU.js";import"./v4-CtRu48qb.js";/**
 * @license lucide-react v0.411.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const q=te("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]),p=l=>{const r={class:{color:"text-blue-500",bgColor:"bg-blue-500/10",borderColor:"border-blue-500/20",icon:Y,label:"Class"},study:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",borderColor:"border-[var(--hive-gold)]/20",icon:W,label:"Study"},meeting:{color:"text-purple-500",bgColor:"bg-purple-500/10",borderColor:"border-purple-500/20",icon:F,label:"Meeting"},personal:{color:"text-green-500",bgColor:"bg-green-500/10",borderColor:"border-green-500/20",icon:re,label:"Personal"},deadline:{color:"text-red-500",bgColor:"bg-red-500/10",borderColor:"border-red-500/20",icon:_,label:"Deadline"}};return r[l]||r.personal},oe=l=>{const r={available:{color:"text-green-500",bgColor:"bg-green-500/10",label:"Available for Study",icon:q},busy:{color:"text-red-500",bgColor:"bg-red-500/10",label:"Busy",icon:_},"in-class":{color:"text-blue-500",bgColor:"bg-blue-500/10",label:"In Class",icon:Y},studying:{color:"text-[var(--hive-gold)]",bgColor:"bg-[var(--hive-gold)]/10",label:"Studying",icon:W},offline:{color:"text-[var(--hive-text-muted)]",bgColor:"bg-[var(--hive-background-secondary)]",label:"Offline",icon:z}};return r[l]||r.offline},i=({user:l,todayEvents:r=[],upcomingEvents:de=[],availabilityStatus:J="available",nextAvailableSlot:N,studyHoursToday:j=0,studyGoal:u=6,isEditable:x=!0,onAddEvent:k,onViewCalendar:S,onEditEvent:y,onUpdateAvailability:Q,className:Z})=>{const[P,H]=X.useState(!1),c=oe(J),M=u>0?Math.min(j/u*100,100):0,s=r.find(n=>n.status!=="completed"),A=n=>new Date(`2024-01-01 ${n}`).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0});return e.jsxs(g,{className:m("relative overflow-hidden transition-all duration-300 hover:shadow-lg","bg-[var(--hive-background-primary)] border-[var(--hive-border-primary)]",P&&"scale-[1.02]",Z),onMouseEnter:()=>H(!0),onMouseLeave:()=>H(!1),children:[e.jsx(h,{className:"pb-2",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(t,{variant:"body-sm",color:"gold",weight:"medium",children:"Calendar & Schedule"}),e.jsxs(E,{variant:"outline",className:m("text-xs",c.color),children:[e.jsx(c.icon,{className:"h-3 w-3 mr-1"}),c.label]})]}),x&&e.jsx(v,{variant:"ghost",size:"icon",onClick:Q,className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(K,{className:"h-3 w-3"})})]})}),e.jsxs(b,{className:"space-y-4",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx("div",{className:m("p-3 rounded-lg border",c.bgColor,"border-[var(--hive-border-primary)]"),children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(c.icon,{className:m("h-4 w-4",c.color)}),e.jsx(t,{variant:"body-sm",weight:"medium",color:"primary",children:c.label})]}),N&&e.jsxs(t,{variant:"body-xs",color:"secondary",children:["Next free: ",N]})]})}),u>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(t,{variant:"body-sm",color:"primary",children:"Today's Study Progress"}),e.jsxs(t,{variant:"body-sm",color:"gold",weight:"medium",children:[j,"h / ",u,"h"]})]}),e.jsx("div",{className:"w-full bg-[var(--hive-background-secondary)] rounded-full h-2",children:e.jsx("div",{className:"bg-[var(--hive-gold)] rounded-full h-2 transition-all duration-500",style:{width:`${M}%`}})}),e.jsx(t,{variant:"body-xs",color:"secondary",children:M>=100?"🎉 Daily goal achieved!":`${(u-j).toFixed(1)}h remaining`})]})]}),s&&e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{variant:"body-sm",color:"primary",weight:"medium",children:"Next Event:"}),e.jsx("div",{className:m("p-3 rounded-lg border",p(s.type).bgColor,p(s.type).borderColor),children:e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex items-start gap-2 flex-1 min-w-0",children:[(()=>{const n=p(s.type).icon;return e.jsx(n,{className:m("h-4 w-4 mt-0.5 flex-shrink-0",p(s.type).color)})})(),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx(t,{variant:"body-sm",weight:"medium",color:"primary",className:"truncate",children:s.title}),e.jsxs("div",{className:"flex items-center gap-3 mt-1",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(z,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsxs(t,{variant:"body-xs",color:"secondary",children:[A(s.startTime)," - ",A(s.endTime)]})]}),s.location&&e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(ee,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsx(t,{variant:"body-xs",color:"secondary",className:"truncate",children:s.location})]})]}),s.participants&&s.participants>1&&e.jsxs("div",{className:"flex items-center gap-1 mt-1",children:[e.jsx(F,{className:"h-3 w-3 text-[var(--hive-text-secondary)]"}),e.jsxs(t,{variant:"body-xs",color:"secondary",children:[s.participants," participants"]})]})]})]}),x&&y&&e.jsx(v,{variant:"ghost",size:"icon",onClick:()=>y(s.id),className:"h-6 w-6 text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)] flex-shrink-0 ml-2",children:e.jsx(ae,{className:"h-3 w-3"})})]})})]}),r.length>1&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(t,{variant:"body-sm",color:"primary",weight:"medium",children:"Today's Schedule:"}),e.jsxs(t,{variant:"body-xs",color:"secondary",children:[r.filter(n=>n.status==="completed").length,"/",r.length," completed"]})]}),e.jsxs("div",{className:"space-y-1",children:[r.slice(0,3).map(n=>{const $=p(n.type);return e.jsxs("div",{className:"flex items-center gap-2 p-2 rounded hover:bg-[var(--hive-background-secondary)] transition-colors cursor-pointer",onClick:()=>x&&(y==null?void 0:y(n.id)),children:[e.jsx("div",{className:m("w-2 h-2 rounded-full",$.color.replace("text-","bg-"))}),e.jsx(t,{variant:"body-xs",color:"primary",className:"flex-1 truncate",children:n.title}),e.jsx(t,{variant:"body-xs",color:"secondary",children:A(n.startTime)}),n.status==="completed"&&e.jsx(q,{className:"h-3 w-3 text-green-500"})]},n.id)}),r.length>3&&e.jsx("div",{className:"text-center pt-1",children:e.jsxs(t,{variant:"body-xs",color:"secondary",children:["+",r.length-3," more events"]})})]})]}),e.jsxs("div",{className:"flex gap-2 pt-2 border-t border-[var(--hive-border-primary)]",children:[x&&k&&e.jsxs(v,{variant:"outline",size:"sm",onClick:k,className:"flex-1",children:[e.jsx(ie,{className:"h-3 w-3 mr-1"}),"Add Event"]}),S&&e.jsxs(v,{variant:"default",size:"sm",onClick:S,className:"flex-1",children:[e.jsx(se,{className:"h-3 w-3 mr-1"}),"View Calendar"]}),e.jsx(v,{variant:"ghost",size:"icon",onClick:S,className:"text-[var(--hive-text-secondary)] hover:text-[var(--hive-text-primary)]",children:e.jsx(ne,{className:"h-3 w-3"})})]})]}),P&&e.jsx("div",{className:"absolute inset-0 -z-10 bg-gradient-to-r from-blue-500/5 to-[var(--hive-gold)]/5 rounded-lg blur-xl"})]})};i.__docgenInfo={description:"",methods:[],displayName:"ProfileCalendarWidget",props:{user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: string;
  name: string;
  timezone?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}},{key:"timezone",value:{name:"string",required:!1}}]}},description:""},todayEvents:{required:!1,tsType:{name:"Array",elements:[{name:"CalendarEvent"}],raw:"CalendarEvent[]"},description:"",defaultValue:{value:"[]",computed:!1}},upcomingEvents:{required:!1,tsType:{name:"Array",elements:[{name:"CalendarEvent"}],raw:"CalendarEvent[]"},description:"",defaultValue:{value:"[]",computed:!1}},availabilityStatus:{required:!1,tsType:{name:"union",raw:"'available' | 'busy' | 'in-class' | 'studying' | 'offline'",elements:[{name:"literal",value:"'available'"},{name:"literal",value:"'busy'"},{name:"literal",value:"'in-class'"},{name:"literal",value:"'studying'"},{name:"literal",value:"'offline'"}]},description:"",defaultValue:{value:"'available'",computed:!1}},nextAvailableSlot:{required:!1,tsType:{name:"string"},description:""},studyHoursToday:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},studyGoal:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"6",computed:!1}},isEditable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onAddEvent:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onViewCalendar:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onEditEvent:{required:!1,tsType:{name:"signature",type:"function",raw:"(eventId: string) => void",signature:{arguments:[{type:{name:"string"},name:"eventId"}],return:{name:"void"}}},description:""},onUpdateAvailability:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const De={title:"03-Organisms/Profile Calendar Widget - COMPLETE DEFINITION",component:i,parameters:{docs:{description:{component:`
...
}`,...(I=(D=f.parameters)==null?void 0:D.docs)==null?void 0:I.source}}};var L,B,V;T.parameters={...T.parameters,docs:{...(L=T.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(V=(B=T.parameters)==null?void 0:B.docs)==null?void 0:V.source}}};var R,G,O;C.parameters={...C.parameters,docs:{...(R=C.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    user: sampleUser,
    todayEvents: sampleEvents.busyStudentDay,
    upcomingEvents: sampleEvents.lightScheduleDay,
...
}`,...(O=(G=C.parameters)==null?void 0:G.docs)==null?void 0:O.source}}};const Ie=["Default","CompleteShowcase","Playground"];export{T as CompleteShowcase,f as Default,C as Playground,Ie as __namedExportsOrder,De as default};
