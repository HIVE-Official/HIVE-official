import{j as e}from"./jsx-runtime-SKoiH9zj.js";import{R as O}from"./index-DJO9vBfz.js";import{c as q}from"./utils-CytzSlOG.js";import{H as d,a as s,b as t,c as o}from"./hive-tokens-CKIUfcHM.js";import{B as l}from"./badge-B09J4pcg.js";import{T as a}from"./text-Cao0VGB4.js";import"./index-BwobEAja.js";import"./framer-motion-proxy-Bzlf7Pk2.js";const z={xs:"max-w-xs",sm:"max-w-sm",md:"max-w-md",lg:"max-w-lg",xl:"max-w-xl","2xl":"max-w-2xl","3xl":"max-w-3xl","4xl":"max-w-4xl","5xl":"max-w-5xl","6xl":"max-w-6xl","7xl":"max-w-7xl",full:"max-w-full",none:"max-w-none"},J={none:"",xs:"p-2",sm:"p-4",md:"p-6",lg:"p-8",xl:"p-12"},Y={none:"",xs:"px-2",sm:"px-4 sm:px-6",md:"px-4 sm:px-6 md:px-8",lg:"px-4 sm:px-6 md:px-8 lg:px-12",xl:"px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16"},Q={default:"",card:["bg-[var(--hive-background-secondary)]","border border-[var(--hive-border-primary)]","rounded-xl","shadow-sm"].join(" "),panel:["bg-[var(--hive-background-primary)]","border border-[var(--hive-border-primary)]","rounded-lg"].join(" "),section:["bg-[var(--hive-background-tertiary)]","border-y border-[var(--hive-border-tertiary)]"].join(" ")},n=O.forwardRef(({maxWidth:r="7xl",padding:c="md",center:F=!0,fluid:j=!1,breakout:f=!1,variant:M="default",gutter:H=!1,className:X,children:U,..._},G)=>{const V=["w-full",!j&&!f&&z[r],F&&"mx-auto",H?Y[c]:J[c],j&&"min-w-full",f&&["relative","left-1/2","right-1/2","-ml-[50vw]","-mr-[50vw]","w-screen","max-w-none"].join(" "),Q[M]].filter(Boolean).join(" ");return e.jsx("div",{ref:G,className:q(V,X),..._,children:U})});n.displayName="Container";const g=r=>e.jsx(n,{maxWidth:"7xl",gutter:!0,...r}),p=r=>e.jsx(n,{maxWidth:"4xl",...r}),y=r=>e.jsx(n,{maxWidth:"2xl",...r}),C=r=>e.jsx(n,{maxWidth:"6xl",...r}),i=r=>e.jsx(n,{variant:"card",...r}),u=r=>e.jsx(n,{variant:"panel",...r}),I=r=>e.jsx(n,{variant:"section",...r}),m=r=>e.jsx(n,{maxWidth:"sm",...r}),B=r=>e.jsx(n,{maxWidth:"md",...r}),D=r=>e.jsx(n,{maxWidth:"lg",...r}),R=r=>e.jsx(n,{maxWidth:"xl",...r}),N=({children:r,className:c})=>e.jsx(n,{maxWidth:"4xl",center:!0,padding:"lg",className:c,children:r}),b=({children:r,className:c})=>e.jsx(n,{fluid:!0,variant:"section",padding:"xl",className:c,children:e.jsx(n,{maxWidth:"7xl",center:!0,padding:"none",children:r})});n.__docgenInfo={description:"",methods:[],displayName:"Container",props:{maxWidth:{required:!1,tsType:{name:"union",raw:"'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | '5xl' | '6xl' | '7xl' | 'full' | 'none'",elements:[{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"},{name:"literal",value:"'2xl'"},{name:"literal",value:"'3xl'"},{name:"literal",value:"'4xl'"},{name:"literal",value:"'5xl'"},{name:"literal",value:"'6xl'"},{name:"literal",value:"'7xl'"},{name:"literal",value:"'full'"},{name:"literal",value:"'none'"}]},description:"",defaultValue:{value:"'7xl'",computed:!1}},padding:{required:!1,tsType:{name:"union",raw:"'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl'",elements:[{name:"literal",value:"'none'"},{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},center:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},fluid:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},breakout:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},variant:{required:!1,tsType:{name:"union",raw:"'default' | 'card' | 'panel' | 'section'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'card'"},{name:"literal",value:"'panel'"},{name:"literal",value:"'section'"}]},description:"",defaultValue:{value:"'default'",computed:!1}},gutter:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};g.__docgenInfo={description:"",methods:[],displayName:"PageContainer"};p.__docgenInfo={description:"",methods:[],displayName:"ContentContainer"};y.__docgenInfo={description:"",methods:[],displayName:"NarrowContainer"};C.__docgenInfo={description:"",methods:[],displayName:"WideContainer"};i.__docgenInfo={description:"",methods:[],displayName:"CardContainer"};u.__docgenInfo={description:"",methods:[],displayName:"PanelContainer"};I.__docgenInfo={description:"",methods:[],displayName:"SectionContainer"};m.__docgenInfo={description:"",methods:[],displayName:"SmallContainer"};B.__docgenInfo={description:"",methods:[],displayName:"MediumContainer"};D.__docgenInfo={description:"",methods:[],displayName:"LargeContainer"};R.__docgenInfo={description:"",methods:[],displayName:"ExtraLargeContainer"};N.__docgenInfo={description:"",methods:[],displayName:"CenteredContent",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};b.__docgenInfo={description:"",methods:[],displayName:"FullWidthSection",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const de={title:"01-Atoms/Container - COMPLETE DEFINITION",component:n,parameters:{docs:{description:{component:`
...
}`,...(S=(w=x.parameters)==null?void 0:w.docs)==null?void 0:S.source}}};var k,W,P;v.parameters={...v.parameters,docs:{...(k=v.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(P=(W=v.parameters)==null?void 0:W.docs)==null?void 0:P.source}}};var L,A,E;h.parameters={...h.parameters,docs:{...(L=h.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    maxWidth: '4xl',
    padding: 'md',
    center: true,
...
}`,...(E=(A=h.parameters)==null?void 0:A.docs)==null?void 0:E.source}}};const se=["Default","CompleteShowcase","Playground"];export{v as CompleteShowcase,x as Default,h as Playground,se as __namedExportsOrder,de as default};
