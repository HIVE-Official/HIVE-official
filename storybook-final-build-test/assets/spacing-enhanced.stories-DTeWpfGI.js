import{j as e}from"./jsx-runtime-B9GTzLod.js";import{S as u,a as L,C as H,b as p,V as s,H as d,G as h,F as V,L as t}from"./spacing-enhanced-Bx1Tb3gF.js";import{H as n,c as o,a as c,b as l}from"./hive-card-DIMxrd4t.js";import{B as v}from"./badge-BLajwy0n.js";import{T as a}from"./text-BOe2XosQ.js";import{B as i}from"./button-DXaHCZ7Q.js";/* empty css                    */import"./index-BMjrbHXN.js";import"./index-BwobEAja.js";import"./utils-CytzSlOG.js";import"./framer-motion-proxy-Bip1EXUU.js";import"./loader-circle-C0fUCed1.js";import"./createLucideIcon-DtX30ipI.js";const Y={title:"01-Atoms/Spacing Enhanced - COMPLETE DEFINITION",component:u,parameters:{docs:{description:{component:`
...
`}}},tags:["autodocs"],argTypes:{direction:{control:"select",options:["horizontal","vertical"],description:"Stack direction"},spacing:{control:"select",options:["none","xs","sm","default","md","lg","xl","2xl","3xl"],description:"Stack spacing size"},align:{control:"select",options:["start","center","end","stretch","baseline"],description:"Cross-axis alignment"},justify:{control:"select",options:["start","center","end","between","around","evenly"],description:"Main-axis distribution"}}},r=({children:m,...z})=>e.jsx("div",{className:"p-4 bg-[var(--hive-background-secondary)] border border-[var(--hive-border-primary)] rounded-lg",...z,children:m}),g={args:{direction:"vertical",spacing:"default",align:"stretch",justify:"start"},render:m=>e.jsx("div",{className:"p-6 bg-[var(--hive-background-primary)]",children:e.jsx(n,{children:e.jsxs(o,{className:"space-y-4",children:[e.jsx(a,{variant:"body-md",color:"primary",children:"HIVE spacing and layout system for University at Buffalo platform organization:"}),e.jsxs(u,{...m,children:[e.jsx(r,{children:e.jsx(a,{variant:"body-sm",children:"First item in stack"})}),e.jsx(r,{children:e.jsx(a,{variant:"body-sm",children:"Second item in stack"})}),e.jsx(r,{children:e.jsx(a,{variant:"body-sm",children:"Third item in stack"})})]}),e.jsx(a,{variant:"body-sm",color:"secondary",children:"Flexible spacing system for consistent platform layout"})]})})})},x={render:()=>e.jsxs("div",{className:"space-y-8 p-6 bg-[var(--hive-background-primary)]",children:[e.jsxs(n,{children:[e.jsxs(c,{children:[e.jsxs(l,{className:"flex items-center gap-3",children:[e.jsx(v,{variant:"success",children:"📐 SPACING COMPONENTS"}),"Layout Component System"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Comprehensive spacing and layout components for University at Buffalo HIVE platform interface organization"})]}),e.jsx(o,{children:e.jsx("div",{className:"space-y-8",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Core Layout Components:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-4",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Spacer Component:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx("div",{className:"p-2 bg-[var(--hive-brand-gold)]/20 rounded",children:"Item 1"}),e.jsx(L,{size:"lg",direction:"horizontal"}),e.jsx("div",{className:"p-2 bg-[var(--hive-brand-gold)]/20 rounded",children:"Item 2"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Flexible spacer for precise spacing control between elements"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Container Component:"}),e.jsxs("div",{className:"bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsx(H,{size:"md",padding:"lg",children:e.jsx("div",{className:"p-4 bg-[var(--hive-brand-gold)]/10 rounded-lg text-center",children:e.jsx(a,{variant:"body-sm",children:"Container content with max-width and padding"})})}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"p-2",children:"Responsive container with size constraints and padding options"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Separator Component:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs("div",{children:[e.jsx(a,{variant:"body-sm",children:"Content above separator"}),e.jsx(p,{className:"my-4"}),e.jsx(a,{variant:"body-sm",children:"Content below separator"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Visual separation between content sections"})]})]})]})]})})})]}),e.jsxs(n,{children:[e.jsxs(c,{children:[e.jsxs(l,{className:"flex items-center gap-3",children:[e.jsx(v,{variant:"info",children:"📚 STACK SYSTEM"}),"Horizontal and Vertical Stacks"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Flexible stack components for organizing content with proper spacing and alignment"})]}),e.jsx(o,{children:e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Stack Directions:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Vertical Stack (VStack):"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(s,{spacing:"sm",children:[e.jsx(r,{children:"Course Space: CSE 331"}),e.jsx(r,{children:"Assignment: Algorithm Analysis"}),e.jsx(r,{children:"Due Date: Next Tuesday"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Vertical organization for course content and academic information"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Horizontal Stack (HStack):"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(d,{spacing:"sm",align:"center",children:[e.jsx(i,{size:"sm",children:"Join Space"}),e.jsx(i,{variant:"outline",size:"sm",children:"View Details"}),e.jsx(i,{variant:"ghost",size:"sm",children:"Share"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Horizontal arrangement for action buttons and navigation elements"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Stack Spacing Options:"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsxs("div",{className:"p-3 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsx(a,{variant:"body-xs",color:"secondary",className:"mb-2",children:"Small Spacing:"}),e.jsxs(s,{spacing:"xs",children:[e.jsx("div",{className:"p-2 bg-[var(--hive-brand-gold)]/20 rounded text-xs",children:"Item"}),e.jsx("div",{className:"p-2 bg-[var(--hive-brand-gold)]/20 rounded text-xs",children:"Item"}),e.jsx("div",{className:"p-2 bg-[var(--hive-brand-gold)]/20 rounded text-xs",children:"Item"})]})]}),e.jsxs("div",{className:"p-3 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsx(a,{variant:"body-xs",color:"secondary",className:"mb-2",children:"Large Spacing:"}),e.jsxs(s,{spacing:"lg",children:[e.jsx("div",{className:"p-2 bg-[var(--hive-brand-gold)]/20 rounded text-xs",children:"Item"}),e.jsx("div",{className:"p-2 bg-[var(--hive-brand-gold)]/20 rounded text-xs",children:"Item"}),e.jsx("div",{className:"p-2 bg-[var(--hive-brand-gold)]/20 rounded text-xs",children:"Item"})]})]})]})]})]})]})})})]}),e.jsxs(n,{children:[e.jsxs(c,{children:[e.jsxs(l,{className:"flex items-center gap-3",children:[e.jsx(v,{variant:"primary",children:"⚡ ADVANCED LAYOUTS"}),"Grid and Flex Systems"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Advanced layout systems for complex interface organization and responsive design"})]}),e.jsx(o,{children:e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Grid System:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Responsive Grid (3 columns):"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(h,{cols:3,gap:"md",responsive:!0,children:[e.jsx(r,{children:"Space Card 1"}),e.jsx(r,{children:"Space Card 2"}),e.jsx(r,{children:"Space Card 3"}),e.jsx(r,{children:"Space Card 4"}),e.jsx(r,{children:"Space Card 5"}),e.jsx(r,{children:"Space Card 6"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Responsive grid layout for space directory and course listings"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Flex Layout:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(V,{justify:"between",align:"center",gap:"sm",children:[e.jsx(r,{children:"Profile Info"}),e.jsx(r,{children:"Statistics"}),e.jsx(r,{children:"Actions"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Flexible layout with space distribution for profile headers and navigation"})]})]})]})]})})})]}),e.jsxs(n,{children:[e.jsxs(c,{children:[e.jsxs(l,{className:"flex items-center gap-3",children:[e.jsx(v,{variant:"secondary",children:"🎨 LAYOUT PRESETS"}),"Pre-configured Layout Patterns"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Common layout patterns optimized for University at Buffalo platform interface consistency"})]}),e.jsx(o,{children:e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Common Layout Patterns:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Page Layout:"}),e.jsxs("div",{className:"bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(t.PageLayout,{children:[e.jsx(r,{children:"Page Header"}),e.jsx(r,{children:"Main Content"}),e.jsx(r,{children:"Footer"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"p-2",children:"Standard page layout with container and vertical spacing"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Header Layout:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(t.HeaderLayout,{children:[e.jsx(r,{children:"Page Title"}),e.jsx(r,{children:"Actions"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Header layout with title and action buttons distributed across space"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Form Layout:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(t.FormLayout,{children:[e.jsx(r,{children:"Form Field 1"}),e.jsx(r,{children:"Form Field 2"}),e.jsx(r,{children:"Submit Button"})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Form layout with consistent spacing for registration and settings forms"})]})]})]})]})})})]}),e.jsxs(n,{children:[e.jsxs(c,{children:[e.jsxs(l,{className:"flex items-center gap-3",children:[e.jsx(v,{variant:"primary",children:"🦌 UNIVERSITY AT BUFFALO"}),"Real Campus Layout Scenarios"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Spacing and layout usage in actual University at Buffalo student interface and platform organization contexts"})]}),e.jsxs(o,{className:"space-y-8",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"CSE 331 Course Space Layout:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx(a,{as:"h3",variant:"heading-sm",color:"primary",children:"Algorithm Analysis Course Organization"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(t.PageLayout,{children:[e.jsx("div",{className:"p-4 bg-[var(--hive-brand-gold)]/10 rounded-lg",children:e.jsxs(t.HeaderLayout,{children:[e.jsxs(s,{spacing:"xs",children:[e.jsx(a,{variant:"heading-md",color:"primary",children:"CSE 331 - Algorithm Analysis"}),e.jsx(a,{variant:"body-sm",color:"secondary",children:"Fall 2024 • Dr. Emily Rodriguez"})]}),e.jsxs(d,{spacing:"sm",children:[e.jsx(i,{size:"sm",children:"Join Space"}),e.jsx(i,{variant:"outline",size:"sm",children:"Syllabus"})]})]})}),e.jsx(p,{}),e.jsxs(h,{cols:3,gap:"md",responsive:!0,children:[e.jsx("div",{className:"p-4 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsxs(s,{spacing:"sm",children:[e.jsx(a,{variant:"body-sm",weight:"medium",children:"Recent Assignments"}),e.jsxs(s,{spacing:"xs",children:[e.jsx(a,{variant:"body-xs",children:"Dynamic Programming - Due Mon"}),e.jsx(a,{variant:"body-xs",children:"Graph Algorithms - Due Wed"}),e.jsx(a,{variant:"body-xs",children:"Final Project - Due Dec 15"})]})]})}),e.jsx("div",{className:"p-4 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsxs(s,{spacing:"sm",children:[e.jsx(a,{variant:"body-sm",weight:"medium",children:"Study Groups"}),e.jsxs(s,{spacing:"xs",children:[e.jsx(a,{variant:"body-xs",children:"Algorithms Study Group"}),e.jsx(a,{variant:"body-xs",children:"Project Team Alpha"}),e.jsx(a,{variant:"body-xs",children:"Exam Prep Group"})]})]})}),e.jsx("div",{className:"p-4 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsxs(s,{spacing:"sm",children:[e.jsx(a,{variant:"body-sm",weight:"medium",children:"Resources"}),e.jsxs(s,{spacing:"xs",children:[e.jsx(a,{variant:"body-xs",children:"Lecture Notes"}),e.jsx(a,{variant:"body-xs",children:"Practice Problems"}),e.jsx(a,{variant:"body-xs",children:"Reference Materials"})]})]})})]})]}),e.jsx(a,{variant:"body-sm",color:"secondary",className:"mt-4",children:"Complete course space layout using HIVE spacing system for academic content organization"})]})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Student Dashboard Organization:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)]",children:[e.jsxs(s,{spacing:"lg",children:[e.jsxs(t.HeaderLayout,{children:[e.jsxs(s,{spacing:"xs",children:[e.jsx(a,{variant:"heading-lg",color:"primary",children:"Sarah Chen's Dashboard"}),e.jsx(a,{variant:"body-sm",color:"secondary",children:"Computer Science Senior • Fall 2024"})]}),e.jsxs(d,{spacing:"sm",children:[e.jsx(i,{size:"sm",variant:"outline",children:"Profile"}),e.jsx(i,{size:"sm",children:"Settings"})]})]}),e.jsx(p,{variant:"muted"}),e.jsxs(h,{cols:2,gap:"lg",responsive:!0,children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx(a,{variant:"body-md",weight:"medium",children:"Quick Actions"}),e.jsxs(s,{spacing:"sm",children:[e.jsx("div",{className:"p-3 bg-[var(--hive-brand-gold)]/10 rounded-lg",children:e.jsxs(d,{justify:"between",align:"center",children:[e.jsx(a,{variant:"body-sm",children:"Check Assignments"}),e.jsx(i,{size:"xs",children:"Go"})]})}),e.jsx("div",{className:"p-3 bg-[var(--hive-brand-gold)]/10 rounded-lg",children:e.jsxs(d,{justify:"between",align:"center",children:[e.jsx(a,{variant:"body-sm",children:"Join Study Group"}),e.jsx(i,{size:"xs",children:"Go"})]})}),e.jsx("div",{className:"p-3 bg-[var(--hive-brand-gold)]/10 rounded-lg",children:e.jsxs(d,{justify:"between",align:"center",children:[e.jsx(a,{variant:"body-sm",children:"View Calendar"}),e.jsx(i,{size:"xs",children:"Go"})]})})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx(a,{variant:"body-md",weight:"medium",children:"Recent Activity"}),e.jsxs(s,{spacing:"sm",children:[e.jsx("div",{className:"p-3 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsx(a,{variant:"body-xs",children:"Joined CSE 331 study group"})}),e.jsx("div",{className:"p-3 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsx(a,{variant:"body-xs",children:"Submitted algorithm assignment"})}),e.jsx("div",{className:"p-3 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsx(a,{variant:"body-xs",children:"Created project planning tool"})})]})]})]})]}),e.jsx(a,{variant:"body-sm",color:"secondary",className:"mt-4",children:"Student dashboard layout showcasing hierarchical spacing and responsive grid organization"})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Mobile Layout Optimization:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-6 rounded-lg space-y-6",children:[e.jsx(a,{variant:"body-md",color:"primary",children:"Mobile-optimized spacing for campus platform usage:"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Mobile Navigation Layout:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] max-w-sm",children:[e.jsxs(s,{spacing:"sm",children:[e.jsxs(t.HeaderLayout,{children:[e.jsx(a,{variant:"body-md",weight:"medium",children:"HIVE"}),e.jsx(i,{size:"sm",variant:"ghost",children:"Menu"})]}),e.jsx(p,{}),e.jsxs(s,{spacing:"xs",children:[e.jsx("div",{className:"w-full p-3 bg-[var(--hive-brand-gold)]/10 rounded-lg",children:e.jsx(a,{variant:"body-sm",children:"Feed"})}),e.jsx("div",{className:"w-full p-3 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsx(a,{variant:"body-sm",children:"Spaces"})}),e.jsx("div",{className:"w-full p-3 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsx(a,{variant:"body-sm",children:"Calendar"})})]})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Mobile navigation with touch-friendly spacing"})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{variant:"body-sm",color:"gold",weight:"medium",children:"Mobile Content Cards:"}),e.jsxs("div",{className:"p-4 bg-[var(--hive-background-primary)] rounded-lg border border-[var(--hive-border-primary)] max-w-sm",children:[e.jsxs(s,{spacing:"md",children:[e.jsx("div",{className:"w-full p-4 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsxs(s,{spacing:"sm",children:[e.jsx(a,{variant:"body-sm",weight:"medium",children:"CSE 331 Assignment"}),e.jsx(a,{variant:"body-xs",color:"secondary",children:"Due: Next Tuesday"}),e.jsxs(d,{spacing:"xs",justify:"end",children:[e.jsx(i,{size:"xs",children:"View"}),e.jsx(i,{size:"xs",variant:"outline",children:"Submit"})]})]})}),e.jsx("div",{className:"w-full p-4 bg-[var(--hive-background-secondary)] rounded-lg",children:e.jsxs(s,{spacing:"sm",children:[e.jsx(a,{variant:"body-sm",weight:"medium",children:"Study Group Meeting"}),e.jsx(a,{variant:"body-xs",color:"secondary",children:"Today at 3pm"}),e.jsxs(d,{spacing:"xs",justify:"end",children:[e.jsx(i,{size:"xs",children:"Join"}),e.jsx(i,{size:"xs",variant:"outline",children:"Details"})]})]})})]}),e.jsx(a,{variant:"body-xs",color:"secondary",className:"mt-2",children:"Mobile-optimized card layouts with appropriate spacing for thumb interaction"})]})]})]})]})]})]})]})]})},y={args:{direction:"vertical",spacing:"default",align:"stretch",justify:"start"},render:m=>e.jsx("div",{className:"p-6 bg-[var(--hive-background-primary)]",children:e.jsxs(n,{children:[e.jsxs(c,{children:[e.jsx(l,{children:"Spacing Enhanced Playground"}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Use the controls to test different spacing configurations"})]}),e.jsx(o,{className:"p-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsxs(u,{...m,children:[e.jsx(r,{children:e.jsx(a,{variant:"body-sm",children:"First item - adjust spacing and alignment"})}),e.jsx(r,{children:e.jsx(a,{variant:"body-sm",children:"Second item - testing layout behavior"})}),e.jsx(r,{children:e.jsx(a,{variant:"body-sm",children:"Third item - University at Buffalo spacing system"})})]}),e.jsx(a,{variant:"body-sm",color:"secondary",children:"Interactive spacing system testing for University at Buffalo HIVE platform layout consistency"})]})})]})})};var b,j,S;g.parameters={...g.parameters,docs:{...(b=g.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    direction: 'vertical',
    spacing: 'default',
    align: 'stretch',
...
}`,...(S=(j=g.parameters)==null?void 0:j.docs)==null?void 0:S.source}}};var N,C,f;x.parameters={...x.parameters,docs:{...(N=x.parameters)==null?void 0:N.docs,source:{originalSource:`{
...
}`,...(f=(C=x.parameters)==null?void 0:C.docs)==null?void 0:f.source}}};var T,k,w;y.parameters={...y.parameters,docs:{...(T=y.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    direction: 'vertical',
    spacing: 'default',
    align: 'stretch',
...
}`,...(w=(k=y.parameters)==null?void 0:k.docs)==null?void 0:w.source}}};const X=["Default","CompleteShowcase","Playground"];export{x as CompleteShowcase,g as Default,y as Playground,X as __namedExportsOrder,Y as default};
