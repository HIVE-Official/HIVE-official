...
test.describe("Tool Builder - Happy Path", () => {
  ...
  test("should add elements via drag and drop", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="canvas-element-textBlock"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="canvas-element-textInput"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="canvas-element-button"]')
    ).toBeVisible();
...
test.describe("Tool Builder - Element Management", () => {
  ...
  test("should lock/unlock elements", async ({ page }) => {
    ...
    const originalBox = await page
      .locator('[data-testid="canvas-element-textBlock"]')
      .boundingBox();
    await page.keyboard.press("ArrowRight");
  ...
  test("should show/hide elements", async ({ page }) => {
    ...
    await page.click('[data-testid="mode-preview"]');
    await expect(
      page.locator('[data-testid="preview-textBlock"]')
    ).not.toBeVisible();
...
test.describe("Tool Builder - Advanced Features", () => {
  ...
  test("should search element library", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="element-textBlock"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="element-textInput"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="element-button"]')
    ).not.toBeVisible();
  ...
  test("should filter elements by category", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="element-choiceSelect"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="element-textBlock"]')
    ).not.toBeVisible();
  ...
  test("should validate tool structure", async ({ page }) => {
    ...
    ).toContainText("exceeds maximum element limit");
  });
