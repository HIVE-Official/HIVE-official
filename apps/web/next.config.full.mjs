...
const nextConfig = {
  ...
  transpilePackages: ['@hive/ui', '@hive/core', '@hive/hooks', 'framer-motion'],
  
  // Performance optimizations
  experimental: {
    optimizePackageImports: ['lucide-react', '@hive/ui', 'framer-motion'],
  ...
  eslint: {
    // Temporarily ignore ESLint during builds to fix timeout
  ...
  webpack: (config, { isServer, dev }) => {
    // Production build optimizations - exclude test/mock files
    if (!dev) {
