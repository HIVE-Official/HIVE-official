...
const mockSpaces: Space[] = [
  {
    ...
    status: "activated",
    tags: [
      { type: "campus_living" as const, sub_type: "programming" },
      { type: "campus_living" as const, sub_type: "algorithms" },
    ],
  ...
  },
  {
    ...
    status: "activated",
    tags: [
      { type: "campus_living" as const, sub_type: "calculus" },
      { type: "campus_living" as const, sub_type: "statistics" },
    ],
