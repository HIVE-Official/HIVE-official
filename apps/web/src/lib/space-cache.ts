...
export const SpaceCaching = {
  ...
  async getOrSetSpace<T>(
    ...
    try {
      ...
      logger.error('Failed to fetch space data for cache', { spaceId, error });
      throw error;
    }
  },
  ...
  async getOrSetMembership<T>(
    ...
    try {
      ...
      logger.error('Failed to fetch membership data for cache', { userId, spaceId, error });
      throw error;
    }
  },
  ...
  async getOrSetTools<T>(
    ...
    try {
      ...
      logger.error('Failed to fetch tools data for cache', { spaceId, error });
      throw error;
    }
  },
