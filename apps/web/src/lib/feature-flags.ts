...
export class FeatureFlagService {
  ...
  async isFeatureEnabled(
    ...
    try {
      ...
      logger.error('Error evaluating feature flag', { error, flagId, userId: userContext.userId });
  ...
  async setFeatureFlag(flag: Omit<FeatureFlag, 'metadata'>, adminUserId: string): Promise<void> {
    try {
      ...
      logger.error('Error setting feature flag', { error, flagId: flag.id, adminUserId });
      throw error;
    }
  }
  ...
  async deleteFeatureFlag(flagId: string, adminUserId: string): Promise<void> {
    try {
      ...
      logger.error('Error deleting feature flag', { error, flagId, adminUserId });
      throw error;
    }
  }
  ...
  async getFeatureFlag(flagId: string): Promise<FeatureFlag | null> {
    try {
      ...
      logger.error('Error getting feature flag', { error, flagId });
      return null;
    }
  }
  ...
  async getFeatureFlagAnalytics(flagId: string, timeRange?: { start: string; end: string }): Promise<any> {
    try {
      ...
      logger.error('Error getting feature flag analytics', { error, flagId });
      return null;
    }
  }
  ...
  private async trackFeatureFlagEvaluation(
    ...
    try {
      ...
      logger.error('Error tracking feature flag evaluation', { error, flagId });
