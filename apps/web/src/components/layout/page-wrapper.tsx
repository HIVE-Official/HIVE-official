...
export function PageWrapper({
  ...
  if (isAuthPage) {
    return <main className="min-h-screen bg-[var(--hive-background-primary)] text-[var(--hive-text-inverse)]">{children}</main>;
  }

  return (
    <div className="min-h-screen bg-[var(--hive-background-primary)] font-sans text-[var(--hive-text-inverse)]">
      {/* <Navbar /> */}
