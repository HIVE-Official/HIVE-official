...
export function PageWrapper({
  ...
  if (isAuthPage) {
    return <main className="min-h-screen bg-[var(--hive-background-primary)] text-white">{children}</main>;
  }

  return (
    <div className="min-h-screen bg-[var(--hive-background-primary)] font-sans text-white">
      {/* <Navbar /> */}
