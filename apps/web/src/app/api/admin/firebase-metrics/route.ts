...
export const GET = withAuthAndErrors(async (context) => {
  ...
  try {
    ...
    logger.error('Error fetching Firebase metrics', { error: error instanceof Error ? error.message : String(error), userId: auth.userId });
...
async function getFirestoreMetrics(since: Date) {
  try {
    ...
    logger.error('Error getting Firestore metrics', { error: error instanceof Error ? error.message : String(error) });
...
async function getCollectionStats() {
  try {
    ...
    logger.error('Error getting collection stats', { error: error instanceof Error ? error.message : String(error) });
    return {
...
async function getRecentOperations(since: Date) {
  try {
    ...
    logger.error('Error getting recent operations', { error: error instanceof Error ? error.message : String(error) });
    return {
      reads: 45234,
      writes: 12456,
      deletes: 234,
...
async function getAuthenticationMetrics(since: Date) {
  try {
    ...
    logger.error('Error getting authentication metrics', { error: error instanceof Error ? error.message : String(error) });
...
async function getHostingMetrics(since: Date) {
  try {
    ...
    logger.error('Error getting hosting metrics', { error: error instanceof Error ? error.message : String(error) });
...
async function getFunctionsMetrics(since: Date) {
  try {
    ...
    logger.error('Error getting functions metrics', { error: error instanceof Error ? error.message : String(error) });
...
async function getPerformanceMetrics(since: Date) {
  try {
    ...
    logger.error('Error getting performance metrics', { error: error instanceof Error ? error.message : String(error) });
