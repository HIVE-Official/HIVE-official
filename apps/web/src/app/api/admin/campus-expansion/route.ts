...
export const GET = withAuthAndErrors(async (context) => {
  ...
  try {
    ...
    logger.error('Error fetching campus expansion data', { error: error instanceof Error ? error.message : String(error), userId: auth.userId });
...
export const POST = withAuthAndErrors(async (context) => {
  ...
  try {
    ...
    logger.error('Error performing campus expansion action', { error: error instanceof Error ? error.message : String(error), userId: auth.userId });
...
async function getCampusMetrics() {
  try {
    ...
    logger.error('Error getting campus metrics', { error: error instanceof Error ? error.message : String(error) });
...
async function getExpansionPipeline() {
  try {
    ...
    logger.error('Error getting expansion pipeline', { error: error instanceof Error ? error.message : String(error) });
...
async function getCampusReadinessAssessment() {
  try {
    ...
    logger.error('Error assessing campus readiness', { error: error instanceof Error ? error.message : String(error) });
...
async function getScalingPlan() {
  try {
    ...
    logger.error('Error getting scaling plan', { error: error instanceof Error ? error.message : String(error) });
...
async function addCampusToPipeline(campusData: any, userId: string) {
  try {
    ...
    logger.error('Error adding campus to pipeline', { error: error instanceof Error ? error.message : String(error) });
...
async function updateCampusStatus(campusId: string, updateData: any, userId: string) {
  try {
    ...
    logger.error('Error updating campus status', { error: error instanceof Error ? error.message : String(error) });
...
async function deployCampusInfrastructure(campusId: string, deploymentData: any, userId: string) {
  try {
    ...
    logger.error('Error deploying campus infrastructure', { error: error instanceof Error ? error.message : String(error) });
...
async function generateExpansionReport(userId: string) {
  try {
    ...
    logger.error('Error generating expansion report', { error: error instanceof Error ? error.message : String(error) });
