...
export const GET = withAuthAndErrors(async (context) => {
  ...
  try {
    ...
    logger.error('Error fetching alerts', { error: error instanceof Error ? error.message : String(error), userId: auth.userId });
...
export const POST = withAuthAndErrors(async (context) => {
  ...
  try {
    ...
    logger.error('Error performing alert action', { error: error instanceof Error ? error.message : String(error), userId: auth.userId });
...
async function getSystemAlerts(since: Date, severity?: string, component?: string) {
  try {
    ...
    logger.error('Error getting system alerts', { error: error instanceof Error ? error.message : String(error) });
    return [];
  }
}
...
async function getPerformanceAlerts(since: Date, severity?: string) {
  try {
    ...
    logger.error('Error getting performance alerts', { error: error instanceof Error ? error.message : String(error) });
    return [];
  }
}
...
async function getSecurityAlerts(since: Date, severity?: string) {
  try {
    ...
    logger.error('Error getting security alerts', { error: error instanceof Error ? error.message : String(error) });
...
async function getUserImpactAlerts(since: Date, severity?: string) {
  try {
    ...
    logger.error('Error getting user impact alerts', { error: error instanceof Error ? error.message : String(error) });
    return [];
  }
}
...
async function getActiveIncidents() {
  try {
    ...
    logger.error('Error getting active incidents', { error: error instanceof Error ? error.message : String(error) });
    return [{
      id: 'incident-001',
...
async function acknowledgeAlert(alertId: string, userId: string, notes?: string) {
  try {
    ...
    logger.error('Error acknowledging alert', { error: error instanceof Error ? error.message : String(error), userId, metadata: { alertId } });
...
async function resolveAlert(alertId: string, userId: string, notes?: string) {
  try {
    ...
    logger.error('Error resolving alert', { error: error instanceof Error ? error.message : String(error), userId, metadata: { alertId } });
...
async function escalateAlert(alertId: string, userId: string, notes?: string) {
  try {
    ...
    logger.error('Error escalating alert', { error: error instanceof Error ? error.message : String(error), userId, metadata: { alertId } });
...
async function suppressAlert(alertId: string, userId: string, notes?: string) {
  try {
    ...
    logger.error('Error suppressing alert', { error: error instanceof Error ? error.message : String(error), userId, metadata: { alertId } });
