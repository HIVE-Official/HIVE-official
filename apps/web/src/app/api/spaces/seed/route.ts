...
const SPACE_TEMPLATES = {
  ...
  cohort: [
    ...
    {
      name: "CS 2026",
      description: "Computer Science students graduating in 2026 - your core academic cohort.",
      tags: ["Major", "Year", "CS"],
      memberCount: 35
    },
    {
    ...
    {
      name: "Class of 2027",
      description: "Students graduating in 2027 - connect with your class for academic and social activities.",
      ...
      try {
        ...
        for (const space of spaces) {
          ...
          const spaceData = {
            ...
            tags: space.tags,
            memberCount: 0, // Start with 0 actual members
            potentialMembers: space.memberCount || 0, // Use memberCount as potential
            isPrivate: space.isPrivate || false,
            status: 'preview', // Preview mode for leader activation
            awaitingLeader: true, // Flag for spaces needing leaders
            ...
            previewEvents: [], // Will be populated by RSS
            activationRequests: [], // Track who wants to lead
            featuredInPreview: Math.random() > 0.7 // 30% featured
          };
