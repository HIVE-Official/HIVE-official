...
export default function FeedPageStoryBookMigration() {
  ...
  const transformApiDataToStorybook = (apiData: any[]): SophisticatedFeedPost[] => {
        ...
        const mockApiResponse = [
          {
            ...
            content: 'Just finished setting up our final exam review session! Room booking confirmed for Lockwood Library study room 204 this Thursday 7-9pm. Bringing whiteboard markers and practice problems 📚',
          ...
          },
          {
            ...
            content: 'Pizza night tonight at 8pm in the common room! Ordering from Mister Pizza. Drop your order in our group chat or DM me. Split cost between everyone who orders 🍕',
          ...
          },
          {
            ...
            authorHandle: 'jliu7',
            authorRole: 'builder',
            content: 'Built a new room finder tool for the library! No more wandering around looking for empty study spaces. Real-time availability for all floors. Check it out and let me know what you think! 🔍',
