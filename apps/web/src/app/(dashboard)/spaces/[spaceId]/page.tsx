...
import { Button, Badge, PageContainer } from "@hive/ui";
import { Users, AlertTriangle, Loader2, Hash } from "lucide-react";
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-6">
              <h2 className="text-lg font-semibold text-white mb-4">Space Feed</h2>
              <p className="text-neutral-400">
                Feed functionality coming soon. Join the space to get notified when it's activated.
              </p>
            </div>
          </div>
        </div>
