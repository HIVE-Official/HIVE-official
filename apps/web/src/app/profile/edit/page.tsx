...
function ProfileEditContent() {
  ...
  const { hiveProfile: profile, updateProfile, uploadAvatar, isLoading, isUpdating } =
    useProfileContext();
  ...
  const pronounOptions = ["they/them", "she/her", "he/him", "ze/zir", "other"];
  ...
  const validateForm = (): boolean => {
    ...
    if (
      ...
      (parseInt(formData.graduationYear) < 2024 ||
        parseInt(formData.graduationYear) > 2035)
    ) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const academicYear = validAcademicYears.includes(
        formData.academicYear.toLowerCase()
      )
        ? (formData.academicYear.toLowerCase() as
            | "freshman"
            | "sophomore"
            | "junior"
            | "senior"
    ...
    <div>
      ...
      >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField>
                  ...
                  {validationErrors.fullName && <FormMessage>{validationErrors.fullName}</FormMessage>}
                </FormField>
              ...
              <div className="mt-4">
                <FormField>
                  ...
                  {validationErrors.handle && <FormMessage>{validationErrors.handle}</FormMessage>}
                </FormField>
              </div>
              ...
              <div className="mt-4">
                <FormField>
                  ...
                  {validationErrors.bio && <FormMessage>{validationErrors.bio}</FormMessage>}
            ...
            <Card className="p-6">
              ...
              <FormField>
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    handleInputChange("housing", e.target.value)
                  }
        ...
        >
          <HiveModalContent>
            <HiveModalHeader>
              <HiveModalTitle>Update Profile Photo</HiveModalTitle>
              <HiveModalDescription>
                Choose a new profile photo that represents you on campus
              </HiveModalDescription>
            </HiveModalHeader>
...
/**
 * Main Profile Edit Page - Unified with ProfileContextProvider
 */
