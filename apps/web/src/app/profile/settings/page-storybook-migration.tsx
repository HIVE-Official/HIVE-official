...
export default function ProfileSettingsStorybook() {
  ...
  const { profile, updateProfile, toggleGhostMode, isLoading, isUpdating } =
    useHiveProfile();
    ...
    <ErrorBoundary>
      ...
      >
              ...
              <div className="space-y-4">
                <FormField>
                  ...
                  <FormControl>
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("email", "spaceInvites", checked)
                    }
                  />
                </FormControl>
                ...
                <FormField>
                  ...
                  <FormControl>
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("email", "eventReminders", checked)
                    }
                  />
                  </FormControl>
                ...
                <FormField>
                  ...
                  <FormControl>
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("email", "toolUpdates", checked)
                    }
                  />
                </FormControl>
                ...
                <FormField>
                  ...
                  <FormControl>
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("email", "weeklyDigest", checked)
                    }
                  />
                </FormControl>
                ...
                <FormField>
                  ...
                  <FormControl>
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("email", "securityAlerts", checked)
                    }
                  />
                  </FormControl>
              ...
              <div className="space-y-4">
                <FormField>
                  ...
                  <FormControl>
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("push", "spaceActivity", checked)
                    }
                  />
                </FormControl>
                ...
                <FormField>
                  ...
                  <FormControl>
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("push", "toolLaunches", checked)
                    }
                  />
                </FormControl>
                ...
                <FormField>
                  ...
                  <FormControl>
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("push", "directMessages", checked)
                    }
                  />
                  </FormControl>
            ...
            <Card className="p-6 border-purple-500/20 bg-purple-500/5">
              ...
              <div className="space-y-4">
                <p className="text-sm text-gray-400 mb-4">
                  Ghost Mode helps you stay focused during finals, study
                  sessions, or when you need a break from social interactions
                  while still accessing your tools and spaces.
                </p>
                    ...
                    <div className="flex items-center gap-2">
                      {["immediate", "daily", "weekly", "never"].map((freq) => (
                        <Badge
                          ...
                          onClick={() =>
                            handleAccountChange("emailFrequency", freq)
                          }
                        >
                          {freq}
                        </Badge>
              ...
              <div className="space-y-4">
                <div className="p-4 border border-red-500/20 rounded-lg">
                  ...
                  <p className="text-xs text-gray-400 mb-3">
                    Permanently delete your HIVE account and all associated
        ...
        <HiveConfirmModal
          ...
          variant={
            privacySettings.ghostMode.enabled ? "default" : "danger"
          }
        />
