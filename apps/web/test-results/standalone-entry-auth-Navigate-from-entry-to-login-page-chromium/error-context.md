...
- generic [ref=e1]:
  - generic [ref=e3]:
    - img "HIVE" [ref=e5]
    - heading "HIVE" [level=1] [ref=e6]
    - paragraph [ref=e7]: Your Campus, Connected
    - generic [ref=e8]:
      - link "Get Started" [ref=e9] [cursor=pointer]:
        - /url: /schools
        - button "Get Started" [ref=e10] [cursor=pointer]
      - paragraph [ref=e11]:
        - link "Sign In" [active] [ref=e12] [cursor=pointer]:
          - /url: /auth/login
  - button "HIVE" [ref=e14] [cursor=pointer]:
    - img "HIVE" [ref=e15] [cursor=pointer]
