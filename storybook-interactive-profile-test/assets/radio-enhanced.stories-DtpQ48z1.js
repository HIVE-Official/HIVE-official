import{j as e}from"./jsx-runtime-B9GTzLod.js";import{R as a,a as r,b as s,c as d}from"./radio-enhanced-bug1PkKU.js";import{H as t,a as l,b as n,c as o}from"./hive-card-DIMxrd4t.js";import{B as i}from"./badge-BLajwy0n.js";/* empty css                    */import"./index-BMjrbHXN.js";import"./index-BwobEAja.js";import"./utils-CytzSlOG.js";import"./framer-motion-proxy-Bip1EXUU.js";const B={title:"01-Atoms/Radio Enhanced - COMPLETE DEFINITION",component:a,parameters:{docs:{description:{component:`
...
`}}},tags:["autodocs"],argTypes:{variant:{control:"select",options:["default","success","error","warning","info"],description:"Radio variant (default uses gold fill for selected state)"},size:{control:"select",options:["sm","default","lg","xl"],description:"Radio size (all optimized for mobile touch)"},checked:{control:"boolean",description:"Selected state"},disabled:{control:"boolean",description:"Disabled state"}}},c={args:{label:"Enable push notifications",description:"Receive real-time updates about your campus activities",variant:"default",size:"default",checked:!0,name:"notifications",value:"push"}},m={render:()=>e.jsxs("div",{className:"space-y-8 p-6 bg-[var(--hive-background-primary)]",children:[e.jsxs(t,{children:[e.jsxs(l,{children:[e.jsxs(n,{className:"flex items-center gap-3",children:[e.jsx(i,{variant:"success",children:"✅ VARIANTS"}),"Radio Variants - Perfect Semantic Token Usage"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"5 variants using 100% semantic tokens (default uses gold fill for selected state)"})]}),e.jsx(o,{children:e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx(a,{label:"Default (Gold Fill)",description:"Gold fill indicates selected campus preferences",variant:"default",checked:!0,name:"variant-demo-1",value:"default"}),e.jsx(a,{label:"Success Selection",description:"Indicates confirmed or validated choices",variant:"success",checked:!0,name:"variant-demo-2",value:"success"}),e.jsx(a,{label:"Error Selection",description:"Used for critical or problematic options",variant:"error",checked:!1,name:"variant-demo-3",value:"error"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx(a,{label:"Warning Selection",description:"Options that require attention or caution",variant:"warning",checked:!0,name:"variant-demo-4",value:"warning"}),e.jsx(a,{label:"Info Selection",description:"Informational options and secondary choices",variant:"info",checked:!1,name:"variant-demo-5",value:"info"})]})]})})]}),e.jsxs(t,{children:[e.jsxs(l,{children:[e.jsxs(n,{className:"flex items-center gap-3",children:[e.jsx(i,{variant:"info",children:"📏 SIZES"}),"Radio Sizes - Mobile-First Touch Optimization"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"4 sizes optimized for different campus coordination contexts"})]}),e.jsx(o,{children:e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-6",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{label:"Small",description:"Compact forms",size:"sm",variant:"default",checked:!0,name:"size-demo-1",value:"sm"}),e.jsx("p",{className:"text-xs text-[var(--hive-text-muted)]",children:"SM: 16px × 16px"})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{label:"Default",description:"Standard use",size:"default",variant:"default",checked:!0,name:"size-demo-2",value:"default"}),e.jsx("p",{className:"text-xs text-[var(--hive-text-muted)]",children:"Default: 20px × 20px"})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{label:"Large",description:"Prominent forms",size:"lg",variant:"default",checked:!0,name:"size-demo-3",value:"lg"}),e.jsx("p",{className:"text-xs text-[var(--hive-text-muted)]",children:"LG: 24px × 24px"})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx(a,{label:"Extra Large",description:"Hero forms",size:"xl",variant:"default",checked:!0,name:"size-demo-4",value:"xl"}),e.jsx("p",{className:"text-xs text-[var(--hive-text-muted)]",children:"XL: 28px × 28px"})]})]})})})]}),e.jsxs(t,{children:[e.jsxs(l,{children:[e.jsxs(n,{className:"flex items-center gap-3",children:[e.jsx(i,{variant:"primary",children:"⚡ FEATURES"}),"Advanced Features - Groups, Cards, Layouts"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Advanced radio features for enhanced campus choice selection UX"})]}),e.jsx(o,{children:e.jsxs("div",{className:"space-y-8",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Vertical Radio Groups:"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs(r,{name:"notification-frequency",value:"daily",label:"Notification Frequency",description:"How often do you want to receive updates?",orientation:"vertical",spacing:"sm",children:[e.jsx(a,{value:"immediate",label:"Immediate",description:"Get notified right away"}),e.jsx(a,{value:"hourly",label:"Hourly Digest",description:"Summary every hour"}),e.jsx(a,{value:"daily",label:"Daily Summary",description:"Once per day overview"}),e.jsx(a,{value:"weekly",label:"Weekly Report",description:"Weekly comprehensive report"})]}),e.jsxs(r,{name:"privacy-level",value:"friends",label:"Privacy Level",description:"Who can see your campus activity?",orientation:"vertical",spacing:"sm",children:[e.jsx(a,{value:"public",label:"Public",description:"Visible to all UB students"}),e.jsx(a,{value:"friends",label:"Friends Only",description:"Only your connections"}),e.jsx(a,{value:"private",label:"Private",description:"Only you can see"}),e.jsx(a,{value:"ghost",label:"Ghost Mode",description:"Invisible to others"})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Horizontal Radio Groups:"}),e.jsxs("div",{className:"bg-[var(--hive-background-secondary)] p-4 rounded-lg space-y-4",children:[e.jsxs(r,{name:"theme-preference",value:"auto",label:"Theme Preference",description:"Choose your preferred interface theme",orientation:"horizontal",spacing:"lg",children:[e.jsx(a,{value:"light",label:"Light"}),e.jsx(a,{value:"dark",label:"Dark"}),e.jsx(a,{value:"auto",label:"Auto"})]}),e.jsxs(r,{name:"text-size",value:"medium",label:"Text Size",description:"Select your preferred text size",orientation:"horizontal",spacing:"md",children:[e.jsx(a,{value:"small",label:"Small",size:"sm"}),e.jsx(a,{value:"medium",label:"Medium",size:"default"}),e.jsx(a,{value:"large",label:"Large",size:"lg"})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Radio Cards:"}),e.jsxs(r,{name:"residence-hall",value:"hadley",label:"Residence Hall Preference",description:"Select your preferred residence hall for next year",orientation:"vertical",spacing:"sm",children:[e.jsx(s,{value:"ellicott",label:"Ellicott Complex",description:"Traditional residence halls with shared bathrooms. Close to academic buildings and dining halls. Great for first-year students.",icon:e.jsx("span",{className:"text-lg",children:"🏢"}),badge:e.jsx(i,{variant:"info",size:"sm",children:"Traditional"})}),e.jsx(s,{value:"hadley",label:"Hadley Village",description:"Apartment-style living with full kitchens and living areas. Perfect for upper-class students seeking independence.",icon:e.jsx("span",{className:"text-lg",children:"🏠"}),badge:e.jsx(i,{variant:"success",size:"sm",children:"Apartment"})}),e.jsx(s,{value:"governors",label:"Governors Complex",description:"Suite-style rooms with shared common areas. Balance between traditional and apartment living.",icon:e.jsx("span",{className:"text-lg",children:"🏘️"}),badge:e.jsx(i,{variant:"primary",size:"sm",children:"Suite"})})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Required Selection:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-4 rounded-lg",children:e.jsxs(r,{name:"graduation-term",value:"",label:"Expected Graduation Term",description:"When do you plan to graduate? (Required for academic planning)",required:!0,error:"Please select your expected graduation term",orientation:"vertical",spacing:"sm",children:[e.jsx(a,{value:"fall-2024",label:"Fall 2024",description:"December 2024"}),e.jsx(a,{value:"spring-2025",label:"Spring 2025",description:"May 2025"}),e.jsx(a,{value:"summer-2025",label:"Summer 2025",description:"August 2025"}),e.jsx(a,{value:"fall-2025",label:"Fall 2025",description:"December 2025"})]})})]})]})})]}),e.jsxs(t,{children:[e.jsxs(l,{children:[e.jsxs(n,{className:"flex items-center gap-3",children:[e.jsx(i,{variant:"secondary",children:"🎯 PRESETS"}),"Radio Presets - Common Campus Patterns"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Pre-built radio components for common campus single-choice scenarios"})]}),e.jsx(o,{children:e.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Priority Selection:"}),e.jsx(d.Priority,{name:"task-priority",value:"medium",label:"Assignment Priority",description:"How urgent is this assignment?"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Size Selection:"}),e.jsx(d.Size,{name:"group-size",value:"md",label:"Study Group Size",description:"Preferred group size for collaboration"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Theme Selection:"}),e.jsx(d.Theme,{name:"interface-theme",value:"auto",label:"Interface Theme",description:"Choose your preferred visual theme"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-medium text-[var(--hive-text-primary)]",children:"Payment Method:"}),e.jsx(d.PaymentMethod,{name:"payment-method",value:"card",label:"Payment Method",description:"How would you like to pay?",options:[{value:"card",label:"Credit Card",icon:e.jsx("span",{children:"💳"})},{value:"paypal",label:"PayPal",icon:e.jsx("span",{children:"📱"})},{value:"campus",label:"Campus Card",icon:e.jsx("span",{children:"🎓"})}]})]})]})})]}),e.jsxs(t,{children:[e.jsxs(l,{children:[e.jsxs(n,{className:"flex items-center gap-3",children:[e.jsx(i,{variant:"primary",children:"🦌 UNIVERSITY AT BUFFALO"}),"Real Campus Single-Choice Scenarios"]}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Radio usage in actual University at Buffalo single-choice selection and preference forms"})]}),e.jsxs(o,{className:"space-y-8",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"CSE 331 Section Selection:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-4 rounded-lg space-y-4",children:e.jsxs(r,{name:"cse331-section",value:"section-a2",label:"Choose Your CSE 331 Section",description:"Select one section that fits your schedule",required:!0,orientation:"vertical",spacing:"sm",children:[e.jsx(s,{value:"section-a1",label:"Section A1 - Dr. Smith",description:"MWF 10:00am - 10:50am • Davis Hall 101 • Available spots: 5/35",icon:e.jsx("span",{className:"text-lg",children:"👨‍🏫"}),badge:e.jsx(i,{variant:"warning",size:"sm",children:"Almost Full"})}),e.jsx(s,{value:"section-a2",label:"Section A2 - Dr. Smith",description:"TTh 2:00pm - 3:20pm • Knox Hall 20 • Available spots: 12/35",icon:e.jsx("span",{className:"text-lg",children:"👨‍🏫"}),badge:e.jsx(i,{variant:"success",size:"sm",children:"Available"})}),e.jsx(s,{value:"section-b1",label:"Section B1 - Prof. Johnson",description:"MWF 1:00pm - 1:50pm • Capen Hall 134 • Available spots: 8/35",icon:e.jsx("span",{className:"text-lg",children:"👩‍🏫"}),badge:e.jsx(i,{variant:"success",size:"sm",children:"Available"})}),e.jsx(s,{value:"section-b2",label:"Section B2 - Prof. Johnson",description:"TTh 11:00am - 12:20pm • Davis Hall 101 • Available spots: 0/35",icon:e.jsx("span",{className:"text-lg",children:"👩‍🏫"}),badge:e.jsx(i,{variant:"error",size:"sm",children:"Full"}),disabled:!0})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Meal Plan Selection:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-4 rounded-lg space-y-4",children:e.jsxs(r,{name:"meal-plan",value:"unlimited",label:"Choose Your Meal Plan",description:"Select the meal plan that best fits your lifestyle",required:!0,orientation:"vertical",spacing:"sm",children:[e.jsx(s,{value:"unlimited",label:"Unlimited Meal Plan",description:"Unlimited access to all dining halls, 400 dining dollars per semester. Perfect for students who eat most meals on campus.",icon:e.jsx("span",{className:"text-lg",children:"🍽️"}),badge:e.jsx(i,{variant:"primary",size:"sm",children:"Most Popular"})}),e.jsx(s,{value:"14-meals",label:"14 Meals Per Week",description:"14 meals per week plus 300 dining dollars. Good balance for students who occasionally eat off-campus.",icon:e.jsx("span",{className:"text-lg",children:"📅"}),badge:e.jsx(i,{variant:"success",size:"sm",children:"Balanced"})}),e.jsx(s,{value:"10-meals",label:"10 Meals Per Week",description:"10 meals per week plus 200 dining dollars. Ideal for students with lighter eating schedules.",icon:e.jsx("span",{className:"text-lg",children:"🥪"}),badge:e.jsx(i,{variant:"info",size:"sm",children:"Light"})}),e.jsx(s,{value:"declining-balance",label:"Declining Balance Only",description:"500 dining dollars per semester, no meal swipes. Maximum flexibility for upperclass students.",icon:e.jsx("span",{className:"text-lg",children:"💰"}),badge:e.jsx(i,{variant:"secondary",size:"sm",children:"Flexible"})})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Academic Advisor Assignment:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-4 rounded-lg space-y-4",children:e.jsxs(r,{name:"advisor-preference",value:"cs-focus",label:"Advisor Specialization Preference",description:"Choose an advisor based on your academic interests",required:!0,orientation:"vertical",spacing:"sm",children:[e.jsx(a,{value:"cs-focus",label:"Computer Science Focus",description:"Specializes in CS curriculum, graduate school prep, and tech industry career guidance"}),e.jsx(a,{value:"research-focus",label:"Research & Graduate School",description:"Expertise in research opportunities, PhD preparation, and academic career paths"}),e.jsx(a,{value:"industry-focus",label:"Industry & Internships",description:"Strong connections with tech companies, internship placement, and industry networking"}),e.jsx(a,{value:"interdisciplinary",label:"Interdisciplinary Studies",description:"Experience with double majors, minors, and cross-department collaboration"})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Graduation Ceremony Participation:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-4 rounded-lg space-y-4",children:e.jsxs(r,{name:"graduation-ceremony",value:"",label:"Graduation Ceremony Plans",description:"Will you participate in the graduation ceremony?",required:!0,orientation:"vertical",spacing:"sm",children:[e.jsx(s,{value:"attending",label:"Yes, I will attend",description:"Participate in the full graduation ceremony with cap and gown. Includes professional photos and diploma presentation.",icon:e.jsx("span",{className:"text-lg",children:"🎓"}),badge:e.jsx(i,{variant:"success",size:"sm",children:"Traditional"})}),e.jsx(s,{value:"virtual",label:"Virtual participation only",description:"Watch the ceremony online and receive diploma by mail. Name will still be announced during virtual ceremony.",icon:e.jsx("span",{className:"text-lg",children:"💻"}),badge:e.jsx(i,{variant:"info",size:"sm",children:"Remote"})}),e.jsx(s,{value:"not-attending",label:"No, I will not participate",description:"Skip the ceremony entirely. Diploma will be mailed to your address on file after degree conferral.",icon:e.jsx("span",{className:"text-lg",children:"📮"}),badge:e.jsx(i,{variant:"secondary",size:"sm",children:"Mail Only"})})]})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"font-semibold text-[var(--hive-text-primary)]",children:"Preferred Study Environment:"}),e.jsx("div",{className:"bg-[var(--hive-background-secondary)] p-4 rounded-lg space-y-4",children:e.jsxs(r,{name:"study-environment",value:"library",label:"Where do you study best?",description:"Help us recommend the best study spaces for you",orientation:"vertical",spacing:"sm",children:[e.jsx(a,{value:"library",label:"Quiet Library Spaces",description:"Lockwood Library silent floors, Capen quiet study areas"}),e.jsx(a,{value:"collaborative",label:"Collaborative Study Areas",description:"Group study rooms, Student Union collaborative spaces"}),e.jsx(a,{value:"cafe",label:"Coffee Shops & Cafes",description:"Starbucks, Tim Hortons, campus cafes with background noise"}),e.jsx(a,{value:"dorm",label:"Residence Hall Study Lounges",description:"Floor study lounges, residence hall quiet areas"}),e.jsx(a,{value:"outdoor",label:"Outdoor Spaces (Weather Permitting)",description:"Campus quads, outdoor seating areas, fresh air study spots"})]})})]})]})]})]})},p={args:{label:"UB Campus Notification Preference",description:"Choose how you want to receive campus updates",variant:"default",size:"default",checked:!0,name:"campus-notifications",value:"immediate"},render:N=>e.jsx("div",{className:"p-6 bg-[var(--hive-background-primary)]",children:e.jsxs(t,{children:[e.jsxs(l,{children:[e.jsx(n,{children:"Radio Enhanced Playground"}),e.jsx("p",{className:"text-[var(--hive-text-muted)]",children:"Use the controls to test different radio configurations"})]}),e.jsx(o,{className:"flex justify-center",children:e.jsx("div",{className:"w-full max-w-md",children:e.jsx(a,{...N})})})]})})};var u,v,h;c.parameters={...c.parameters,docs:{...(u=c.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
...
}`,...(h=(v=c.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var x,g,y;m.parameters={...m.parameters,docs:{...(x=m.parameters)==null?void 0:x.docs,source:{originalSource:`{
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <Radio label="Default (Gold Fill)" description="Gold fill indicates selected campus preferences" variant="default" checked={true} name="variant-demo-1" value="default" />
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="space-y-3">
                <Radio label="Small" description="Compact forms" size="sm" variant="default" checked={true} name="size-demo-1" value="sm" />
                <p className="text-xs text-[var(--hive-text-muted)]">SM: 16px × 16px</p>
              </div>
              <div className="space-y-3">
                <Radio label="Default" description="Standard use" size="default" variant="default" checked={true} name="size-demo-2" value="default" />
                <p className="text-xs text-[var(--hive-text-muted)]">Default: 20px × 20px</p>
              </div>
              <div className="space-y-3">
                <Radio label="Large" description="Prominent forms" size="lg" variant="default" checked={true} name="size-demo-3" value="lg" />
                <p className="text-xs text-[var(--hive-text-muted)]">LG: 24px × 24px</p>
              </div>
              <div className="space-y-3">
                <Radio label="Extra Large" description="Hero forms" size="xl" variant="default" checked={true} name="size-demo-4" value="xl" />
...
}`,...(y=(g=m.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};var f,b,j;p.parameters={...p.parameters,docs:{...(f=p.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
...
}`,...(j=(b=p.parameters)==null?void 0:b.docs)==null?void 0:j.source}}};const G=["Default","CompleteShowcase","Playground"];export{m as CompleteShowcase,c as Default,p as Playground,G as __namedExportsOrder,B as default};
