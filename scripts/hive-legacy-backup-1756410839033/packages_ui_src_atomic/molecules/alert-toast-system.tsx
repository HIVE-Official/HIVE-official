...
export const AlertPresets = {
  ...
  ErrorBoundary: (props: Omit<AlertProps, 'variant' | 'dismissible'>) => (
    <Alert variant="error" dismissible={false} {...props} />
  ),
  
  // Success confirmation
  Success: (props: Omit<AlertProps, 'variant'>) => (
    <Alert variant="success" {...props} />
  ),
  
  // Warning notification
  Warning: (props: Omit<AlertProps, 'variant'>) => (
    <Alert variant="warning" {...props} />
  ),
  
  // Information notice
  Info: (props: Omit<AlertProps, 'variant'>) => (
