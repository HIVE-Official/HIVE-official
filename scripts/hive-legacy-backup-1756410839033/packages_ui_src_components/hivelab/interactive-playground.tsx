          ...
          <button
            ...
            className={cn(
              ...
              value 
                ...
                : "bg-[var(--hive-background-secondary)] text-[var(--hive-text-muted)] border border-gray-200"
            )}
          >
        ...
        return (
          <div className="flex gap-2">
            <input
              ...
              value={value || '#000000'}
              onChange={(e) => onChange(e.target.value)}
              className="w-12 h-10 border border-[var(--hive-border-default)] rounded-md cursor-pointer"
            />
            <input
              type="text"
              value={value || '#000000'}
              onChange={(e) => onChange(e.target.value)}
              placeholder="#000000"
              className="flex-1 px-3 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
            />
          </div>
        );
      ...
      case 'file':
        return (
          <div className="space-y-2">
            ...
            />
            {value && (
              <p className="text-sm text-[var(--hive-text-muted)]">Current: {value}</p>
            )}
          </div>
        );
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="relative">
        <pre className="bg-[var(--hive-background-primary)] text-gray-100 p-4 rounded-lg text-sm overflow-x-auto">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-amber-400 to-amber-600 rounded-lg flex items-center justify-center">
            <element.icon className="w-5 h-5 text-[var(--hive-text-inverse)]" />
          </div>
          <div>
            <h2 className="text-lg font-semibold text-gray-900">{element.name}</h2>
            <p className="text-sm text-[var(--hive-text-muted)]">Interactive Playground</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" variant="secondary" onClick={handleExportCode}>
      ...
      <div className="flex h-[600px]">
            ...
            {activeTab === 'properties' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" variant="secondary" onClick={resetProps}>
              ...
              <div className="space-y-4">
                ...
                {element.examples && element.examples.length > 0 ? (
                      ...
                      <Card key={example.id} className="p-3">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            ...
                            <p className="text-xs text-[var(--hive-text-muted)]">{example.description}</p>
                          </div>
                          <Button
                            size="sm"
                            variant="secondary"
                        ...
                        {example.code && (
                          <pre className="bg-[var(--hive-background-secondary)] p-2 rounded text-xs overflow-x-auto">
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-[var(--hive-text-muted)]">No examples available</p>
                  </div>
                )}
              </div>
            )}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
            <div className="flex items-center gap-2">
              <Eye className="w-4 h-4 text-[var(--hive-text-muted)]" />
