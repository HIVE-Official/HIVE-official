...
const MOCK_ELEMENTS: ElementDefinition[] = [
  {
    ...
    previewComponent: ({ value = '', placeholder = 'Enter text...' }) => (
      <input 
        ...
        className="w-full px-3 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
        readOnly
      />
    ),
    ...
    previewComponent: ({ label = 'Button', variant = 'primary' }) => (
      <button 
        className={cn(
          ...
          variant === 'primary' && "bg-amber-500 text-[var(--hive-text-inverse)] hover:bg-amber-600",
  ...
  },
  {
    ...
    previewComponent: ({ type = 'bar', data = [] }) => (
      <div className="w-full h-32 bg-[var(--hive-background-secondary)] rounded-lg flex items-center justify-center">
  ...
  },
  {
    ...
    previewComponent: ({ userName = 'John Doe', userEmail = 'john@example.com' }) => (
      <div className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg">
        <div className="w-12 h-12 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center text-[var(--hive-text-inverse)] font-semibold">
          {userName.charAt(0)}
        </div>
        <div>
          ...
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            >
              <IconComponent className={cn(
                "w-6 h-6",
                element.isVerified ? "text-green-600" : "text-[var(--hive-text-muted)]"
              )} />
            </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-[var(--hive-text-muted)] truncate mb-2">{element.description}</p>
    ...
    >
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-[var(--hive-text-muted)] mb-3 line-clamp-2">
            {element.description}
          </p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--hive-text-muted)]">Discover and use pre-built components for your tools</p>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-[var(--hive-border-default)] rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
          />
        </div>
        ...
        <div className="flex gap-2">
          <select
            ...
            className="px-3 py-2 border border-[var(--hive-border-default)] rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
          >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1">
                {['Verified', 'Premium', 'Community'].map(type => (
                  <Badge key={type} variant="secondary" className="cursor-pointer hover:bg-[var(--hive-background-secondary)]">
                    {type}
                  </Badge>
                ))}
              </div>
            ...
            <button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "bg-[var(--hive-background-secondary)] text-gray-700 hover:bg-gray-200"
              )}
            >
