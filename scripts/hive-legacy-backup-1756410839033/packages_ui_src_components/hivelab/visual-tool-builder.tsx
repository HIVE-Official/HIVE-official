        ...
        <div className="border-b border-[var(--hive-border-default)] p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <ButtonEnhanced variant="secondary" onClick={handlePreview}>
                <Play className="w-4 h-4 mr-2" />
                Test
              </ButtonEnhanced>
              <ButtonEnhanced variant="secondary" onClick={() => setShowDeployment(true)} disabled={elements.length === 0}>
                <Zap className="w-4 h-4 mr-2" />
                Deploy
              </ButtonEnhanced>
              <ButtonEnhanced onClick={handleSave}>
