        ...
        <ButtonEnhanced 
          ...
          className={cn(
            ...
            usePassword 
              ...
              : "bg-gradient-to-r from-[var(--hive-status-info)] to-[var(--hive-status-info)] text-[var(--hive-text-inverse)] shadow-[var(--hive-shadow-level2)]"
          )}
    ...
    <div className="liquid-metal rounded-3xl p-8 space-y-6 border border-[var(--hive-border-glass)] shadow-[var(--hive-shadow-level3)]">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <ButtonEnhanced 
          ...
          variant="primary"
          size="lg"
          className="w-full bg-gradient-to-r from-[var(--hive-status-info)] to-[var(--hive-status-info)] text-[var(--hive-text-inverse)] font-semibold hive-interactive"
          disabled={state.loading}
        >
