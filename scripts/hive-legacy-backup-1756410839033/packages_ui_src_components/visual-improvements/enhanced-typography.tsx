...
const enhancedTypographyVariants = cva(
...
export interface EnhancedTypographyProps
  extends React.HTMLAttributes<HTMLElement>,
    VariantProps<typeof enhancedTypographyVariants> {
  as?: React.ElementType
  children: React.ReactNode
}

const EnhancedTypography = React.forwardRef<HTMLElement, EnhancedTypographyProps>(
  ({ className, variant, size, weight, spacing, as: Component = "p", children, ...props }, ref) => {
...
export const HeroText = ({ children, className, ...props }: Omit<EnhancedTypographyProps, 'variant'>) => (
  <EnhancedTypography variant="hero" as="h1" className={className} {...props}>
    {children}
  </EnhancedTypography>
)

export const EnergyText = ({ children, className, ...props }: Omit<EnhancedTypographyProps, 'variant'>) => (
  <EnhancedTypography variant="energy" as="h2" className={className} {...props}>
    {children}
  </EnhancedTypography>
)

export const HandwrittenText = ({ children, className, ...props }: Omit<EnhancedTypographyProps, 'variant'>) => (
  <EnhancedTypography variant="handwritten" as="span" className={className} {...props}>
    {children}
  </EnhancedTypography>
)

export const NeonText = ({ children, className, ...props }: Omit<EnhancedTypographyProps, 'variant'>) => (
  <EnhancedTypography variant="neon" as="h3" className={className} {...props}>
    {children}
  </EnhancedTypography>
)

export const StickerText = ({ children, className, ...props }: Omit<EnhancedTypographyProps, 'variant'>) => (
  <EnhancedTypography variant="sticker" as="span" className={className} {...props}>
    {children}
  </EnhancedTypography>
)
