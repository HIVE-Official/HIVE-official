...
const glassCardVariants = cva(
  "relative overflow-hidden backdrop-blur-md transition-all duration-300 ease-out",
  {
    variants: {
      variant: {
        default: [
...
const techCardVariants = cva(
  "relative font-mono transition-all duration-150 ease-out",
  {
    variants: {
      variant: {
        terminal: [
...
export const CampusCard = React.forwardRef<HTMLDivElement, CampusCardProps>(
  ({ className, variant, padding, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(campusCardVariants({ variant, padding }), className)}
        {...props}
      />
    )
  }
...
export const TechCard = React.forwardRef<HTMLDivElement, TechCardProps>(
  ({ className, variant, padding, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(techCardVariants({ variant, padding }), className)}
        {...props}
      />
    )
  }
...
export const SocialCard = React.forwardRef<HTMLDivElement, SocialCardProps>(
  ({ className, variant, padding, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(socialCardVariants({ variant, padding }), className)}
        {...props}
      />
    )
  }
