      ...
      <div className="flex items-center gap-1">
        <ButtonEnhanced
          ...
          className={`${isFollowing 
            ...
            : 'bg-[var(--hive-primary)] text-[var(--hive-text-inverse)] hover:bg-[var(--hive-primary)]/90'
          }`}
        >
          {actionLoading ? (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-2">
              ...
              {user.isVerified && (
                <div className="w-4 h-4 bg-[var(--hive-primary)] text-[var(--hive-text-inverse)] rounded-full flex items-center justify-center">
