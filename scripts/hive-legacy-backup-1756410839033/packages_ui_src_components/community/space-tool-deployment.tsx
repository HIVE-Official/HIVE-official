      ...
      <div className="border-b border-[var(--hive-border-default)] p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <ButtonEnhanced variant="secondary" onClick={onCancel}>
              Cancel
            </ButtonEnhanced>
            <ButtonEnhanced 
            ...
            {spacesError && (
              <div className="flex items-center justify-center py-8">
                <div className="text-center">
                  ...
                  <ButtonEnhanced variant="secondary" onClick={fetchAvailableSpaces}>
                    Retry
                  </ButtonEnhanced>
                </div>
              </div>
                ...
                <div>
                  ...
                  <Card className="p-4">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-[var(--hive-border-default)]">
                      <div className="flex items-center space-x-2">
                        <ButtonEnhanced size="sm" className="bg-[var(--hive-primary)] text-[var(--hive-text-inverse)]">
