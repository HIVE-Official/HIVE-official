      ...
      >
        ...
        {template.isPremium && (
          <div className="absolute top-2 right-2 z-10">
            <Badge className="bg-[var(--hive-color-gold-primary)] text-[var(--hive-background-primary)]">
              <Star size={12} />
              Premium
            </Badge>
          </div>
        ...
        <HiveCardContent className={cn(
          ...
          <div className={cn(
            ...
            >
              ...
              >
                <GraduationCap size={16} className="text-[var(--hive-text-inverse)]" />
              </div>
            </div>
          </div>
          ...
          <div className={cn(
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <Badge variant="course-tag" className="text-xs">
                {template.category}
              </Badge>
            </div>
