      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <ButtonEnhanced
            ...
            className="bg-[var(--hive-primary)] text-[var(--hive-text-inverse)] flex items-center space-x-2"
          >
              ...
              {selectedFlags.length > 0 && (
                <div className="flex items-center space-x-2">
                  <ButtonEnhanced
                    ...
                    className="bg-green-600 hover:bg-green-700 text-[var(--hive-text-inverse)]"
                  >
                    Enable Selected
                  </ButtonEnhanced>
                  <ButtonEnhanced
