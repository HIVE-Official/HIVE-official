...
export const HiveLandingPage: React.FC<HiveLandingPageProps> = ({
  ...
  return (
    <div className={cn("min-h-screen bg-background text-[var(--hive-text-inverse)]", className)}>
      {/* Hero Section */}
              ...
              >
                <Card variant="elevated" padding="lg" className="h-full hover:border-accent/50 transition-all duration-[180ms] ease-[cubic-bezier(0.33,0.65,0,1)]">
                  <CardContent className="text-center space-y-4">
                    ...
                    <h3 className="text-xl font-semibold text-[var(--hive-text-inverse)]">{feature.title}</h3>
                  ...
                  <CardContent>
                    <form onSubmit={handleEmailSubmit} className="space-y-4">
                      ...
                      <ButtonEnhanced
                        ...
                        variant="primary"
                        size="lg"
                        className="w-full bg-background hover:bg-background/90 text-[var(--hive-text-inverse)] border-2 border-accent hover:border-accent focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-accent/20"
                        disabled={!email.trim() || isSubmitting}
                      >
