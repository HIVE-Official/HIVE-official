      ...
      <div className={cn(
        ...
        {item.badge && (
          <div className={cn(
            ...
            item.badge.color === 'error' && "bg-red-500 text-[var(--hive-text-inverse)]",
            item.badge.color === 'warning' && "bg-yellow-500 text-[var(--hive-text-primary)]",
            item.badge.color === 'primary' && "bg-[var(--hive-brand-secondary)] text-[var(--hive-text-inverse)]",
    ...
    >
      ...
      {badge && (
        <div className={cn(
          "absolute -top-1 -right-1 min-w-[16px] h-4 px-1",
          "flex items-center justify-center text-xs font-medium rounded-full",
          "bg-red-500 text-[var(--hive-text-inverse)] border-2 border-[var(--hive-background-primary)]",
