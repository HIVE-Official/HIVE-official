    ...
    <>
      <div className="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors border-b border-gray-100">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          {/* Avatar */}
          <div className="w-10 h-10 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center text-[var(--hive-text-inverse)] font-semibold text-sm">
            {rsvp.userAvatar ? (
      ...
      {showDetails && (
        <div className="px-4 py-3 bg-gray-50 border-b border-gray-100">
          ...
          <div className="mt-3 pt-3 border-t border-gray-200 flex gap-2">
            <Button size="sm" variant="secondary" onClick={() => onMessage(rsvp.userId)}>
  ...
  if (loading) {
    return (
      <div className="p-8 text-center">
        ...
        <p className="text-[var(--hive-text-muted)]">Loading RSVPs...</p>
      </div>
    );
  }
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-[var(--hive-text-muted)]">Manage event attendance and communicate with attendees</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-6">
          ...
          <Card className="p-4 text-center">
            <div className="text-2xl font-bold text-[var(--hive-text-muted)]">{stats.noShow}</div>
              ...
              {selectedRSVPs.length > 0 && (
                <div className="p-4 bg-amber-50 border-b border-amber-200">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <Button size="sm" variant="secondary" onClick={handleBulkMessage}>
                        <Mail className="w-3 h-3 mr-1" />
                        Message
                      </Button>
                      <Button size="sm" variant="secondary" onClick={() => setSelectedRSVPs([])}>
                        Clear
                      </Button>
                    </div>
                  </div>
