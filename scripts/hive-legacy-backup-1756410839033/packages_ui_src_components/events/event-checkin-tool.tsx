...
const CheckinMethodBadge = ({ method }: { method: CheckinEntry['method'] }) => {
  ...
  return (
    <Badge className={config[method].className}>
      {config[method].label}
    </Badge>
  );
};
...
const QRCodeDisplay = ({ qrCode, onRefresh }: { qrCode: string; onRefresh: () => void }) => (
  <div className="text-center space-y-4">
    <div className="inline-block p-4 bg-white rounded-lg shadow-sm border">
      <div className="w-48 h-48 bg-[var(--hive-background-secondary)] rounded-lg flex items-center justify-center">
      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full">
        ...
        {error ? (
          ...
          <div className="space-y-4">
            <div className="relative">
              <video 
                ...
                autoPlay 
                playsInline 
                className="w-full h-64 object-cover rounded-lg bg-[var(--hive-background-secondary)]"
              />
            ...
            <p className="text-sm text-[var(--hive-text-muted)] text-center">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-[var(--hive-text-muted)]">Starting camera...</p>
          </div>
        )}
      </div>
    </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selectedUser === rsvp.userId
                        ...
                        : "border-gray-200 hover:border-[var(--hive-border-default)]"
                    )}
                  >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="w-8 h-8 rounded-full border border-[var(--hive-border-default)] flex items-center justify-center text-[var(--hive-text-muted)] hover:bg-gray-50"
                  >
                    -
                  </button>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[var(--hive-text-muted)]">Display this code for attendees to scan</p>
          </div>
            ...
            <div className="space-y-4 text-sm">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[var(--hive-text-muted)]">Show this screen on a large display at the entrance</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[var(--hive-text-muted)]">Attendees scan with their phone camera or any QR scanner app</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[var(--hive-text-muted)]">Code refreshes every 5 minutes for security</p>
                </div>
              </div>
            </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--hive-text-muted)]">Real-time attendance tracking for {event.title}</p>
        </div>
        
        <div className="flex items-center gap-3">
          <Button variant="secondary" onClick={() => onExportAttendance?.('csv')}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        ...
        <Card className="p-4 text-center">
          <div className="text-2xl font-bold text-[var(--hive-text-muted)]">{stats.totalExpected}</div>
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
              />
            </div>
          </div>
