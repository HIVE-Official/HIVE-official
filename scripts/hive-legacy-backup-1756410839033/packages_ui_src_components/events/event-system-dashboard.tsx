        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--hive-text-muted)]">Upcoming Events</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--hive-text-muted)]">Total RSVPs</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--hive-text-muted)]">Attendance Rate</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--hive-text-muted)]">Avg Rating</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <div className="space-y-4">
        ...
        {loading ? (
          ...
          <Card className="p-8 text-center">
            ...
            <p className="text-[var(--hive-text-muted)] mb-4">Create your first event to get started</p>
            <Button onClick={() => setCurrentView('create')}>
              Create Event
            </Button>
          </Card>
...
function EventToolCard({ tool, onLaunch }: EventToolCardProps) {
  ...
  return (
    <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer" onClick={onLaunch}>
      <div className="space-y-3">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <Badge variant="secondary" className={cn("text-xs", categoryColors[tool.category])}>
                {tool.category}
              </Badge>
            </div>
          </div>
