  ...
  const renderBasicStep = () => (
    <div className="space-y-6">
      <div className="mb-6">
        ...
        <p className="text-[var(--hive-text-muted)]">Tell us about your event</p>
      </div>
  ...
  const renderDateTimeStep = () => (
    <div className="space-y-6">
      <div className="mb-6">
        ...
        <p className="text-[var(--hive-text-muted)]">Set the date, time, and location</p>
      </div>
  ...
  const renderSettingsStep = () => (
    <div className="space-y-6">
      <div className="mb-6">
        ...
        <p className="text-[var(--hive-text-muted)]">Configure attendance and visibility</p>
      </div>
  ...
  const renderPreviewStep = () => (
    <div className="space-y-6">
      <div className="mb-6">
        ...
        <p className="text-[var(--hive-text-muted)]">This is how your event will appear to others</p>
      </div>
              ...
              <React.Fragment key={step.id}>
                <div className={cn(
                  ...
                  <div className={cn(
                    ...
                    isActive && "bg-amber-600 text-[var(--hive-text-inverse)]",
                    isCompleted && "bg-green-600 text-[var(--hive-text-inverse)]",
                    !isActive && !isCompleted && "bg-gray-300 text-[var(--hive-text-muted)]"
                  )}>
                    {index + 1}
                  </div>
