                    ...
                    <div className="flex gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="px-3 py-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                        >
                      ...
                      <div className="flex items-center">
                        <label className="flex items-center gap-2 text-sm">
                          <input
                            ...
                            className="rounded border-[var(--hive-border-default)] focus:ring-amber-500"
                          />
                          Required
                        </label>
                      </div>
  ...
  if (loading) {
    return (
      <div className="p-8 text-center">
        ...
        <p className="text-[var(--hive-text-muted)]">Loading feedback data...</p>
      </div>
    );
  }
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[var(--hive-text-muted)]">Design a custom feedback form for your event</p>
          </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[var(--hive-text-muted)]">Insights from {activeSurvey.title}</p>
          </div>
          <div className="flex gap-3">
            <Button variant="secondary" onClick={() => onExportFeedback?.('csv')}>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--hive-text-muted)]">Collect and analyze feedback from event attendees</p>
        </div>
        ...
        {activeSurvey ? (
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-[var(--hive-text-muted)] mb-4">{activeSurvey.description}</p>
            ...
            <div className="flex flex-col gap-2">
              <Button size="sm" onClick={() => setView('analytics')}>
              ...
              <div key={response.id} className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex-1">
                  ...
                  {response.responses.improvements && (
                    <p className="text-sm text-[var(--hive-text-muted)]">"{response.responses.improvements}"</p>
                  )}
                </div>
