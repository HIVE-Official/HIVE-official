          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              {eventData.location?.room && (
                <p className="text-sm text-[var(--hive-text-muted)]">{eventData.location.room}</p>
              )}
            </div>
          </div>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-[var(--hive-text-muted)]">Plan and coordinate campus events with your community</p>
      </div>
