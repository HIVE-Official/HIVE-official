        ...
        <div className="mb-3 space-y-2">
          {coordination.details.subject && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-[var(--hive-text-inverse)]">{coordination.details.subject}</span>
            </div>
          )}
          {coordination.details.restaurant && (
            <div className="flex items-center gap-2 text-sm">
              <span className="text-gray-400">Restaurant:</span>
              <span className="text-[var(--hive-text-inverse)]">{coordination.details.restaurant}</span>
            </div>
          )}
          {coordination.details.destination && (
            <div className="flex items-center gap-2 text-sm">
              <span className="text-gray-400">Destination:</span>
              <span className="text-[var(--hive-text-inverse)]">{coordination.details.destination}</span>
            </div>
          )}
          {coordination.location && (
            <div className="flex items-center gap-2 text-sm">
              <span className="text-gray-400">Location:</span>
              <span className="text-[var(--hive-text-inverse)]">{coordination.location}</span>
            </div>
          )}
        </div>
      )}
                ...
                <div className="w-4 h-4 rounded-full bg-gray-600 overflow-hidden">
                  {response.user?.photoURL ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
                      <span className="text-xs text-[var(--hive-text-inverse)]">
      ...
      {showResponseForm && (
        ...
        >
          <div className="space-y-3">
                ...
                <motion.button
                  ...
                  className={cn(
                    ...
                    responseType === type
                      ...
                      : 'text-gray-400 bg-gray-500/20 border-gray-500/30 hover:text-[var(--hive-text-inverse)]'
                  )}
            ...
            <textarea
              className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-[var(--hive-text-inverse)] placeholder-gray-400 resize-none focus:outline-none focus:border-blue-400/50 transition-colors"
            ...
            <div className="flex justify-end gap-2">
              ...
              <motion.button
                className="px-3 py-1 bg-blue-500 hover:bg-blue-600 text-[var(--hive-text-inverse)] text-xs rounded-md transition-colors disabled:opacity-50"
            ...
            >
              <div className="flex gap-2">
                ...
                <div className="flex flex-col gap-1">
                  <motion.button
                    className="px-3 py-1 bg-blue-500 hover:bg-blue-600 text-[var(--hive-text-inverse)] text-xs rounded-md transition-colors"
                    onClick={handleReply}
