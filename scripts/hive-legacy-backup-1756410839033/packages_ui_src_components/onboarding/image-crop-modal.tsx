...
export const ImageCropModal: React.FC<ImageCropModalProps> = ({
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-surface border border-border rounded-lg p-6 max-w-2xl w-full mx-4"
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-muted font-body mt-1">
                Your photo will be displayed prominently like a profile card
              </p>
            </div>
          ...
          <div className="space-y-6">
            {/* Image Preview Area */}
            <div className="relative bg-surface-01 border border-border rounded-lg p-4">
              <div className="flex justify-center">
                ...
                >
                  ...
                  {/* Crop Overlay */}
                  <div
                    className="absolute border-2 border-accent bg-accent/10 cursor-move"
                    style={{
                      left: crop.x,
                      top: crop.y,
                      width: crop.width,
              ...
              <div className="text-center">
                ...
                <div className="text-center space-y-2">
                  <p className="text-sm text-muted font-body">
                    Drag the highlighted area to position your crop
                  </p>
                  <p className="text-xs text-muted font-body">
                    Make sure your face is clear and well-lit for the best results
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-4">
              <ButtonEnhanced variant="secondary" onClick={onClose} className="flex-1">
                Cancel
              </ButtonEnhanced>
              <ButtonEnhanced 
                variant="primary" 
