  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <h1 className="text-3xl font-bold text-slate-900 dark:text-[var(--hive-text-inverse)]">
          Welcome to HIVE
        </h1>
      ...
      <div className="space-y-4">
        ...
        <ButtonEnhanced 
          onClick={nextStep}
          className="bg-yellow-500 hover:bg-yellow-600 text-[var(--hive-text-primary)]"
          size="lg"
        >
          Let's Get Started
  ...
  return (
    ...
    >
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-[var(--hive-text-inverse)]">
          Confirm Your Role
        </h2>
            ...
            >
              <CardContent className="p-6 flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h3 className={cn(
                    "font-semibold",
                    state.userType === option.value ? "text-yellow-600" : "text-slate-900 dark:text-[var(--hive-text-inverse)]"
                  )}>
                    {option.title}
                  </h3>
                  <p className="text-sm text-slate-600 dark:text-slate-400">
      ...
      <div className="flex justify-between">
        <ButtonEnhanced variant="secondary" onClick={prevStep}>
    ...
    >
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <label className="text-sm font-medium text-slate-900 dark:text-[var(--hive-text-inverse)]">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <select 
            ...
            className="w-full p-3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg focus:border-yellow-500 text-slate-900 dark:text-[var(--hive-text-inverse)]"
          >
          ...
          >
            <div className="space-y-2">
              <h3 className={cn(
                ...
                selectedInterests.includes(interest.id) ? "text-yellow-600" : "text-slate-900 dark:text-[var(--hive-text-inverse)]"
              )}>
                {interest.name}
              </h3>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-3">
                    <h3 className={cn(
                      "font-bold text-lg",
                      selectedSpaces.includes(space.id) ? "text-yellow-600" : "text-slate-900 dark:text-[var(--hive-text-inverse)]"
                    )}>
                      {space.name}
                    </h3>
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h3 className={cn(
                    "font-semibold",
                    experience === option.value ? "text-yellow-600" : "text-slate-900 dark:text-[var(--hive-text-inverse)]"
                  )}>
                    {option.title}
                  </h3>
                  <p className="text-sm text-slate-600 dark:text-slate-400">
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            ...
            />
            <div className="flex-1">
              <p className="text-sm text-slate-900 dark:text-[var(--hive-text-inverse)]">
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700">
            ...
            <h3 className="font-semibold text-slate-900 dark:text-[var(--hive-text-inverse)] text-sm">Explore Spaces</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400">
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700">
            ...
            <h3 className="font-semibold text-slate-900 dark:text-[var(--hive-text-inverse)] text-sm">Build Tools</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400">
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700">
            ...
            <h3 className="font-semibold text-slate-900 dark:text-[var(--hive-text-inverse)] text-sm">Coordinate</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400">
      ...
      <Card className="relative w-full max-w-2xl bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-slate-200 dark:border-slate-700 shadow-2xl rounded-3xl overflow-hidden z-10">
        ...
        <div className="p-8 pb-6 text-center border-b border-slate-200 dark:border-slate-700">
          ...
          <motion.div
            ...
            className="space-y-2"
          >
            <h1 className="text-2xl font-bold text-slate-900 dark:text-[var(--hive-text-inverse)]">
              Welcome to HIVE
            </h1>
