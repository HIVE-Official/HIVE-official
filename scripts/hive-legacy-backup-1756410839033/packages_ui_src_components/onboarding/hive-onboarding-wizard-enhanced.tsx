        ...
        <div className="glass-strong rounded-2xl p-6 space-y-4 border border-[var(--hive-border-glass-strong)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="flex items-center gap-3 text-[var(--hive-text-secondary)]">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[var(--hive-brand-primary)]/20 to-[var(--hive-brand-accent)]/20 flex items-center justify-center border border-[var(--hive-border-[var(--hive-brand-secondary)])]">
    ...
    <div className="glass-strong rounded-3xl p-8 space-y-8 border border-[var(--hive-border-glass-strong)] shadow-[var(--hive-shadow-level4)] relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-4">
        <div className="flex justify-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[var(--hive-brand-primary)]/20 to-[var(--hive-brand-accent)]/20 flex items-center justify-center border border-[var(--hive-border-[var(--hive-brand-secondary)])]">
          ...
          <div
            className={cn(
              ...
              dragActive 
                ...
                : "border-[var(--hive-border-glass)] hover:border-[var(--hive-border-[var(--hive-brand-secondary)])] hover:bg-[var(--hive-overlay-glass)]"
            )}
      ...
      <div className="space-y-4">
        {agreements.map((agreement) => {
          ...
          return (
            <label
              key={agreement.key}
              className="flex items-start gap-4 p-4 rounded-xl border border-[var(--hive-border-glass)] cursor-pointer hover:border-[var(--hive-border-[var(--hive-brand-secondary)])] hover:bg-[var(--hive-overlay-glass)] transition-all duration-300 hive-interactive"
            >
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
  ...
  return (
    <div className="glass-strong rounded-3xl p-8 text-center space-y-8 border border-[var(--hive-border-glass-strong)] shadow-[var(--hive-shadow-gold-glow-strong)] relative overflow-hidden">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="glass-strong rounded-2xl p-6 space-y-4 border border-[var(--hive-border-[var(--hive-brand-secondary)])]">
          <h3 className="text-lg font-semibold text-[var(--hive-text-primary)] flex items-center justify-center gap-2">
            <Rocket className="h-5 w-5 text-[var(--hive-brand-primary)]" />
            What's next?
          </h3>
