...
const FreshmanBadge = ({ ...props }: Omit<HiveBadgeProps, 'variant'>) => (
  <Badge variant="freshman" aria-label="Academic status: Freshman" {...props}>
    Freshman
  </Badge>
);
...
const GrindModeBadge = ({ ...props }: Omit<HiveBadgeProps, 'variant'>) => (
  <Badge variant="grind-mode" aria-label="Study status: Grind Mode active" {...props}>
    Grind Mode
  </Badge>
);

const DeansListBadge = ({ ...props }: Omit<HiveBadgeProps, 'variant'>) => (
  <Badge variant="deans-list" aria-label="Academic achievement: Dean's List" {...props}>
    Dean's List
  </Badge>
);

const AllNighterBadge = ({ ...props }: Omit<HiveBadgeProps, 'variant'>) => (
  <Badge variant="all-nighter" aria-label="Study status: All-nighter session" {...props}>
    All-Nighter
  </Badge>
);

const TAApprovedBadge = ({ ...props }: Omit<HiveBadgeProps, 'variant'>) => (
  <Badge variant="ta-approved" aria-label="Recognition: Teaching Assistant approved" {...props}>
    TA Approved
  </Badge>
);

const CampusLegendBadge = ({ ...props }: Omit<HiveBadgeProps, 'variant'>) => (
  <Badge variant="campus-legend" aria-label="Elite status: Campus Legend" {...props}>
    Campus Legend
  </Badge>
);

const FinalsWeekBadge = ({ ...props }: Omit<HiveBadgeProps, 'variant'>) => (
  <Badge variant="finals-week" aria-label="Study period: Finals Week" {...props}>
    Finals Week
  </Badge>
);
