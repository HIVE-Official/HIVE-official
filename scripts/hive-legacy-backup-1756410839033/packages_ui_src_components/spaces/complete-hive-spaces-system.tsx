        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center py-16">
            <Card className="p-6 text-center max-w-md">
              ...
              <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-2">Spaces Error</h2>
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center py-16">
              <AlertCircle className="h-12 w-12 text-red-400 mx-auto mb-4" />
              <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-2">Category Not Found</h2>
            ...
            <Card className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-[var(--hive-text-inverse)]">{category.title}</h1>
                ...
                <Button
                  ...
                  className="text-gray-400 hover:text-[var(--hive-text-inverse)]"
                >
                  ← Back to Explore
                </Button>
              </div>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex bg-gray-800 rounded-lg p-1">
                  <button
                    ...
                    className={`p-2 rounded ${layoutMode === 'grid' ? 'bg-[#FFD700] text-[var(--hive-text-primary)]' : 'text-gray-400'}`}
                  >
                    <Grid className="w-4 h-4" />
                  </button>
                  <button
                    onClick={() => setLayoutMode('list')}
                    className={`p-2 rounded ${layoutMode === 'list' ? 'bg-[#FFD700] text-[var(--hive-text-primary)]' : 'text-gray-400'}`}
                  >
            ...
            {layoutMode === 'grid' ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mockFeaturedSpaces
                  ...
                  .map((space) => (
                  <Card key={space.id} className="p-6 hover:bg-gray-800/50 transition-colors cursor-pointer">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
                          <Users className="w-6 h-6 text-[var(--hive-text-inverse)]" />
                        </div>
                        <div>
                      ...
                      {space.isVerified && (
                        <div className="bg-green-600 p-1 rounded-full">
                          <Star className="w-3 h-3 text-[var(--hive-text-inverse)]" />
                        </div>
                      )}
                    </div>
              ...
              <div className="space-y-4">
                {mockFeaturedSpaces
                  .filter(space => !categoryType || categoryType === 'all' || space.category === categoryType)
                  .map((space) => (
                  <Card key={space.id} className="p-4 hover:bg-gray-800/50 transition-colors cursor-pointer">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
                          <Users className="w-5 h-5 text-[var(--hive-text-inverse)]" />
                        </div>
                        <div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <p className="text-sm text-[var(--hive-text-inverse)]">{space.memberCount} members</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        >
          <Card className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)]">Featured Spaces</h2>
                ...
                <div key={space.id} className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-[var(--hive-text-inverse)]">{space.name}</h3>
                        <p className="text-sm text-gray-400">{space.memberCount} members</p>
                      </div>
                    </div>
                    {space.isVerified && (
        ...
        >
          <Card className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)] flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {mockTrendingSpaces.map((space, index) => (
                <div key={space.id} className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 bg-[#FFD700] text-[var(--hive-text-primary)] rounded flex items-center justify-center text-sm font-bold">
                      {index + 1}
                    </div>
                    <div>
