...
function MySpacesSection({ 
  ...
  if (isLoading) {
    return (
      <Card className="p-6 bg-[color-mix(in_srgb,var(--hive-interactive-hover)_40%,transparent)] border-[var(--hive-interactive-active)]">
  ...
  return (
    <Card className="p-6 bg-[color-mix(in_srgb,var(--hive-interactive-hover)_40%,transparent)] border-[var(--hive-interactive-active)] hover:bg-[color-mix(in_srgb,var(--hive-interactive-hover)_80%,transparent)] transition-all">
      <div className="flex items-center gap-3 mb-4">
