  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-[var(--hive-text-inverse)]">{analytics.spaceName} Analytics</h2>
      ...
      {/* Health Overview */}
      <Card className={`p-6 ${getHealthBgColor(analytics.healthMetrics.overallHealth)}`}>
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-lg font-semibold text-[var(--hive-text-inverse)] mb-1">Space Health Score</h3>
          ...
          <div className="text-right">
            ...
            <div className="flex items-center gap-1">
              {getTrendIcon(analytics.healthMetrics.engagementTrend)}
              <span className="text-[var(--hive-text-inverse)] capitalize">{analytics.healthMetrics.engagementTrend}</span>
            </div>
          </div>
        </div>
        ...
        {([
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-sm rounded transition-colors ${
              activeTab === key 
                ? 'bg-[#FFD700] text-[var(--hive-text-primary)]' 
                : 'text-gray-400 hover:text-[var(--hive-text-inverse)] hover:bg-gray-700'
            }`}
          >
      ...
      >
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="p-6">
              ...
              <div className="text-2xl font-bold text-[var(--hive-text-inverse)]">{analytics.membershipData.totalMembers}</div>
            ...
            <Card className="p-6">
              ...
              <div className="text-2xl font-bold text-[var(--hive-text-inverse)]">{analytics.membershipData.activeMembers}</div>
            ...
            <Card className="p-6">
              ...
              <div className="text-2xl font-bold text-[var(--hive-text-inverse)]">{analytics.contentData.totalPosts}</div>
            ...
            <Card className="p-6">
              ...
              <div className="text-2xl font-bold text-[var(--hive-text-inverse)]">{analytics.eventData.totalEvents}</div>
        ...
        {activeTab === 'members' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Member Growth</h3>
              ...
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Engagement Levels</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
              ...
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Member Roles</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'content' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Content Performance</h3>
                <div className="space-y-4">
                  {analytics.contentData.topContentTypes.map((content, index) => (
                    <div key={index} className="flex items-center justify-between">
                      <div>
                        <div className="text-[var(--hive-text-inverse)] capitalize">{content.type.replace('_', ' ')}</div>
                        <div className="text-sm text-gray-400">{content.count} posts</div>
                      </div>
                      <div className="text-right">
                        <div className="text-[var(--hive-text-inverse)]">{content.engagement}%</div>
              ...
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Content Moderation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'events' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Event Performance</h3>
                <div className="space-y-4">
                  {analytics.eventData.topEventTypes.map((event, index) => (
                    <div key={index} className="flex items-center justify-between">
                      <div>
                        <div className="text-[var(--hive-text-inverse)] capitalize">{event.type.replace('_', ' ')}</div>
                        <div className="text-sm text-gray-400">{event.count} events</div>
                      </div>
                      <div className="text-right">
                        <div className="text-[var(--hive-text-inverse)]">{event.avgAttendance}%</div>
              ...
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Event Insights</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'tools' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Tool Usage</h3>
                <div className="space-y-4">
                  {analytics.toolData.topTools.map((tool, index) => (
                    <div key={index} className="flex items-center justify-between">
                      <div>
                        <div className="text-[var(--hive-text-inverse)]">{tool.name}</div>
                        <div className="text-sm text-gray-400">{tool.usage} uses</div>
                      </div>
                      <div className="text-right">
                        <div className="text-[var(--hive-text-inverse)]">{tool.satisfaction}%</div>
              ...
              <Card className="p-6">
                <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Tool Health</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
      ...
      {analytics.healthMetrics.recommendations.length > 0 && (
        <Card className="p-6">
          <h3 className="font-semibold text-[var(--hive-text-inverse)] mb-4">Recommendations</h3>
          <div className="space-y-3">
            {analytics.healthMetrics.recommendations.map((rec, index) => (
              <div key={index} className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div className="flex-1">
                  <div className="text-[var(--hive-text-inverse)]">{rec.action}</div>
