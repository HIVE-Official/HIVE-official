      ...
      <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-all">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-[var(--hive-text-muted)] truncate">{tool.description}</p>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-start justify-between">
          <div className="w-12 h-12 bg-gradient-to-br from-amber-400 to-amber-600 rounded-xl flex items-center justify-center">
            <IconComponent className="w-6 h-6 text-[var(--hive-text-inverse)]" />
          </div>
        ...
        <div>
          ...
          <p className="text-sm text-[var(--hive-text-muted)] mb-2 line-clamp-2">
            {tool.description}
          </p>
