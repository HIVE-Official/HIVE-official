      ...
      >
        ...
        <div className="relative shrink-0">
          ...
          >
            {user.avatar ? (
              ...
              <div className="flex h-full w-full items-center justify-center bg-[#2C2C2E] text-[var(--hive-text-inverse)]/70 text-sm font-medium">
                {avatarFallback}
              </div>
            )}
          </Avatar>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {/* Ghost Mode Badge */}
            {user.isGhostMode && (
              <Badge variant="secondary" className="bg-white/10 text-[var(--hive-text-inverse)]/60">
                Ghost
              </Badge>
            )}
          </div>
