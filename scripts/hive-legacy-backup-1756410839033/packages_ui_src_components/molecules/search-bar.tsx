    ...
    return (
      <div className={cn("relative w-full", className)}>
        <div className="relative">
          {/* Search Icon */}
          <div className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--hive-text-inverse)]/50">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-medium text-[var(--hive-text-inverse)] truncate">
                      {highlightMatch(suggestion.label, internalValue)}
                    </div>
                    {suggestion.description && (
                      <div className="text-xs text-[var(--hive-text-inverse)]/70 truncate mt-1">
                        {suggestion.description}
                      </div>
                    )}
                  </div>
