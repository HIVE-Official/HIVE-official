...
export interface HiveSliderProps
  extends React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root>,
    VariantProps<typeof hiveSliderVariants> {
    ...
    <div className="w-full space-y-3">
      ...
      {(label || showValue) && (
        <div className="flex items-center justify-between">
          ...
          {showValue && (
            <span className="text-sm font-mono text-[var(--hive-text-secondary)]">
      ...
      <SliderPrimitive.Root
        ref={ref}
        className={cn(hiveSliderVariants({ variant, size, className }))}
        value={currentValue}
      ...
      >
        ...
        <SliderPrimitive.Track 
          className={cn(hiveSliderTrackVariants({ variant, size }))}
        >
          {/* Range (filled portion) */}
          <SliderPrimitive.Range 
            className={cn(hiveSliderRangeVariants({ variant }))}
          />
        </SliderPrimitive.Track>
        ...
        <SliderPrimitive.Thumb asChild>
          {liquidMotion ? (
            <motion.div
              className={cn(hiveSliderThumbVariants({ variant, size }))}
            ...
            <div className={cn(hiveSliderThumbVariants({ variant, size }))} />
          )}
...
const HiveVolumeSlider = React.forwardRef<
  React.ElementRef<typeof SliderPrimitive.Root>,
  Omit<HiveSliderProps, 'label' | 'min' | 'max' | 'showValue' | 'valueFormatter'>
>(({ ...props }, ref) => (
  <Slider
    ref={ref}
    label="Volume"
...
const HiveBrightnessSlider = React.forwardRef<
  React.ElementRef<typeof SliderPrimitive.Root>,
  Omit<HiveSliderProps, 'label' | 'min' | 'max' | 'showValue' | 'valueFormatter'>
>(({ ...props }, ref) => (
  <Slider
...
const HiveProgressSlider = React.forwardRef<
  React.ElementRef<typeof SliderPrimitive.Root>,
  Omit<HiveSliderProps, 'label' | 'min' | 'max' | 'showValue' | 'valueFormatter'>
>(({ ...props }, ref) => (
  <Slider
...
const HivePriceRangeSlider = React.forwardRef<
  React.ElementRef<typeof SliderPrimitive.Root>,
  Omit<HiveSliderProps, 'label' | 'min' | 'max' | 'showValue' | 'valueFormatter'>
>(({ ...props }, ref) => (
  <Slider
...
const HiveTemperatureSlider = React.forwardRef<
  React.ElementRef<typeof SliderPrimitive.Root>,
  Omit<HiveSliderProps, 'label' | 'min' | 'max' | 'showValue' | 'valueFormatter'>
>(({ ...props }, ref) => (
  <Slider
...
export {
  ...
  hiveSliderVariants,
  hiveSliderTrackVariants,
  hiveSliderRangeVariants,
  hiveSliderThumbVariants
};

// Simple Slider component for basic use cases (backwards compatibility)
const Slider = React.forwardRef<
  React.ElementRef<typeof SliderPrimitive.Root>,
  Omit<HiveSliderProps, 'label' | 'description' | 'showValue' | 'liquidMotion'>
>(({ ...props }, ref) => (
  <Slider
    ref={ref}
    variant="minimal"
