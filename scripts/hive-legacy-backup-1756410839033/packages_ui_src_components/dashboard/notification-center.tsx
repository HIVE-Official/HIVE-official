          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="p-2 rounded bg-hive-background-overlay">
                <p className="text-[var(--hive-text-inverse)] font-medium">Email Notifications</p>
                <p className="text-hive-text-mutedLight">Important updates only</p>
              </div>
              <div className="p-2 rounded bg-hive-background-overlay">
                <p className="text-[var(--hive-text-inverse)] font-medium">Push Notifications</p>
        ...
        <div className="flex-1 min-w-0 space-y-1">
          <div className="flex items-center justify-between">
            <h4 className={`text-sm font-medium transition-colors ${
              notification.isRead ? 'text-hive-text-mutedLight' : 'text-[var(--hive-text-inverse)] group-hover:text-hive-gold'
            }`}>
              {notification.title}
            </h4>
            <div className="flex items-center space-x-2">
