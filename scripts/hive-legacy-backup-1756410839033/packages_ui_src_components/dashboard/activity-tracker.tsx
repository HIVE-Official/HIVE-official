    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          <p className="text-lg text-[var(--hive-text-muted)] mb-4">Unable to load activity data</p>
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <ButtonEnhanced variant="secondary" size="sm" onClick={onExport}>
                ...
                >
                  <Card className="h-full">
                    <CardContent className="p-4">
                      ...
                      <div className="text-sm text-[var(--hive-text-muted)]">{metric.name}</div>
                      {metric.target && (
                        <div className="mt-2">
                          <Progress 
                ...
                <CardContent>
                  <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-[var(--hive-text-muted)]">Avg Session</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-600">
                        {data.weeklyStats.mostActiveDay}
                      </div>
                      <div className="text-sm text-[var(--hive-text-muted)]">Most Active</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-orange-600">
                        {data.weeklyStats.preferredTimeSlot}
                      </div>
                      <div className="text-sm text-[var(--hive-text-muted)]">Peak Hours</div>
                    </div>
                    <div className="text-center">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-[var(--hive-text-muted)]">Tools</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-[var(--hive-text-muted)] mb-2">{insight.description}</p>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <p className="text-xs text-[var(--hive-text-muted)]">{goal.description}</p>
                        </div>
                        <Badge variant="secondary" className="text-xs">
                          {goal.category}
                        </Badge>
