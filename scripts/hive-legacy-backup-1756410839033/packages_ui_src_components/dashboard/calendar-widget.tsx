    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          <p className="text-lg text-[var(--hive-text-muted)] mb-4">Unable to load calendar</p>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 mt-1 text-xs text-[var(--hive-text-muted)]">
