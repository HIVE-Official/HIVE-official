    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white/[0.02] border border-white/[0.06] rounded-lg text-[var(--hive-text-inverse)] placeholder-neutral-400 focus:border-[#FFD700]/30 focus:outline-none"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-2 bg-white/[0.02] border border-white/[0.06] rounded-lg text-[var(--hive-text-inverse)] focus:border-[#FFD700]/30 focus:outline-none"
          >
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="font-semibold text-[var(--hive-text-inverse)] truncate">{event.title}</h3>
                    {event.isVirtual && (
      ...
      {filteredEvents.length === 0 && (
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-[var(--hive-text-inverse)] mb-2">No Events Found</h3>
          ...
          >
            ...
            >
              <div className="p-6 border-b border-white/[0.06]">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)]">{selectedEvent.title}</h2>
                  <ButtonEnhanced
                    variant="secondary"
                    size="sm"
                    onClick={() => setSelectedEvent(null)}
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-sm font-medium text-[var(--hive-text-inverse)] mb-2">Event Details</h4>
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-[var(--hive-text-inverse)] mb-2">Attendees</h4>
                          ...
                          <div key={attendee.id} className="flex items-center gap-2">
                            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#FFD700]/20 to-purple-500/20 flex items-center justify-center">
                              {attendee.avatar ? (
                                ...
                                <span className="text-xs font-bold text-[var(--hive-text-inverse)]">{attendee.name.charAt(0)}</span>
                              )}
                            </div>
                            <span className="text-sm text-[var(--hive-text-inverse)]">{attendee.name}</span>
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-white/[0.06]">
                    <div className="flex items-center gap-2">
                      {selectedEvent.status === 'published' && (
                        <ButtonEnhanced className="bg-green-500/20 text-green-400 border-green-500/30 hover:bg-green-500/30">
