        ...
        {(toolState?.options || ['Library', 'Coffee Shop', 'Dorm Room', 'Study Hall']).map((option: string, index: number) => (
          <div key={index} className="flex items-center justify-between">
            <input
              ...
              className="flex-1 px-3 py-1 text-sm border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
            />
    ...
    <div className="space-y-3">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <p className="text-sm text-[var(--hive-text-muted)]">{iface.description}</p>
        </div>
    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--hive-text-muted)]">{toolDescription}</p>
        </div>

        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <span className="text-sm text-[var(--hive-text-muted)]">Status:</span>
            <Badge className={
              toolState.isActive 
                ? "bg-green-100 text-green-800 border-green-200"
