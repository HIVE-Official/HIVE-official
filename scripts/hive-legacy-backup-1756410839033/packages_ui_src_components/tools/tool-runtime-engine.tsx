...
export function ToolRuntimeEngine({
  ...
  const renderElement = useCallback((element: ToolElement) => {
    ...
    switch (element.type) {
        ...
        elementComponent = (
          <div className="space-y-2">
            ...
            <textarea
              ...
              disabled={state.loading}
              className={cn(
                "w-full p-2 border border-[var(--hive-border-default)] rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500",
      ...
      case 'divider':
        elementComponent = <hr className="border-[var(--hive-border-default)] my-4" />;
        break;
      ...
      <div className="border-b border-gray-200 pb-4">
        <div className="flex items-start justify-between">
          <div>
            ...
            {tool.description && (
              <p className="text-[var(--hive-text-muted)] mt-1">{tool.description}</p>
            )}
          </div>
