        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center py-16">
            <Card className="p-6 text-center max-w-md">
              ...
              <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-2">Tools Error</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <Card className="p-8 text-center bg-gradient-to-r from-gray-800 to-gray-900 border-gray-700">
            <h1 className="text-3xl font-bold text-[var(--hive-text-inverse)] mb-4">
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <Button
                ...
                className="bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFE255]"
              >
              ...
              <button
                ...
                className={`flex-1 px-4 py-2 text-sm rounded-md transition-colors ${
                  internalActiveTab === 'marketplace'
                    ? 'bg-[#FFD700] text-[var(--hive-text-primary)] font-medium'
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 bg-gray-800 border-gray-700 text-[var(--hive-text-inverse)]"
                      />
                    </div>
                  </div>
                  <Button
                  ...
                  <div className="flex bg-gray-800 rounded-lg p-1">
                    <button
                      ...
                      className={`p-2 rounded ${internalViewMode === 'grid' ? 'bg-[#FFD700] text-[var(--hive-text-primary)]' : 'text-gray-400'}`}
                    >
                      <Grid className="w-4 h-4" />
                    </button>
                    <button
                      onClick={() => handleViewModeChange('list')}
                      className={`p-2 rounded ${internalViewMode === 'list' ? 'bg-[#FFD700] text-[var(--hive-text-primary)]' : 'text-gray-400'}`}
                    >
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-sm transition-colors ${
                        internalCategory === category.id
                          ? 'bg-[#FFD700] text-[var(--hive-text-primary)]'
                          : 'bg-gray-800 text-gray-400 hover:text-[var(--hive-text-inverse)]'
                      }`}
                    >
                  ...
                  >
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div>
                        ...
                        <select className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-[var(--hive-text-inverse)]">
              ...
              >
                <Card className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)]">Featured Tools</h2>
                        ...
                        <div key={tool.id} className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer group">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                              ...
                              >
                                <IconComponent className="w-5 h-5 text-[var(--hive-text-inverse)]" />
                              </div>
                              <div>
                                <h3 className="font-medium text-[var(--hive-text-inverse)]">{tool.name}</h3>
                                <div className="flex items-center gap-2 text-xs">
                                  <span className="text-gray-400">{tool.creator}</span>
                                  {tool.creatorVerified && (
                                    <div className="w-3 h-3 bg-blue-500 rounded-full flex items-center justify-center">
                                      <span className="text-[var(--hive-text-inverse)] text-xs">✓</span>
                                    </div>
                                  )}
                                </div>
                              </div>
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <button
                                ...
                                className="p-1 text-gray-400 hover:text-[var(--hive-text-inverse)] transition-colors"
                              >
                          ...
                          <div className="flex gap-2">
                            {!tool.isInstalled ? (
                              <Button
                                ...
                                className="flex-1 bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFE255]"
                              >
                      ...
                      return (
                        <div key={tool.id} className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors group">
                          <div className="flex items-start justify-between mb-3">
                            ...
                            <div className="flex items-center gap-1">
                              {tool.isInstalled && (
                                <span className="text-xs bg-green-600 text-[var(--hive-text-inverse)] px-2 py-1 rounded-full">
                                  Installed
                                </span>
                              )}
                              {tool.isPremium && (
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  {tool.isInstalled && (
                                    <span className="text-xs bg-green-600 text-[var(--hive-text-inverse)] px-2 py-1 rounded-full">Installed</span>
                                  )}
                                  {tool.isPremium && (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div className="text-center">
                    <div className="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center mx-auto mb-2">
                      <Download className="w-6 h-6 text-[var(--hive-text-inverse)]" />
                    </div>
                    <div className="text-2xl font-bold text-[var(--hive-text-inverse)]">{installed.length}</div>
                  ...
                  <div className="text-center">
                    <div className="w-12 h-12 bg-green-600 rounded-lg flex items-center justify-center mx-auto mb-2">
                      <Activity className="w-6 h-6 text-[var(--hive-text-inverse)]" />
                    </div>
                    <div className="text-2xl font-bold text-[var(--hive-text-inverse)]">12</div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-bold text-[var(--hive-text-inverse)]">{favoriteTools.length}</div>
                    <div className="text-sm text-gray-400">Favorites</div>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-orange-600 rounded-lg flex items-center justify-center mx-auto mb-2">
                      <Zap className="w-6 h-6 text-[var(--hive-text-inverse)]" />
                    </div>
                    <div className="text-2xl font-bold text-[var(--hive-text-inverse)]">87%</div>
            ...
            {installed.length > 0 ? (
              <>
                ...
                >
                  <Card className="p-6">
                    <div className="flex items-center justify-between mb-6">
                      <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)]">Quick Access</h2>
                      <Button variant="secondary" size="sm">
                      ...
                      {installed.slice(0, 4).map((tool) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <h3 className="font-medium text-[var(--hive-text-inverse)] text-sm mb-1">{tool.name}</h3>
                ...
                >
                  <Card className="p-6">
                    <div className="flex items-center justify-between mb-6">
                      <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)]">My Tools</h2>
                      <div className="flex items-center gap-2">
                        <Button variant="secondary" size="sm">
              ...
              >
                <Card className="p-12 text-center">
                  ...
                  <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-4">
        ...
        {internalActiveTab === 'hivelab' && (
          <div className="space-y-6">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              <Card className="p-8 text-center bg-gradient-to-r from-purple-900/20 to-blue-900/20 border-purple-700/30">
                <div className="w-20 h-20 bg-gradient-to-br from-[#FFD700] to-[#FFE255] rounded-3xl flex items-center justify-center mx-auto mb-6">
                  <Palette className="w-10 h-10 text-[var(--hive-text-primary)]" />
                </div>
            ...
            >
              <Card className="p-6">
                <h3 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-6">Choose Your Creation Method</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-gray-800 rounded-2xl p-6 text-center hover:bg-gray-700 transition-colors group cursor-pointer">
                    ...
                    <h4 className="font-semibold text-[var(--hive-text-inverse)] mb-2">Quick Builder</h4>
                  ...
                  <div className="bg-gray-800 rounded-2xl p-6 text-center hover:bg-gray-700 transition-colors group cursor-pointer">
                    <div className="w-12 h-12 bg-purple-600 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                      <Code className="w-6 h-6 text-[var(--hive-text-inverse)]" />
                    </div>
                    <h4 className="font-semibold text-[var(--hive-text-inverse)] mb-2">Template Builder</h4>
                    <p className="text-sm text-gray-300 mb-4">
                  ...
                  <div className="bg-gray-800 rounded-2xl p-6 text-center hover:bg-gray-700 transition-colors group cursor-pointer border-2 border-[#FFD700]/30">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#FFD700] to-[#FFE255] rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                      <Palette className="w-6 h-6 text-[var(--hive-text-primary)]" />
                    </div>
                    <h4 className="font-semibold text-[var(--hive-text-inverse)] mb-2">Visual Builder</h4>
                    <p className="text-sm text-gray-300 mb-4">
                    ...
                    <Button 
                      size="sm"
                      onClick={() => onCreateTool?.('visual')}
                      className="w-full bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFE255]"
                    >
                      Open Builder
                    </Button>
                  </div>
            ...
            >
              <Card className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-semibold text-[var(--hive-text-inverse)]">Popular Templates</h3>
                  <Button variant="secondary" size="sm">
                    View All <ArrowRight className="w-4 h-4 ml-1" />
                  </Button>
                </div>
                  ...
                  <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors group">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                        <MessageSquare className="w-4 h-4 text-[var(--hive-text-inverse)]" />
                      </div>
                      <div>
                        <h4 className="font-medium text-[var(--hive-text-inverse)]">Poll & Survey Tool</h4>
                    ...
                    <Button size="sm" className="w-full" onClick={() => onCreateTool?.('template')}>
                      Use Template
                    </Button>
                  </div>
                  ...
                  <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors group">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-8 h-8 bg-green-600 rounded-lg flex items-center justify-center">
                        <Calendar className="w-4 h-4 text-[var(--hive-text-inverse)]" />
                      </div>
                      <div>
                        <h4 className="font-medium text-[var(--hive-text-inverse)]">Event Coordinator</h4>
                  ...
                  <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors group">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-8 h-8 bg-orange-600 rounded-lg flex items-center justify-center">
                        <Calculator className="w-4 h-4 text-[var(--hive-text-inverse)]" />
                      </div>
                      <div>
                        <h4 className="font-medium text-[var(--hive-text-inverse)]">Grade Tracker</h4>
            ...
            >
              <Card className="p-6">
                <h3 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-6">Getting Started with HiveLab</h3>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h4 className="font-medium text-[var(--hive-text-inverse)] mb-4 flex items-center gap-2">
                      <div className="w-6 h-6 bg-[#FFD700] text-[var(--hive-text-primary)] rounded-full flex items-center justify-center text-sm font-bold">1</div>
                  ...
                  <div>
                    <h4 className="font-medium text-[var(--hive-text-inverse)] mb-4 flex items-center gap-2">
                      <div className="w-6 h-6 bg-[#FFD700] text-[var(--hive-text-primary)] rounded-full flex items-center justify-center text-sm font-bold">2</div>
                      Design & Build
                    </h4>
                    <ul className="space-y-2 text-sm text-gray-300">
                  ...
                  <div>
                    <h4 className="font-medium text-[var(--hive-text-inverse)] mb-4 flex items-center gap-2">
                      <div className="w-6 h-6 bg-[#FFD700] text-[var(--hive-text-primary)] rounded-full flex items-center justify-center text-sm font-bold">3</div>
                      Test & Refine
                    </h4>
                    <ul className="space-y-2 text-sm text-gray-300">
                  ...
                  <div>
                    <h4 className="font-medium text-[var(--hive-text-inverse)] mb-4 flex items-center gap-2">
                      <div className="w-6 h-6 bg-[#FFD700] text-[var(--hive-text-primary)] rounded-full flex items-center justify-center text-sm font-bold">4</div>
                      Deploy & Share
                    </h4>
                    <ul className="space-y-2 text-sm text-gray-300">
