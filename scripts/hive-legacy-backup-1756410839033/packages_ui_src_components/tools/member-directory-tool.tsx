    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold text-[var(--hive-text-inverse)]">Member Directory</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-lg text-[var(--hive-text-inverse)] placeholder-neutral-400 focus:outline-none focus:border-[#FFD700]/50 focus:ring-1 focus:ring-[#FFD700]/20"
          />
        </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="flex items-center gap-2 ml-auto">
                ...
                <select
                  ...
                  className="bg-white/5 border border-white/10 rounded px-3 py-1 text-sm text-[var(--hive-text-inverse)] focus:outline-none focus:border-[#FFD700]/50"
                >
      ...
      {filteredMembers.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-[var(--hive-text-inverse)] mb-2">No members found</h3>
      ...
      >
        <div className="flex items-center gap-4">
          <div className="relative">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#FFD700]/20 to-purple-500/20 flex items-center justify-center">
              {member.avatar ? (
                ...
                <span className="text-lg font-bold text-[var(--hive-text-inverse)]">{member.name.charAt(0)}</span>
              )}
            </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h3 className="font-medium text-[var(--hive-text-inverse)] truncate">{member.name}</h3>
        ...
        <div className="flex items-center gap-2">
          <div className="text-right text-sm">
            <div className="text-[var(--hive-text-inverse)] font-medium">{member.contributionScore}</div>
            <div className="text-neutral-400">contribution</div>
          </div>
          {isManageMode && isLeader && (
            <ButtonEnhanced variant="secondary" size="sm" onClick={(e) => { e.stopPropagation(); /* Open role menu */ }}>
          ...
          <div className="relative">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#FFD700]/20 to-purple-500/20 flex items-center justify-center">
              {member.avatar ? (
                ...
                <span className="text-sm font-bold text-[var(--hive-text-inverse)]">{member.name.charAt(0)}</span>
              )}
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 mb-3 text-center">
        <div>
          <div className="text-sm font-medium text-[var(--hive-text-inverse)]">{member.postsCount}</div>
          <div className="text-xs text-neutral-400">Posts</div>
        </div>
        <div>
          <div className="text-sm font-medium text-[var(--hive-text-inverse)]">{member.contributionScore}</div>
          <div className="text-xs text-neutral-400">Score</div>
        </div>
        <div>
          <div className="text-sm font-medium text-[var(--hive-text-inverse)]">{member.helpfulnessRating.toFixed(1)}</div>
      ...
      {isManageMode && isLeader && (
        <div className="flex items-center gap-2 pt-2 border-t border-white/10">
          <ButtonEnhanced variant="secondary" size="sm" className="flex-1 text-xs">
            <UserCog className="h-3 w-3 mr-1" />
            Manage
          </ButtonEnhanced>
          <ButtonEnhanced variant="secondary" size="sm" className="text-xs">
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/[0.06]">
          <div className="flex items-center gap-4">
            <div className="relative">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#FFD700]/20 to-purple-500/20 flex items-center justify-center">
                {member.avatar ? (
                  ...
                  <span className="text-2xl font-bold text-[var(--hive-text-inverse)]">{member.name.charAt(0)}</span>
                )}
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h2 className="text-xl font-bold text-[var(--hive-text-inverse)]">{member.name}</h2>
          ...
          <div className="flex items-center gap-2">
            ...
            <ButtonEnhanced variant="secondary" size="sm" onClick={onClose}>
              ✕
            </ButtonEnhanced>
          </div>
        </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)] space-y-6">
          ...
          {member.academicInfoVisible && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-medium text-[var(--hive-text-inverse)] mb-3">Academic Info</h3>
                <div className="space-y-2 text-sm">
                  {member.major && (
                    <div className="flex justify-between">
                      <span className="text-neutral-400">Major:</span>
                      <span className="text-[var(--hive-text-inverse)]">{member.major}</span>
                    </div>
                  )}
                  {member.graduationYear && (
                    <div className="flex justify-between">
                      <span className="text-neutral-400">Graduation:</span>
                      <span className="text-[var(--hive-text-inverse)]">{member.graduationYear}</span>
                    </div>
                  )}
                  {member.gpa && (
                    <div className="flex justify-between">
                      <span className="text-neutral-400">GPA:</span>
                      <span className="text-[var(--hive-text-inverse)]">{member.gpa}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div>
                <h3 className="text-lg font-medium text-[var(--hive-text-inverse)] mb-3">Activity Stats</h3>
          ...
          {/* Skills & Interests */}
          <div>
            <h3 className="text-lg font-medium text-[var(--hive-text-inverse)] mb-3">Skills & Expertise</h3>
          ...
          {member.contactVisible && (
            <div>
              <h3 className="text-lg font-medium text-[var(--hive-text-inverse)] mb-3">Contact & Availability</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-neutral-400">Preferred contact:</span>
                    <span className="text-[var(--hive-text-inverse)] capitalize">{member.preferredContactMethod}</span>
                  </div>
                  {member.availableHours && (
                    <div className="flex justify-between">
                      <span className="text-neutral-400">Available:</span>
                      <span className="text-[var(--hive-text-inverse)]">{member.availableHours}</span>
                    </div>
                  )}
                  {member.location && (
                    <div className="flex justify-between">
                      <span className="text-neutral-400">Location:</span>
                      <span className="text-[var(--hive-text-inverse)]">{member.location}</span>
                    </div>
                  )}
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-[var(--hive-text-inverse)]">{member.joinedAt.toLocaleDateString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-neutral-400">Last active:</span>
                    <span className="text-[var(--hive-text-inverse)]">{member.lastActive.toLocaleString()}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {isLeader && (
            <div className="pt-4 border-t border-white/10">
              <h3 className="text-lg font-medium text-[var(--hive-text-inverse)] mb-3">Leader Actions</h3>
              <div className="flex flex-wrap gap-2">
                <ButtonEnhanced
                  variant="secondary"
                  size="sm"
