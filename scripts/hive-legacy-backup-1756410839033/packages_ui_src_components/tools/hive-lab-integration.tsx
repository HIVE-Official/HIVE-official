      ...
      <div className={cn("space-y-6", className)}>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-[var(--hive-text-muted)] mt-1">
        ...
        {/* Navigation */}
        <div className="flex gap-1 p-1 bg-[var(--hive-background-secondary)] rounded-lg overflow-x-auto">
          {[
              ...
              <button
                ...
                className={cn(
                  ...
                  currentView === tab.id
                    ...
                    : "text-[var(--hive-text-muted)] hover:text-gray-900 hover:bg-gray-50"
                )}
              >
        ...
        {currentView === 'dashboard' && (
          <div className="space-y-6">
              ...
              <Card className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[var(--hive-text-muted)]">Total Tools</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[var(--hive-text-muted)]">Connected Spaces</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[var(--hive-text-muted)]">Weekly Usage</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[var(--hive-text-muted)]">Element Library</p>
                  </div>
                </div>
              </Card>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-amber-700">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-green-100 text-green-800 text-xs">Optimized</Badge>
                    </div>
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-amber-700">
                    ...
                    <div className="flex items-center justify-between">
                      <span>• Load Time</span>
                      <Badge className="bg-green-100 text-green-800 text-xs">&lt;2s</Badge>
                    </div>
                    <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer" onClick={() => setCurrentView('events')}>
                <div className="flex items-center gap-3 mb-3">
                  <Users className="w-6 h-6 text-amber-600" />
                  <h3 className="font-semibold text-gray-900">Event System</h3>
                </div>
                <p className="text-sm text-[var(--hive-text-muted)] mb-3">
              ...
              <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer" onClick={() => setCurrentView('marketplace')}>
                <div className="flex items-center gap-3 mb-3">
              ...
              <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer" onClick={() => setCurrentView('analytics')}>
                <div className="flex items-center gap-3 mb-3">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[var(--hive-text-muted)]">Average Load Time</span>
                    <span className="text-sm font-medium">1.2s</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[var(--hive-text-muted)]">Cache Hit Rate</span>
                    <span className="text-sm font-medium">94%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[var(--hive-text-muted)]">Error Rate</span>
                    <span className="text-sm font-medium">0.1%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[var(--hive-text-muted)]">User Satisfaction</span>
