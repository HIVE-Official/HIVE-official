...
const ToolCard: React.FC<ToolCardProps> = ({
  ...
  if (view === 'list') {
    return (
      ...
      >
        <Card className="p-6 cursor-pointer hover:shadow-lg transition-shadow" onClick={handleCardClick}>
        <div className="flex items-center gap-6">
          ...
          {isOwnProfile && (
            <div className="flex items-center gap-2">
              <Button variant="secondary" size="sm" onClick={(e) => { e.stopPropagation(); onViewAnalytics(); }}>
