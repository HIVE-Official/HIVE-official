  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <Icon className={cn('w-4 h-4', isActive ? 'text-[var(--hive-text-inverse)]' : config.textColor)} />
        <span className={cn('text-sm font-medium', isActive ? 'text-[var(--hive-text-inverse)]' : 'text-[var(--hive-text-primary)]')}>
          {config.label}
        </span>
      </div>
    </motion.button>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={cn('w-8 h-8 rounded-full flex items-center justify-center', config.color)}>
                        <Icon className="w-4 h-4 text-[var(--hive-text-inverse)]" />
                      </div>
                      <div>
