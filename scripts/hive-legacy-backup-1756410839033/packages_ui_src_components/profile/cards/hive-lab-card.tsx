    ...
    >
      <div className="flex items-start gap-2">
        <div className={cn('w-6 h-6 rounded flex items-center justify-center flex-shrink-0', config.color)}>
          <TypeIcon className="w-3 h-3 text-[var(--hive-text-inverse)]" />
        </div>
      ...
      {stats.badges.length > 0 && (
        <div className="flex justify-center gap-1">
          ...
          {stats.badges.length > 3 && (
            <div className="w-6 h-6 bg-[var(--hive-background-secondary)] rounded-full flex items-center justify-center">
              <span className="text-xs text-[var(--hive-text-muted)]">+{stats.badges.length - 3}</span>
            </div>
          )}
        </div>
      )}
  ...
  return (
    <div className="text-center space-y-3">
      ...
      <div className="space-y-2">
        ...
        <ButtonEnhanced size="sm" className="w-full" onClick={onBecomeBuilder}>
          ...
          <>
            ...
            {tools.length === 0 && (
              <div className="text-center py-4">
                ...
                <ButtonEnhanced size="sm" onClick={onCreateTool}>
