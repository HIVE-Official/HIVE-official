    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <ButtonEnhanced size="sm" variant="secondary" onClick={onCancel}>
            <X className="w-4 h-4" />
          </ButtonEnhanced>
          <ButtonEnhanced size="sm" onClick={handleSave} disabled={!hasChanges}>
          ...
          <div className="flex gap-4">
            ...
            <div className="relative group cursor-pointer" onClick={handlePhotoClick}>
              ...
              {!isEditMode && (
                ...
                >
                  <Camera className="w-5 h-5 text-[var(--hive-text-inverse)]" />
                </motion.div>
              )}
              ...
              {profile.builderStatus && (
                <div className="absolute -top-2 -right-2">
                  <div className="w-6 h-6 bg-[var(--hive-brand-gold)] rounded-full flex items-center justify-center">
                    <Crown className="w-3 h-3 text-[var(--hive-text-inverse)]" />
                  </div>
                </div>
              )}
              ...
              {profile.ghostMode && (
                <div className="absolute -bottom-1 -right-1">
                  <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center">
                    <EyeOff className="w-3 h-3 text-[var(--hive-text-inverse)]" />
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="flex-1 min-w-0 space-y-2">
              ...
              <div className="flex flex-wrap gap-1">
                {profile.builderStatus && (
                  <Badge variant="primary" className="bg-[var(--hive-brand-gold)] text-[var(--hive-text-inverse)] text-xs">
