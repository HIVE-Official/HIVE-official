      ...
      <div className="flex items-start gap-3">
        ...
        <div className="relative">
          ...
          <div className={cn(
            ...
            <CategoryIcon className="w-2.5 h-2.5 text-[var(--hive-text-inverse)]" />
          </div>
        </div>
              ...
              <div className="relative">
                ...
                {unreadCount > 0 && (
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 text-[var(--hive-text-inverse)] text-xs rounded-full flex items-center justify-center"
                  >
