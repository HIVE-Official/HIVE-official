        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center py-16">
            <Card className="p-6 text-center max-w-md">
              ...
              <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-2">Profile Error</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center py-16">
            <Card className="p-6 text-center">
              ...
              <h2 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-2">Profile Not Found</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        >
          <Card className="p-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-[var(--hive-text-inverse)]">Quick Actions</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              >
                ...
                <span className="text-sm text-[var(--hive-text-inverse)]">Avatar</span>
              </button>
              ...
              >
                ...
                <span className="text-sm text-[var(--hive-text-inverse)]">Privacy</span>
              </button>
              ...
              >
                ...
                <span className="text-sm text-[var(--hive-text-inverse)]">Settings</span>
              </button>
              ...
              >
                ...
                <span className="text-sm text-[var(--hive-text-inverse)]">Stats</span>
              </button>
            </div>
          </Card>
        </motion.div>
        ...
        {completeness && completeness.percentage < 100 && (
          ...
          >
            <Card className="p-4 border-l-4 border-[#FFD700]">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-semibold text-[var(--hive-text-inverse)] mb-1">Complete Your Profile</h4>
