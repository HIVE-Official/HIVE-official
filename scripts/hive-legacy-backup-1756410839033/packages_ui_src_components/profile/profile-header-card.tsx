  ...
  return (
    <div className={cn("flex flex-col h-full", className)}>
        ...
        <div className="relative">
          ...
          {isBuilder && (
            <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-[#FFD700] rounded-full flex items-center justify-center shadow-lg">
              <svg className="w-4 h-4 text-[var(--hive-text-primary)]" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="mt-auto grid grid-cols-2 gap-3">
        <button className="px-4 py-2 bg-[#FFD700] text-[var(--hive-text-primary)] rounded-lg font-medium text-sm hover:bg-[#FFD700]/90 transition-colors duration-[180ms]">
          Edit Profile
        </button>
