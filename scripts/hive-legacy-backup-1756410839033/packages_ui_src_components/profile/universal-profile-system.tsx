        ...
        <div className="h-32 sm:h-40 bg-gradient-to-r from-hive-gold/20 via-hive-brand-secondary/20 to-hive-gold/20 relative overflow-hidden">
          ...
          {isOwnProfile && (
            <div className="absolute top-4 right-4">
              <ButtonEnhanced variant="secondary" size="sm" className="bg-[var(--hive-background-primary)]/20 backdrop-blur-sm border-white/20">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  {isOwnProfile ? (
                    <>
                      <ButtonEnhanced variant="secondary" onClick={onEditProfile}>
                        <Edit3 className="h-4 w-4 mr-2" />
                        Edit Profile
                      </ButtonEnhanced>
                      <ButtonEnhanced variant="secondary" onClick={onPrivacySettings}>
                        <Settings className="h-4 w-4" />
                      </ButtonEnhanced>
                    </>
                  ) : (
                    <>
                      <ButtonEnhanced onClick={onMessageUser}>
                        <MessageSquare className="h-4 w-4 mr-2" />
                        Message
                      </ButtonEnhanced>
                      <ButtonEnhanced variant="secondary" onClick={onFollowUser}>
                        <UserPlus className="h-4 w-4 mr-2" />
                        Connect
                      </ButtonEnhanced>
                      <ButtonEnhanced variant="ghost" size="sm" onClick={onShareProfile}>
      ...
      <div className="px-4 sm:px-6 mt-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <ButtonEnhanced variant="ghost" size="sm" onClick={() => setViewMode(viewMode === 'grid' ? 'list' : 'grid')}>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        {spaces.length > 12 && (
          <ButtonEnhanced variant="ghost" onClick={onToggleShowAll}>
