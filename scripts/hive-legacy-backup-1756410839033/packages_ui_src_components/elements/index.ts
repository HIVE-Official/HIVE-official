...
// Type definitions for element loading
...
export const getElementMetadata = (elementId: ElementId) => {
  return ELEMENT_METADATA[elementId];
};

export const loadElement = async (elementId: ElementId) => {
...
export const isValidElementId = (elementId: string): elementId is ElementId => {
  return elementId in ELEMENT_REGISTRY;
};

export const getAllElements = () => {
  return Object.keys(ELEMENT_REGISTRY) as ElementId[];
};

export const getAllCategories = () => {
  return Object.keys(ELEMENT_CATEGORIES) as ElementCategory[];
};