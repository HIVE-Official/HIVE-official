      ...
      <div className="p-6">
        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-[180ms]">
            <ButtonEnhanced variant="ghost" size="sm" onClick={onBookmark} className="h-8 w-8 p-0">
              <motion.div
            ...
            <ButtonEnhanced variant="ghost" size="sm" className="h-8 w-8 p-0">
        ...
        {(space || ritual) && (
          <div className="mb-4 p-3 bg-surface-01 border border-border rounded-lg">
            <div className="flex items-center justify-between">
              ...
              {space && (
                <ButtonEnhanced variant="ghost" size="sm" onClick={onViewSpace} className="h-6 gap-1">
