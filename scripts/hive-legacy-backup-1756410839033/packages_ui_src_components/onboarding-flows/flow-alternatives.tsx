...
export const InstantActivationFlow = () => {
  ...
  if (step === 1) {
    return (
      <div className="min-h-screen bg-black text-[var(--hive-text-inverse)] font-['Geist_Sans'] flex items-center justify-center p-6">
        <div className="max-w-md w-full space-y-8">
          {/* Logo */}
          <div className="text-center">
            <div className="w-16 h-16 bg-[#FFD700] rounded-2xl flex items-center justify-center mx-auto mb-4">
              <span className="font-black text-[var(--hive-text-primary)] text-2xl">H</span>
            </div>
            <h1 className="text-3xl font-bold">Welcome to HIVE</h1>
            <p className="text-[var(--hive-text-inverse)]/60 mt-2">Join your campus community in 30 seconds</p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-lg text-[var(--hive-text-inverse)] placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:border-transparent"
              />
            </div>
            <div>
            ...
            <ButtonEnhanced 
              className="w-full bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFD700]/90 font-semibold py-3 text-base"
              onClick={() => setStep(2)}
            >
          ...
          {/* Skip Option */}
          <div className="text-center">
            <button className="text-[var(--hive-text-inverse)]/60 hover:text-[var(--hive-text-inverse)] text-sm">
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            <div className="w-12 h-12 bg-accent rounded-full flex items-center justify-center mx-auto mb-4">
              <Check className="w-6 h-6 text-[var(--hive-text-inverse)]" />
            </div>
            <h2 className="text-2xl font-bold">You're In!</h2>
            <p className="text-[var(--hive-text-inverse)]/60 mt-2">Magic link sent to {email}</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/20 rounded-lg p-6 text-center">
            ...
            <p className="text-sm text-[var(--hive-text-inverse)]/70">
              Click the link in your email to verify your account and you'll be redirected to your campus feed.
            </p>
          </div>

          <div className="space-y-3">
            <ButtonEnhanced className="w-full bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFD700]/90 font-semibold">
              Open Email App
            </ButtonEnhanced>
            <ButtonEnhanced variant="secondary" className="w-full border-white/20 text-[var(--hive-text-inverse)] hover:bg-white/5">
              Resend Link
            </ButtonEnhanced>
          </div>

          <div className="text-center">
            <p className="text-xs text-[var(--hive-text-inverse)]/40">
      ...
      <div className="min-h-screen bg-black text-[var(--hive-text-inverse)] font-['Geist_Sans'] flex items-center justify-center p-6">
        <div className="max-w-2xl w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[var(--hive-text-inverse)]/60 text-lg">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={cn("w-10 h-10 rounded-lg flex items-center justify-center", community.color)}>
                      <community.icon className="w-5 h-5 text-[var(--hive-text-inverse)]" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-semibold">{community.name}</h3>
                      <p className="text-sm text-[var(--hive-text-inverse)]/60">{community.members} members</p>
                    </div>
                    {selectedCommunities.includes(community.id) && (
                      <div className="w-6 h-6 bg-[#FFD700] rounded-full flex items-center justify-center">
                        <Check className="w-4 h-4 text-[var(--hive-text-primary)]" />
                      </div>
                    )}
                  </div>
                </Card>
          ...
          <div className="text-center">
            <ButtonEnhanced 
              className="bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFD700]/90 font-semibold px-8 py-3 text-base"
              onClick={() => setStep(2)}
            ...
            <p className="text-xs text-[var(--hive-text-inverse)]/40 mt-2">
      ...
      <div className="min-h-screen bg-black text-[var(--hive-text-inverse)] font-['Geist_Sans'] flex items-center justify-center p-6">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="text-[var(--hive-text-inverse)]/60">Just need your email to get you connected</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ButtonEnhanced className="w-full bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFD700]/90 font-semibold py-3">
                ...
                return (
                  <div key={id} className="flex items-center gap-3">
                    <div className={cn("w-6 h-6 rounded flex items-center justify-center", community?.color)}>
                      {community?.icon && <community.icon className="w-3 h-3 text-[var(--hive-text-inverse)]" />}
                    </div>
    ...
    return (
      <div className="min-h-screen bg-black text-[var(--hive-text-inverse)] font-['Geist_Sans'] flex items-center justify-center p-6">
        <div className="max-w-2xl w-full space-y-8">
          ...
          <div className="text-center">
            <div className="w-16 h-16 bg-[#FFD700] rounded-2xl flex items-center justify-center mx-auto mb-6">
              <GraduationCap className="w-8 h-8 text-[var(--hive-text-primary)]" />
            </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[var(--hive-text-inverse)]/60">{level.description}</p>
                    </div>
                  </div>
                </Card>
              ))}
      ...
      <div className="min-h-screen bg-black text-[var(--hive-text-inverse)] font-['Geist_Sans'] flex items-center justify-center p-6">
        <div className="max-w-2xl w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[var(--hive-text-inverse)]/60">Help us connect you with relevant academic communities</p>
          </div>
                  ...
                  {years.map(year => (
                    <button
                      ...
                      className={cn(
                        ...
                        selectedYear === year
                          ? "bg-[#FFD700] text-[var(--hive-text-primary)] border-[#FFD700]"
                          : "bg-white/5 border-white/20 text-[var(--hive-text-inverse)] hover:border-white/40"
                      )}
                    >
                      {year}
                    </button>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 bg-accent rounded flex items-center justify-center">
                  <Code className="w-3 h-3 text-[var(--hive-text-inverse)]" />
                </div>
                <span className="text-sm">{selectedMajor || 'Your Major'} Students</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 bg-accent rounded flex items-center justify-center">
                  <GraduationCap className="w-3 h-3 text-[var(--hive-text-inverse)]" />
                </div>
                <span className="text-sm">Class of {selectedYear || 'Your Year'}</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 bg-accent rounded flex items-center justify-center">
                  <BookOpen className="w-3 h-3 text-[var(--hive-text-inverse)]" />
                </div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              <div className="w-12 h-12 bg-[#FFD700] rounded-2xl flex items-center justify-center">
                <Sparkles className="w-6 h-6 text-[var(--hive-text-primary)]" />
              </div>
              <div className="text-left">
                <div className="text-2xl font-bold">Level 1</div>
                <div className="text-sm text-[var(--hive-text-inverse)]/60">{xp} XP</div>
              </div>
            </div>
            <h1 className="text-3xl font-bold mb-2">Welcome to HIVE</h1>
            <p className="text-[var(--hive-text-inverse)]/60">Complete your profile to unlock campus features</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/20 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center">
                  <UserCheck className="w-4 h-4 text-[var(--hive-text-inverse)]" />
                </div>
                <div>
                  <h3 className="font-semibold">First Quest: Your Identity</h3>
                  <p className="text-sm text-[var(--hive-text-inverse)]/60">+25 XP</p>
                </div>
              </div>
              <Badge className="bg-[#FFD700] text-[var(--hive-text-primary)]">Active</Badge>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ButtonEnhanced 
                className="w-full bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFD700]/90 font-semibold"
                onClick={() => {
                  addXP(25)
      ...
      <div className="min-h-screen bg-black text-[var(--hive-text-inverse)] font-['Geist_Sans'] flex items-center justify-center p-6">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[var(--hive-text-inverse)]/60">Next quest: Connect your campus identity</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/20 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center">
                  <Mail className="w-4 h-4 text-[var(--hive-text-inverse)]" />
                </div>
                <div>
                  <h3 className="font-semibold">Campus Connection</h3>
                  <p className="text-sm text-[var(--hive-text-inverse)]/60">+30 XP</p>
                </div>
              </div>
              <Badge className="bg-[#FFD700] text-[var(--hive-text-primary)]">Active</Badge>
            </div>
          ...
          <div className="bg-white/5 border border-white/20 rounded-lg p-4 opacity-60">
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 bg-accent rounded-full flex items-center justify-center">
                <Heart className="w-3 h-3 text-[var(--hive-text-inverse)]" />
              </div>
              <div>
                <h4 className="font-semibold text-sm">Bonus Quest: Find Your Tribe</h4>
                <p className="text-xs text-[var(--hive-text-inverse)]/60">+50 XP • Select your interests</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-black text-[var(--hive-text-inverse)] font-['Geist_Sans'] flex items-center justify-center p-6">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[var(--hive-text-inverse)]/60">Final quest: Discover your community</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/20 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center">
                  <Heart className="w-4 h-4 text-[var(--hive-text-inverse)]" />
                </div>
                <div>
                  <h3 className="font-semibold">Find Your Tribe</h3>
                  <p className="text-sm text-[var(--hive-text-inverse)]/60">+50 XP • Select 3+ interests</p>
                </div>
              </div>
              <Badge className="bg-[#FFD700] text-[var(--hive-text-primary)]">Bonus</Badge>
            </div>
            ...
            <div className="space-y-4">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      profile.interests.includes(interest)
                        ? "bg-[#FFD700] text-[var(--hive-text-primary)] border-[#FFD700] scale-105"
                        : "bg-white/5 border-white/20 text-[var(--hive-text-inverse)] hover:border-white/40"
                    )}
                  >
                    {interest}
              ...
              <p className="text-xs text-[var(--hive-text-inverse)]/40 text-center">
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            <div className="w-20 h-20 bg-[#FFD700] rounded-full flex items-center justify-center mx-auto mb-6">
              <Award className="w-10 h-10 text-[var(--hive-text-primary)]" />
            </div>
            <h1 className="text-3xl font-bold mb-2">Adventure Complete!</h1>
            <p className="text-[var(--hive-text-inverse)]/60">You've unlocked your campus community</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/20 rounded-lg p-6">
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                ...
                <div className="text-sm text-[var(--hive-text-inverse)]/60">XP Earned</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-[#FFD700]">{achievements.length}</div>
                <div className="text-sm text-[var(--hive-text-inverse)]/60">Achievements</div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-2">
              {profile.interests.slice(0, 3).map(interest => (
                <div key={interest} className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-[#FFD700] rounded-full flex items-center justify-center">
                    <Check className="w-3 h-3 text-[var(--hive-text-primary)]" />
                  </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-[var(--hive-text-inverse)]/60">Let's get you connected to your campus community</p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-[var(--hive-text-inverse)]/60">This helps us connect you with the right communities</p>
            </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[var(--hive-text-inverse)]/60">{role.description}</p>
                    </div>
                  </div>
                </Card>
              ))}
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-[var(--hive-text-inverse)]/60">We'll send you a magic link to get started</p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-[var(--hive-text-inverse)]/60">Help us connect you with relevant communities</p>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-lg text-[var(--hive-text-inverse)] focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:border-transparent"
                >
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-[var(--hive-text-inverse)]/60">Magic link sent to {formData.email}</p>
            </div>
            
            <div className="bg-white/5 border border-white/20 rounded-lg p-6 text-center">
              <Mail className="w-12 h-12 text-[#FFD700] mx-auto mb-4" />
              <h3 className="font-semibold mb-2">Check your email</h3>
              <p className="text-sm text-[var(--hive-text-inverse)]/60">
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-[#FFD700] rounded-2xl flex items-center justify-center mx-auto mb-4">
            <span className="font-black text-[var(--hive-text-primary)]">H</span>
          </div>
          <div className="text-sm text-[var(--hive-text-inverse)]/60 mb-2">Step {step} of {totalSteps}</div>
        ...
        <div className="flex gap-3">
          ...
          {step < totalSteps && (
            <ButtonEnhanced 
              className="flex-1 bg-[#FFD700] text-[var(--hive-text-primary)] hover:bg-[#FFD700]/90 font-semibold"
              onClick={() => setStep(step + 1)}
              disabled={
