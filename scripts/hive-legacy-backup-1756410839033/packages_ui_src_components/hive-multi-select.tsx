...
const triggerVariants = cva(
  "flex flex-wrap items-center gap-2 w-full px-4 py-3 bg-[var(--hive-background-secondary)] backdrop-blur-xl border rounded-xl transition-all cursor-pointer min-h-[12.5]",
  {
    variants: {
      variant: {
        default: "border-[var(--hive-border-subtle)] hover:border-[var(--hive-border-primary)] focus:border-[var(--hive-border-[var(--hive-brand-secondary)])]",
        ...
        elevated: "border-[var(--hive-border-primary)] hover:border-[var(--hive-border-secondary)] focus:border-[var(--hive-border-[var(--hive-brand-secondary)])] bg-[var(--hive-background-tertiary)]",
        minimal: "border-[var(--hive-border-subtle)] hover:border-[var(--hive-border-primary)] focus:border-[var(--hive-border-[var(--hive-brand-secondary)])] bg-transparent",
      },
