...
const inputVariants = cva(
  ...
  "flex w-full bg-background text-[var(--hive-text-inverse)] font-medium transition-all duration-[180ms] ease-[cubic-bezier(0.33,0.65,0,1)] file:border-0 file:bg-transparent file:font-medium placeholder:text-muted focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 selection:bg-accent/20",
  {
    variants: {
      variant: {
