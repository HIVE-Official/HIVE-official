  ...
  const mockElements: ElementDefinition[] = [
    {
      ...
      previewComponent: () => <div className="text-sm text-[var(--hive-text-muted)]">Poll preview</div>,
    ...
    },
    {
      ...
      previewComponent: () => <div className="text-sm text-[var(--hive-text-muted)]">Timer preview</div>,
    ...
    },
    {
      ...
      previewComponent: () => <div className="text-sm text-[var(--hive-text-muted)]">Attendance preview</div>,
    ...
    },
    {
      ...
      previewComponent: () => <div className="text-sm text-[var(--hive-text-muted)]">Mood check preview</div>,
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between mb-2">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-[var(--hive-text-muted)] line-clamp-2 mb-2">
                {element.description}
              </p>
            </div>
            
            <div className="flex items-center gap-1 ml-2">
              <Badge className={categoryConfig[category].className}>
          ...
          <div className="mt-2 p-2 bg-gray-50 rounded-md">
            <p className="text-xs text-[var(--hive-text-muted)]">{reason}</p>
          </div>
        </div>
      </div>
    </Card>
...
const CategorySection = ({ 
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-sm text-[var(--hive-text-muted)]">{category.description}</p>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            <div className="text-center py-8">
              ...
              <p className="text-[var(--hive-text-muted)]">Installing tool...</p>
            </div>
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button onClick={() => console.log('Browse HiveLAB')}>
