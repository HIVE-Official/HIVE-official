      ...
      case 'compact':
        return (
          <Button
            ...
            disabled={disabled}
            className={cn(
              "bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-[var(--hive-text-inverse)] border-0",
        ...
        return (
          <button
            ...
            className={cn(
              ...
              "text-[var(--hive-text-inverse)] rounded-full shadow-2xl",
