...
export const RadioPresets = {
  ...
  Priority: (props: Omit<RadioGroupProps, 'children'>) => (
    <RadioGroup {...props}>
      <RadioEnhanced value="low" label="Low Priority" />
      <RadioEnhanced value="medium" label="Medium Priority" />
      <RadioEnhanced value="high" label="High Priority" />
      <RadioEnhanced value="urgent" label="Urgent" />
    </RadioGroup>
  ),
  ...
  Size: (props: Omit<RadioGroupProps, 'children'>) => (
    <RadioGroup orientation="horizontal" {...props}>
      <RadioEnhanced value="xs" label="XS" />
      <RadioEnhanced value="sm" label="SM" />
      <RadioEnhanced value="md" label="MD" />
      <RadioEnhanced value="lg" label="LG" />
      <RadioEnhanced value="xl" label="XL" />
    </RadioGroup>
  ),
  ...
  Theme: (props: Omit<RadioGroupProps, 'children'>) => (
    <RadioGroup {...props}>
      <RadioEnhanced value="light" label="Light Theme" description="Clean and bright interface" />
      <RadioEnhanced value="dark" label="Dark Theme" description="Easy on the eyes" />
      <RadioEnhanced value="auto" label="Auto" description="Matches system preference" />
    </RadioGroup>
  ),
};
