...
export const ProgressSection = ({ user }: ProgressSectionProps) => {
  ...
  return (
    <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-lg p-6">
      <h3 className="font-display text-lg font-semibold text-[var(--hive-text-inverse)] mb-6">
        Progress
      </h3>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative w-24 h-24 mb-4">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="font-display text-2xl font-bold text-[var(--hive-text-inverse)]">
        ...
        {user.isBuilder && (
          <div className="w-full mt-6 space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-sans text-sm font-medium text-[var(--hive-text-inverse)]">
