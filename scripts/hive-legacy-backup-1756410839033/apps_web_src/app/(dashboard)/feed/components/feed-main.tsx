          ...
          <CardContent className="pt-0">
            ...
            <div className="flex items-center justify-between mt-4 pt-3 border-t border-border">
              <div className="flex items-center gap-4">
                ...
                <ButtonEnhanced variant="ghost" size="sm" onClick={() => router.push(`/feed/post/${post.id}`)}>
                  <MessageCircle className="h-4 w-4 mr-1" />
                  {post.stats.comments}
                </ButtonEnhanced>
                
                <ButtonEnhanced variant="ghost" size="sm" onClick={() => handleSharePost(post.id)}>
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {unreadCount > 0 && (
              <ButtonEnhanced variant="outline" size="sm" className="relative">
                ...
                <Card className="p-8 text-center">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      {!searchQuery && (
                        <ButtonEnhanced onClick={() => router.push('/tools/builder')}>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <ButtonEnhanced variant="ghost" size="sm" className="w-full" onClick={() => router.push('/tools/browse')}>
                  View All Tools
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <ButtonEnhanced variant="ghost" size="sm" className="w-full" onClick={() => router.push('/calendar')}>
                  View Calendar
                  <ChevronRight className="h-3 w-3 ml-1" />
                </ButtonEnhanced>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <ButtonEnhanced variant="outline" size="sm" className="w-full justify-start" onClick={() => router.push('/tools/builder')}>
                  <Wrench className="h-4 w-4 mr-2" />
                  Create Tool
                </ButtonEnhanced>
                <ButtonEnhanced variant="outline" size="sm" className="w-full justify-start" onClick={() => router.push('/spaces')}>
                  <Users className="h-4 w-4 mr-2" />
                  Discover Spaces
                </ButtonEnhanced>
                <ButtonEnhanced variant="outline" size="sm" className="w-full justify-start" onClick={() => router.push('/calendar')}>
