...
import { ButtonEnhanced, Badge, HivePostsSurface, HiveEventsSurface, HiveMembersSurface, HivePinnedSurface, HiveToolsSurface, type Comment } from "@hive/ui";
    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center max-w-md px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/spaces">
            <ButtonEnhanced variant="outline" className="w-full sm:w-auto">
              Browse Spaces
            </ButtonEnhanced>
          </Link>
          <ButtonEnhanced
