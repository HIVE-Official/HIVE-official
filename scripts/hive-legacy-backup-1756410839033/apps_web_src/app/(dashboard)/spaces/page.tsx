...
import { ButtonEnhanced, Card } from "@hive/ui";
      ...
      >
        ...
        {showCreateModal && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-[var(--hive-background-primary)] border border-white/[0.1] rounded-2xl w-full max-w-md p-8 text-center">
              <div className="w-16 h-16 bg-[var(--hive-brand-secondary)]/20 rounded-xl flex items-center justify-center text-2xl mx-auto mb-4">
                🚀
              </div>
              <h3 className="text-xl font-semibold text-[var(--hive-text-inverse)] mb-2">Space Creation Coming Soon!</h3>
