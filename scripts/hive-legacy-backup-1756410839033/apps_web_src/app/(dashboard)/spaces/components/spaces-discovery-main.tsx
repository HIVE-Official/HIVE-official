    ...
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-8">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <ButtonEnhanced variant="outline" size="sm" onClick={() => setViewMode(viewMode === 'grid' ? 'list' : 'grid')}>
            {viewMode === 'grid' ? 'List View' : 'Grid View'}
          </ButtonEnhanced>
          <ButtonEnhanced variant="primary" onClick={handleRequestSpace}>
          ...
          <div className={viewMode === 'list' ? 'flex items-center gap-4' : ''}>
            ...
            <div className="flex justify-end">
              {space.status === 'preview' ? (
                ...
                <ButtonEnhanced size="sm" variant="ghost" onClick={onClick}>
                  View Space
                </ButtonEnhanced>
              ) : (
                <ButtonEnhanced size="sm" variant="primary" onClick={onClick}>
