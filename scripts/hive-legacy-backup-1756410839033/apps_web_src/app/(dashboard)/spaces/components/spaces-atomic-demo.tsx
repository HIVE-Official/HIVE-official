  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <ButtonEnhanced variant="primary" size="large">Large Primary</ButtonEnhanced>
                <ButtonEnhanced variant="primary" size="medium">Medium Primary</ButtonEnhanced>
                <ButtonEnhanced variant="primary" size="small">Small Primary</ButtonEnhanced>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <ButtonEnhanced variant="secondary" size="large">Large Secondary</ButtonEnhanced>
                <ButtonEnhanced variant="secondary" size="medium">Medium Secondary</ButtonEnhanced>
                <ButtonEnhanced variant="secondary" size="small">Small Secondary</ButtonEnhanced>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <ButtonEnhanced variant="ghost" size="medium">Ghost Button</ButtonEnhanced>
                <ButtonEnhanced variant="destructive" size="medium">Destructive</ButtonEnhanced>
                <ButtonEnhanced variant="accent" size="medium">Accent</ButtonEnhanced>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <div className="flex justify-center pt-8">
        <ButtonEnhanced variant="primary" size="large">
          Explore More Spaces
        </ButtonEnhanced>
      </div>
    </div>
