        ...
        <Card className="border-accent/20 shadow-2xl">
          <CardHeader className="border-b border-border bg-gradient-to-r from-background to-accent/5">
            <div className="flex items-center justify-between">
              ...
              <ButtonEnhanced variant="ghost" size="sm" onClick={handleClose}>
                <X className="h-4 w-4" />
              </ButtonEnhanced>
            </div>
          </CardHeader>
                ...
                <AnimatePresence mode="wait">
                  ...
                  {step === 2 && (
                    ...
                    >
                      ...
                      <div className="flex justify-between pt-4">
                        <ButtonEnhanced variant="outline" onClick={() => setStep(1)}>
                          Back
                        </ButtonEnhanced>
                        <ButtonEnhanced 
                          onClick={() => setStep(3)}
                  ...
                  {step === 3 && (
                    ...
                    >
                      ...
                      <div className="flex justify-between pt-4">
                        <ButtonEnhanced variant="outline" onClick={() => setStep(2)}>
                          Back
                        </ButtonEnhanced>
                        <ButtonEnhanced 
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-3">
        <ButtonEnhanced variant="outline" onClick={onClose}>
          Continue Exploring
        </ButtonEnhanced>
        <ButtonEnhanced onClick={handleViewSpace}>
          View Space
          <ArrowRight className="h-4 w-4 ml-2" />
        </ButtonEnhanced>
      </div>
