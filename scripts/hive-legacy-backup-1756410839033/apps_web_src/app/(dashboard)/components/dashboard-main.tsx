      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <ButtonEnhanced onClick={() => window.location.reload()} className="mt-4">
              Try Again
            </ButtonEnhanced>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        >
          ...
          <div className="flex items-center space-x-3 mt-4 md:mt-0">
            <ButtonEnhanced onClick={() => router.push('/spaces')} className="flex items-center space-x-2">
              <Users className="h-4 w-4" />
              <span>Browse Spaces</span>
            </ButtonEnhanced>
            <ButtonEnhanced variant="outline" onClick={() => router.push('/spaces/create')} className="flex items-center space-x-2">
