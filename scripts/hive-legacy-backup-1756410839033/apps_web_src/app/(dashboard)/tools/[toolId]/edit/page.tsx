...
import { ButtonEnhanced, Card, Grid as _Grid } from "@hive/ui";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <ButtonEnhanced size="sm" variant="ghost" className="h-6 w-6 p-0 opacity-0 group-hover:opacity-100">
          ...
          <div className="col-span-3 space-y-6">
            ...
            <Card className="p-4 bg-[rgba(255,255,255,0.02)] border-[rgba(255,255,255,0.06)] flex-1">
              <div className="flex items-center justify-between mb-4">
                ...
                <ButtonEnhanced size="sm" variant="ghost" className="h-6 w-6 p-0">
                  <MoreHorizontal className="h-3 w-3 text-[var(--hive-text-muted)]" />
                </ButtonEnhanced>
              </div>
