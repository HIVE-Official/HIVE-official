    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <SelectEnhanced value={tool.visibility} onValueChange={(value: any) => setTool(prev => ({ ...prev, visibility: value }))}>
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        {tool.visibility === 'space' && userSpaces.length > 0 && (
          <div>
            ...
            <SelectEnhanced value={tool.spaceId || ''} onValueChange={(value) => {
        ...
        <div className="flex gap-2 pt-4">
          <ButtonEnhanced variant="outline" onClick={() => setCurrentStep('category')}>
  ...
  const renderBuilderStep = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <ButtonEnhanced variant="outline" onClick={() => setCurrentStep('details')}>
          <ArrowLeft className="h-4 w-4 mr-2" />
          Back
        </ButtonEnhanced>
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="flex items-center justify-between mb-3">
            ...
            {tool.elements.length > 0 && (
              <ButtonEnhanced size="sm" onClick={() => setCurrentStep('settings')}>
              ...
              <Card className="p-8 text-center">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ButtonEnhanced onClick={() => addElement('text')}>
  ...
  const renderSettingsStep = () => (
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        <ButtonEnhanced variant="outline" onClick={() => setCurrentStep('builder')}>
          <ArrowLeft className="h-4 w-4 mr-2" />
          Back
        </ButtonEnhanced>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-2">
          <ButtonEnhanced onClick={() => setCurrentStep('preview')}>
  ...
  const renderPreviewStep = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <ButtonEnhanced variant="outline" onClick={() => setCurrentStep('settings')}>
          <ArrowLeft className="h-4 w-4 mr-2" />
          Back
        </ButtonEnhanced>
      </div>
            ...
            <form className="space-y-4">
              {tool.elements.map((element) => (
                <div key={element.id}>
                  ...
                  {element.type === 'text' && (
                    <InputEnhanced placeholder={element.placeholder} disabled />
                  )}
                  {element.type === 'textarea' && (
                    <TextareaEnhanced placeholder={element.placeholder} disabled />
                  )}
                  {element.type === 'select' && (
                    <SelectEnhanced disabled>
                      <SelectTrigger>
                  ...
                  {element.type === 'date' && (
                    <InputEnhanced type="date" disabled />
                  )}
                  {element.type === 'email' && (
                    <InputEnhanced type="email" placeholder="Enter email address" disabled />
                  )}
                  {element.type === 'url' && (
                    <InputEnhanced type="url" placeholder="https://example.com" disabled />
                  )}
                </div>
              ))}
            </form>
      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="p-8 text-center">
          <div className="space-y-4">
            ...
            <ButtonEnhanced onClick={() => router.push('/auth/login')}>
              Log In
            </ButtonEnhanced>
          </div>
        </Card>
