...
export default function SchoolsPage() {
  ...
  return (
    <React.Fragment>
      <div 
        className="relative min-h-screen overflow-hidden hive-font-sans bg-hive-background-primary text-hive-text-primary animate-in fade-in duration-300" 
        style={{ backgroundColor: '#0A0A0B', color: '#F5F5F7' }}
      >
      ...
      <div className="relative z-10 max-w-6xl mx-auto p-6 py-12">
        <div className="text-center mb-16">
          ...
          <p className="hive-font-sans text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-8 text-hive-text-secondary">
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="hive-font-sans text-sm text-hive-text-muted">
        ...
        {!loading && (
          <div className="grid gap-4 hive-animate-liquid-reveal mb-16">
            ...
            >
              ...
              <div className="relative p-6">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center hive-gap-md hive-font-sans text-sm text-hive-text-muted">
                  ...
                  <div className="ml-6 opacity-60 group-hover:opacity-100 transition-opacity">
                    {navigatingSchool === school.id ? (
                      <div className="flex items-center hive-gap-sm text-hive-brand-primary">
                        ...
                        <span className="hive-font-sans font-medium text-sm">Loading...</span>
                      </div>
                    ) : school.isActive ? (
                        ...
                        {!school.isComingSoon && school.signupCount !== undefined && school.activationThreshold && (
                          <div className="space-y-1">
                            ...
                            <div className="w-16 bg-surface rounded-full h-1">
                              <div 
                                className="bg-accent/60 h-1 rounded-full transition-all duration-base"
              ...
              {/* Hover glow effect */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-base pointer-events-none">
        ...
        <div className="text-center">
          <div className="p-8 max-w-2xl mx-auto border border-hive-border-[var(--hive-brand-secondary)] rounded-lg bg-hive-background-secondary/80 backdrop-blur-sm">
      ...
      {isComingSoonOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="p-8 max-w-md w-full border border-hive-border-[var(--hive-brand-secondary)] rounded-lg bg-hive-background-secondary shadow-2xl">
            <h2 className="text-2xl font-bold text-foreground mb-4">What&apos;s Coming to HIVE</h2>
            <p className="text-muted mb-6">
              We&apos;re building the future of campus collaboration. Check back soon for new features and campus expansions.
            </p>
            <button
              onClick={() => setIsComingSoonOpen(false)}
              className="w-full px-6 py-3 bg-transparent border-2 border-hive-border-primary text-hive-text-secondary rounded-lg hover:bg-hive-background-tertiary/10 focus:outline-none focus:ring-2 focus:ring-hive-border-primary/50 transition-all duration-200 font-medium"
            >
              Close
            </button>
          </div>
