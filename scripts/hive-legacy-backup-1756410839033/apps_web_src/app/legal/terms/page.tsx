  ...
  content: (
    <div className="prose prose-invert max-w-none">
      ...
      <p>
        ...
        <Link href="/legal/privacy" className="text-[var(--hive-brand-secondary)] hover:text-[var(--hive-brand-secondary)]/80">
          Privacy Policy
        </Link>
        .
      </p>
      ...
      <p>
        ...
        <a href="mailto:legal@hive.co" className="text-[var(--hive-brand-secondary)] hover:text-[var(--hive-brand-secondary)]/80">
          legal@hive.co
        </a>
      </p>
