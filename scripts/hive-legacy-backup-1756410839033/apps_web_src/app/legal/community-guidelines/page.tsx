  ...
  content: (
    <div className="prose prose-invert max-w-none">
      ...
      <div className="mb-6 grid gap-4 md:grid-cols-3">
        <div className="rounded-lg border border-[var(--hive-brand-secondary)]/20 bg-[var(--hive-background-primary)]/30 p-4">
          <h3 className="mt-0 text-[var(--hive-brand-secondary)]">🤝 Respect</h3>
          <p className="mb-0 text-sm">
            Honor different perspectives, backgrounds, and experiences.
          </p>
        </div>
        <div className="rounded-lg border border-[var(--hive-brand-secondary)]/20 bg-[var(--hive-background-primary)]/30 p-4">
          <h3 className="mt-0 text-[var(--hive-brand-secondary)]">✨ Authenticity</h3>
          <p className="mb-0 text-sm">
            Be genuine in your interactions and contributions.
          </p>
        </div>
        <div className="rounded-lg border border-[var(--hive-brand-secondary)]/20 bg-[var(--hive-background-primary)]/30 p-4">
          <h3 className="mt-0 text-[var(--hive-brand-secondary)]">🚀 Growth</h3>
          <p className="mb-0 text-sm">
