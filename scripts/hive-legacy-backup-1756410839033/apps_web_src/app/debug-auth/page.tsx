...
export default function DebugAuthPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--hive-background-primary)] text-[var(--hive-text-inverse)] p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="space-y-4">
              <button 
                onClick={setTestAuth}
                className="w-full bg-green-600 hover:bg-green-700 px-4 py-2 rounded text-[var(--hive-text-inverse)]"
              >
                Set Test Session
              </button>
              <button 
                onClick={clearAuth}
                className="w-full bg-red-600 hover:bg-red-700 px-4 py-2 rounded text-[var(--hive-text-inverse)]"
              >
                Clear All Auth Data
              </button>
              <a 
                href="/dev-login"
                className="block w-full bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded text-[var(--hive-text-inverse)] text-center"
              >
                Go to Dev Login
              </a>
              <a 
                href={returnTo}
                className="block w-full bg-purple-600 hover:bg-purple-700 px-4 py-2 rounded text-[var(--hive-text-inverse)] text-center"
              >
