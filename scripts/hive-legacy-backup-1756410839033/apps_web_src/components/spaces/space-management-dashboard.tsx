    ...
    <div className="space-y-6">
                      ...
                      <div className="flex gap-1">
                        ...
                        <Dialog>
                          ...
                          <DialogContent>
                            ...
                            <DialogFooter>
                              <ButtonEnhanced variant="outline">Cancel</ButtonEnhanced>
                              <ButtonEnhanced 
                                variant="destructive"
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <InputEnhanced defaultValue={spaceData.name} />
                  </div>
                  <div>
                    <label className="text-sm font-medium">Visibility</label>
                    <SelectEnhanced defaultValue={spaceData.isPrivate ? 'private' : 'public'}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div>
                  ...
                  <InputEnhanced defaultValue={spaceData.description} />
                </div>
                <div className="flex gap-2">
                  <ButtonEnhanced>Save Changes</ButtonEnhanced>
                  <ButtonEnhanced variant="outline">Cancel</ButtonEnhanced>
                </div>
              </CardContent>
            </Card>
      ...
      <Dialog open={editMode} onOpenChange={setEditMode}>
        <DialogContent>
          ...
          <DialogFooter>
            <ButtonEnhanced variant="outline" onClick={() => setEditMode(false)}>
              Cancel
            </ButtonEnhanced>
            <ButtonEnhanced onClick={() => updateSpaceSettings({})}>
              Save Changes
            </ButtonEnhanced>
          </DialogFooter>
        </DialogContent>
