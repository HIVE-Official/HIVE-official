...
import { ButtonEnhanced, Badge } from "@hive/ui";
      ...
      {currentMode && (
        ...
        >
          {currentMode === 'moderate' && (
            <>
              <ButtonEnhanced size="sm" variant="outline" className="border-red-400/30 text-red-400 hover:bg-red-400/10">
          ...
          {currentMode === 'manage' && (
            <>
              <ButtonEnhanced size="sm" variant="outline" className="border-blue-400/30 text-blue-400 hover:bg-blue-400/10">
          ...
          {currentMode === 'insights' && (
            <ButtonEnhanced size="sm" variant="outline" className="border-purple-400/30 text-purple-400 hover:bg-purple-400/10">
