...
import { ButtonEnhanced, Card, Badge, Modal, Input } from "@hive/ui";
import { 
  Users, 
  Plus, 
  Calendar, 
          ...
          {filteredSpaces.map((space) => (
            <Card key={space.id} className="p-6 bg-zinc-800/50 border-zinc-700 hover:bg-zinc-800/70 transition-colors">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-zinc-700">
                ...
                <ButtonEnhanced variant="ghost" size="sm" className="text-zinc-400 hover:text-[var(--hive-text-inverse)]">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t border-zinc-800">
            <ButtonEnhanced variant="outline" onClick={() => setShowInviteModal(false)}>
              Cancel
            </ButtonEnhanced>
