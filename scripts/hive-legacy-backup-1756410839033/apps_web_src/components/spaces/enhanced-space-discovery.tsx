  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <ButtonEnhanced onClick={() => router.push('/spaces/create')}>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <SelectEnhanced value={selectedCategory} onValueChange={setSelectedCategory}>
              ...
              <SelectEnhanced value={sortBy} onValueChange={setSortBy as any}>
      ...
      <Dialog open={!!showJoinModal} onOpenChange={() => setShowJoinModal(null)}>
        <DialogContent>
          ...
          <DialogFooter>
            <ButtonEnhanced variant="outline" onClick={() => setShowJoinModal(null)}>
              Cancel
            </ButtonEnhanced>
            <ButtonEnhanced
              onClick={() => {
