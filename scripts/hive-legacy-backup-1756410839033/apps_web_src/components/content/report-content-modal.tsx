  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogTrigger asChild>
        {trigger || (
          <ButtonEnhanced variant="outline" size="sm" className="text-red-400 border-red-400/50 hover:bg-red-400/10">
            ...
            <div className="space-y-4">
              ...
              {subCategories[formData.category as keyof typeof subCategories] && (
                <div>
                  ...
                  <SelectEnhanced value={formData.subCategory} onValueChange={(value) => 
