...
export function AuthGuard({ 
  ...
  try {
    ...
    // If auth context throws, report error and show fallback
    setAuthError(error instanceof Error ? error.message : 'Authentication system unavailable');
    authState = { isAuthenticated: false, isLoading: false, requiresOnboarding: () => false };
  }
