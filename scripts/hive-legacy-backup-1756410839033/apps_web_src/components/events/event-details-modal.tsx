...
import { Modal, ButtonEnhanced, Badge, Card } from "@hive/ui";
                    ...
                    {Array.from({ length: Math.min(event.engagement.going - 1, 5) }, (_, i) => (
                      <div key={i} className="flex items-center space-x-3 p-3 bg-zinc-800/50 rounded-lg">
                        ...
                        {currentUserId === event.organizer.id && (
                          <ButtonEnhanced variant="ghost" size="sm" className="text-zinc-400">
              ...
              <div className="flex items-start space-x-3 p-4 bg-zinc-800/30 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <ButtonEnhanced size="sm" className="bg-hive-gold text-hive-obsidian hover:bg-hive-champagne">
                      Comment
                    </ButtonEnhanced>
                  </div>
                </div>
                      ...
                      <div className="flex items-start space-x-3 p-4 bg-zinc-800/20 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 mt-2">
                            <ButtonEnhanced variant="ghost" size="sm" className="text-zinc-400 hover:text-[var(--hive-text-inverse)] text-xs">
