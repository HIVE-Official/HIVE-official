...
export function AuthTest() {
  ...
  return (
    <div className="p-4 border border-[var(--hive-border-default)] rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-3 py-1 bg-blue-500 text-[var(--hive-text-inverse)] rounded text-sm hover:bg-blue-600"
          >
            Dev Login
          </button>
          <button
            onClick={() => unifiedAuth.logout()}
            className="px-3 py-1 bg-red-500 text-[var(--hive-text-inverse)] rounded text-sm hover:bg-red-600"
          >
            Logout
          </button>
        </div>
