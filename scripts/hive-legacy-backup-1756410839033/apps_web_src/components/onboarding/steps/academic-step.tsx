...
import { Card, CardContent, CardHeader, CardTitle, CardDescription, ButtonEnhanced, InputEnhanced, Label, SelectEnhanced, SelectContent, SelectItem, SelectTrigger, SelectValue, Badge } from '@hive/ui';
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <SelectEnhanced value={academicLevel} onValueChange={(value: AcademicLevel) => setAcademicLevel(value)}>
