    ...
    <div className="space-y-6">
      ...
      {showFilters && (
        <div className="flex flex-wrap items-center gap-3">
          {/* Search Type */}
          <SelectEnhanced value={searchType} onValueChange={(value: any) => setSearchType(value)}>
          ...
          {/* Sort By */}
          <SelectEnhanced value={sortBy} onValueChange={(value: any) => setSortBy(value)}>
          ...
          {/* Time Range */}
          <SelectEnhanced value={timeRange} onValueChange={(value: any) => setTimeRange(value)}>
            <SelectTrigger className="w-32">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
